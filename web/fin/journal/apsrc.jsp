            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
              ...
              <form name="frmap" method ="post" action="">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr align="left" valign="top"> 
                    <td height="8"  colspan="3"> 
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr align="left" valign="top"> 
                          <td height="8" valign="middle" colspan="3"> 
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr align="left" valign="top"> 
                                <td height="14" valign="middle" colspan="3" class="comment"><b><u>Account 
                                  Payable &gt; Search Data</u></b></td>
                              </tr>
                              <tr align="left" valign="top"> 
                        ...
                        <tr align="left" valign="top"> 
                          <td height="14" valign="middle" colspan="3" class="comment">&nbsp;Ap 
                            List </td>
                        </tr>
                        <%
							try{
							...
							%>
                        <tr align="left" valign="top"> 
                          <td height="22" valign="middle" colspan="3"> <%= drawList(listAp,oidAp)%> </td>
                        </tr>
                        <%  } 
						  }catch(Exception exc){ 
						  }%>
                  ...
                  <tr align="left" valign="top"> 
                    <td height="8" valign="middle" colspan="3"> 
                      <%if((iJSPCommand ==JSPCommand.ADD)||(iJSPCommand==JSPCommand.SAVE)&&(jspAp.errorSize()>0)||(iJSPCommand==JSPCommand.EDIT)||(iJSPCommand==JSPCommand.ASK)){%>
                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr align="left" valign="top"> 
                          ...
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_DATE] %>"  value="<%= ap.getDate() %>" class="formElemen">
                        <tr align="left" valign="top"> 
                          <td height="21" valign="top" width="17%">Due Date</td>
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_DUE_DATE] %>"  value="<%= ap.getDueDate() %>" class="formElemen">
                        <tr align="left" valign="top"> 
                          <td height="21" valign="top" width="17%">Vendor Id</td>
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_VENDOR_ID] %>"  value="<%= ap.getVendorId() %>" class="formElemen">
                        <tr align="left" valign="top"> 
                        ...
                        <tr align="left" valign="top"> 
                          ...
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_VOUCHER_NUMBER] %>"  value="<%= ap.getVoucherNumber() %>" class="formElemen">
                        <tr align="left" valign="top"> 
                          <td height="21" valign="top" width="17%">Voucher Date</td>
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_VOUCHER_DATE] %>"  value="<%= ap.getVoucherDate() %>" class="formElemen">
                        <tr align="left" valign="top"> 
                          <td height="21" valign="top" width="17%">Voucher Counter</td>
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_VOUCHER_COUNTER] %>"  value="<%= ap.getVoucherCounter() %>" class="formElemen">
                        <tr align="left" valign="top"> 
                        ...
                        <tr align="left" valign="top"> 
                          ...
                          <td height="21" colspan="2" width="83%"> 
                            <input type="text" name="<%=jspAp.colNames[JspAp.JSP_MEMO] %>"  value="<%= ap.getMemo() %>" class="formElemen">
                        <tr align="left" valign="top"> 
