            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
              ...
              <form name="frm_data" method="post" action="">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    <td width="29%"><font face="Geneva, Arial, Helvetica, san-serif" size="3"><b><u>BANK 
                      - PAYMENT</u></b></font></td>
                    <td width="19%"><b><font size="3"><b><font face="Geneva, Arial, Helvetica, san-serif"><u>NON 
                      PO </u></font></b></font></b></td>
                    <td width="33%">&nbsp;</td>
                        ...
                        <tr> 
                          ...
                          <td width="29%"> 
                            <select name="select">
                              ...
                              <option>1-2002 Bank BNI Denpasar Opr</option>
                            </select>
                          </td>
                          <td width="10%"><b>Account Balance</b></td>
                          <td width="48%"><b>Rp. 1,000,000,000.-</b></td>
                        </tr>
                        <tr> 
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    <tr> 
                                      ...
                                      <td width="100" bgcolor="#C0D6C0"> 
                                        <div align="center"><a href="nopo-proto.jsp?menu_idx=2">Expense</a></div>
                                      </td>
                              ...
                              <tr> 
                                ...
                                <td width="30%" class="tablecell"><a href="#" title="Review job descriptions to meet the actual positions needed in the site (BTNK-PNK Team)">Review 
                                  job descriptions to meet the actual positions 
                                  ...</a><br>
                                </td>
                                <td width="14%" class="tablecell">IFC</td>
                                <td width="10%" class="tablecell"> 
                  ...
                  <tr> 
                    <td width="29%">1. predefined activity mengeluarkan open window, 
                      yang berisi semua default setup dari expense account yang 
                      di link ke activity, tidak harus semua yang ada pada list 
                      activity tersebut dialokasikan ke expense. tapi bisa diupdate 
                      persentase. apabila persentase diupdate, otomatis akan mengupdate 
