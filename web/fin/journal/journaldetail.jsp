...
<%!
...

	{
		...
		ctrlist.addHeader("Coa Id","9%");
		ctrlist.addHeader("Amount","9%");
		ctrlist.addHeader("Department Id","9%");
		ctrlist.addHeader("Section Id","9%");
		ctrlist.addHeader("Periode Id","9%");
		ctrlist.addHeader("Exchange Rate","9%");
		ctrlist.addHeader("Currency","9%");
		ctrlist.addHeader("User Id","9%");
		ctrlist.addHeader("Debet","9%");
		ctrlist.addHeader("Credit","9%");
		ctrlist.addHeader("Is Debet","9%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			rowx.add(String.valueOf(journalDetail.getCoaId()));

			rowx.add(String.valueOf(journalDetail.getAmount()));

			rowx.add(String.valueOf(journalDetail.getDepartmentId()));

			rowx.add(String.valueOf(journalDetail.getSectionId()));

			rowx.add(String.valueOf(journalDetail.getPeriodeId()));

			rowx.add(String.valueOf(journalDetail.getExchangeRate()));

			rowx.add(journalDetail.getCurrency());

			rowx.add(String.valueOf(journalDetail.getUserId()));

			rowx.add(String.valueOf(journalDetail.getDebet()));

			rowx.add(String.valueOf(journalDetail.getCredit()));

			rowx.add(String.valueOf(journalDetail.getIsDebet()));
				...
				<input type="hidden" name="hidden_journal_detail_id" value="<%=oidJournalDetail%>">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					    ...
					    <tr align="left" valign="top">
					       ...
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspJournalDetail.fieldNames[JspJournalDetail.FRM_FIELD_DEPARTMENT_ID] %>"  value="<%= journalDetail.getDepartmentId() %>" class="formElemen">
					    <tr align="left" valign="top">
					    ...
					    <tr align="left" valign="top">
					       ...
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspJournalDetail.fieldNames[JspJournalDetail.FRM_FIELD_CURRENCY] %>"  value="<%= journalDetail.getCurrency() %>" class="formElemen">
					    <tr align="left" valign="top">
					    ...
					    <tr align="left" valign="top">
					       <td height="21" valign="top" width="17%">Is Debet</td>
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspJournalDetail.fieldNames[JspJournalDetail.FRM_FIELD_IS_DEBET] %>"  value="<%= journalDetail.getIsDebet() %>" class="formElemen">
					    <tr align="left" valign="top">
					       <td height="21" valign="top" width="17%">Debet</td>
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspJournalDetail.fieldNames[JspJournalDetail.FRM_FIELD_DEBET] %>"  value="<%= journalDetail.getDebet() %>" class="formElemen">
					    <tr align="left" valign="top">
					       <td height="21" valign="top" width="17%">Credit</td>
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspJournalDetail.fieldNames[JspJournalDetail.FRM_FIELD_CREDIT] %>"  value="<%= journalDetail.getCredit() %>" class="formElemen">
								 <tr align="left" valign="top">
