            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
              ...
              <form name="frm_data" method="post" action="">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    <td width="18%"><font face="Geneva, Arial, Helvetica, san-serif" size="3"><b><u>BANK 
                      - PAYMENT</u></b></font></td>
                    <td width="28%"> 
                      <div align="center"><font size="3"><b><font face="Geneva, Arial, Helvetica, san-serif"><u>NON 
                        PO </u></font></b></font></div>
                    </td>
                    <td width="30%">&nbsp;</td>
                    ...
                    <td colspan="4"> 
                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr> 
                          ...
                          <td width="9%"><b>Account Balance</b></td>
                          <td width="49%"><b>Rp. 1,000,000,000.-</b></td>
                        </tr>
                        <tr> 
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    <tr> 
                                      ...
                                      <td width="100" bgcolor="#C0D6C0"> 
                                        <div align="center"><a href="nopo1-proto.jsp?menu_idx=2">Activity</a></div>
                                      </td>
                                      <td width="74%">&nbsp;</td>
                                    </tr>
                                  </table>
