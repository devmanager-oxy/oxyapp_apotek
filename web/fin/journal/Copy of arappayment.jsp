...
<%!
...

	{
		...
		ctrlist.addHeader("Date","33%");
		ctrlist.addHeader("Paid By","33%");
		ctrlist.addHeader("Rec By","33%");
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					    ...
					    <tr align="left" valign="top">
					       ...
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspArapPayment.fieldNames[JspArapPayment.FRM_FIELD_ARAP_ID] %>"  value="<%= arapPayment.getArapId() %>" class="formElemen">
					    <tr align="left" valign="top">
					    ...
					    <tr align="left" valign="top">
					       ...
					       <td height="21" colspan="2" width="83%">
							<input type="text" name="<%=jspArapPayment.fieldNames[JspArapPayment.FRM_FIELD_NOTE] %>"  value="<%= arapPayment.getNote() %>" class="formElemen">
					    <tr align="left" valign="top">
