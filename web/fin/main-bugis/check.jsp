...
boolean payableInvPriv = true;//false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_ACCPAYABLE, AppMenu.M2_MENU_ACCPAYABLE_INVOICE);
boolean payableArcPriv = true;//false;//faappSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_ACCPAYABLE, AppMenu.M2_MENU_ACCPAYABLE_ARCHIVES);
...
boolean akrualSetupPriv = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_ACCRECEIVABLE, AppMenu.M2_MENU_ACCRECEIVABLE_CUSTOMER);
boolean akrualProcessPriv = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_ACCRECEIVABLE, AppMenu.M2_MENU_ACCRECEIVABLE_CUSTOMER);

boolean assetSetupPriv = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_ACCRECEIVABLE, AppMenu.M2_MENU_ACCRECEIVABLE_CUSTOMER);
boolean assetProcessPriv = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_ACCRECEIVABLE, AppMenu.M2_MENU_ACCRECEIVABLE_CUSTOMER);


//titipan
boolean depoList = false;
boolean newDepo = false;
boolean returDepo  = false;
boolean sadloDepo = false;
boolean depoArchives = false;

//dp
boolean xxdepoList = false;
boolean xxnewDepo = false;
boolean xxreturDepo  = false;
boolean xxsadloDepo = false;
boolean xxdepoArchives = false;

//bymhd
boolean bymhdList = false;
boolean newBymhd = false;
boolean returBymhd  = false;
boolean sadloBymhd = false;
boolean bymhdArchives = false;
