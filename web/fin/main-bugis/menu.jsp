              ...
              <tr id="frpt"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
					...
					<tr> 
                      <td height="18" width="90%" class="menu2"><a href="<%=approot%>/freport/biaya_v01_month.jsp?menu_idx=4&pnl_type=0">Biaya</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2"><a href="<%=approot%>/freport/pendapatan_v01_month.jsp?menu_idx=4&pnl_type=1">Pendapatan</a></td>
                    </tr>
					<%}%>
                    <!--tr> 
                    ...
                    <tr> 
                      <td height="18" width="90%"> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  %>
                          <tr> 
                            <td width="80%" height="18" class="menu2"><a href="<%=approot%>/master/coabudget_edt_month.jsp?menu_idx=6">Account 
                              Budget/Target </a></td>
                          </tr>
                          <%}
