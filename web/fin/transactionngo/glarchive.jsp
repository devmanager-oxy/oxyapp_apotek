...
//String whereClause = "";
            ...
            if (iCommand == JSPCommand.NONE || iCommand == JSPCommand.BACK) {
                ...
                type = I_Project.JOURNAL_TYPE_GENERAL_LEDGER;
            }

            int vectSize = 0;
//vectSize = DbGl.getCountGLReguler(DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, 0, 0, null, type);
//vectSize = DbGl.getCountGLRegulerIByType(DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, src_memo);
            vectSize = DbGl.getCountGLRegulerArchives(type, DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, src_memo);
            listGlArchive = DbGl.getGLRegulerArchive(type, DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, start, recordToGet, orderClause, src_memo);
            
            if ((iCommand == JSPCommand.FIRST || iCommand == JSPCommand.PREV) ||
                    (iCommand == JSPCommand.NEXT || iCommand == JSPCommand.LAST || iCommand == JSPCommand.BACK)) {
                start = cmdGlArchive.actionList(iCommand, start, vectSize, recordToGet);
                //listGlArchive = DbGl.getGLReguler(DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, start, recordToGet, orderClause, type);
                //listGlArchive = DbGl.getGLRegulerIByType(DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, start, recordToGet, orderClause, src_memo);                
                listGlArchive = DbGl.getGLRegulerArchive(type, DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, start, recordToGet, orderClause, src_memo);
            ...
            String[] langGL = {"Journal Number", "Reference Number", "Input Date", "to", "Ignore", //0-4
                "Period", "Transaction Date", "General Journal List", "Memo", "Please click search button to get your data.", "Data not found.", "Debet", "Credit", "Advance Journal"}; //5-13

            String[] langNav = {"General Journal", "Archives", "Date", "General Journal", "Advance Journal", "Type", "Journal Reverse", "Copy Journal"};

            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Nomor Referensi", "Tanggal Dibuat", "sampai", "Abaikan", //0-4
                    "Periode", "Tanggal Transaksi", "Daftar Jurnal Umum", "Memo", "Silahkan tekan tombol pencarian untuk menampilkan data.", "Data tidak ditemukan.", "Debet", "Credit", "Daftar Jurnal Kasbon"}; //5-13
                langGL = langID;

                String[] navID = {"Jurnal Umum", "Arsip", "Tanggal", "Jurnal Umum", "Jurnal Kasbon", "Type", "Jurnal Balik", "Jurnal Copy"};
                langNav = navID;
            }
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                document.frmglarchive.start.value=0;
                                                                                                    ...
                                                                                                    <tr>                                                                                                                                            
                                                                                                        <td class="tablecell1" > 
                                                                                                            <table width="100%" border="0" style="border:1px solid #ABA8A8" cellspacing="1" cellpadding="1">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td width="5"></td>
                                                                                                                    <td width="16%"><%=langGL[0]%></td>
                                                                                                                    <td width="26%"><input type="text" name="<%=jspGlArchive.colNames[jspGlArchive.JSP_JOURNAL_NUMBER] %>"  value="<%= glArchive.getJournalNumber() %>"></td>
                                                                                                                    <td width="14%">&nbsp;</td>
                                                                                                                    <td >&nbsp;</td>
                                                                                                                </tr>
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td>
                                                                                                                                <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmglarchive.<%=jspGlArchive.colNames[jspGlArchive.JSP_START_DATE]%>);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a> 
                                                                                                                            </td>
                                                                                                                            <td>    
                                                                                                                                &nbsp;&nbsp;<%=langGL[3]%>&nbsp;&nbsp;                                                                                                         
                                                                                                                            </td>
                                                                                                                            ...
                                                                                                                            <td><a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmglarchive.<%=jspGlArchive.colNames[jspGlArchive.JSP_END_DATE]%>);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a>                                                                                                        
                                                                                                                            </td>
                ...
                for (int i = 0; i < p.size(); i++) {
                    Periode period = (Periode) p.get(i);
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <td > 
                                                                                                                        <select name="TYPE">
                                                                                                                            <option value="<%=I_Project.JOURNAL_TYPE_GENERAL_LEDGER%>" <%if (type == I_Project.JOURNAL_TYPE_GENERAL_LEDGER) {%>selected<%}%>><%=langNav[3]%></option>
                                                                                                                            <option value="<%=I_Project.JOURNAL_TYPE_KASBON %>" <%if (type == I_Project.JOURNAL_TYPE_KASBON) {%>selected<%}%>><%=langNav[4]%></option>
                                                                                                                            <option value="<%=I_Project.JOURNAL_TYPE_REVERSE%>" <%if (type == I_Project.JOURNAL_TYPE_REVERSE) {%>selected<%}%>><%=langNav[6]%></option>
                                                                                                                            <option value="<%=I_Project.JOURNAL_TYPE_COPY%>" <%if (type == I_Project.JOURNAL_TYPE_COPY) {%>selected<%}%>><%=langNav[7]%></option>
                                                                                                                        </select>
                                                                                                                    </td>
                                                                                                                    <td >&nbsp;</td>
                                                                                                                    <td >&nbsp;</td>
                                                                            ...
                                                                            <tr> 
                                                                                <td height="10"><a href="javascript:cmdSearch()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new2','','../images/search2.gif',1)"><img src="../images/search.gif" name="new2" border="0"></a> </td>
                                                                            </tr>    
                                                                            <tr> 
                                                                                <td height="10"></td>
                                                                            </tr>    
            ...
            if (listGlArchive != null && listGlArchive.size() > 0) {
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                for (int i = 0; i < listGlArchive.size(); i++) {
                                                                                    ...
                                                                                    if (i % 2 != 0) {
                                                                                        fontCell = "tablearialcell";
                                                                                    } else {
                                                                                        fontCell = "tablearialcell1";
                                                                                    }
                                                                                        %>
                                                                                        <tr height="22"> 
                                                                                            <td class="<%=fontCell%>" align="center">
                                                                                                <a href="javascript:cmdEditGl('<%=bd.getOID()%>')"> <%=bd.getJournalNumber()%></a>
                                                                                            </td>
                                                                                            <td class="<%=fontCell%>"><div align="center"><%=JSPFormater.formatDate(bd.getTransDate(), "dd MMM yyyy")%></div></td>
                                                                                            <td class="<%=fontCell%>"><div align="center"><%=bd.getRefNumber()%></div></td>
                                                                                            <td class="<%=fontCell%>" ><%=getSubstring(bd.getMemo())%></td>
                                                                                            ...
                                                                                            <td align="center">
                                                                                                <table width="100%" height="21" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td bgcolor="#E9E37B" align="center"><font face="arial">NOT POSTED</font></td>
                                                                                                    </tr>    
                                                                                                    </table>
                                                                                            </td>
                                                                                            <%}%>
