                                                                                ...
                                                                                for (int i = 0; i < listCashArchive.size(); i++) {
                                                                                    ...
                                                                                    if (i % 2 != 0) {
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="<%=syle%>" >
                                                                                                <div align="center"><a href="<%=approot%>/<%=transactionFolder%>/cash_receive_detail.jsp?menu_idx=2&hidden_pettycash_payment_id=<%=pp.getOID()%>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ok','','../images/ok2.gif',1)"><img src="../images/ok.gif" name="ok" width="49" height="22" border="0"></a></div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%
