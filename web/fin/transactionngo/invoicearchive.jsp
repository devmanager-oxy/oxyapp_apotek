...
<%!
	...
	public String drawList(Vector objectClass, int start){
		...
		cmdist.addHeader("Inv/DO","10%");
		cmdist.addHeader("Date","10%");
		cmdist.addHeader("PO Reference","5%");		
		cmdist.addHeader("Vendor","15%");
		cmdist.addHeader("Notes","12%");
		cmdist.addHeader("Invoice Amount","10%");
		cmdist.addHeader("Payment Amount","10%");
                cmdist.addHeader("Pay. Status","7%");
		cmdist.addHeader("Due Date","8%");		
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Account Payable</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Invoice List</span></font>";
					  %>
