...
<%-- 
    Document   : coapettycash
    Created on : Mar 12, 2012, 10:16:33 AM
    Author     : Roy Andika
--%>
...
String frm = JSPRequestValue.requestString(request, "frm_name");
String coa_id = JSPRequestValue.requestString(request, "coa_id");
...
function cmdSelect(coaid, coaname){                
	self.opener.document.<%=frm%>.coa_txt.value = coaname;
	self.opener.document.<%=frm%>.<%=coa_id%>.value = coaid;           
	self.close();
}

function cmdChangeList(){
	document.frmrptformatdetailcoa.action="coapettycash.jsp";
                    ...
                    <tr> 
                      <td> 
                        <form name="frmrptformatdetailcoa" method ="post" action="">
                          ...
                          <input type="hidden" name="frm_name" value="<%=frm%>">
