...
<%
            ...
            String[] langNav = {"Bank Transaction", "Post Jurnal", "Search for", "Bank Deposit", "Bank Payment", "Bank Payment", "Please click on the search button to find your data", "Data not found", "process is completed", "Segment", "Account", "Amount", "Memo"};

            if (lang == LANG_ID) {

                String[] langID = {"Nomor Jurnal", "Tgl. Transaksi", "Perkiraan", "Mata Uang", "Memo", "Posting", "Kode", "Jumlah", "Transaksi Bank", "Post Jurnal", "Data tidak ditemukan", "Nomor Jurnal", "Periode"}; //0 - 12
                langCT = langID;

                String[] navID = {"Transaksi Bank", "Post Jurnal", "Pencarian", "Setoran Bank", "Pembayaran Bank", "Pembayaran Bank", "Klik tombol search untuk mencari data", "Data tidak ditemukan", "Proses selesai", "Segmen", "Perkiraan", "Jumlah", "Keterangan"};
                langNav = navID;
            }
                                                                                                    ...
                                                                                                    <tr>                                                                                                                                            
                                                                                                        <td class="tablecell1" >                                                                                                            
                                                                                                            <table width="100%" border="0" style="border:1px solid #ABA8A8" cellspacing="1" cellpadding="1">
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    <td width="5">&nbsp;</td>
                                                                                                                    <td class="fontarial"><%=langNav[2]%></td>
                                                                                                                    <td >                                                                                                         
                                                                                                                    ...
                                                                                                                    <td align="right" class="fontarial"><%=langCT[12]%>&nbsp;</td>
                                                                                                                    <td >
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                if (type_document == TYPE_BANK_DEPOSIT) {
                                                                                    ...
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                        <tr>
                                                                                            <td width="4%" rowspan="2" class="tablehdr">No</td>
                                                                                            ...
                                                                                            <td width="4%" rowspan="2" class="tablehdr"><input type="checkbox" name="chkbox" onClick="setChecked(this)"></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="<%=style%>" align="center"><%=bankDeposit.getJournalNumber()%></td>
                                                                                            <td class="<%=style%>" align="center"><%=JSPFormater.formatDate(bankDeposit.getTransDate(), "dd/MM/yyyy")%></td>
                                                                                            <td class="<%=style%>" align="left"><%=coa.getCode() + " - " + coa.getName()%></td>
                                                                                            <td class="<%=style%>" align="center"><%=cur.getCurrencyCode()%></td>                                                                                            
                                                                                            ...
                                                                                            <td class="<%=style%>" align="center"><input type="checkbox" name="check_<%=bankDeposit.getOID()%>" value="1"></td>
                                                                                        </tr>        
                                                                                        <%
                                                                                        ...
                                                                                        <tr height="22">
                                                                                            ...
                                                                                            <td class="tablecell1" colspan="6">
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr height="20">
                                                                                                        <td class="tablearialcell" align="center" width="25%"><B><%=langNav[9]%></b></td>                                                                        
                                                                                                        <td class="tablearialcell" align="center" ><B><%=langNav[10]%></b></td>
                                                                                                        <td class="tablearialcell" align="center" width="15%"><B><%=langNav[11]%></b></td>
                                                                                                        <td class="tablearialcell" align="center" width="30%"><B><%=langNav[12]%></b></td>
                                                                                                    </tr>  
                                                                                                    <%
                                                                                    ...
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan="2" class="tablehdr"><%=langCT[3]%></td>
                                                                                            <td width="35%" rowspan="2" class="tablehdr"><%=langCT[4]%></td>
                                                                                            <td width="5%" rowspan="2" class="tablehdr"><input type="checkbox" name="chkbox" onClick="setChecked(this)"></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td width="5%" class="tablehdr"><%=langCT[6]%></td>
                                                                                            <td width="12%" class="tablehdr"><%=langCT[7]%></td>
                                                                                        </tr>
                                                                                        <%
                                                                                        for (int i = 0; i < list.size(); i++) {
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="<%=style%>" align="center"><%=(i + 1)%></td>
                                                                                            <td class="<%=style%>" align="center"><%=bnonP.getJournalNumber()%></td>
                                                                                            <td class="<%=style%>" align="center"><%=JSPFormater.formatDate(bnonP.getTransDate(), "dd/MM/yyyy")%></td>
                                                                                            <td class="<%=style%>" align="left"><%=coa.getCode() + " - " + coa.getName()%></td>
                                                                                            <td class="<%=style%>" align="center"><%=IDR%></td>                                                                                            
                                                                                            <td class="<%=style%>" align="right"><%=JSPFormater.formatNumber(bnonP.getAmount(), "#,###.##")%>&nbsp;&nbsp;</td>
                                                                                            <td class="<%=style%>" align="left"><%=bnonP.getMemo()%></td>
                                                                                            <td class="<%=style%>" align="center"><input type="checkbox" name="check_<%=bnonP.getOID()%>" value="1"></td>
                                                                                        </tr>
                                                                                        <%
                                                                                                Vector crd = new Vector();
