...
// end switch
            ...
            whereClause = DbGl.colNames[DbGl.COL_IS_REVERSAL] + " = " + DbGl.IS_REVERSAL;
...
//modify where clause base on search for
            ...
            int vectSize = 0;
            vectSize = DbGl.CountGlReverseArchive(glArchive.getPeriodeId(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getJournalNumber(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber);
            ...
            if ((iCommand == JSPCommand.FIRST || iCommand == JSPCommand.PREV) ||
                ...
                listGlArchive = DbGl.glReverseArchive(glArchive.getPeriodeId(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getJournalNumber(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber);            
            }
            ...
            String[] langNav = {"Reversal Journal", "Archives", "Date"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Jurnal Reversal", "Arsip", "Tanggal"};
                langNav = navID;
            }
    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdSearch(){
                ...
                document.frmglarchive.action="glreversearchive.jsp";
                document.frmglarchive.submit();
            }
            
            function cmdView(oidGl){
                document.frmglarchive.command.value="<%=JSPCommand.VIEW%>";
                document.frmglarchive.hidden_gl_id.value=oidGl;
                document.frmglarchive.action="glreverseview.jsp";
                document.frmglarchive.submit();
            }
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/search2.gif')">
                                                                                            ...
                                                                                            <td colspan="4" valign="top"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <input name="<%=jspGlArchive.colNames[jspGlArchive.JSP_IGNORE_TRANSACTION_DATE] %>" type="checkBox" class="formElemen"  value="1" <%if (glArchive.getIgnoreTransactionDate() == 1) {%>checked<%}%>><%=langGL[4]%></td>
                                                                                                    </tr>
                                                                                                    <tr> 
     ...
     for (int i = 0; i < listGlArchive.size(); i++) {
         ...
         if (i % 2 != 0) {
                                                                                        %>
                                                                                        <tr> 
                                                                                            <td class="tablecell" width="13%"><a href="javascript:cmdView('<%=bd.getOID()%>')"><%=bd.getJournalNumber()%></a></td>
                                                                                        ...
                                                                                        %>
                                                                                        <tr> 
                                                                                            <td class="tablecell1" width="13%"><a href="javascript:cmdView('<%=bd.getOID()%>')"><%=bd.getJournalNumber()%></a></td>
