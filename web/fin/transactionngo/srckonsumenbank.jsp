    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdSelect(cstname,cstid){      
                self.opener.document.frmbankdepositdetail.cst_name.value = cstname;
                self.opener.document.frmbankdepositdetail.<%=JspBankDeposit.colNames[JspBankDeposit.JSP_CUSTOMER_ID]%>.value = cstid;                                 
                self.close();
            }
            
            function cmdSearch(){   
                document.frm_nomorjurnal.command.value="<%=JSPCommand.SEARCH%>";
                document.frm_nomorjurnal.action="srckonsumenbank.jsp";
            ...
            function cmdDelPict(oidCashReceiveDetail){
                ...
                document.frmimage.action="srckonsumenbank.jsp";
    ...
    <body> 
        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
            <form name="frm_nomorjurnal" method ="post" action="">
                ...
                <input type="hidden" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_CUSTOMER_ID]%>" value="">
