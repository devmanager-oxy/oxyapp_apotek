...
<%-- 
    Document   : glcopy
    Created on : Oct 11, 2013, 9:12:05 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            int vectSize = DbGl.countGlCopy(glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getJournalNumber(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, glArchive.getPeriodeId(), srcMemo);
            ...
            if ((iCommand == JSPCommand.FIRST || iCommand == JSPCommand.PREV) ||
                ...
                listGlArchive = DbGl.glCopy(glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getJournalNumber(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber,glArchive.getPeriodeId(), srcMemo, start, recordToGet);
            }
    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdSearch(){
                ...
                document.frmglarchive.action="glcopy.jsp";
