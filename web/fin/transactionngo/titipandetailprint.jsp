...
function cmdPrintJournal(){	 
	window.open("<%=printroot%>.report.RptTitipanAndKembaliPDF?oid=<%=appSessUser.getLoginId()%>&crd_id=<%=oidCashReceive%>&type=<%=cashReceive.getType()%>");
}
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Deposit/Titipan</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">"+((cashReceive.getType()==1) ? "Titipan" : "Pengembalian Titipan")+"</span></font>"; 
					  %>
                                      ...
                                      <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr>
                                                <td rowspan="2"  class="tablehdr" nowrap width="20%">Penitip/Unit</td>
                                              ...
                                              <tr>
												...
												<%
														...
														try{
															vndx = DbVendor.fetchExc(crd.getCustomerId());
														}
														catch(Exception e){
														}
												%>
												<%=vndx.getCode()+"-"+vndx.getName()%>
												</td>
