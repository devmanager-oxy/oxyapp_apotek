...
<%
            String[] langCT = {"Receipt to Account", "Receipt From", "Amount", "Memo", "Journal Number", "Transaction Date", //0-5
                ...
                "Cash Received document is ready to be saved", "Cash Receive document has been saved successfully", "Searching", "Customer", "Search Advance", "Credit", "Credit Amount in", "Period", "Segment", "Jemaat"}; //13-22
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Diterima Pada", "Diterima Dari", "Jumlah", "Catatan", "Nomor Jurnal", "Tanggal Transaksi", //0-5
                    ...
                    "Dokumen Penerimaan Tunai siap untuk disimpan", "Dokumen Penerimaan Tunai sudah disimpan dengan sukses", "Pencarian", "Konsumen", "Cari Kasbon", "Credit", "Jumlah Credit", "Periode", "Segmen", "Jemaat"}; //13-22
                langCT = langID;
...
<html >
        ...
        for (int t = 0; t < periods.size(); t++) {
                                                                                    ...
                                                                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr> 
                                                                                            <td class="boxed1">                                                                                                
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        <td rowspan="2" class="tablehdr" nowrap width="15%"><%=langCT[21]%></td>
                                                                                                        <td rowspan="2" class="tablehdr" nowrap width="15%"><%=langCT[6]%></td>                                                                                                        
                                                                                                        <td class="tablehdr" rowspan="2" width="15%"><%=langCT[22]%></td>
                                                                                                        <td class="tablehdr" colspan="2" width="20%"><%=langCT[7]%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="5%"><%=langCT[10]%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="10%"><%=langCT[11]%> <%=baseCurrency.getCurrencyCode()%></td>                                                                                                        
                                                                                                        <td rowspan="2" class="tablehdr" ><%=langCT[12]%></td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td class="tablehdr"><%=langCT[8]%></td>
                                                                                                        <td class="tablehdr"><%=langCT[9]%></td>                                                                                                        
                                                                                                    </tr>
                                                                                                    <%
            int idx = -1;
            ...
            if (((iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.SAVE || iErrCode > 0 || iErrCodeRec != 0) && recIdx == -1) && !(isSave && iErrCode == 0 && iErrCodeRec == 0) && (cashReceive.getPostedStatus() != 1)) {
                                                                                                    ...
                                                                                                    if (segments != null && segments.size() > 0) {
                                                                                                        ...
                                                                                                        for (int x = 0; x < deps.size(); x++) {
                                                                                                            ...
                                                                                                            switch (d.getLevel()) {
                                                                                                                ...
                                                                                                                case 3:
                                                                                                                    ...
                                                                                                                    %>
                                                                                                                    <option value="<%=d.getOID()%>" <%if (cashReceiveDetail.getDepartmentId() == d.getOID()) {%>selected<%}%>><%=d.getName()%></option>
                                                                                                                    <%}
                                                                                                    }%>
                                                                                                                </select>
                                                                                                            <%= jspCashReceiveDetail.getErrorMsg(jspCashReceiveDetail.JSP_DEPARTMENT_ID) %> </div>
                                                                                                        ...
                                                                                                        <td class="tablecell" >
                                                                                                            <div align="center"><input type="text" name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_BOOKED_RATE]%>" size="7" value="<%=JSPFormater.formatNumber(cashReceiveDetail.getBookedRate(), "#,###.##")%>" style="text-align:right"  onBlur="javascript:cmdUpdateExchangeXX()" onClick="this.select()"></div>
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td class="tablecell"><div align="center"><input type="text" name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_MEMO]%>" size="30" value="<%=cashReceiveDetail.getMemo()%>"></div></td>
                                                                                                    </tr>
                                                                                                    <%}%>
                                                                                                </table>
                                                                                            </td>
    ...
    if ((iJSPCommand != JSPCommand.ADD && iJSPCommand != JSPCommand.EDIT && iJSPCommand != JSPCommand.ASK && iErrCode == 0 && iErrCodeRec == 0) || (isSave && iErrCode == 0 && iErrCodeRec == 0)) {
        if (privAdd) {%>
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    <td> 
                                                                                                                        <table border="0" cellpadding="2" cellspacing="0" class="warning" width="293" align="left">
                                                                                                                            ...
                                                                                                                            <td width="253" nowrap><%=msgStringRec%></td></tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <%}%>
                                                                                                    ...
                                                                                                    <tr align="left" valign="top"><td height="1" valign="middle" colspan="2" width="100%"><table width="99%" border="0" cellspacing="0" cellpadding="0"><tr><td height="2" background="../images/line.gif" ><img src="../images/line.gif"></td></tr></table></td>
                                                                                                    </tr>
                                                                                                    <%}
    ...
    if (temp != null && temp.size() > 0) {
        ...
        if (userEmp.getPosition().equalsIgnoreCase(employee.getPosition())) {
                                                                                                            %>
                                                                                                            <div align="center"> 
                                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1"><tr><td><div align="center"><a href="javascript:cmdApproval('<%=apd.getOID()%>','1')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('save1','','../images/success-2.gif',1)" alt="Klik : Untuk Menyetujui Dokumen"><img src="../images/success.gif" name="save1" height="20" border="0"></a></div></td>
