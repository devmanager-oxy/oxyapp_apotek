...
%>
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <%//=JSPDate.drawDateWithStyle(jspBankArchive.colNames[jspBankArchive.JSP_TRANSACTION_DATE], (bankArchive.getTransactionDate()==null) ? new Date() : bankArchive.getTransactionDate(), 0,-10, "formElemen", "") %> 
            ...
            if (p != null && p.size() > 0) {
                for (int i = 0; i < p.size(); i++) {
                    Periode period = (Periode) p.get(i);
                                                                            ...
                                                                            <tr> 
                                                                                <td><b><font size="2" face="arial"><%=langCT[7]%></font></b> 
                                                                                </td>
                                                                            </tr>
                                                                            <%} else if (bankArchive.getSearchFor().equals("paymentbaseonpo") && privPoView) {%>
                                                                            <tr> 
                                                                                <td><b><font size="2" face="arial"><%=langCT[8]%></font></b> 
                                                                                </td>
                                                                            </tr>
                                                                            <%} else if (privNonPoView) {
                                                                            %>
                                                                            <tr> 
                                                                                <td><b><font size="2" face="arial"><%=langCT[9]%></font></b> 
                                                                                </td>
                                                                            </tr>
                                                                            <%}%>
                                                                            <tr> 
