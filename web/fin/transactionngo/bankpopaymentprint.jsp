...
//out.println("<br>oidBankpoPaymentx : --------"+oidBankpoPaymentx+"--------");
...
//out.println("listBankpoPaymentDetail : "+listBankpoPaymentDetail);
                                              ...
                                              <tr> 
                                                <td width="100%" class="page"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    <tr> 
                                                      <td  class="tablehdr" width="8%"><font size="1">Invoice 
                                                        Number </font></td>
