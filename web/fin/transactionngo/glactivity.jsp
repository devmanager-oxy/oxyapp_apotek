...
//out.println("<br>sebelum save : "+listGlActivity);
            ...
            if (iJSPCommand == JSPCommand.SAVE) {
                if (gl.getOID() != 0) {
                    ...
                    response.sendRedirect("glactivityprint.jsp?hidden_glarchive=" + oidGl);
...
//out.println("accountBalance : "+accountBalance);
            ...
            String st1 = JSPFormater.formatNumber(totalDetail, "###.##");
            String st2 = JSPFormater.formatNumber(totalDebet, "###.##");
            totalDebet = Double.parseDouble(st2);
            totalDetail = Double.parseDouble(st1);
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPredefined(oid){
                ...
                document.frmpglactivity.action="glactivitypredefined.jsp";
            ...
            <%@ include file="../main/hmenu.jsp"%>
                  ...
                  <%@ include file="../calendar/calendarframe.jsp"%>
                                        ...
                                        <td width="100%" valign="top"> 
                                           ...
                                           <%
            String navigator = "<font class=\"lvl1\">General Journal</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Activity</span></font>";
                                           %>
