...
<%
            ...
            if (iJSPCommand == JSPCommand.SAVE) {
                ...
                if (isValidDate) {
                    reverseGl.setJournalNumber(journalNumber);
                    reverseGl.setJournalPrefix(journalPrefix);
                    reverseGl.setJournalCounter(journalCounter);
                    reverseGl.setJournalType(journalType);
                    reverseGl.setRefNumber(refNumber);
                    reverseGl.setPeriodId(periodId);
                    reverseGl.setMemo(memo);

                    if (transDate != null) {
                        reverseGl.setTransDate(transDate);
                    }

                    oidGlReverse = DbGl.doReversePostedJournal(oidGl, reverseGl, glType, user.getOID());
                    if (oidGlReverse == 0) {
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/print2.gif','../images/back2.gif')">
                                                                                                    ...
                                                                                                    <tr>                                                                                                         
                                                                                                        <td colspan="5">
                                                                                                            <table width="140" border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr height="30">
                                                                                                                    <td bgcolor="#93EC87" align="center">
                                                                                                                        <% if (oidGlReverse == 0) {%>
                                                                                                                        <font face="arial"><%=langGL[0].toUpperCase() %></font>
                                                                                                                        <% } else {%>
                                                                                                                        <font face="arial"><%=langGL[1].toUpperCase() %></font>
                                                                                                                        <% }%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
     ...
     Vector vPeriod = DbPeriode.list(0, 0, where, DbPeriode.colNames[DbPeriode.COL_START_DATE]);
     ...
     String prefixGl = DbSystemDocNumber.getNumberPrefixGl(periodeSelected.getOID());
     int counterGl = DbSystemDocNumber.getNextCounterGl(periodeSelected.getOID());
     String strNumber = DbSystemDocNumber.getNextNumberGl(counterGl, periodeSelected.getOID());
                                                                                                                %>
                                                                                                                <tr> 
                                                                                                                    <td width="5">&nbsp;</td>
