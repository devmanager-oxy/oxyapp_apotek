            ...
            <%@ include file="../main/hmenu.jsp"%>
                  ...
                  <%@ include file="../calendar/calendarframe.jsp"%>
                                        ...
                                        <td width="100%" valign="top"> 
                                           ...
                                           <%
            String navigator = "<font class=\"lvl1\">Cash</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Receipt Archives</span></font>";
                                           %>
                                                                                    ...
                                                                                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr> 
                                                                                            <td class="boxed1"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        <td rowspan="2"  class="tablehdr" nowrap width="20%">Account - Description</td>
                                                                                                        <td colspan="2" class="tablehdr" width="15">Currency</td>
                                                                                                        <td rowspan="2" class="tablehdr" width="10%">Booked Rate</td>
                                                                                                        <td rowspan="2" class="tablehdr" width="15%">Amount <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="40%">Description</td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                            ...
                                                                                            <td width="78%"> 
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr> 
                                                                                                        <td width="3%">
                                                                                                            <%
            out.print("<a href=\"../freport/rpt_cashreceive_detail.jsp?cash_receive_id=" + cashReceive.getOID() + "\"  onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/print.gif\" name=\"print\" height=\"22\" border=\"0\"></a></div>");
                                                                                                            %>
                                                                                                        </td>
                                                                                                        <td width="3%">&nbsp;</td>
