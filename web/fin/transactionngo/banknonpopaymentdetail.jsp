...
<%
            ...
            String[] langBT = {"Vendor", "Type", "Payment from Account", "Payment Method", "Bank Reference Number", "Amount in", "Memo", //0-6
                ...
                "Journal is ready to be saved", "Journal has been saved", "Insufficient bank balance", "Customer", "Period", "Segmen", "Jemaat" //20-26
            };

            String[] langNav = {"Bank Transaction", "Non PO Payment", "Date", "Select...", "SEARCHING", "BANK PAYMENT EDITOR", "Payment to"};
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Suplier", "Tipe", "Pembayaran dari Perkiraan", "Cara Pembayaram", "Nomor Referensi Bank", "Jumlah", "Catatan",
                    ...
                    "Jurnal siap untuk disimpan", "Jurnal sukses disimpan", "Saldo bank tidak mencukupi", "Sarana", "Periode", "Segmen", "Jemaat"
                };
                langBT = langID;

                String[] navID = {"Transaksi Bank", "Pembayaran Bank Langsung", "Tanggal", "Pilih...", "PENCARIAN", "EDITOR PEMBAYARAN BANK", "Dibayarkan kepada"};
                langNav = navID;
...
<head>
    ...
    function cmdPrintJournal(oidBank){	 
        window.open("<%=printroot%>.report.RptPembayaranBankPDF?user_id=<%=appSessUser.getUserOID()%>&cash_id="+oidBank+"&lang=<%=lang%>");
        } 
                                                ...
                                                <td colspan="4">
                                                    ...
                                                    <tr>                                                                                                                                            
                                                        ...
                                                        <table width="100%" border="0" style="border:1px solid #ABA8A8" cellspacing="2" cellpadding="1"> 
                                                            ...
                                                            <tr> 
                                                                <td width="5"></td>
                                                                <td nowrap class="fontarial"><%=langBT[0]%></td>
                                                                <td colspan="3">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td width="18%"> 
                                            ...
                                            <tr> 
                                                <td width="100%" class="page">
                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1"><!--DWLayoutTable-->
                                                        <tr>
                                                            <td class="tablearialhdr" rowspan="2" width="19%"><%=langBT[25]%></td>
                                                            <td class="tablearialhdr" rowspan="2" width="19%"><%=langBT[12]%></td>                                                                        
                                                            <td class="tablearialhdr" rowspan="2" width="12%"><%=langBT[26]%></td>
                                                            <td class="tablearialhdr" colspan="2"><%=langBT[14]%></td>
                                                            <td class="tablearialhdr" rowspan="2" width="5%"><%=langBT[17]%></td>
                    ...
                    <tr> 
                        <td colspan="4">
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                    <td width="8%"><a href="javascript:cmdSubmitCommand()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('post','','../images/savedoc2.gif',1)"><img src="../images/savedoc.gif" name="post" border="0"></a>
                                        <%if (banknonpoPayment.getOID() != 0) {%>
                                        ...
                                        &nbsp;&nbsp;<a href="javascript:cmdPrintJournal('<%=banknonpoPayment.getOID()%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('print','','../images/printdoc2.gif',1)"><img src="../images/printdoc.gif" name="print" width="112" border="0"></a>
                                        <%}%>
                                    </td>                                    
                                </tr>
                            </table>
