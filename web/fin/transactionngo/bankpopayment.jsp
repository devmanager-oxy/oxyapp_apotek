...
<%
            ...
            String[] langCT = {"Suspense Account", "Customer", "Payment Method", "Cheque/Transfer Number", "Memo", "Journal Number", "Trans. Date", "Amount"}; //0 - 7

            String[] langNav = {"Bank", "PO Payment", "Date", "Invoice", "Vendor", "Inv. Currency", "Unit Usaha", "Balance",
                "Rate", "Payment", "Payment by Invoice", "Description", "DO Number", "Currency"
            };

            if (lang == LANG_ID) {

                String[] langID = {"Account Sementara", "Sarana", "Cara Pelunasan", "Cek/nomor Transfer", "Memo", "Nomor Jurnal", "Tgl. Transfer", "Jumlah"}; //0 - 7

                langCT = langID;

                String[] navID = {"Bank", "Order Pembelian", "Tanggal", "Tagihan", "Vendor", "Mata uang Inv.", "Unit Usaha", "Balance",
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                ...
                for (int i = 0; i < accLinks.size(); i++) {
                    ...
                    if (bankpoPayment.getCoaId() == 0 && i == 0) {
                        bankpoPayment.setCoaId(acl.getCoaId());
                                        ...
                                        <td height="21" valign="middle" width="13%" nowrap>&nbsp;&nbsp;<b>Account Balance <%=baseCurrency.getCurrencyCode()%></b>&nbsp;&nbsp;</td>
                                    ...
                                    <tr align="left"> 
                                        <td height="21" valign="middle" width="12%"><%=langCT[1]%></td>                                        
                                        <td height="21" valign="middle" width="28%">
                                            <%
            ...
            if (vCustomer != null && vCustomer.size() > 0) {
                ...
                for (int iC = 0; iC < vCustomer.size(); iC++) {
                    ...
                    Customer objCustomer = (Customer) vCustomer.get(iC);
                                                ...
                                                %>                                                                                                                
                                                <option <%if (bankpoPayment.getCustomerId() == objCustomer.getOID()) {%>selected<%}%> value="<%=objCustomer.getOID()%>"><%=objCustomer.getName()%></option>                                                                                                                
                                                <%
                                                    }
                                                } else {
                                                %>
                                        ...
                                        <td height="21" valign="middle" width="13%">&nbsp;&nbsp;<%=langCT[5]%></td>
                                        <td height="21" colspan="2" width="47%" class="comment" valign="top"> 
            <%
            String strNumber = "";
            ...
            Vector vpm = DbPaymentMethod.list(0, 0, "", "");
                                                                ...
                                                                <td width="100%" class="page"> 
                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                        <tr> 
                                                                            ...
                                                                            <td  class="tablehdr" width="8%" nowrap><font size="1"><%=langNav[10]%>/<br>
                                                                            <%=langNav[12]%></font></td>
                                                                            ...
                                                                            <td class="tablehdr" width="9%"><font size="1"><%=langNav[7]%> 
                                                                            <%=baseCurrency.getCurrencyCode()%></font></td>
                                                                            <td class="tablehdr" width="9%"><font size="1"><%=langNav[9]%>
                                                                            <%=baseCurrency.getCurrencyCode()%></font></td>
                                                                            <td class="tablehdr" width="11%"><font size="1"><%=langNav[10]%><br>
                                                                                    <%=langNav[13]%>
                ...
                for (int i = 0; i < invoices.size(); i++){
                    ...
                    try {
                        us = DbUnitUsaha.fetchExc(invoice.getUnitUsahaId());
                    } catch (Exception e) {
                        System.out.println("[exception] " + e.toString());
                    }
                    ...
                    BankpoPaymentDetail bpd = getBankpoPaymentDetail(invoice, vBPD);
                                                                        ...
                                                                        <tr> 
                                                                            ...
                                                                            <td width="9%" class="tablecell"><font size="1"><%=us.getName()%></font></td>
            ...
            if (bankpoPayment.getOID() == 0 || bankpoPayment.getStatus().equals(I_Project.STATUS_NOT_POSTED)) {
                if (iJSPCommand == JSPCommand.SAVE) {
                    if (iErrCode != 0){
                                                            ...
                                                            %>
                                                            <%
            if (bankpoPayment.getOID() == 0 || bankpoPayment.getStatus().equals(I_Project.STATUS_NOT_POSTED)) //if(bankpoPayment.getOID()!=0 && bankpoPayment.getAmount()>0 && iErrCode==0 && bankpoPayment.getStatus().equals(I_Project.STATUS_NOT_POSTED)){
            {
                                                            %>
                                                            <tr> 
                                                                <td width="43%">
