...
<%
            ...
            int vectSize = DbGl.CountGlReverse(glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getJournalNumber(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, glType, glArchive.getPeriodeId(), srcMemo);
            ...
            if ((iCommand == JSPCommand.FIRST || iCommand == JSPCommand.PREV) ||
                ...
                listGlArchive = DbGl.glReverse(glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getJournalNumber(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, glType, glArchive.getPeriodeId(), srcMemo, start, recordToGet);
            }
