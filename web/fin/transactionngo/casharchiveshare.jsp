...
<%}%>
	...
	function cmdSearch(){
		...
		document.frmcasharchive.action="casharchiveshare.jsp";
	...
	function cmdEditPayment(oidPayment, status){
		...
		if(parseInt(status)==1){	
			...
			document.frmcasharchive.hidden_pettycash_payment_id.value=oidPayment;
			document.frmcasharchive.command.value="<%=JSPCommand.START%>";
			document.frmcasharchive.action="<%=approot%>/fd/purchasesharemain.jsp";
		}
		document.frmcasharchive.submit();
	}
                                              ...
                                              <tr> 
												...
												%>
                                                  <select name="<%=jspCashArchive.colNames[jspCashArchive.JSP_SEARCH_FOR] %>" onChange="javascript:cmdSearch()">
                                                    ...
                                                    <option value="paymentpettycash" <%if(cashArchive.getSearchFor().equals("paymentpettycash")){%> selected <%}%>>Payment Petty Cash</option>
                                    ...
                                    <td class="boxed1">
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <%												
											...
											%>
                                        <tr> 
                                          <td class="tablecell" width="9%"><a href="javascript:cmdEditPayment('<%=pp.getOID()%>','<%=pp.getStatus()%>')"><%=pp.getJournalNumber()%></a></td>
                                          <td class="tablecell" width="18%"><%=coa.getCode()+" - "+coa.getName()%></td>
                                        ...
                                        <%
											...
											%>
                                        <tr> 
                                          <td class="tablecell1" width="9%"><a href="javascript:cmdEditPayment('<%=pp.getOID()%>','<%=pp.getStatus()%>')"><%=pp.getJournalNumber()%></a></td>
                                          <td class="tablecell1" width="18%"><%=coa.getCode()+" - "+coa.getName()%></td>
