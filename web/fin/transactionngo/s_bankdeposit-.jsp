...
if(iJSPCommand == JSPCommand.SEARCH){
    ...
    listBankDepsit = DbBankDeposit.list(0, 0, where, DbBankDeposit.colNames[DbBankDeposit.COL_JOURNAL_NUMBER]);    
            ...
            <td colspan=2>
                <table width="100%" border=0 cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tablecell" align="right"><%=JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##")%>&nbsp;</td>
                    </tr> 
                    <%
                    }else{ 
                    %>
                    <tr>
                        ...
                        <td class="tablecelll" align="left">&nbsp;<%=bankDeposit.getMemo()%></td>
                        <td class="tablecelll" align="right"><%=JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##")%>&nbsp;</td>
                    </tr> 
                    <% 
                    } 
                    %>
