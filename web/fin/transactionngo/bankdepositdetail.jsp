...
<%
            ...
            try {
                cs = DbCustomer.fetchExc(bankDeposit.getCustomerId());
                cstName = cs.getName();
            } catch (Exception e) {
            }
            ...
            String[] langNav = {"Bank Transaction", "Deposit", "Date", "Select..."};
            ...
            if (lang == LANG_ID) {
                ...
                langBT = langID;
                String[] navID = {"Transaksi Bank", "Setoran", "Tanggal", "Pilih..."};
                langNav = navID;
...
<html >
    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdSearchCustomer(){
                var cstName = document.frmbankdepositdetail.cst_name.value;  
                window.open("<%=approot%>/<%=transactionFolder%>/srckonsumenbank.jsp?cst_name=\'"+cstName+"'&command=<%=JSPCommand.SEARCH%>", null, "height=400,width=700, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                }   
                
                function cmdSearchJurnal(){
                    var numb = document.frmbankdepositdetail.jurnal_number.value; 
                    window.open("<%=approot%>/<%=transactionFolder%>/s_bankdeposit.jsp?txt_jurnal=\'"+numb+"'&command=<%=JSPCommand.SEARCH%>&formName=frmbankdepositdetail&txt_Id=bankdeposit_id&txt_Name=jurnal_number", null, "height=400,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                    }
                    
                    function cmdPrintJournal(oidCashReceive){	                       
                window.open("<%=printroot%>.report.RptSetoranBankPDF?user_id=<%=appSessUser.getUserOID()%>&bank_deposit_id="+oidCashReceive+"&lang=<%=lang%>");
                }
         ...
         <%}
            ...
            if(!isNaN(famount)){
                if(famount == 51.23){ // bugs di java script
                    
                    var tmpfamount = famount * 100;
                    var tmpfbooked = fbooked / 100;
                    
                    document.frmbankdepositdetail.<%=JspBankDepositDetail.colNames[JspBankDepositDetail.JSP_AMOUNT]%>.value= formatFloat(parseFloat(tmpfamount) * parseFloat(tmpfbooked), '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace);
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (isLoad && reset_app != 1) {
                ...
                bangdepositId = bankDeposit.getOID();
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td width="5">&nbsp;</td>
                                                                                                                                <td class="fontarial"><font face="arial"><b><i><%=langBT[14]%></i></b></font></td>
                                                                                                                                <td>&nbsp;</td>
                                                                                                                                <td>&nbsp;</td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                                <td width="5">&nbsp;</td>
                                                                                                                                <td class="fontarial" width="80"><%=langBT[3]%></td>
                                                                                                                                <td class="fontarial" width="30"><input size="25" type="text" name="jurnal_number" value="<%=jur_number%>"></td>
                                                                                                                ...
                                                                                                                <tr>                                                                                                                                            
                                                                                                                    <td class="tablecell1" > 
                                                                                                                        <table width="100%" border="0" style="border:1px solid #ABA8A8" cellspacing="2" cellpadding="1">                                                                                                        
                                                                                                                            <tr> 
                                                                                                                                <td width="5"></td>
                                                                                                                                <td colspan="4" height="23"><font face="arial"><b><i><%=langBT[18]%></i></b></font></td>
                                                                                                                            </tr>     
                                                                                                                            <tr>
                                                                                                                                <td width="5"></td>
                                                                                                                                <td width="120" class="fontarial"><%=langBT[3]%></td>
                                                                                                                                <td width="330" class="fontarial"> 
                                                                                                                                    <%
            ...
            if (bankDeposit.getOID() != 0 || oidBankDeposit != 0) {
                strNumber = bankDeposit.getJournalNumber();
                                                                                                                                ...
                                                                                                                                <td class="fontarial"> 
                                                                                                                                    ...
                                                                                                                                    <%=open.getName()%>
                                                                                                                                    <input type="hidden" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_PERIODE_ID]%>" value="<%=open.getOID()%>">
                                                                                                                                    <%} else {%>
                                                                                                                                    <%if (periods.size() > 1) {%>
    ...
    if (periods != null && periods.size() > 0) {
        ...
        for (int t = 0; t < periods.size(); t++) {
            ...
            Periode objPeriod = (Periode) periods.get(t);
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                <td width="5"></td>
                                                                                                                                <td class="fontarial"><%=langBT[0]%></td>
                                                                                                                                <td class="fontarial"> 
                ...
                for (int i = 0; i < accLinks.size(); i++) {
                    ...
                    if (bankDeposit.getCoaId() == 0 && i == 0) {
                        bankDeposit.setCoaId(accLink.getCoaId());
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                <td width="5"></td>
                                                                                                                                <td class="fontarial"><%=langBT[1]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                                                <td ><input type="text" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_AMOUNT]%>" style="text-align:right" value="<%=JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##")%>" onBlur="javascript:checkNumber()"  class="readonly" readOnly size="25"><%= jspBankDeposit.getErrorMsg(jspBankDeposit.JSP_AMOUNT) %></td>
                                                                                                                                <td class="fontarial"><div align="left"><%=langBT[15]%>&nbsp;&nbsp;</div></td>
                                                                                                                                <td valign="top" class="fontarial">
                                                                                                                                    <input type="hidden" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_CUSTOMER_ID]%>" value="<%=bankDeposit.getCustomerId()%>">
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                <td width="5"></td>
                                                                                                                                <td valign="top" class="fontarial"><div align="left"><%=langBT[22]%>&nbsp;&nbsp;</div></td>
                                                                                                                                <td valign="top" class="fontarial"><input type="text" size="25" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_RECEIVE_FROM]%>" value="<%=bankDeposit.getReceiveFrom()%>"> </td>
                                                                                                                                <td valign="top"></td>
                                                                                                                                <td valign="top"></td>
                                                                                                                            </tr>     
                                                                                                                            <tr> 
                                                                                                                                <td width="5"></td>
                                                                                                                                <td valign="top" class="fontarial"><%=langBT[2]%></td>
                                                                                                                                <td valign="top" class="fontarial"> 
                                                                                                                                    <textarea name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_MEMO]%>" cols="40" rows="2"><%=bankDeposit.getMemo()%></textarea>
                                                                                                                                <%= jspBankDeposit.getErrorMsg(jspBankDeposit.JSP_MEMO) %> </td>
                                                                                                                                <td valign="top" colspan="2">
                                                                                                                                    
                                                                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                        <tr> 
                                                                                                                                            <td width="100" class="fontarial"><b><i><%=langBT[16]%></i></b></td>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr> 
                                                                                            <td class="boxed1">                                                                                                 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr>
                                                                                                        <td rowspan="2" class="tablearialhdr"  width="15%" nowrap><%=langBT[23]%></td>
                                                                                                        <td rowspan="2" class="tablearialhdr"  width="25%" nowrap><%=langBT[5]%></td>                                                                                                        
                                                                                                        <td colspan="2" class="tablearialhdr" ><%=langBT[6]%></td>
                                                                                                        <td rowspan="2" class="tablearialhdr" ><%=langBT[9]%></td>
                                                                                                        <td rowspan="2" class="tablearialhdr" width="10%"><%=langBT[10]%> <%=baseCurrency.getCurrencyCode()%></td>                                                                                                        
                                                                                                        <td rowspan="2" class="tablearialhdr" width="25%"><%=langBT[11]%></td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td class="tablearialhdr"><%=langBT[7]%></td>
                                                                                                        <td class="tablearialhdr"><%=langBT[8]%></td>                                                                                                        
                                                                                                    </tr>
                                                                                                    <%
                                                                                if (listBankDepositDetail != null && listBankDepositDetail.size() > 0) {
    ...
    if (privAdd == false) {
        ctrLine.setAddCaption("");
                                                                                ...
                                                                                if (bankDeposit.getAmount() != 0 && ((iErrCode == 0 && iErrCodeMain == 0 && balance == 0) || listBankDepositDetail.size() > 0) && bankDeposit.getPostedStatus() != 1) {%>
                                                                                                    <tr> 
                                                                                                        <td colspan="2"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                <tr> 
                                                                                                                    <td width="100"><a href="javascript:cmdSubmitCommand()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('post','','../images/savedoc2.gif',1)"><img src="../images/savedoc.gif" name="post" height="22" border="0"></a></td>     
                                                                                                                    <%if (bankDeposit.getOID() != 0) {%>
                                                                                                                    <td ><a href="javascript:cmdNewJournal()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('newdox','','../images/newdoc2.gif',1)"><img src="../images/newdoc.gif" name="newdox" height="22" border="0"></a>
                                                                                                                    &nbsp&nbsp<a href="javascript:cmdPrintJournal('<%=bankDeposit.getOID()%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('print','','../images/printdoc2.gif',1)"><img src="../images/printdoc.gif" name="print" width="112" border="0"></a>                                                                                                                   
                                                                                                                    <%}%>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                    ...
                                                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                                        <tr>
                                                                                            <td width="50%">
                                                                                                ...
                                                                                                &nbsp;&nbsp;<a href="javascript:cmdPrintJournal('<%=bankDeposit.getOID()%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('print','','../images/printdoc2.gif',1)"><img src="../images/printdoc.gif" name="print" width="112" border="0"></a>                                                                                                                   
                                                                                            </td>
                                                                                            <td width="50%">
                                                                            ...
                                                                            <%if (bankDeposit.getOID() != 0 && strApproval.equalsIgnoreCase("Y")) {%>
                                                                            <tr align="left" valign="top"> 
                                                                                <td valign="middle" colspan="3"> 
                                                                                    <%
