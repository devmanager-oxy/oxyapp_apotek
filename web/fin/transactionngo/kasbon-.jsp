...
<%
            ...
            String[] langCT = {"Taken From Account", "Amount in", "Memo", "Account Balance", "Journal Number", "Transaction Date", //0-5
                ...
                "Advance document is ready to be saved", "Advance document has been saved successfully", "Searching", "Customer", "Employee", "Search Parameter", "Advance Editor", "Advance document is ready to be saved", "Period", "Payment to", "Segmen"}; //10-20
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Transaksi Kas", "Kasbon", "Tanggal", "Data harus diisi"};
                langNav = navID;
            }
...
<head>
    ...
    <script language="JavaScript">
        ...
        function cmdSearchJurnal(){
            window.open("s_kasbon.jsp?formName=frmpettycashpaymentdetail&txt_Id=cash_id&txt_Name=jurnal_number", null, "height=400,width=700, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
            }
...
<td valign="top"> 
    ...
    if (isLoad) {
        nom_jur = pettycashPayment.getJournalNumber();
                                                                                        ...
                                                                                        %>
                                                                                        <tr>
                                                                                            <td><font face="arial"><b><%=langCT[12]%></b></font></td>
                                                                                            <td>&nbsp;</td>
                                                                                            <td>&nbsp;</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td><%=langCT[4]%></td>
                                                                                            <td><input size="25" readonly type="text" name="jurnal_number" value="<%=nom_jur%>" class="readonly"></td>
                                                                            ...
                                                                            <tr> 
                                                                                <td colspan=5 height=20px><font face="arial"><b><u><%=langCT[16].toUpperCase()%></u></b></font></td>
                                                                            </tr>
                                                                            <tr> 
    ...
    if (vEmployee != null && vEmployee.size() > 0) {
        ...
        for (int ix = 0; ix < vEmployee.size(); ix++) {
            ...
            Employee objEmployee = (Employee) vEmployee.get(ix);
                                                                            ...
                                                                            <tr> 
                                                                                <td width="10%" height="16" valign="top"><%=langCT[19]%></td>
                                                                                <td height="16"></td>
                                                                                <td width="37%" valign="top"><input type="text" size="25" name="<%=jspPettycashPayment.colNames[jspPettycashPayment.JSP_PAYMENT_TO]%>" value="<%=pettycashPayment.getPaymentTo()%>"> </td>
                                                                                <td width="13%" height="16"></td>
                                                                                <td width="38%" height="16"></td>
                                                                            </tr>
                                                                            <tr> 
                                                                                <td width="10%" height="16" valign="top"><%=langCT[2]%></td>
    ...
    if (segments != null && segments.size() > 0) {
        for (int i = 0; i < 1; i++) {
            ...
            Vector sgDetails = DbSegmentDetail.list(0, 0, wh, "");
                                                                                                    ...
                                                                                                    %>
                                                                                                    <tr> 
                                                                                                        <td width="55%"><%=segment.getName()%></td>
                                                                                                        <td width="45%"> 
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="100%" class="page"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                                                <tr> 
                                                                                                                    <td  class="tablehdr" width="30%" height="20"><%=langCT[20]%></td>
    ...
    out.print("<a href=\"../freport/rpt_pettycashpayment.jsp?pettycashPayment_id=" + pettycashPayment.getOID() + "\" onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('prt','','../images/printdoc2.gif',1)\" onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/printdoc.gif\" name=\"prt\" height=\"22\" border=\"0\"></a></div>");
                                                                    ...
                                                                    <td width="2%">&nbsp;</td>
                                                                    <td width="9%" nowrap>
                                                                        <a href="javascript:cmdNewJournal()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new12','','../images/newdoc2.gif',1)"><img src="../images/newdoc.gif" name="new12" height="22" border="0"></a>&nbsp;&nbsp;&nbsp;
                                                                    </td>                                                                                                                    
