...
<%
            ...
            String[] langCT = {"Journal Number", "Transaction Date", "Receipt to Account", "Currency", "Memo", "Posting", "Code", "Summary", "Data not found", "Journal Number", "Period","Proses done"}; // 0 - 13

            String[] langNav = {"Bank Transaction", "Post Jurnal", "Search for", "Bank Deposit", "Payment Selection", "Direct Bank Payment"};

            if (lang == LANG_ID) {

                String[] langID = {"Nomor Jurnal", "Tgl. Transaksi", "Perkiraan Penerimaan", "Mata Uang", "Memo", "Posting", "Code", "Jumlah", "Transaksi Bank", "Post Jurnal", "Data tidak ditemukan", "Nomor Jurnal", "Periode","Proses selesai"}; //0 - 13
                langCT = langID;

                String[] navID = {"Transaksi Bank", "Post Jurnal", "Pencarian", "Setoran Bank", "Pilih/Seleksi Invoice", "Pembayaran Bank"};
                langNav = navID;
            }
    ...
    <tr> 
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">            
                                                                        ...
                                                                        <td class="tablecell1" >                                                                                                            
                                                                            <table width="100%" border="0" style="border:1px solid #ABA8A8" cellspacing="1" cellpadding="0">
                                                                                ...
                                                                                <tr> 
                                                                                    ...
                                                                                    <td class="fontarial"><%=langCT[12]%>&nbsp;</td>
                                                                                    <td >
                ...
                for (int i = 0; i < p.size(); i++) {
                    Periode period = (Periode) p.get(i);
                                                                                ...
                                                                                <tr> 
                                                                                    ...
                                                                                    <td ><input type="text" name="JOURNAL_NUMBER"  value="<%= journalNumber %>"></td>
                                                                                    <td >&nbsp;</td>
                                                                                    <td >&nbsp;</td>
                                                                                </tr>                                                                                   
                                                                                <tr> 
            ...
            if (list != null && list.size() > 0) {
                                            ...
                                            <tr> 
                                                ...
                                                if (type_document == TYPE_BANK_DEPOSIT) {
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        <tr>
                                                            <td width="10%" rowspan="2" class="tablearialhdr"><%=langCT[0]%></td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        <tr>
                                                            <td width="10%" rowspan="2" class="tablearialhdr"><%=langCT[0]%></td>
                                                            <td width="10%" rowspan="2" class="tablearialhdr"><%=langCT[1]%></td>
                                                            <td width="25%" rowspan="2" class="tablearialhdr"><%=langCT[2]%></td>
                                                            <td colspan="2" class="tablearialhdr"><%=langCT[3]%></td>
                                                            <td width="35%" rowspan="2" class="tablearialhdr"><%=langCT[4]%></td>
                                                            <td width="5%" rowspan="2" class="tablearialhdr"><%=langCT[5]%></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="5%" class="tablearialhdr"><%=langCT[6]%></td>
                                                            <td width="15%" class="tablearialhdr"><%=langCT[7]%></td>
                                                        </tr>
                                                        <%
                                                        for (int i = 0; i < list.size(); i++) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="<%=style%>" align="center"><%=JSPFormater.formatNumber(bnonP.getAmount(), "#,###.##")%></td>
                                ...
                                <tr>
                                    <td align="left" class="container"><a href="javascript:cmdPost()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('post','','../images/post_journal2.gif',1)"><img src="../images/post_journal.gif" name="post" height="22" border="0" width="92"></a></td>                                     
                                </tr>    
                                <%}%>
                                <tr>
                                    <td height="40px;">&nbsp;</td>
                                ...
                                <% if (iCommand == JSPCommand.POST) {%>
                                <tr>
                                    <td height="40px;" class="fontarial"><i><%=langCT[13]%></i></td>
                                </tr> 
                                <%} else if (iCommand != JSPCommand.NONE) {%>
                                <tr>
                                    <td height="40px;" class="fontarial"><i><%=langCT[10]%></i></td>
                                </tr> 
                                <%}%>
