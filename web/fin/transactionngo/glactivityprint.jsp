...
/*** LANG ***/
String[] langGL = {"Journal Number", "Transaction Date", "Reference Number", "Amount", "Memo", "Disbursement", "Activity", //0-6
"Direct", "Type", "Account", "Activity", "Amount"}; //7-11

String[] langNav = {"General Journal", "Activity", "Date"};
	
if(lang == LANG_ID) {
	String[] langID = {"Nomor Jurnal", "Tanggal Transaksi", "Nomor Referensi", "Jumlah", "Memo", "Pengeluaran", "Aktifitas", //0-6
        "Langsung", "Tipe", "Perkiraan", "Aktivitas", "Jumlah"}; //7-11
        langGL = langID;
	
	String[] navID = {"Jurnal Umum", "Aktifitas", "Tanggal"};
	langNav = navID;
}
...
function cmdFixing(){	
	...
	document.frmpglactivity.action="glactivity.jsp";
...
function cmdGl(oid){
	<%if(cntActivity>0){%>
		...
		document.frmpglactivity.prev_command.value="<%=prevJSPCommand%>";
		document.frmpglactivity.action="glprint.jsp";
		document.frmpglactivity.submit();
	<%}else{%>
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="glactivity.jsp";
                                        ...
                                        <tr> 
                                          <td colspan="4"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                              ...
                                              <tr> 
                                                <td width="10%" nowrap><%=langGL[0]%></td>
                                                <td width="2%">&nbsp;</td>
                                                <td width="29%"><%=gl.getJournalNumber()%></td>
                                                <td width="11%" nowrap><%=langGL[1]%></td>
                                                      ...
                                                      <td> 
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                          <tr > 
                                                            ...
                                                            <td class="tabin"><a href="javascript:cmdGl('<%=oidGl%>')" class="tablink"><%=langGL[5]%></a></td>
                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                            <td class="tab"><%=langGL[6]%></td>
                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                          ...
                                                          <tr> 
                                                            <td width="100%" class="page"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                <tr> 
                                                                  <td  class="tablehdr" width="7%" height="20"><%=langGL[7]%></td>
                                                                  <td  class="tablehdr" width="11%" height="20"><%=langGL[8]%></td>
                                                                  <td class="tablehdr" width="35%" height="20"><%=langGL[9]%></td>
                                                                  <td class="tablehdr" width="28%" height="20"><%=langGL[10]%></td>
                                                                  <td class="tablehdr" width="19%" height="20"><%=langGL[11]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                </tr>
                                                                <%
