...
<%
            ...
            String[] langAR = {"Number Invoice","No","Code","Note","Amount","Data not found","Click search to searching data"}; //0 - 6

            String[] langNav = {};

            if (lang == LANG_ID) {
                String[] langID = {"Nomor Faktur","No","Kode","Keterangan","Jumlah","Data tidak ditemukan","Klik search untuk melakukan pencarian"};
                langAR = langID;
                    ...
                    <td colspan=2>
                        <table width="100%" border=0 cellpadding="1" cellspacing="1">
                            <tr>
                                ...
                                <td class="tablehdr" width="20%" ><font size="1"><%=langAR[4]%></font></td>
                                <td class="tablehdr" width="57%" ><font size="1"><%=langAR[3]%></font></td>
                            </tr>    
                            <%
