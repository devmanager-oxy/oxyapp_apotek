...
<%-- 
    ...
    Created on : May 4, 2014, 11:37:32 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            String where = DbGl.colNames[DbGl.COL_JOURNAL_TYPE] + " = " + I_Project.JOURNAL_TYPE_GIRO_KELUAR;
            ...
            String[] langNav = {"Bank Transaction", "BG Archives", "Date", "General Journal", "Advance Journal", "Type", "Searching Parameter"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Transaksi Bank", "Arsip BG", "Tanggal", "Jurnal Umum", "Jurnal Kasbon", "Type", "Parameter Pencarian"};
                langNav = navID;
            }
                                                                            ...
                                                                            <tr> 
                                                                                <td class="boxed1"> 
                                                                                    <table width="800" border="0" cellspacing="1" cellpadding="1">                                                                                        
                                                                                        <tr height="25"> 
                                                                                            <td width="50" class="tablehdr"><%=langGL[0]%></td>
                                                                                            <td width="100" class="tablehdr"><%=langGL[6]%></td>                                                                                            
                                                                                            <td  width="430" class="tablehdr"><%=langGL[8]%></td>
