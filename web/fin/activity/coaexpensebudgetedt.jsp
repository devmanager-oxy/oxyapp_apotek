...
//out.println("listCoa :"+listCoa);
            ...
            Vector expenseCategory = DbCoaCategory.list(0, 0, "", "");

            Vector natureExpenseCategory = DbCoaGroupAlias.list(0, 0, "", "");
...
//out.println("coa : "+coaActivityBudget.getCoaId());
            ...
            if (iJSPCommand == JSPCommand.SAVE) {
                ...
                if (coaActivityBudgetId == 0) {
                    coaActivityBudgetId = coaActivityBudget.getOID();
                }

                if (submodules != null && submodules.size() > 0) {
                    for (int i = 0; i < submodules.size(); i++) {
                        Module m = (Module) submodules.get(i);
                        double percent = JSPRequestValue.requestDouble(request, "mdl_" + m.getOID());
                        if (percent > 0) {
                ...
                if (selected != null && selected.size() > 0) {//iErrCode==0){
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script type="text/javascript">
            ...
            window.location = "coaexpensebudget.jsp?menu_idx=<%=menuIdx%>";
            <%}%>
            ...
            <%@ include file="../main/hmenu.jsp"%>
                  ...
                  <%@ include file="../main/menu.jsp"%>
                                        ...
                                        <td width="100%" valign="top"> 
                                           ...
                                           <%
            String navigator = "<font class=\"lvl1\">Activity</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Expense Predefine Editor</span></font>";
                                           %>
                ...
                for (int i = 0; i < submodules.size(); i++) {
                    ...
                    double val = 0;
                    if (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK || iJSPCommand == JSPCommand.BACK) {
