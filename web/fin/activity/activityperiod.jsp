...
<%
            ...
            String whereClause = "";
            String orderClause = DbActivityPeriod.colNames[DbActivityPeriod.COL_START_DATE] + " desc";
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/new2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            <%@ include file="../main/hmenu.jsp"%>
                  ...
                  <%@ include file="../calendar/calendarframe.jsp"%>
                                        ...
                                        <td width="100%" valign="top"> 
                                           ...
                                           <%
            String navigator = "<font class=\"lvl1\">Kegiatan</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Activity Period</span></font>";
                                           %>
            ...
            ctrLine.setLastOnMouseOver("MM_swapImage('Image26x','','" + approot + "/images/last2.gif',1)");
                                                                                        ...
                                                                                        <%if ((listActivityPeriod == null || listActivityPeriod.size() < 1) && iJSPCommand != JSPCommand.ADD && iJSPCommand != JSPCommand.EDIT && iJSPCommand != JSPCommand.ASK && iErrCode == 0 && privUpdate) {%>
                                                                                        <tr align="left" valign="top"> 
