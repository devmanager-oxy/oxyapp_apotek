                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">MINIMARKET</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Saldo</span></font>";
					  %>
                                      ...
                                      <select name="customer_id" onChange="javascript:cmdChange()">
                                        ...
                                        <%if(vnds!=null && vnds.size()>0){
											for(int i=0; i<vnds.size(); i++){
												Member v = (Member)vnds.get(i);
												if(oidCus==v.getOID()){
													rptKonstan.setUnit(""+v.getNoMember()+" - "+v.getNama());
												}
										%>
                                        <option value="<%=v.getOID()%>" <%if(oidCus==v.getOID()){%>selected<%}%>><%=v.getNoMember()+" - "+v.getNama()%></option>
                                        <%}}%>
                                      </select>
                                    </td>
                                  </tr>
                                  ...
                                  <tr> 
                                    <td colspan="2"> 
                                      <table width="65%" border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <%}else{%>
                                        <tr> 
                                          <td width="64%" class="tablecell1" nowrap><%=v.getNoMember()+" - "+v.getNama()%></td>
