...
//	out.println("test : "+vectSize);
	...
	{
		header = "BYMHD LIST";		
		whereClause = (whereClause.length()>0) ? whereClause + " and (type=3 or type=4)" : "(type=3 or type=4)";
...
<%}%>
	...
	function cmdSearch(){
		...
		document.frmcasharchive.action="minimarketarchive.jsp";
	...
	function cmdEditReceipt(oidReceive){
		...
		document.frmcasharchive.action="bymhddetailprint.jsp";
		document.frmcasharchive.submit();
	}
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">BYMHD</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Archives</span></font>";
					  %>
                                              ...
                                              <tr> 
												...
												%>
                                                  <select name="<%=jspCashArchive.colNames[jspCashArchive.JSP_SEARCH_FOR] %>" onChange="javascript:cmdSearch()">
												  	<%if(cashRecView){%>
                                                    <option value="cashreceive" <%if(cashArchive.getSearchFor().equals("cashreceive")){%> selected <%}%>>BYMHD</option>
													<!--option value="cashpayment" <%if(cashArchive.getSearchFor().equals("cashpayment")){%> selected <%}%>>BYMHD Payment</option-->
													<%}%>
                                                  </select>
                                                </td>
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          <td width="9%" class="tablehdr">Nomor 
                                            Jurnal </td>
                                          <td height="26" width="10%" class="tablehdr">Type</td>
                                          <td height="26" width="21%" class="tablehdr"> 
                                            BYMHD/BANK</td>
                                          <td width="15%" class="tablehdr">Uraian</td>
                                          <td width="11%" class="tablehdr">Jumlah 
                                            IDR</td>
                                          <td width="10%" class="tablehdr">Tanggal 
                                            Transaksi</td>
                                          <td width="24%" class="tablehdr">Keterangan</td>
                                        </tr>
                                        <%												
													if(listCashArchive!=null && listCashArchive.size()>0)
													{
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablecell" width="10%"><%=(bd.getType()==3) ? "Payment" : "BYMHD"%></td>
                                          <td class="tablecell" width="21%"><%=coa.getCode()+" - "+coa.getName()%></td>
                                          <td class="tablecell" width="15%"><%=v.getCode()+ " - "+v.getName()%></td>
                                          ...
                                          <td class="tablecell" width="24%"><%=getSubstring(bd.getMemo())%></td>
                                        </tr>
                                        <%
															}else
															{
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablecell1" width="10%"><%=(bd.getType()==3) ? "Payment" : "BYMHD"%></td>
                                          <td class="tablecell1" width="21%"><%=coa.getCode()+" - "+coa.getName()%></td>
                                          <td class="tablecell1" width="15%"><%=v.getCode()+ " - "+v.getName()%></td>
                                          ...
                                          <td class="tablecell1" width="24%"><%=getSubstring(bd.getMemo())%></td>
                                        </tr>
                                        <%
															}
														}
