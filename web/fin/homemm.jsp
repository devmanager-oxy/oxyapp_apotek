...
boolean homePriv = true;//QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_HOMEPAGE);
%>
<html >
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  %>
                        <%@ include file="../main/navigatormm.jsp"%>
                        <!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                                ...
                                <table width="68%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr> 
                                    <td width="55%" valign="top"> 
                                      <div align="left"><font face="Arial, Helvetica, sans-serif"><b><%=loginMember.getNama()%> - <%=loginMember.getNoMember()%></b>, welcome to Sipadu Simpan 
                                        Pinjam.<br>
                                        <br>
