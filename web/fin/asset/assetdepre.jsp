...
long periodId = periode.getOID();//JSPRequestValue.requestLong(request, "period_id");
...
//jika command save dan belum pernah save ke depre
if(count==0 && iJSPCommand==JSPCommand.SAVE && assetList!=null && assetList.size()>0){

	//out.println("command save -------- ");
	
	Vector proceed = new Vector();
	...
	for(int i=0; i<assetList.size(); i++){
		...
		if(ads!=null && ads.size()>0){
			...
			//out.println("<br>	-> in i = "+i);
		
			assetData = (AssetData)ads.get(0);
			
			double totalDepre = DbAssetDataDepresiasi.getTotalDepresiasi(assetData.getOID());
		
			if((assetData.getAmountPerolehan()-assetData.getResidu())>totalDepre && assetData.getCoaAkumDepId()!=0 && assetData.getCoaExpenseDepId()!=0){
				
				AssetDataDepresiasi assetdatadepresiasi = new AssetDataDepresiasi();
				
				assetdatadepresiasi.setPeriodeId(periodId);
				assetdatadepresiasi.setAssetDataId(assetData.getOID());
				assetdatadepresiasi.setDate(new Date());
				assetdatadepresiasi.setMth(assetdatadepresiasi.getDate().getMonth());
				assetdatadepresiasi.setYear(assetdatadepresiasi.getDate().getYear());
				assetdatadepresiasi.setAmount(assetData.getMthDepresiasi());
				assetdatadepresiasi.setUserId(user.getOID());
				...
				assetdatadepresiasi.setCoaAkumDepId(assetData.getCoaAkumDepId());
				assetdatadepresiasi.setCoaExpenseDepId(assetData.getCoaExpenseDepId());
				assetdatadepresiasi.setDepreDate(new Date());
				
				double pengurang = JSPRequestValue.requestDouble(request, im.getOID()+"_pengurang");
									
				assetdatadepresiasi.setPengurang(pengurang);
				
				proceed.add(assetdatadepresiasi);
	...
	//out.println("<br>proceed : "+proceed);
	
	DbAssetDataDepresiasi.postJournal(proceed);
...
function cmdSave(){
	...
	document.form1.action="assetdepre.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Asset Management</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Depreciation Process</span></font>";
					  %>
                            ...
                            <tr> 
                              <td class="container"> 
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  <tr> 
                                    <td width="7%">Date</td>
                                    <td width="15%"><b>: &nbsp;<%=JSPFormater.formatDate(new Date(), "dd MMMM yyyy")%></b></td>
                                    <td width="9%">Doc. Number</td>
                                    <td width="69%"><b>:&nbsp; <%=ax.getNumber()%></b></td>
                                  </tr>
                                  <tr> 
                                    <td width="7%">Period</td>
                                    <td width="15%"><b>: &nbsp;<%=periodeXXX.getName()%></b></td>
                                    <td colspan="2"><%if(count>0){%>
                                      <i><font color="#FF0000">posting depresiasi 
                                      sudah dilakukan pada periode ini</font></i> 
                                      <%}%></td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr> 
                              <td class="container">
                                <table width="40%" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="4%"><a href="javascript:cmdSave()"><img src="../images/success.gif" width="20" height="20" border="0"></a></td>
                                    <td width="2%"><img src="../images/spacer.gif" width="4" height="1"></td>
                                    <td width="94%"><a href="javascript:cmdSave()">Post 
                                      Jurnal Depresiasi</a></td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
