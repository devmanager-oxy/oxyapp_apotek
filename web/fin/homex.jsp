...
<body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','images/success1.gif','images/no1.gif','images/viewdoc1.gif')">
                                          ...
                                          <td colspan="6" nowrap> 
                                            <table width="69%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="6%"> 
                                                  <div align="center"><a href="javascript:cmdDetailx('<%=docType%>','0','<%=docId%>')"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new2111x1<%=i%>','','images/viewdoc1.gif',1)"><img src="images/viewdoc.gif" name="new2111x1<%=i%>"  border="0" alt="Klik untuk melihat detail dokumen"></a></div>
                                                </td>
                                              </tr>
                                              <tr bgcolor="#CCCCCC"> 
                                                <td colspan="6" height="1"></td>
