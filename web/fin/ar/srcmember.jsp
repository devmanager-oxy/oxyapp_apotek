...
<%
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Nama Member","No","Kode","Nama","Alamat","Data tidak ditemukan","Klik search untuk melakukan pencarian"};
                langAR = langID;
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdSelect(vendor,vendorOid){      
                self.opener.document.frmarapmemo.txt_customer.value = vendor;
                self.opener.document.frmarapmemo.JSP_CUSTOMER_ID.value = vendorOid;                                 
            ...
            function cmdSearch(){           
                ...
                document.frmvendor.action="srcmember.jsp";
