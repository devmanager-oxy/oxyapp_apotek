...
<%
	...
	ExchangeRate eRate = DbExchangeRate.getStandardRate(company.getOID());
...
<script language="JavaScript">
	...
	function cmdAdd(){
		...
		document.frmarpayment.action="invoicepaymentdisplay.jsp?oid=<%=oidInv%>";
	...
	function cmdBack(){
		...
		//document.frmarpayment.hidden_arpayment.value="0";
		//document.frmarpayment.command.value="<%=JSPCommand.ADD%>";
		document.frmarpayment.action="archives.jsp?oid=<%=oidInv%>";
		document.frmarpayment.submit();
		}
...
<body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/cancel2.gif')">
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Account Receivable</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Payment Detail</span></font>";
					  %>
                                                                ...
                                                                <tr align="left" valign="top"> 
                                                                  <td height="22" valign="middle" colspan="3"> 
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                      ...
                                                                      <tr> 
                                                                        <td width="97%"><a href="javascript:cmdBack()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new21','','../images/cancel2.gif',1)"><img src="../images/cancel.gif" name="new21" width="71" height="22" border="0"></a></td>
                                                                      </tr>
                                                                    </table>
                                                                  </td>
                                                                </tr>
