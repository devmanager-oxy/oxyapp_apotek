...
<html >
    ...
    <head>
        ...
        <script language="JavaScript">
			...
			function cmdOpen(){
				window.open("/btdc-fin/proto/kegiatanopen.jsp?formName=frmpettycashpaymentdetail&txt_Id=cash_id&txt_Name=jurnal_number", null, "height=500,width=700, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
			}
                                                                                            ...
                                                                                            <td colspan="4"> 
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="32%">&nbsp;</td>
                                                                                                        <td width="37%"> 
                                                                                                            <div align="right">Tanggal : 08 September 2011&nbsp;, &nbsp;Operator 
                                                                                                            : admin&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td colspan="4"> 
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="10%" nowrap>Cari Nomor Jurnal</td>
                                                                                                        <td width="2%">&nbsp;</td>
                                                                                                        <td width="37%">
                                                                                                            <table>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <input size="50" type="hidden" name="cash_id" value="0">
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td colspan=5 height=10px>*) Harus diisi</td>
                                                                                                    </tr>  
                                                                                                    <tr> 
                                                                                                        <td colspan=5 height=10px>&nbsp;</td>
                                                                                                    </tr>    
                                                                                                    <tr> 
                                                                                                        <td width="10%" nowrap>Nomor Jurnal</td>
                                                                                                        <td width="2%">&nbsp;</td>
                                                                                                        <td width="37%">
 
                                                                                                            
                                                                                                            10911 
                                                                                                            <input type="hidden" name="JSP_JOURNAL_NUMBER">
                                                                                                            <input type="hidden" name="JSP_JOURNAL_COUNTER">
                                                                                                            <input type="hidden" name="JSP_JOURNAL_PREFIX">
                                                                                                            
                                                                                                        </td>
                                                                                                        <td width="13%" nowrap>&nbsp;</td>
                                                                                                        <td width="38%"><input type="hidden" name="JSP_ACCOUNT_BALANCE" readOnly style="text-align:right"></td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        
                                                <td width="10%" nowrap>Account 
                                                  Kas Sementara</td>
                                                                                                        <td width="2%">&nbsp;</td>
                                                                                                        <td width="37%">
                                                                                                            <select name="JSP_COA_ID">
                                                    <option>5020 - Suspense Account 
                                                    Biaya</option>
                                                  </select>
                                                                                                         </td>
                                                                                                        <td width="13%" nowrap>Tanggal Transaksi</td>
                                                                                                        <td width="38%"> 
                                                                                                            <input name="JSP_TRANS_DATE" value="08/09/2011" size="11" readonly>
                                                                                                            <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmpettycashpaymentdetail.JSP_TRANS_DATE);return false;" ><img class="PopcalTrigger" align="absmiddle" src="/btdc-fin/calendar/calbtn.gif" height="19" border="0" alt=""></a> 
                                                                                                             
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td width="10%">Jumlah Rp.</td>
                                                                                                        <td width="2%">&nbsp;</td>
                                                                                                        <td width="37%"> 
                                                                                                            <input type="text" name="JSP_AMOUNT" style="text-align:right" value="0.00" onBlur="javascript:checkNumber()" class="readonly" readOnly size="50">
                                                                                                         </td>
                                                                                                        <td width="13%">Sarana</td>
                                                                                                        <td width="38%">
                                                                                                            
                                                                                                            <select name="JSP_CUSTOMER_ID">                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404459121386333">Aesthetic & Cosmetic Surgery</option>                                                                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404453340716161">Amphiteater</option>                                                                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404459114413583">Asia Pasifika Art Museum</option>                                                                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404459113264489">Kriya Spa</option>                                                                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404459114118442">PT. Gemilang Putri Nusantara</option>                                                                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404459114631786">Service Apartement</option>                                                                                                                
                                                                                                                                                                                                                                
                                                                                                                <option  value="504404459113547020">Villa</option>                                                                                                                
                                                                                                                
                                                                                                            </select>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td width="10%" height="16">Catatan</td>
                                                                                                        <td width="2%" height="16">&nbsp;</td>
                                                                                                        <td rowspan="2" width="37%" valign="top"> 
                                                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                <textarea name="JSP_MEMO" cols="47" rows="3"></textarea>
                                                                                                                </td>
                                                                                                                <td valign="top">&nbsp;*)</td>
                                                                                                                <td></td>
                                                                                                            </tr>
                                                      ...
                                                      <td>&nbsp; </td>
                                                              ...
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                <tr> 
                                                                  ...
                                                                  <td  class="tablehdr" width="30%" height="20">Perkiraan</td>
                                                                  <td class="tablehdr" width="15%" height="20">Jumlah 
                                                                    Rp.</td>
                                                                  <td class="tablehdr" width="55%" height="20">Penjelasan</td>
                                                                </tr>
                                                                <tr> 
                                                                  <td class="tablecell" width="30%"> 
                                                                    ...
                                                                    <div align="center"><table width="50%" border="0" cellspacing="0" cellpadding="0">
                                                                      <tr>
                                                                        <td width="57%"> 
                                                                          <input type="text" name="kegiatan" size="40" value="">
                                                                        </td>
                                                                          <td width="43%"><a href="javascript:cmdOpen()"><img src="../images/search2.jpg" width="19" height="19" border="0"></a></td>
                                                                      </tr>
                                                                    </table></div>
                                                                  ...
                                                                  <td class="tablecell" width="30%"> 
                                                                    <div align="center"> 
                                                                      <select name="detailJSP_COA_ID">
                                                                        <option value="2995" >50010 - TKP</option>
                                                                        <option value="2996" >50020 - KONSUMSI</option>
                                                                  ...
                                                                  <td width="15%" class="tablecell"> 
                                                                    <div align="center"> 
                                                                      <input type="text" name="detailJSP_AMOUNT" value="0.00" style="text-align:right" size="15" onBlur="javascript:checkNumber2()" onClick="javascript:cmdClickIt()">
                                                                    </div>
                                                                  </td>
                                                                  <td width="55%" class="tablecell"> 
                                                                    <div align="center"> 
                                                                      <input type="text" name="detailJSP_MEMO" size="40" value="">
                                                                    </div>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                                                                                        ...
                                                                                                                        <table width="50%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                <td> 
                                                                                                                                        ...
                                                                                                                                        <table width="90%"><tr><td valign="top" width="90"><a href="javascript:cmdSave()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('save','','/btdc-fin/images/savenew2.gif',1)"><img src="/btdc-fin/images/savenew.gif" name="save" height="22" border="0"></a> </td><td valign="top" width="10">&nbsp;</td></tr></table> 
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                ...
                                                                                                                                <td width="64%"> 
                                                                                                                                    <div align="right"><b> 
                                                                                                                                            ...
                                                                                                                                            <input type="hidden" name="total_detail" value="0.0">
                                                                                                                                    0.00</b></div>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
