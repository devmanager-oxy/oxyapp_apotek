                                          ...
                                          <td colspan="4"> 
                                            <table width="50%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                ...
                                                <td width="38%" class="tablehdr">Segment</td>
                                                <td width="25%" class="tablehdr">Tipe</td>
                                                <td width="33%" class="tablehdr">Fungsi</td>
                                              </tr>
                                              <tr> 
                                                <td width="4%" class="tablecell">1</td>
                                                <td width="38%" class="tablecell"><a href="segmentdata.jsp">GL</a></td>
                                                <td width="25%" class="tablecell">GL</td>
                                                <td width="33%" class="tablecell">N/A</td>
                                              </tr>
                                              <tr> 
                                                <td width="4%" class="tablecell">2</td>
                                                <td width="38%" class="tablecell"><a href="segmentdata.jsp">Lokasi</a></td>
                                                <td width="25%" class="tablecell">NBAL</td>
                                                <td width="33%" class="tablecell">N/A</td>
                                              </tr>
                                              <tr> 
                                                <td width="4%" class="tablecell">3</td>
                                                <td width="38%" class="tablecell"><a href="segmentdata.jsp">Jenis 
                                                  Kegiatan</a></td>
                                                <td width="25%" class="tablecell">NBAL</td>
                                                <td width="33%" class="tablecell">N/A</td>
                                              </tr>
                                              <tr> 
                                                <td width="4%" class="tablecell">4</td>
                                                <td width="38%" class="tablecell"><a href="segmentdata.jsp">Jenis 
                                                  Aktifitas</a></td>
                                                <td width="25%" class="tablecell">NBAL</td>
                                                <td width="33%" class="tablecell">N/A</td>
                                              ...
                                              <tr> 
                                                <td width="4%" class="tablecell">5</td>
                                                <td width="38%" class="tablecell"><a href="segmentdata.jsp">Bidang 
                                                  &amp; Komisi</a></td>
                                                <td width="25%" class="tablecell">NBAL</td>
                                                <td width="33%" class="tablecell">N/A</td>
                                              </tr>
