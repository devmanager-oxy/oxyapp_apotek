                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="8" valign="top" colspan="3"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <td colspan="4">
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                ...
                                                <td width="7%" class="tablehdr">Hari 
                                                </td>
                                                <td width="7%" class="tablehdr">Tanggal</td>
                                                <td width="6%" class="tablehdr">Waktu</td>
                                                <td width="14%" class="tablehdr">Keterangan</td>
                                                <td width="18%" class="tablehdr">Anggaran</td>
                                              </tr>
                                              <tr valign="top"> 
                                                <td width="3%" class="tablecell"><font size="1">1</font></td>
                                                <td width="10%" class="tablecell">11.011190.0001</td>
                                                <td width="13%" class="tablecell"><a href="kegiatanedit.jsp"><font size="1">Persekutuan 
                                                  pengerja </font></a></td>
                                                ...
                                                <td width="7%" class="tablecell"><font size="1">Senin</font></td>
                                                <td width="7%" class="tablecell"><font size="1">31 
                                                  Jan 2011<br>
                                                  30 Mei 2011<br>
                                                  29 Agu 2011<br>
                                                  31 Okt 2011<br>
                                                  </font></td>
                                                <td width="6%" class="tablecell"><font size="1">19.00 
                                                  Wita </font></td>
                                                <td width="14%" class="tablecell"> 
                                                  <p><font size="1">1. 1 th diadakan 
                                                    4x setian 3 bulan<br>
                                                    2. Acara :</font></p>
                                                  <p>&nbsp;</p>
                                                </td>
                                                <td width="18%" class="tablecell"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                      <td><font size="1">TKP</font></td>
                                                      <td> 
                                                        <div align="right"><font size="1">Rp. 
                                                          10.000.000,-</font></div>
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                      <td><font size="1">Konsumsi</font></td>
                                                      <td> 
                                                        <div align="right"><font size="1">Rp. 
                                                          5.000.000,-</font></div>
                                                      </td>
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td> 
                                                        <div align="right"><b><font size="1">Rp. 
                                                          15.000.000,-</font></b></div>
                                                      </td>
                                                    </tr>
                                                  </table>
                                                </td>
                                              ...
                                              <tr valign="top"> 
                                                ...
                                                <td width="13%" class="tablecell"><a href="kegiatanedit.jsp"><font size="1">Rapat 
                                                ...
                                                <td width="7%" class="tablecell"><font size="1"></font></td>
                                                <td width="6%" class="tablecell"><font size="1"></font></td>
                                                <td width="14%" class="tablecell"><font size="1"></font></td>
                                                <td width="18%" class="tablecell"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                      <td><font size="1">Transport</font></td>
                                                      <td> 
                                                        <div align="right"><font size="1">Rp. 
                                                          3.000.000,-</font></div>
                                                      </td>
                                              ...
                                              <tr valign="top"> 
                                                ...
                                                <td width="6%" class="tablecell"><font size="1"></font></td>
                                                <td width="14%" class="tablecell"><font size="1"></font></td>
                                                <td width="18%" class="tablecell"><font size="1"></font></td>
                                              </tr>
                                              <tr valign="top"> 
                                        ...
                                        <tr> 
                                          <td colspan="4"> 
                                            <p><font color="#FF0000">Struktur 
                                              kode : YY.AABCDD.XXXX<br>
                                              YY = 2 digit year<br>
                                              AA = Kode Lokasi<br>
                                              B = Kode Jenis Kegiatan<br>
                                              C = Kode Jenis Aktifitas<br>
                                              DD = Kode Bidang &amp; Komisi<br>
                                              XXXX = Counter</font></p>
                                            </td>
                                        </tr>
                                      </table>
