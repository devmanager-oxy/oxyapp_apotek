...
<iframe width=174 height=189 name="gToday:normal:agenda.js" id="gToday:normal:agenda.js" src="/btdc-fin/calendar/ipopeng.htm" scrolling="no" frameborder="0" style="visibility:visible; z-index:999; position:absolute; top:-500px; left:-500px;">
                            ...
                            <td width="60%" height="23">&nbsp;&nbsp;<font class="lvl1">Setup</font><font class="tit1">&nbsp;&raquo;&nbsp;<span class="lvl2">Segment 
                              Data </span></font></td>
                                        ...
                                        <tr> 
                                          <td colspan="4"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr> 
                                                <td width="9%" bgcolor="#CCCCCC">Kode</td>
                                                <td width="14%" bgcolor="#CCCCCC">Nama</td>
                                                <td width="53%">&nbsp;</td>
                                                <td width="6%">&nbsp;</td>
                                              </tr>
                                              <tr> 
                                                <td width="9%" bgcolor="#F3F3F3">10</td>
                                                <td width="14%" bgcolor="#F3F3F3">Ibadah</td>
                                                <td width="53%">&nbsp;</td>
                                                <td width="6%">&nbsp;</td>
                                              </tr>
                                              <tr> 
                                                <td width="9%" bgcolor="#F3F3F3">20</td>
                                                <td width="14%" bgcolor="#F3F3F3">Persekutuan</td>
                                                <td width="53%">&nbsp;</td>
                                                <td width="6%">&nbsp;</td>
                                              </tr>
                                              <tr> 
                                                <td width="9%" bgcolor="#F3F3F3">21</td>
                                                <td width="14%" bgcolor="#F3F3F3">Persekutuan 
                                                  - Kms Anak</td>
                                                <td width="53%">&nbsp;</td>
                                                <td width="6%">&nbsp;</td>
                                              </tr>
                                              <tr> 
                                                <td width="9%" bgcolor="#F3F3F3">22</td>
                                                <td width="14%" bgcolor="#F3F3F3">Persekutuan 
                                                  - Kms Remaja</td>
                                                <td width="53%">&nbsp;</td>
                                                <td width="6%">&nbsp;</td>
                                              ...
                                              <tr> 
                                                <td width="9%" bgcolor="#F3F3F3">23</td>
                                                <td width="14%" bgcolor="#F3F3F3">Persekutuan 
                                                  - Kms Pria</td>
                                                <td width="53%">&nbsp;</td>
                                                <td width="6%">&nbsp;</td>
