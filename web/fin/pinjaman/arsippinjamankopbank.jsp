...
//if(iJSPCommand == JSPCommand.LIST){
	temp = SrcPinjaman.getListPinjamanKoperasi(0,0, srcPinjaman);
	count = SrcPinjaman.getCountPinjamanKoperasi(srcPinjaman);
//}
...
function cmdSearch(){
	...
	document.form1.action="arsippinjamankopbank.jsp";
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Keanggotaan</span> 
                        ...
                        <span class="level2">Pencarian Arsip Pinjaman Koperasi 
                        ke Bank<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                                  ...
                                  <tr> 
                                    <td colspan="4"> 
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
										...
										%>
                                        <tr> 
                                          <td class="tablecell" width="9%"><a href="javascript:cmdEdit('<%=pinjaman.getOID()%>')"><%=JSPFormater.formatDate(pinjaman.getDate(), "dd MMMM yyyy")%></a></td>
                                        ...
                                        <%}else{%>
                                        <tr> 
                                          <td class="tablecell1" width="9%"><a href="javascript:cmdEdit('<%=pinjaman.getOID()%>')"><%=JSPFormater.formatDate(pinjaman.getDate(), "dd MMMM yyyy")%></a></td>
