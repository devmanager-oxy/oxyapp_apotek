...
if(periodId==0){
	if(periods!=null && periods.size()>0){
		Periode p = (Periode)periods.get(0);
		periodId = p.getOID();
	...
	try{
		Periode p = DbPeriode.fetchExc(periodId);
		periodName = p.getName();
	}
	catch(Exception e){
	}
}
Vector result = DbTabunganSukarela.getBungaTabungan(periodId);
session.putValue("SALDO_BUNGA_ANGGOTA", result);
session.putValue("SALDO_BUNGA_PERIODE", periodName);
%>
<html >
...
function cmdChanged(){
	document.frmtabungansukarela.action="tabungansukarelabunga.jsp";
	document.frmtabungansukarela.submit();
}

function cmdPrintIt(){	
	window.open("<%=printrootsp%>.report.RptBungaSukarelaXLS?idx=<%=System.currentTimeMillis()%>");
}
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Keanggotaan</span> 
                        ...
                        <span class="level2">Biaya Bunga Simpanan Sukarela<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
...
<table width="50%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td width="91%"> 
                                            <select name="period_id" onChange="javascript:cmdChanged()">
                                              <%
										if(periods!=null && periods.size()>0){
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="26" valign="middle" colspan="3" class="comment"> 
                                      <b>Biaya Bunga Tabungan Sukarela</b></td>
                                  </tr>
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3"> 
                                      <table width="60%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          ...
                                          <td class="tablehdr" width="29%">Total 
                                            Bunga </td>
                                        </tr>
                                        <%
