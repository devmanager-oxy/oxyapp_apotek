...
if(iJSPCommand==JSPCommand.RESET){
	...
	out.println("strDate : "+strDate+", pdOID : "+pdOID);
	...
	//DbPinjamanDetail.updateBayarPinjaman(oidPinjaman, strDate);
}
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptSaldoSukarelaXLS?idx=<%=System.currentTimeMillis()%>");
}
                            ...
                            <tr align="left" valign="top"> 
                              <td height="8" valign="middle" colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                  ...
                                  <tr align="left"> 
                                    <td height="21" width="11%">Status Pinjaman 
                                    </td>
                                    <td height="21" width="24%"> 
                                      <%if(pinjaman.getStatus()==DbPinjaman.STATUS_DRAFT){%>
                                      ...
                                      <div align="left"> 
                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                          ...
                                          <tr> 
                                            ...
                                            <td class="tablecell" width="9%"> 
                                              <div align="right"><a href="javascript:cmdUpdateTanggalBayar('<%=pd.getOID()%>')"><%=(bp.getOID()!=0) ? JSPFormater.formatDate(bp.getTanggal(), "dd MMMM yyyy") : "-"%></a></div>
                                            </td>
