...
<script language="JavaScript">
	...
	function cmdAdd(){
		...
		document.frm_bayarpinjaman.action="pelunasan.jsp";
                              ...
                              <td class="container"> 
                                <table width="100%" cellspacing="1" cellpadding="1" >
                                  ...
                                  <tr align="left"> 
                                    ...
                                    <td  width="20%"> 
                                      <input type="text" name="<%=JspBayarPinjaman.colNames[JspBayarPinjaman.JSP_AMOUNT]%>" value="<%=JSPFormater.formatNumber(bayarPinjaman.getAmount(),"#,###.##")%>" class="formElemen" style="text-align:right" >
                                  ...
                                  <tr align="left"> 
                                    ...
                                    <td  width="20%"> 
                                      <input type="text" name="<%=JspBayarPinjaman.colNames[JspBayarPinjaman.JSP_BUNGA]%>" value="<%=JSPFormater.formatNumber(bayarPinjaman.getBunga(),"#,###.##")%>" class="formElemen" style="text-align:right" onBlur="javascript:checkNumber(this)" onClick="this.select()">
                                    </td>
                                    <td  width="13%">&nbsp;</td>
                                    <td  width="56%">&nbsp;</td>
                                  </tr>
                                  ...
                                  <tr align="left"> 
                                    ...
                                    <td colspan="2" rowspan="6"> 
                                      <table width="74%" border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%">Angsuran Pokok Diterima 
                                            Pada </td>
                                          <td width="34%" nowrap> 
                                            <%	
											Vector temp = DbAccLink.list(0,0, DbAccLink.colNames[DbAccLink.COL_TYPE]+"='"+I_Project.ACC_LINK_PINJAMAN_CREDIT+"'", "");											
											if(temp!=null && temp.size()>0){
												if(temp.size()>0){
												%>
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%" nowrap>Pendapatan Bunga 
                                            Diterima Pada </td>
                                          <td width="34%"> 
                                            <%	
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%" nowrap>Pendapatan Denda 
                                            Diterima Pada </td>
                                          <td width="34%"> 
                                            <%	
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%">Pendapatan Pinalti Diterima 
                                            Pada </td>
                                          <td width="34%"> 
                                            <%	
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%">Pengurangan Pihutang 
                                            (AR)</td>
                                          <td width="34%">&nbsp; </td>
                                          <td width="36%"> 
                                            <%	
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%">Pendapatan Bunga </td>
                                          <td width="34%">&nbsp; </td>
                                          <td width="36%"> 
                                            <%	
                                        ...
                                        <tr bgcolor="#E1E1E1"> 
                                          <td width="30%">Pendapatan Denda</td>
                                          <td width="34%">&nbsp; </td>
                                          <td width="36%"> 
                                            <%	
										 ...
										 <tr bgcolor="#E1E1E1"> 
                                          <td width="30%">Pendapatan Pinalti</td>
                                          <td width="34%">&nbsp; </td>
                                          <td width="36%"> 
                                            <%	
