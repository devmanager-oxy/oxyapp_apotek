                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="14" valign="middle" colspan="3"> 
                                                ...
                                                <td colspan="4"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    <tr> 
                                                      ...
                                                      <td class="tablehdr" rowspan="2" width="11%">No 
                                                        Transaksi </td>
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="11%" class="tablecell"> 
                                                        <div align="center"><%=simpmember.getNumber()%></div>
                                                      </td>
                                                      <td width="11%" class="tablecell"> 
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="10%" class="tablecell" nowrap> 
                                                        <div align="center"> <%=JSPDate.drawDateWithStyle(JspSimpananMember.colNames[JspSimpananMember.JSP_TANGGAL], (simpananMember.getTanggal()==null) ? new Date() : simpananMember.getTanggal(), 0,-10, "formElemen", "") %></div>
                                                      </td>
                                                    ...
                                                    <tr> 
                                                      <td colspan="8"> 
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                          ...
                                                          <tr> 
                                                            <td width="18%" bgcolor="#EEEEEE" nowrap><b>Detail 
                                                              Jurnal</b></td>
                                                            <td width="6%">&nbsp;</td>
                                                            <td width="76%">&nbsp;</td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="18%" nowrap bgcolor="#E9E9E9">&nbsp;</td>
                                                            <td colspan="2" bgcolor="#E9E9E9"><b>Debet</b></td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="18%" nowrap bgcolor="#E9E9E9">Debet 
                                                              Pokok</td>
															...
															if(true){//simpananMember.getStatus()==DbRekapMain.DOCUMENT_STATUS_DRAFT){
                                                              ...
                                                              <select name="<%=JspSimpananMember.colNames[JspSimpananMember.JSP_SIMPANAN_COA_DEBET_NSP_ID] %>">
                                                                <%for(int i=0; i<temp.size(); i++){
																				...
																				boolean coaOK = checkCoa(cx, debetSimpananPokok);
                                                          ...
                                                          <tr> 
                                                            <td width="18%" bgcolor="#E9E9E9">Debet 
                                                              Wajib </td>
                                                            <td colspan="2" bgcolor="#E9E9E9"> 
                                                              <%
															temp = new Vector();
															if(true){//simpananMember.getStatus()==DbRekapMain.DOCUMENT_STATUS_DRAFT){
																...
																if(temp!=null && temp.size()>0){
																	if(temp.size()>0){
																	%>
                                                              <select name="<%=JspSimpananMember.colNames[JspSimpananMember.JSP_SIMPANAN_COA_WAJIB_ID] %>">
                                                                <%for(int i=0; i<temp.size(); i++){
																				AccLink al = (AccLink)temp.get(i);
																				Coa cx = new Coa();
																				try{
																				...
																				boolean coaOK = checkCoa(cx, debetSimpananWajib);
																				if(coaOK){
																		  %>
                                                                <option value="<%=cx.getOID()%>" <%if(simpananMember.getSimpananCoaDebetNSPId()==cx.getOID()){%>selected<%}%>><%=cx.getCode()+" - "+cx.getName()%></option>
                                                                <%}}%>
															...
															if(true){//simpananMember.getStatus()==DbRekapMain.DOCUMENT_STATUS_DRAFT){
                                                              ...
                                                              <select name="<%=JspSimpananMember.colNames[JspSimpananMember.JSP_SIMPANAN_COA_DEBET_ID] %>">
                                                                <%for(int i=0; i<temp.size(); i++){
																				...
																				boolean coaOK = checkCoa(cx, debetSimpananSukarelaSHU);
																				if(coaOK){
																		  %>
                                                          ...
                                                          <tr> 
                                                            ...
                                                            <td colspan="2" bgcolor="#E9E9E9"><b>Credit</b></td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="18%" bgcolor="#E9E9E9">Simpanan 
                                                              Wajib </td>
                                                            <td colspan="2" bgcolor="#E9E9E9"> 
                                                              <%
												...
												if(temp!=null && temp.size()>0){
													...
													%>
                                                              <select name="<%=JspSimpananMember.colNames[JspSimpananMember.JSP_SIMPANAN_COA_CREDIT_ID] %>">
																...
																boolean coaOK = checkCoa(cx, creditSimpananWajib);
																if(coaOK){
														  %>
												...
												if(temp!=null && temp.size()>0){
													...
													%>
                                                              <select name="<%=JspSimpananMember.colNames[JspSimpananMember.JSP_SIMPANAN_COA_POKOK_ID] %>">
																...
																boolean coaOK = checkCoa(cx, creditSimpananPokok);
																if(coaOK){
														  %>
											...
											%>
                                                          ...
                                                          <tr> 
                                                            <td width="18%" nowrap bgcolor="#E9E9E9">Simpanan 
                                                              Sukarela </td>
                                                            <td colspan="2" bgcolor="#E9E9E9"> 
                                                              <%
											if(simpananMember.getStatus()==DbRekapMain.DOCUMENT_STATUS_DRAFT){	
												...
												if(temp!=null && temp.size()>0){
													...
													%>
                                                              <select name="<%=JspSimpananMember.colNames[JspSimpananMember.JSP_SIMPANAN_COA_SUKARELA_ID] %>">
																...
																boolean coaOK = checkCoa(cx, creditSimpananSukarelaSHU);
																if(coaOK){
														  %>
											...
											%>
                                                          ...
                                                          <tr> 
                                                            <td width="18%" nowrap bgcolor="#E9E9E9">SHU/Alokasi</td>
                                                            <td colspan="2" bgcolor="#E9E9E9"> 
                                                              <%
											if(simpananMember.getStatus()==DbRekapMain.DOCUMENT_STATUS_DRAFT){	
											...
											%>
                                                        ...
                                                        <table width="20%" border="0" cellspacing="1" cellpadding="1" align="left" height="33">
                                                          <tr> 
                                                            <td width="14%" height="23"><a href="javascript:cmdPost()"><img src="../images/yesx.gif" width="17" height="14" border="0"></a></td>
                                                            <td width="86%" height="23"><a href="javascript:cmdSave()">Save</a></td>
                                                          </tr>
                                                        </table>
                                                      </td>
                                                      <td width="32%">&nbsp; </td>
                                                    ...
                                                    <tr> 
                                                      <td colspan="9"><span class="command"> 
                                                        <% 
								   int cmd = 0;
									   if ((iJSPCommand == JSPCommand.FIRST || iJSPCommand == JSPCommand.PREV )|| 
										(iJSPCommand == JSPCommand.NEXT || iJSPCommand == JSPCommand.LAST))
