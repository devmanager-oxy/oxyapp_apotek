        ...
        <tr> 
          <td style="padding-left:10px"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <%if(depoList || newDepo || returDepo || sadloDepo || depoArchives){%>
              <tr id="titip1"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('16')"> <a href="javascript:cmdChangeMenu('16')">Deposit/Titipan</a></td>
              </tr>
              <tr id="titip2"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('0')"> <a href="javascript:cmdChangeMenu('0')">Deposit/Titipan</a></td>
              </tr>
              <tr id="titip"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    ...
                    <%if(sadloDepo){%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/saldotitipan.jsp?menu_idx=16">Deposit 
                        Saldo </a></td>
                    </tr>
                    <%}%>
                    <%if(depoArchives){%>
              ...
              <tr id="bymhd"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/bymhdsaldo.jsp?menu_idx=18">Saldo 
                        BYMHD</a></td>
                    </tr>
                    <%}%>
                    <%if(bymhdArchives){%>
              ...
              <tr id="frpt"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td height="18" width="90%" class="menu2"><a href="<%=approot%>/freport/profitloss_v01.jsp?menu_idx=4&pnl_type=0">Biaya</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2"><a href="<%=approot%>/freport/profitloss_v01.jsp?menu_idx=4&pnl_type=1">Pendapatan</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2">Rasio</td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2">Iktisar Laba Rugi</td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2">Kinerja</td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2">BYMHD</td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2">Titipan</td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu2">Aktiva Tetap</td>
                    </tr>
                    <tr> 
