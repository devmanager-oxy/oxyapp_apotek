...
<html >
        ...
        <script language="JavaScript">            
            ...
            function cmdSearchCustomer(){
                ...
                function cmdSearchJurnal(){
                    ...
                    window.open("<%=approot%>/transactionact/s_bankdeposit.jsp?txt_jurnal=\'"+numb+"'&command=<%=JSPCommand.SEARCH%>&formName=frmbankdepositdetail&txt_Id=bankdeposit_id&txt_Name=jurnal_number", null, "height=400,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                    }
         ...
         %>
             if(idCurr=='<%=cx.getOID()%>'){
                 document.frmbankdepositdetail.<%=JspBankDepositDetail.colNames[JspBankDepositDetail.JSP_BOOKED_RATE]%>.value="<%=cx.getRate()%>";
             }	
         <%}
            }%>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (bankDeposit.getOID() != 0 || oidBankDeposit != 0) {
                strNumber = bankDeposit.getJournalNumber();
                                                                                                                                ...
                                                                                                                                <td class="fontarial"> 
                                                                                                                                    <%if (open.getStatus().equals("Closed") || bankDeposit.getOID() != 0) {%>
                                                                                                                                    <%=open.getName()%>
        ...
        for (int t = 0; t < periods.size(); t++) {
            ...
            if (segments != null && segments.size() > 0) {
                for (int i = 0; i < segments.size(); i++) {
                    ...
                    Vector sgDetails = new Vector();
                    if(i==0){
                        sgDetails = DbSegmentUser.userSegments(user.getOID(),0); 
                    }else{
                        sgDetails = DbSegmentDetail.list(0, 0, wh, DbSegmentDetail.colNames[DbSegmentDetail.COL_CODE]);
                    }
            ...
            try {
                    ...
                    if(xx==0){
                        ...
                        sgDetails = DbSegmentDetail.list(0, 0, "segment_id=" + seg.getOID(), DbSegmentDetail.colNames[DbSegmentDetail.COL_CODE]);
                    }
    ...
    if (privAdd == false) {
        ctrLine.setAddCaption("");
                                                                            ...
                                                                            <%if (bankDeposit.getOID() != 0 && strApproval.equalsIgnoreCase("Y") && false) {%>
                                                                            <tr align="left" valign="top"> 
                                                                                <td valign="middle" colspan="3"> 
                                                                                    <%
    ...
    if (user.getEmployeeId() == apd.getEmployeeId()) {
        if (apd.getStatus() == DbApprovalDoc.STATUS_APPROVED) {
                                                                            ...
                                                                            <%if (bankDeposit.getOID() != 0) {
                                                                                ...
                                                                                String date = "";
                                                                                try{
                                                                                    User u = DbUser.fetch(bankDeposit.getOperatorId());
                                                                                    Employee e = DbEmployee.fetchExc(u.getEmployeeId());
                                                                                    name = e.getName();
                                                                                }catch(Exception e){}
                                                                                try{
                                                                                    date = JSPFormater.formatDate(bankDeposit.getDate(),"dd MMM yyyy");
                                                                                }catch(Exception e){}
                                                                                ...
                                                                                String postedDate = "";
                                                                                try{
                                                                                    User u = DbUser.fetch(bankDeposit.getPostedById());
                                                                                    Employee e = DbEmployee.fetchExc(u.getEmployeeId());
                                                                                    postedName = e.getName();
                                                                                }catch(Exception e){}
                                                                                try{
                                                                                    if(bankDeposit.getPostedDate() != null){
                                                                                        postedDate = JSPFormater.formatDate(bankDeposit.getPostedDate(),"dd MMM yyyy");
                                                                                    }
