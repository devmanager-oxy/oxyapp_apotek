...
function cmdFixing(){	
	...
	document.frmcashreceivedetail.action="kembalikantitipan.jsp";
...
function cmdDelPict(oidCashReceiveDetail){
	...
	document.frmimage.action="kembalikantitipan.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Deposit/Titipan</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Pengembalian Titipan</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmcashreceivedetail" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=JspCashReceive.colNames[JspCashReceive.JSP_TYPE]%>" value="<%=DbCashReceive.TYPE_CASH_LIABILITY_PAYMENT%>">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td rowspan="2"  class="tablehdr" nowrap width="10%">Penitip/Unit</td>
