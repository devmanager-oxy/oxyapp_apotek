...
<%-- 
    Document   : saleseditorarchives
    Created on : Mar 9, 2015, 5:57:32 PM
    Author     : Roy
--%>
...
<%
            ...
            if (iJSPCommand == JSPCommand.SUBMIT || iJSPCommand == JSPCommand.ACTIVATE) {
                result = DbMerchant.getPaymentMerchant(locationId, tanggal, tanggalEnd, number, type, statusPosted, bankId);
            ...
            String navigator = "<font class=\"lvl1\">Administrator</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Sales Editor</span></font>";
                ...
                for (int i = 0; i < locations.size(); i++) {
                    Location us = (Location) locations.get(i);
                                                                            ...
                                                                            <tr height="22"> 
                                                                                <td width="14%" class="tablearialcell1">&nbsp;Bank</td>
                                                                                <td width="86%">: 
                                                                    ...
                                                                    <td>
                                                                        <table cellpadding="0" cellspacing="1" width="1100">
                                                                            <tr height="22">
                                                                                ...
                                                                                <td class="tablehdr" width="70">Payment</td>
                                                                                <td class="tablehdr" width="70">Expense</td>
                                                                                <td class="tablehdr" width="70">Amount</td>
                                                                                <td class="tablehdr" width="70">Status</td>
                                                                                <td class="tablehdr" width="70">Type</td>
                                                                                <td class="tablehdr" >Merchant</td>
                                                                                <td class="tablehdr" width="10%">New Merchant</td>
                ...
                for (int x = 0; x < result.size(); x++) {
                    ...
                    total = total + pm.getAmount();
                                                                            ...
                                                                            <tr height="22">
                                                                                ...
                                                                                <td class="tablecell1" align="right"><%=JSPFormater.formatNumber((pm.getBiaya() + pm.getAmount()), "###,###.##")%></td>
                                                                                <td class="tablecell1" align="right"><%=JSPFormater.formatNumber(pm.getBiaya(), "###,###.##")%></td>
                                                                                <td class="tablecell1" align="right"><%=JSPFormater.formatNumber(pm.getAmount(), "###,###.##")%></td>
                                                                                <%if (pm.getPostedStatus() == 1) {%>
                                                                                <td class="fontarial" bgcolor="#E79191" align="center">POSTED</td>
                                                                                <%} else {%>
                                                                                <td class="tablecell1" align="center">-</td>
                                                                                <%}%>
                                                                                <td class="tablecell1"><%if (pm.getPayType() == DbPayment.PAY_TYPE_CREDIT_CARD) {%> Credit Card <%} else {%>Debit Card<%}%></td>
                    ...
                    for (int z = 0; z < merchants.size(); z++) {
                        ...
                        if (mx.getTypePayment() == DbMerchant.TYPE_CREDIT_CARD) {
                            ...
                            namex = mx.getDescription();
                                                                            ...
                                                                            <%}%>
                                                                            <tr height="22">
                                                                                <td colspan="4" class="tablecell1" align="center"><b>Total</b></td>
                                                                                <td class="tablecell1" align="right"><b><%=JSPFormater.formatNumber(total, "###,###.##")%></b></td>
                                                                                <td colspan="5" class="tablecell1"></td>
                                                                            </tr>
                                                                            <tr height="22">
                                                                                <td colspan="7">&nbsp;</td>
                                                                            </tr>
