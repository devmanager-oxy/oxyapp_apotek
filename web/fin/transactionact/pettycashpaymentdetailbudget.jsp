...
<%-- 
    Document   : pettycashpaymentdetailbudget
    Created on : Mar 21, 2016, 4:28:30 PM
    Author     : Roy
--%>
...
<%
            ...
            String[] langNav = {"Cash Transaction", "Budget Payment"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Transaksi Tunai", "Pembayaran Budget"};
                langNav = navID;
            }
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cmdSearch(){  
                ...
                document.frmbudgetarchive.action="pettycashpaymentdetailbudget.jsp";
            ...
            function cmdEdit(oidBudgetRequest,keyUniqId){
                ...
                document.frmbudgetarchive.action="pettycashpaymentdetailbudgetproses.jsp";
                document.frmbudgetarchive.submit();
                <%}%>
            }
