...
<%-- 
    Document   : glbalikedit
    Created on : Oct 11, 2013, 1:41:43 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            if (iJSPCommand == JSPCommand.SAVE) {
                ...
                if (isValidDate) {
                    ...
                    oidGlReverse = DbGl.doReversePostedJournal(oidGl, reverseGl, user.getOID());
                    if (oidGlReverse == 0) {
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/print2.gif','../images/back2.gif')">
     ...
     if ((gl.getOID() != 0 || oidGl != 0) && isSave == false) {
         strNumber = gl.getJournalNumber() + "REV";         
     } else {
