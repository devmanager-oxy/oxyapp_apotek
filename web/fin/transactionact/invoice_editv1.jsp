...
<%
            ...
            //String status = JSPRequestValue.requestLong(request, JspReceive.colNames[JspReceive.JSP_STATUS]);
            ...
            JspReceive jspReceive = new JspReceive();
            if (oidReceive == 0) {
            ...
            JspReceiveItem jspReceiveItem = new JspReceiveItem();
            ...
            if (iJSPCommand == JSPCommand.ACTIVATE) {
                ...
                if (!isError) {
                    ...
                    if (result == 0) {
                        ...
                        SessIncoming.updateChecked(oidReceive,user.getOID());                                             
                        try{
