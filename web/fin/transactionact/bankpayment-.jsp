...
<%
            ...
            if (oidBankpoPayment != 0 && (iJSPCommand == JSPCommand.SAVE || iJSPCommand == JSPCommand.REFRESH) && (countUniq <= 0 && countUniqDetail <= 0)) {
                ...
                String refNumber = JSPRequestValue.requestString(request, JspBankpoPayment.colNames[JspBankpoPayment.JSP_REF_NUMBER]);
                ...
                if (perId != 0) {
                    ...
                    if ((v == null || v.size() == 0 ) && iJSPCommand == JSPCommand.SAVE) {
                        err = true;
                    }
                }

                if (paymentMethod == 0 && iJSPCommand == JSPCommand.SAVE) {
                    err = true;
                }
                
                if(paymentMethod == oidCheckPending || paymentMethod == oidBG){
                ...
                if (err == false && iJSPCommand == JSPCommand.SAVE) {                    
            ...
            if (iJSPCommand == JSPCommand.SAVE || iJSPCommand == JSPCommand.REFRESH) {
                ...
                if(countUniq <= 0 && countUniqDetail <= 0) {
                    ...
                    if (bankpoPayment.getPaymentMethodId() == 0 && iJSPCommand == JSPCommand.SAVE) {
                        msgErr = "Payment method required";
                        msgPayment = "Payment method required";
                    }
                    
                    if(bankpoPayment.getPaymentMethodId() == oidCheckPending || bankpoPayment.getPaymentMethodId() == oidBG){
                        if(bankpoPayment.getRefNumber() == null || bankpoPayment.getRefNumber().length() <=0){
                            jspBankpoPayment.addError(jspBankpoPayment.JSP_REF_NUMBER, "Required");
            ...
            if ((iJSPCommand == JSPCommand.SAVE || iJSPCommand == JSPCommand.REFRESH) && (countUniq <= 0 && countUniqDetail <= 0)) {
                ...
                if (bankpoPayment.getOID() != 0) {
                    try {
                        ...
                        if (bankpoPayment.getPaymentMethodId() == oidBG || bankpoPayment.getPaymentMethodId() == oidCheckPending) {
                            ...
                            long coaPaymentId = 0;
                            try{
                                coaPaymentId = Long.parseLong(String.valueOf(strMapping.get(String.valueOf(bankpoPayment.getCoaId()))));                                                                                                        
                            }catch(Exception e){coaPaymentId = 0;}
                            bp.setCoaPaymentId(coaPaymentId);
                            ...
                            try {
                                ...
                                DbBgMaster.updateRefIdByNumb(bankpoPayment.getRefNumber(),type,bankpoPayment.getOID(),bankpoPayment.getDueDateBG(),bankpoPayment.getAmount());
...
<html>
    ...
    <head>
        ...
        function isBG(){                
            if(document.frmbankpopaymentdetail.<%=JspBankpoPayment.colNames[JspBankpoPayment.JSP_PAYMENT_METHOD_ID]%>.value == '<%=oidBG%>' ||  document.frmbankpopaymentdetail.<%=JspBankpoPayment.colNames[JspBankpoPayment.JSP_PAYMENT_METHOD_ID]%>.value == '<%=oidCheckPending%>'){
                ...
                document.all.inpBg2.style.display="";
            }else{                    
            document.all.inpBg.style.display="none";
            document.all.inpBg2.style.display="none";
        }
    }
        ...
        for (int t = 0; t < periods.size(); t++) {
            ...
            Periode objPeriod = (Periode) periods.get(t);
                                                                                                    ...
                                                                                                    <tr height="22">
                                                                                                        ...
                                                                                                        <td class="fontarial">:</td>
                                                                                                        <td >
                                                                                                            <select name="<%=jspBankpoPayment.colNames[jspBankpoPayment.JSP_COA_ID]%>" <%if(bankpoPayment.getStatus().compareTo(DbBankpoPayment.STATUS_PAID) != 0){%> onChange="javascript:cmdRefresh()" <%}%>>
    ...
    Vector vpm = DbPaymentMethod.list(0, 0, "", "");
                                                                                                            %>
                                                                                                            <select name="<%=jspBankpoPayment.colNames[jspBankpoPayment.JSP_PAYMENT_METHOD_ID]%>" <%if(bankpoPayment.getStatus().compareTo(DbBankpoPayment.STATUS_PAID) != 0){%> onChange="javascript:cmdRefresh()" <%}%>>
        ...
        for (int i = 0; i < vpm.size(); i++) {
            PaymentMethod pm = (PaymentMethod) vpm.get(i);
                                                                                                    ...
                                                                                                    <tr id="inpBg" height="22"> 
                                                                                                        <td class="tablecell1" nowrap>&nbsp;&nbsp;Due Date BG/Cheque</td>                                                                                                                    
                                                                                                        <td class="fontarial">:</td>
                                                                                                        <td >
                                                                                                    ...
                                                                                                    <% 
                                                                                                    String whBg = "";
                                                                                                    if(bankpoPayment.getPaymentMethodId() == oidCheckPending){
                                                                                                    ...
                                                                                                    String strCoa = "0";
                                                                                                    try{
                                                                                                        strCoa = String.valueOf(strMapping.get(String.valueOf(bankpoPayment.getCoaId())));                                                                                                        
                                                                                                    ...
                                                                                                    if (bankpoPayment.getStatus().compareTo(DbBankpoPayment.STATUS_PAID) == 0 && bankpoPayment.getOID() != 0) {
                                                                                                        vbgMaster = DbBgMaster.list(0, 0, DbBgMaster.colNames[DbBgMaster.COL_REF_ID]+" = "+bankpoPayment.getOID(),DbBgMaster.colNames[DbBgMaster.COL_NUMBER]);
                                                                                                    }else{
                                                                                                    ...
                                                                                                    %>
                                                                                                    <tr id="inpBg2" height="22">
                                                                                                        <td class="tablecell1" nowrap>&nbsp;&nbsp;<%=langCT[16]%></td>                                                                                                                    
                                                                                                        <td class="fontarial">:</td>
                                                                                                        <td > 
                                                                                                            <select name="<%=jspBankpoPayment.colNames[jspBankpoPayment.JSP_REF_NUMBER] %>" class="fontarial">
                                                                                                                ...
                                                                                                                %>
                                                                                                                    <option value="<%=bgMaster.getNumber()%>" <%if(bankpoPayment.getRefNumber().equals(bgMaster.getNumber())){%> selected<%}%> ><%=bgMaster.getNumber()%></option>
                                                                                                                <%} }%>
                                                                                                            </select>                                                                                                                
                                                                                                    ...
                                                                                                    <%}else{%>
                                                                                                    <tr id="inpBg2" height="22">
                                                                                                        <td class="tablecell1" nowrap>&nbsp;&nbsp;Nomor Referensi</td>                                                                                                                    
                                                                                                        <td class="fontarial">:</td>
                                                                                                        <td > 
    ...
    if (iJSPCommand == JSPCommand.NONE) {
        ...
        notes = bankpoPaymentDetail.getMemo();
                                                                                                    ...
                                                                                                    <%}%>
                                                                                                    <%if ((bankpoPayment.getOID() != 0 && bankpoPayment.getStatus().compareTo(DbBankpoPayment.STATUS_PAID) != 0) || (iJSPCommand == JSPCommand.REFRESH && bankpoPayment.getStatus().compareTo(DbBankpoPayment.STATUS_PAID) != 0) || (msgErr.length() > 0 && bankpoPayment.getStatus().compareTo(DbBankpoPayment.STATUS_PAID) != 0) && countUniq==0 && countUniqDetail==0) {%>
                                                                                                    <tr> 
                                                                                                        <td colspan="5">&nbsp;</td>
                                                                                                    </tr>
                                                                                                    <tr> 
