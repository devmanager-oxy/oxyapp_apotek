...
<%-- 
    Document   : coaberulang
    Created on : Jul 23, 2014, 10:44:55 AM
    Author     : Roy
--%>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSelect(coaid, coaname){                
                self.opener.document.frmakrualsetup.akrual_debet.value = coaname;
                self.opener.document.frmakrualsetup.<%=JspAkrualSetup.colNames[JspAkrualSetup.JSP_FIELD_DEBET_COA_ID]%>.value = coaid;           
                self.close();
            }
            
            function cmdChangeList(){
                document.frmrptformatdetailcoa.action="coaberulang.jsp";
