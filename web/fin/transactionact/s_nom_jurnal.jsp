                                                        ...
                                                        for (int i = 0; i < listPettycashPayment.size(); i++) {
                                                            ...
                                                            if (i % 2 == 0) {
                                                                ...
                                                                <tr height="21">
                                                                    ...
                                                                    <td class="<%=style%>" align="center">&nbsp;<%=JSPFormater.formatDate(pettycashPayment.getTransDate(), "dd MMM yyyy")%></td>
                                                                    <td class="<%=style%>" align="left">&nbsp;<%=pettycashPayment.getMemo()%></td>
                                                                    <td class="<%=style%>" align="right"><%=JSPFormater.formatNumber(pettycashPayment.getAmount(), "#,###.##")%>&nbsp;</td>
