...
<%-- 
    Document   : s_banknonpopayment
    Created on : Jun 14, 2011, 9:53:52 AM
    Author     : Roy Andika
--%>
...
String banknonpopaymentId = JSPRequestValue.requestString(request, "banknonpopaymentId");
...
Vector listbanknonpopayment = new Vector();
...
if(iJSPCommand == JSPCommand.SEARCH){
    ...
    listbanknonpopayment = DbBanknonpoPayment.list(0, 0, where, DbBanknonpoPayment.colNames[DbBanknonpoPayment.COL_JOURNAL_NUMBER]);    
...
function cmdSelect(jurnalname,banknonpopaymentOid){      
    self.opener.document.<%=formName%>.<%=txt_Id%>.value = banknonpopaymentOid;
...
<body> 
    <table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <input type="hidden" name="banknonpopaymentId" value="<%=banknonpopaymentId%>">
        ...
        <%
        if(listbanknonpopayment != null && listbanknonpopayment.size() > 0){
        %>    
        <tr>
            <td width="5px">&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan=2>
                <table width="200px" border=0 cellpadding="1" cellspacing="1">
                    ...
                    <%
                    for(int i = 0 ; i < listbanknonpopayment.size() ; i++){
                
                    BanknonpoPayment banknonpoPayment = (BanknonpoPayment)listbanknonpopayment.get(i);
