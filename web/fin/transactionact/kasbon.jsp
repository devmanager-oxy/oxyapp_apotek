    ...
    if (segments != null && segments.size() > 0) {
        for (int i = 0; i < segments.size(); i++) {
            ...
            Vector sgDetails = DbSegmentDetail.list(0, 0, wh, DbSegmentDetail.colNames[DbSegmentDetail.COL_NAME]);
                                                                                                        ...
                                                                                                        %>
                                                                                                        <tr> 
                                                                                                            <td width="40%"><%=segment.getName()%></td>
                                                                                                            <td > 
                                                        ...
                                                        <tr align="left" valign="top"> 
                                                            <td valign="middle" colspan="3" class="container"> 
                                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        <td width="50%"><a href="javascript:cmdNewJournal()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('newdox','','../images/newdoc2.gif',1)"><img src="../images/newdoc.gif" name="newdox" height="22" border="0"></a></td>
                                                                        <td width="50%">
