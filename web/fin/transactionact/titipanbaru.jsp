...
Vector custs = DbVendor.list(0,0,"type=1", "");
...
function cmdFixing(){	
	...
	document.frmcashreceivedetail.action="titipanbaru.jsp";
...
function cmdDelPict(oidCashReceiveDetail){
	...
	document.frmimage.action="titipanbaru.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Deposit/Titipan</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">New Deposit</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmcashreceivedetail" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=JspCashReceive.colNames[JspCashReceive.JSP_TYPE]%>" value="<%=DbCashReceive.TYPE_CASH_LIABILITY%>">
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> 
										  ...
										  %>
                                              ...
                                              <tr> 
                                                <td width="10%">Terima Pada Akun</td>
                                                <td width="3%">&nbsp;</td>
                                                <td colspan="3"> 
                                      ...
                                      <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td rowspan="2"  class="tablehdr" nowrap width="15%">Penitip/Unit</td>
