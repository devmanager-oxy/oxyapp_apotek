...
//----------delete doc ---------
            if (iJSPCommand == JSPCommand.STOP) {
                try {
                    CONHandler.execUpdate("delete from gl_detail where gl_id=" + oidGl);
                    DbGl.deleteExc(oidGl);
                } catch (Exception e) {
                }
            }
            ...
            if (iJSPCommand == JSPCommand.START) {
                try {
                    DbGlDetail.deleteExc(oidGlDetail);
                } catch (Exception e) {
                }
            }
...
function cmdDeleteDetail(oid){
    ...
    if(confirm('sure to delete ?')){
        ...
        document.frmgl.hidden_gl_detail_id.value=oid;
        document.frmgl.prev_command.value="<%=JSPCommand.LAST%>";
        document.frmgl.action="gldetail-audit.jsp";
        document.frmgl.submit();
    }
...
function cmdDeleteDoc(){
    <%if(privDelete){%>
    if(confirm('sure to delete ?')){
        document.frmgl.command.value="<%=JSPCommand.STOP%>";
        document.frmgl.prev_command.value="<%=JSPCommand.LAST%>";
        document.frmgl.action="gldetail-audit.jsp";
        document.frmgl.submit();
    }	
...
%>
                                                                                                        ...
                                                                                                        <td width="100%" class="page"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    - Description</td>
                                                                                                                    <td width="4%" rowspan="2" class="tablehdr">Department</td>
                                                                                                                    <td colspan="3" class="tablehdr">Currency</td>
                    ...
                    try {
                        c = DbCoa.fetchExc(crd.getCoaId());
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <td width="15%" class="tablecell"> 
                                                                                                                    <input type="text" name="<%=JspGlDetail.colNames[JspGlDetail.JSP_MEMO]%>" value="<%=crd.getMemo()%>">                                                      </td>
                                                                                                                </tr>
                                                                                                                <%} else {%>
                                                                                                                <tr> 
                                                                                                                    <td class="tablecell" nowrap width="21%" height="17"> 
                                                                                                                        ...
                                                                                                                        &nbsp;-&nbsp; <%=c.getName()%></a>
                                                                                                                        <br>
                                                                                                                    [<a href="javascript:cmdDeleteDetail('<%=crd.getOID()%>')">delete</a>]                                                      </td>
                                                                                                                    <td width="4%" class="tablecell">													  <%
                                                                                                                    try {
            ...
            if ((iJSPCommand == JSPCommand.ADD || (iJSPCommand == JSPCommand.SUBMIT && (iErrCode != 0 || iErrCodeMain != 0))) && recIdx == -1) {%>
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <td width="4%" class="tablecell">													 <select name="<%=JspGlDetail.colNames[JspGlDetail.JSP_DEPARTMENT_ID]%>" onChange="javascript:cmdUpdateExchange()">
                                                                                                                            <%
                                                                                                                    Vector vlistDepartment = DbDepartment.list(0, 0, "", "");
                                                                                                                    String strSelected = "";
                                                                                                                    if (vlistDepartment.size() > 0) {
                                                                                                                    ...
                                                                                                                    <td width="15%" class="tablecell"> 
                                                                                                                    <input type="text" name="<%=JspGlDetail.colNames[JspGlDetail.JSP_MEMO]%>" value="<%=glDetail.getMemo()%>">                                                        </td>
                                                                                                                </tr>
                                                                                                                <%}%>
                                                                                                                <tr> 
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td height="2"> 
                                                                                                <table width="50%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="34%" height="30"><a href="javascript:cmdDeleteDoc()">Delete 
                                                                                                        Doc</a> </td>
    ...
    if (iJSPCommand == JSPCommand.SAVE) {
        if (glUpdate) {%>
                                                                                    <font color="#0000FF"> Sukses update gl 
                                                                                    atau item ...</font> 
                                                                                    <%} else {%>
