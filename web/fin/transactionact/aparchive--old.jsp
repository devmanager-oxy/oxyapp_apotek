        ...
        <script language="JavaScript">
            ...
            function cmdPrintJournal(oidBankpoPayment){	                       
                ...
                function cmdPrintJournalx(oidBankpoPayment){	                       
                    ...
                    window.open("<%=printroot%>.report.PrintBgV2XLS?user_id=<%=appSessUser.getUserOID()%>&bankpo_id="+oidBankpoPayment+"&lang=<%=lang%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                    }
                    
                    function cmdPrintJournalCheck(oidBankpoPayment){	                       
                    window.open("<%=printroot%>.report.PrintCheckXLS?user_id=<%=appSessUser.getUserOID()%>&bankpo_id="+oidBankpoPayment+"&lang=<%=lang%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                    }
                                                                                                                    ...
                                                                                                                    <td >
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td>   
                                                                                                                                    <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmaparchive.<%=jspBankArchive.colNames[jspBankArchive.JSP_START_DATE]%>);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a> &nbsp;&nbsp;<%=langCT[4]%>&nbsp;&nbsp;                                                                                                        
                                                                                                                                </td>
                                                                                                                                <td>   
