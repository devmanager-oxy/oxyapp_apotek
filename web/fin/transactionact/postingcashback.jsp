...
<%-- 
    Document   : postingcashback
    Created on : Dec 1, 2015, 2:55:54 PM
    Author     : Roy
--%>
...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MN_GL, AppMenu.M2_MN_CASH_BACK_POST);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_GL, AppMenu.M2_MN_CASH_BACK_POST, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_GL, AppMenu.M2_MN_CASH_BACK_POST, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_GL, AppMenu.M2_MN_CASH_BACK_POST, AppMenu.PRIV_ADD);
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_GL, AppMenu.M2_MN_CASH_BACK_POST, AppMenu.PRIV_DELETE);
            boolean privPrint = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_GL, AppMenu.M2_MN_CASH_BACK_POST, AppMenu.PRIV_PRINT);
%>
<!-- Jsp Block -->
...
<%
            ...
            String where = DbMemberPoint.colNames[DbMemberPoint.COL_POSTED_STATUS] + " = 0 and " +
                    DbMemberPoint.colNames[DbMemberPoint.COL_TYPE] + " = " + DbMemberPoint.TYPE_CASH_BACK_LANGSUNG + " and " +
            ...
            String[] langNav = {"Journal", "Cash Back - Post Journal", "Records", "Adjusment Stock", "Search Parameters", "Posted journal success",
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Jurnal", "Cash Back - Post Jurnal", "Arsip", "Penyesuaian Stock", "Parameter Pencarian", "Jurnal berhasil diposting",
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.frmcashback.action="postingcashback.jsp?menu_idx=<%=menuIdx%>";
