...
<%
            ...
            String editSetup = "N";
            try{
                editSetup = DbSystemProperty.getValueByName("ALLOW_EDIT_AKRUAL_SETUP");
            }catch(Exception e){}
            ...
            int countAkrual = DbAkrualProses.getCount(DbAkrualProses.colNames[DbAkrualProses.COL_AKRUAL_SETUP_ID] + " = " + akrualSet.getOID());
            
            int count = 1;
            if(editSetup.equals("Y")){
                count = 0;
            }else{
                if(countAkrual <= 0){
                    count = 0;
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSeacrhCoa(accid, accname){
                ...
                function cmdOpenCoa(){
                    var y = document.frmakrualsetup.akrual_debet.value;	                    
                    window.open("<%=approot%>/transactionact/coaberulang.jsp?coa_select="+y, null, "height=400,width=800, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                    }
                    
                    function cmdOpenCoaCredit(){
                    var y = document.frmakrualsetup.akrual_credit.value;	                    
                    window.open("<%=approot%>/transactionact/coaberulangcredit.jsp?coa_select="+y, null, "height=400,width=800, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                    }
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                ...
                                                                                if (segments != null && segments.size() > 0) {
                                                                                    for (int i = 0; i < segments.size(); i++) {
                                                                                        ...
                                                                                        Vector sgDetails = DbSegmentDetail.list(0, 0, "", DbSegmentDetail.colNames[DbSegmentDetail.COL_NAME]);
                                                                                                    %>
                                                                                                    <tr> 
                                                                                                        <td >&nbsp;</td>
                                                                                                    ...
                                                                                                    <tr >
                                                                                                        ...
                                                                                                        <td width="1">:</td>
                                                                                                        <td >
                                                                                                            <input type="text" name="<%=jspAkrualSetup.colNames[JspAkrualSetup.JSP_FIELD_PEMBAGI]%>" value="<%=akrualSet.getPembagi()%>" size="5" style="text-align:right" <%if(countAkrual > 0){%> readonly <%}%> <%if(countAkrual > 0){%> class="readOnly" <%}else{%> class="formElemen" <%}%>>
                                                                                                        ...
                                                                                                        <td >
                                                                                                             <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <input size="30" type="text" name="akrual_debet" value="<%=objCoaD.getName()%>" class="fontarial">
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%if(count <= 0){%>
                                                                                                                        <a href="javascript:cmdOpenCoa()" >
    ...
    try {
        ...
        System.out.println(e.toString());
                                                                                                        ...
                                                                                                        <td >
                                                                                                             <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <input size="30" type="text" name="akrual_credit" value="<%=objCoaC.getName()%>">
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <%if(count <= 0){%>
                                                                                                                        <a href="javascript:cmdOpenCoaCredit()" >
                                                                                                    ...
                                                                                                    <tr >
                                                                                                        ...
                                                                                                        <td width="1">:</td>
                                                                                                        <td >
                                                                                                             <input type="text" name="<%=jspAkrualSetup.colNames[JspAkrualSetup.JSP_FIELD_ANGGARAN]%>" value="<%=JSPFormater.formatNumber(akrualSet.getAnggaran(), "#,###.##")%>" size="20" onBlur="javascript:checkNumber()" style="text-align:right" <%if(countAkrual > 0){%> readonly <%}%> <%if(countAkrual > 0){%> class="readOnly" <%}else{%> class="formElemen" <%}%>>
