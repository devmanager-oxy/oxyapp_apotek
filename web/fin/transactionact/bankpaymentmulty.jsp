...
<%
            ...
            if (iJSPCommand == JSPCommand.SAVE && countUniq == 0 && oidMateraiCredit != 0 && oidMateraiDebet != 0) {
...
<html>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            %>                
                ...
                document.frmbankpopaymentdetail.total_hutang<%=bp.getOID()%>.value = formatFloat(pay, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace);              
                <%}%>             
                ...
                document.frmbankpopaymentdetail.total_materai.value = formatFloat(materai, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace);              
    ...
    if (bankpoGroupId != 0) {
        strNumber = bankpoGroup.getJournalNumber();
                                                                                                    ...
                                                                                                    <tr height="22">
                                                                                                        ...
                                                                                                        <td class="fontarial">:</td>
                                                                                                        <td >
                                                                                                            <select name="coa_id" class="fontarial">
    ...
    Vector vpm = DbPaymentMethod.list(0, 0, "", "");
                                                                                                            %>
                                                                                                            <select name="payment_method_id" onChange="javascript:isBG()">
        ...
        for (int i = 0; i < vpm.size(); i++) {
            PaymentMethod pm = (PaymentMethod) vpm.get(i);
                                                                                                    ...
                                                                                                    <tr id="inpBg" height="22"> 
                                                                                                        <td class="tablecell" style="padding:3px;" nowrap>Due Date BG</td>                                                                                                                    
                                                                                                        <td class="fontarial">:</td>
                                                                                                        <td >
