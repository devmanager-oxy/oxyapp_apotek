...
<%-- 
    Document   : s_gl_reversal
    Created on : Jun 9, 2011, 3:25:46 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            if (iJSPCommand == JSPCommand.SEARCH) {
                listGl = DbGl.getGLReguler(DbGl.IS_REVERSAL, v_txt_jurnal);
            }
%>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){                   
                ...
                document.frm_nomorjurnal.action="s_gl_reversal.jsp";
            ...
            function cmdDelPict(oidCashReceiveDetail){
                ...
                document.frmimage.action="s_gl_reversal.jsp";
                    ...
                    for (int i = 0; i < listGl.size(); i++) {
                        ...
                        if (i % 2 == 0) {
                            ...
                            <tr>
                                ...
                                <td class="tablecelll" align="right"><%=JSPFormater.formatNumber(debet, "#,###.##")%>&nbsp;</td>
                                <td class="tablecelll" align="right"><%=JSPFormater.formatNumber(credit, "#,###.##")%>&nbsp;</td>
                            </tr> 
                            <%
                                } 
                            %>
