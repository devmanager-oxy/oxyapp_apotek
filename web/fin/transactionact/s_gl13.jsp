...
<%-- 
    Document   : s_gl13
    Created on : Dec 16, 2011, 4:34:21 PM
    Author     : Roy Andika
--%>
...
if(iJSPCommand == JSPCommand.SEARCH){
    ...
    listGl = DbGl.getGL13(DbGl.IS_NOT_REVERSAL,v_txt_jurnal);
...
function cmdSearch(){                   
    ...
    document.frm_nomorjurnal.action="s_gl13.jsp";
...
function cmdDelPict(oidCashReceiveDetail){
	...
	document.frmimage.action="s_gl13.jsp";
        ...
        <tr>
            <td colspan=2>
                <table width="100%" border="0" cellpadding="1" cellspacing="1">
                    ...
                    %>
                    <tr>
                        <td class="tablecelll" align="left">&nbsp; 
                        <%
                        out.println("<a style='color:blue' href=\"javascript:cmdSelect('" + gl.getJournalNumber() + "','"+gl.getOID()+"')\">" + gl.getJournalNumber() + "</a>");
                        %>
                        </td>
