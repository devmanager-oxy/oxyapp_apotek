...
<%
                    ...
                    for (int i = 0; i < listAkrualSetup.size(); i++) {
                        ...
                        if ((v == null || v.size() <= 0) && chk == 1) {
                            try {
                                ...
                                if (oid != 0) {
                                    String memo = JSPRequestValue.requestString(request, "memo"+as.getOID());
                                    DbAkrualProses.postJournal(ap, periodId, memo);
                                }
            ...
            String[] langAT = {"Range Date", "Period", //0-1
                ...
                "The data that will be process not found", "Go to Archives", "Date Transaction", "Input Parameter", "Segment", "All documents in this period have been processed"}; //10-15
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Batas Tanggal", "Periode",
                    ...
                    "Data yang akan di proses tidak ditemukan", "Lihat Arsip", "Tanggal Transaksi", "Parameter Input", "Segmen", "Semua dokumen di periode ini sudah di proses"
                };
                langAT = langID;
...
<html >
    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function setChecked(val,per){                                          
                <%            
            for (int x = 0; x < vPeriode.size(); x++) {
                Periode p = (Periode) vPeriode.get(x);
                %>  
                    if('<%=p.getOID()%>'==per){                        
                        <%
                for (int i = 0; i < listAkrualSetup.size(); i++) {
                    ...
                    int count = DbAkrualProses.getCount(DbAkrualProses.colNames[DbAkrualProses.COL_PERIODE_ID] + " = " + p.getOID() + " and " + DbAkrualProses.colNames[DbAkrualProses.COL_AKRUAL_SETUP_ID] + " = " + as.getOID());
                    int countPeriode = DbAkrualProses.getCount(DbAkrualProses.colNames[DbAkrualProses.COL_AKRUAL_SETUP_ID] + " = " + as.getOID());
                ...
                %>                        
                    document.frmakrualsetup.chk_<%=as.getOID()%>.checked=val.checked;
                <%
                    }
                }  
                        %>
                                                                                ...
                                                                                <td>
                                                                                    <table width="1150" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="5%" class="tablehdr"><input type="checkbox" name="chkbox" onClick="setChecked(this,'<%=px.getOID()%>')" checked></td>
                                                                                        </tr>                                                                                        
                                                                                        <%if (listAkrualSetup != null && listAkrualSetup.size() > 0) {
        for (int i = 0; i < listAkrualSetup.size(); i++) {
            AkrualSetup as = (AkrualSetup) listAkrualSetup.get(i);
            ...
            Vector akrualProses = DbAkrualProses.list(0, 1, DbAkrualProses.colNames[DbAkrualProses.COL_PERIODE_ID] + " = " + px.getOID() + " and " + DbAkrualProses.colNames[DbAkrualProses.COL_AKRUAL_SETUP_ID] + " = " + as.getOID(), null);

            SegmentDetail sdx = new SegmentDetail();
            try {
                if (akrualProses != null && akrualProses.size() > 0) {
                    AkrualProses obj = (AkrualProses) akrualProses.get(0);
                    sdx = DbSegmentDetail.fetchExc(obj.getSegment1Id());
                }
            } catch (Exception e) {
            }
            int countPeriode = DbAkrualProses.getCount(DbAkrualProses.colNames[DbAkrualProses.COL_AKRUAL_SETUP_ID] + " = " + as.getOID());
            ...
            if(iJSPCommand == JSPCommand.SUBMIT){
                memo = JSPRequestValue.requestString(request, "memo"+as.getOID());
            }else{
                memo = as.getNama();
            }
            ...
            if (i % 2 == 0) {
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablecell1"><input type="text" name="memo<%=as.getOID()%>" value="<%=memo%>" size="25"></td>
                                                                                            <td class="tablecell1">
                                                                                                <div align="left"> 
                                                                                                    <%
                                                                                                String segment = "";
                                                                                                try {
                                                                                                    if (as.getSegment1Id() != 0) {
                                                                                                        ...
                                                                                                        if (count > 0 && sdx.getOID() != 0) {
                                                                                                            sd = DbSegmentDetail.fetchExc(sdx.getOID());
                                                                                                        } else {
                                                                                                            sd = DbSegmentDetail.fetchExc(as.getSegment1Id());
                                                                                                        }
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablecell"><input type="text" name="memo<%=as.getOID()%>" value="<%=memo%>" size="25"></td>
                                                                                            <td class="tablecell">
                                                                                                <div align="left"> 
                                                                                                    <%
