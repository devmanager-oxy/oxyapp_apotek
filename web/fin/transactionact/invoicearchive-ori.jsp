...
<%
            ...
            whereClause = DbReceive.colNames[DbReceive.COL_TYPE_AP] + " = " + DbReceive.TYPE_AP_NO;
            ...
            String[] langCT = {"Vendor", "Doc Number", "Receive Date", "Ignored", "Invoice/DO", "Date", "Paid", "Amount", "Status", "Due Date", "Print", "Balance"};
            String[] langNav = {"Account Payable", "Invoice List", "Search Parameters"};

            if (lang == LANG_ID) {
                String[] langID = {"Suplier", "Nomor Faktur", "Tanggal Pembelian", "Abaikan", "Faktur/DO", "Tanggal", "Terbayar", "Jumlah Hutang", "Status", "Batas Pembayaran", "Print", "Sisa Hutang"};
                langCT = langID;
        ...
        <script language="JavaScript">
            ...
            function cmdPrintJournalXLS(){	                       
                ...
                function cmdSearch(){
                    ...
                    document.frmreceive.command.start = 0;
                                                                                                ...
                                                                                                <table border="0" cellspacing="1" cellpadding="0">           
                                                                                                    ...
                                                                                                    <tr>                                                                                                         
                                                                                                        <td colspan="6" >
                                                                                                            <table >
                                                                                                                <tr>
                                                                                                                    <td class="tablehdr"></td>
                                                                                                                    <td class="fontarial"><b><i><%=langNav[2]%> :</i></b></td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    </tr>
            ...
            try {
                if (listReceive != null && listReceive.size() > 0) {
                    ...
                    for (int i = 0; i < listReceive.size(); i++) {
                        ...
                        double payment = DbBankpoPaymentDetail.getTotalPaymentPosted(receive.getOID());
