...
if(iJSPCommand==JSPCommand.SAVE){
	if(cashReceive.getOID()!=0){
		...
		//posting ke journal
		DbCashReceive.postJournalBYHMDNew(cashReceive, listCashReceiveDetail);
	}
}
...
wherex = "((account_group='"+I_Project.ACC_GROUP_EXPENSE+"' or account_group='"+I_Project.ACC_GROUP_OTHER_EXPENSE+"')"+// or account_group='"+I_Project.ACC_GROUP_OTHER_REVENUE+"')"+
				" and (location_id="+sysLocation.getOID()+" or location_id=0))";			
//only view postable account in combo				
if(isPostableOnly){
	wherex = wherex + " and status='"+I_Project.ACCOUNT_LEVEL_POSTABLE+"'";
...
Vector expensesCoas = DbCoa.list(0,0, wherex, "code");				
...
Vector accLinks = DbAccLink.list(0,0, "type='"+I_Project.ACC_LINK_GROUP_CASH+"' and location_id="+sysCompany.getSystemLocation(), "");
...
function cmdFixing(){	
	...
	document.frmcashreceivedetail.action="bymhdnew.jsp";
...
function cmdDelPict(oidCashReceiveDetail){
	...
	document.frmimage.action="bymhdnew.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">BYMHD</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">New BYMHD</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmcashreceivedetail" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=JspCashReceive.colNames[JspCashReceive.JSP_TYPE]%>" value="<%=DbCashReceive.TYPE_BYMHD_NEW%>">
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr align="left" valign="top"> 
										  ...
										  %>
                                                          <option <%if(cashReceive.getCoaId()==coax.getOID()){%>selected<%}%> value="<%=coax.getOID()%>"><%=str+coax.getCode()+" - "+coax.getName()%></option>
                                                          <%}}else{%>
                                                          <option>select ..</option>
                                                          <%}%>
                                                        </select>
									  ...
									  %>
										  ...
										  %>
                                                      ...
                                                      <td width="10%">Nomor Jurnal</td>
                                                      <td width="44%"> 
                                                        <%
									  int counter = DbCashReceive.getNextCounter(DbCashReceive.TYPE_BYMHD_NEW);
									  String strNumber = DbCashReceive.getNextNumber(counter,DbCashReceive.TYPE_BYMHD_NEW);
										  ...
										  %>
                                                      ...
                                                      <td class="<%=cssName%>" width="10%"> 
                                                        <select name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_COA_ID]%>">
                                                          <%if(expensesCoas!=null && expensesCoas.size()>0){
											for(int x=0; x<expensesCoas.size(); x++){
												Coa coax = (Coa)expensesCoas.get(x);
											...
											if(currencies!=null && currencies.size()>0){
										  	...
										  	%>
                                                      ...
                                                      <td width="46%" class="<%=cssName%>"> 
                                                        <div align="left"> 
                                                          <input type="text" name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_MEMO]%>" size="20" value="<%=crd.getMemo()%>">
                                                        </div>
                                                      </td>
                                                    </tr>
                                                    <%}else{%>
										...
										%>
										  ...
										  %>
                                                      ...
                                                      <td width="46%" class="tablecell"> 
                                                        <div align="left"> 
                                                          <input type="text" name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_MEMO]%>" size="20" value="<%=cashReceiveDetail.getMemo()%>">
                                                        </div>
                                                      </td>
                                                    </tr>
                                                    <%}%>
