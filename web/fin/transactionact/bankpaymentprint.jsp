...
<%-- 
    Document   : bankpaymentprint
    Created on : Nov 29, 2012, 10:49:34 AM
    Author     : Roy Andika
--%>
...
<%
            ...
            try {
                objBankpoPayment = DbBankpoPayment.fetchExc(bankpoPayment.getRefId());
            } catch (Exception e) {
            }
            Vector listBankpoPaymentDetail = DbBankpoPaymentDetail.list(0, 0, "bankpo_payment_id=" + objBankpoPayment.getOID(), "");
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (bankpoPayment.getOID() != 0) {
                strNumber = bankpoPayment.getJournalNumber();
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="21" valign="middle" width="14%" bgcolor="#EBEBEB">&nbsp;<%=langCT[1]%></td>
                                                                                <td height="21" valign="middle" width="26%"> : 
            ...
            try {
                pm = DbPaymentMethod.fetchExc(bankpoPayment.getPaymentMethodId());
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="21" valign="middle" width="14%" bgcolor="#EBEBEB">&nbsp;<%=langCT[2]%></td>
                                                                                <td height="21" valign="middle" width="26%"> : 
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="21" valign="top" width="14%" bgcolor="#EBEBEB">&nbsp;<%=langCT[3]%></td>
            ...
            if (listBankpoPaymentDetail != null && listBankpoPaymentDetail.size() > 0) {
                for (int i = 0; i < listBankpoPaymentDetail.size(); i++) {
                    ...
                    if (bpd.getInvoiceId() != 0) {
                        ...
                        number = receive.getNumber() + "/" + receive.getDoNumber();
