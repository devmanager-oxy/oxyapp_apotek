...
<%
            ...
            String[] langNav = {"Journal", "Copy Journal", "Date"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Jurnal", "Jurnal Copy", "Tanggal"};
                langNav = navID;
            }
%>
         ...
         strNumber = gl.getJournalNumber();
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <td width="30%" class="fontarial">:
                                                                                                                        ...
                                                                                                                        <input type="hidden" name="<%=JspGl.colNames[JspGl.JSP_JOURNAL_TYPE]%>" value="<%=I_Project.JOURNAL_TYPE_COPY%>">
                                                                                                                    </td>
