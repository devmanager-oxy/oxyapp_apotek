...
<%-- 
    Document   : coaberualangcredit
    Created on : Jul 23, 2014, 10:57:05 AM
    Author     : Roy
--%>
...
<%
            ...
            String coaSelect = JSPRequestValue.requestString(request, "coa_select");
            ...
            String where = "";
            selectUntil = 0;
            if(coaSelect != null && coaSelect.length() > 0){
                where = DbCoa.colNames[DbCoa.COL_NAME]+" like '%"+coaSelect+"%'";
            }
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSelect(coaid, coaname){                
                self.opener.document.frmakrualsetup.akrual_credit.value = coaname;
                self.opener.document.frmakrualsetup.<%=JspAkrualSetup.colNames[JspAkrualSetup.JSP_FIELD_CREDIT_COA_ID]%>.value = coaid;           
                self.close();
            }
            
            function cmdChangeList(){
                document.frmrptformatdetailcoa.action="coaberulangcredit.jsp";
                                                                                            ...
                                                                                            <td height="14" valign="middle" colspan="3" class="comment"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        &nbsp;&nbsp;&nbsp; </td>                                                                                                        
                                                                                                        <td width="11%" nowrap>&nbsp;&nbsp;&nbsp;Perkiraan</td>
                                                                                                        <td width="11%" nowrap><input type="text" name="coa_select" value="<%=coaSelect%>">                                                                                                            
                                                                                                        &nbsp;&nbsp;&nbsp; </td>
                                                                                                        <td width="11%" nowrap>&nbsp; 
                ...
                for (int x = 0; x < coas.size(); x++) {
                    ...
                    if (checkOnly != 1) {
                        ...
                        if (coax.getStatus().equals("HEADER")) {
                                                                                        ...
                                                                                        <%} else {%>
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" width="36%" nowrap class="<%if (count > 0) {%>tablecellselect<%} else {%>tablecell<%}%>"><font size="1"><a href="javascript:cmdSelect('<%=coax.getOID()%>','<%=coax.getName()%>')"><%=str + coax.getCode() + " - " + coax.getName()%></a></font></td>
