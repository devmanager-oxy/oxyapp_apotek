...
<%
            ...
            if ((iJSPCommand == JSPCommand.FIRST || iJSPCommand == JSPCommand.PREV) ||
                    (iJSPCommand == JSPCommand.NEXT || iJSPCommand == JSPCommand.LAST || iJSPCommand == JSPCommand.BACK || iJSPCommand == JSPCommand.SEARCH)) {
                ...
                vectSize = DbGl.getCountGLReguler(DbGl.IS_NOT_REVERSAL, v_txt_jurnal);
                start = cmdGlArchive.actionList(iJSPCommand, start, vectSize, recordToGet);
                ...
                listGl = DbGl.getGLReguler(start, recordToGet, DbGl.IS_NOT_REVERSAL, v_txt_jurnal);
            }
