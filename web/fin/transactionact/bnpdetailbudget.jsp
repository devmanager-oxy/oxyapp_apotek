...
<%-- 
    Document   : bnpdetailbudget
    Created on : Mar 22, 2016, 11:18:33 PM
    Author     : Roy
--%>
...
<%
            ...
            String[] langNav = {"Bank Transaction", "Budget Payment"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Transaksi Bank", "Pembayaran Budget"};
                langNav = navID;
            }
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cmdSearch(){  
                ...
                document.frmbudgetarchive.action="bnpdetailbudget.jsp";
            ...
            function cmdEdit(oidBudgetRequest,keyUniqId){
                ...
                document.frmbudgetarchive.action="bnpdetailbudgetproses.jsp";
                document.frmbudgetarchive.submit();
                <%}%>
            }
