...
<%
            ...
            String[] langNav = {"Acc. Payable", "PO Payment", "Date", "Invoice", "Vendor", "Inv. Currency", "Location", "Balance",
                "Rate", "Payment", "Invoice Number", "Description", "DO Number", "Currency","Open Invoice","Paid Invoice"
            };
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Hutang", "Order Pembelian", "Tanggal", "Tagihan", "Suplier", "Mata uang Inv.", "Lokasi", "Balance", // 0 -7
                    "Rate", "Pembayaran", "Nomor Invoice", "Keterangan", "Nomor DO", "Mata Uang Inv","Faktur yang Belum Terbayarkan","Faktur yang sudah terbayarkan" // 8 -15
                };
                langNav = navID;
            }
...
<td valign="top"> 
                                                    ...
                                                    <td width="100%" class="page"> 
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                            <tr> 
                                                                ...
                                                                <td class="tablehdr" width="3%" nowrap><font size="1"></font></td>
                                                                <td class="tablehdr" ><font size="1"><%=langNav[6]%></font></td>
                                                            ...
                                                            <tr> 
                                                                ...
                                                                <td width="11%" class="tablecell" nowrap> 
                                                                    <div align="center"> 
                                                                        ...
                                                                        <%=c.getCurrencyCode()%> 
                                                                        <input type="text" name="inv_curr_amountd_<%=invoice.getOID()%>" value="<%=JSPFormater.formatNumber(bpd.getPaymentByInvCurrencyAmount(), "#,###.##")%>"   style="text-align:right" size="15" onClick="this.select()"  onBlur="javascript:getAmountd('<%=invoice.getOID()%>')">
                                                                    </div>
                                                                </td>
                                                                <%
                                                                String notes = "";
    ...
    for (int i = 0; i < invoices.size(); i++) {
        ...
        try{
            //onePendingPO = (OnePendingPO)pendingOnePO.get(""+invoice.getOID());
        }catch(Exception e){}
                                                            ...
                                                            <tr> 
                                                                ...
                                                                <td width="11%" class="tablecell" nowrap> 
                                                                    <div align="center"> 
                                                                        ...
                                                                        %>
                                                                            <%// <input type="text" name="inv_curr_amount_<%=invoice.getOID() value=<%=JSPFormater.formatNumber(bpd.getPaymentByInvCurrencyAmount(), "#,###.##")"   style="text-align:right" size="15" onClick="this.select()"  onBlur="javascript:getAmount('<%=invoice.getOID()')" class="readOnly"> %>
                                                                        <%//}else{%>
