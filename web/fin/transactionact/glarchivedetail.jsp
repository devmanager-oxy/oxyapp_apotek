...
<%-- 
    ...
    Created on : Feb 16, 2014, 11:55:26 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            String[] langNav = {"Journal Archive", "Journal Detail", "Date", "SEARCHING", "EDITOR JOURNAL"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Arsip Jurnal", "Jurnal Detail", "Tanggal", "PENCARIAN", "EDITOR JURNAL"};
                langNav = navID;
            ...
            long nextGl = DbGl.getNextGl(gl.getJournalCounter(),gl.getPeriodId());
            long prevGl = DbGl.getPrevGl(gl.getJournalCounter(),gl.getPeriodId());
%>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdEditGl(oidGl){                
                ...
                document.frmgl.action="glarchivedetail.jsp";
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="0"> 
                                                                                        <tr> 
                                                                                            <td colspan = "5" height="10" align="right">
                                                                                                <%if(prevGl != 0){%>                                                                                                
                                                                                                <a href="<%="javascript:cmdEditGl('" + prevGl + "')"%>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('prev','','../images/ctr_line/BtnPrevOn.jpg',1)"><img src="../images/ctr_line/BtnPrev.jpg" name="prev" height="22" border="0"></a>
                                                                                                <%}%>
                                                                                                <%if(nextGl != 0){%>                                                                                                
                                                                                                <a href="<%="javascript:cmdEditGl('" + nextGl + "')"%>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('next','','../images/ctr_line/BtnNextOn.jpg',1)"><img src="../images/ctr_line/BtnNext.jpg" name="next" height="22" border="0"></a>
                                                                                                <%}%>
                                                                                            </td>
                                                                                        </tr>           
