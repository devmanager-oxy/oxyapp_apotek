...
<%
            ...
            String[] langGL = {"Journal Number", "Transaction Date", "Reference Number", "Journal Detail", //0-3
                ...
                "Error, can't posting journal when details mixed between SP and NSP", "Journal has been saved successfully.", "Searching", "Memo","Activity"};
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Tanggal Transaksi", "Nomor Referensi", "Detail Jurnal", //0-3
                    ...
                    "Error, tidak bisa posting journal dengan detail gabungan SP dan NSP.", "Jurnal sukses disimpan.", "Pencarian", "Memo","Kegiatan"}; //13-17
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (isLoad) {
                ...
                glId = gl.getOID();
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td colspan="5"><font face="arial"><U><B><%=langNav[4]%></B></U></font></td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td colspan="5">&nbsp;</td>
                                                                                                    </tr>
            ...
            if (gl.getOID() != 0) {                								  
                strNumber = gl.getJournalNumber();
                                                                                                            ...
                                                                                                            <input type="hidden" name="<%=JspGl.colNames[JspGl.JSP_JOURNAL_PREFIX]%>">
                                                                                                            <input type="hidden" name="<%=JspGl.colNames[JspGl.JSP_PERIOD_ID]%>" value="<%=gl.periodId()%>">
                                                                                                        </td>
                ...
                for (int i = 0; i < listGlDetail.size(); i++) {
                    ...
                    try {
                        ...
                        System.out.println("[exception] " + e.toString());
                                                                                                                ...
                                                                                                                <%header_view = true;%>
                                                                                                                <tr> 
                                                                                                                    <td rowspan="2"  class="tablehdr" nowrap width="21%"><%=langGL[17]%></td>
