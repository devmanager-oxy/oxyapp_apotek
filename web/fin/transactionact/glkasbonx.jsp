...
function cmdSearchJurnal(){
                        ...
                        if (ct == 2) {
                            ...
                            if (c.getAccountClass() == 2) {
                                diffCoaClass = true;
                                                                                                                ...
                                                                                                                <%header_view = true;%>
                                                                                                                <tr> 
                                                                                                                    <td rowspan="2"  class="tablehdr" nowrap width="21%"><%=langGL[18]%></td>
    ...
    if ((iJSPCommand == JSPCommand.ADD || (iJSPCommand == JSPCommand.SUBMIT && (iErrCode != 0 || iErrCodeMain != 0))) && recIdx == -1 && gl.getPostedStatus() == 0) {
        ...
        colspan = 5;
                                                                                                                ...
                                                                                                                <%}%>
                                                                                                                <tr><td class="tablecell" colspan="10" height="1">&nbsp;</td></tr>
                                                                                                                <tr> 
                                                                                                                    <td colspan="7" align="right"><b>TOTAL : </b></td><td width="15%" class="tablecell" align="center"> 
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                ...
                                                                                if (iJSPCommand != JSPCommand.ADD && iJSPCommand != JSPCommand.EDIT && iJSPCommand != JSPCommand.ASK && iErrCode == 0 && iErrCodeMain == 0) {
                                                                                                ...
                                                                                                <table border="0" cellpadding="5" cellspacing="0" class="info" width="219" align="left">
                                                                                                    <tr><td width="16"><img src="../images/inform.gif" width="20" height="20"></td><td width="183" nowrap><%=langNav[5]%></td></tr>
                                                                                                </table>
                                                                                                <%}%>
                                                                                                <%}%>
                                                                                                <%}%>
                                                                                            ...
                                                                                            <td width="52%">&nbsp;</td><td width="23%" class="boxed1"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1"><tr> <td width="41%" nowrap><b>Out of Balance <%=baseCurrency.getCurrencyCode()%> :</b></td><td width="59%"> <div align="right"><b><a id="tot_balance"></a></b></div> </td></tr></table>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
    ...
    out.print("<a href=\"../freport/gl_priview.jsp?gl_id=" + gl.getOID() + "\" onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('prt','','../images/printdoc2.gif',1)\" onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/printdoc.gif\" name=\"prt\" height=\"22\" border=\"0\"></a></div>");
							...
							if(iJSPCommand==JSPCommand.EDIT){								
								System.out.println("glDetail.getModuleId() : "+selectModuleId);
								if(selectModuleId==0){							
								%>
									cmdInactveAct(0);	
								<%
