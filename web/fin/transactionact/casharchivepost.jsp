...
<%
            ...
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_CASH, AppMenu.M2_MN_CRP, AppMenu.PRIV_DELETE);
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td >
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                            <tr>
                                                                                                                                <td><input name="<%=JspCashArchive.colNames[JspCashArchive.JSP_START_DATE]%>" value="<%=JSPFormater.formatDate((cashArchive.getStartDate() == null ? new Date() : cashArchive.getStartDate()), "dd/MM/yyyy")%>" size="11" readOnly></td>
                                                                                                                                <td><a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmcasharchive.<%=JspCashArchive.colNames[JspCashArchive.JSP_START_DATE]%>);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a></td>
                                                                                                                                <td>&nbsp;<%=langCT[4]%>&nbsp;</td>
                                                                                                                                <td><input name="<%=JspCashArchive.colNames[JspCashArchive.JSP_END_DATE]%>" value="<%=JSPFormater.formatDate((cashArchive.getEndDate() == null ? new Date() : cashArchive.getEndDate()), "dd/MM/yyyy")%>" size="11" readOnly></td>
                                                                                                                                <td><a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmcasharchive.<%=JspCashArchive.colNames[JspCashArchive.JSP_END_DATE]%>);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a></td>
            ...
            if (listCashArchive != null && listCashArchive.size() > 0) {
                if (cashArchive.getSearchFor().equals("cashreceive")) {
                                                                            ...
                                                                            <tr> 
                                                                                <td class="boxed1"> 
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr height="28">
                                                                                            <td width="20" class="tablearialhdr">No</td>
                                                                                    ...
                                                                                    if (listCashArchive != null && listCashArchive.size() > 0) {
                                                                                        for (int i = 0; i < listCashArchive.size(); i++) {
                                                                                            ...
                                                                                            boolean isPostingReady = true;//DbApprovalDoc.isPostingReady(bd.getOID())
                                                                                        ...
                                                                                        <tr height="22">
                                                                                            ...
                                                                                            <td class="tablearialcell1" align="center"><%=bd.getJournalNumber()%></td>
                                                                                            <td class="tablearialcell1" ><%=coa.getCode() + " - " + coa.getName()%></td>
                                                                                ...
                                                                                <td class="boxed1"> 
                                                                                    ...
                                                                                    if (listCashArchive != null && listCashArchive.size() > 0) {
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablearialcell1"><%=bd.getReceiveFromName()%></td>
                                                                                            <td class="tablearialcell1"> 
                                                                                                <div align="right"><%=JSPFormater.formatNumber(bd.getAmount(), "#,###.##")%></div>
                                                                                            </td>
                                                                                            <td class="tablearialcell1"> 
                                                                                ...
                                                                                <td class="boxed1"> 
                                                                                    ...
                                                                                    if (listCashArchive != null && listCashArchive.size() > 0) {
                                                                                        for (int i = 0; i < listCashArchive.size(); i++) {
                                                                                            ...
                                                                                            boolean isPostingReady = true;//DbApprovalDoc.isPostingReady(pp.getOID());
                                                                            ...
                                                                            %>
                                                                            <tr> 
                                                                                <td class="fontarial"><b><i><%=langCT[31]%></i></b></td>
                                                                            </tr>
                                                                            <tr> 
                                                                                <td height="3"></td>
                                                                            </tr>
                                                                                ...
                                                                                <td class="boxed1"> 
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr height="28"> 
                                                                                            ...
                                                                                            <td width="14%" class="tablearialhdr">Segmen</td>
                                                                                            <td width="14%" class="tablearialhdr"><%=langCT[17]%></td>
                                                                                            <td width="15%" class="tablearialhdr"><%=langCT[18]%></td>
                                                                                            <td class="tablearialhdr"><%=langCT[19]%></td>                                                                                            
                                                                                            <td width="15" class="tablearialhdr">&nbsp;</td>
                                                                                        </tr>
                                                                                        <%
                                                                                    vectSize = 0;
                                                                                    if (listCashArchive != null && listCashArchive.size() > 0) {
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td class="tablearialcell1" align="center"><%=(i + 1)%></td>                                                                                            
                                                                                            <td class="tablearialcell1" align="center"><%=pp.getJournalNumber()%></td>
                                                                                            <td class="tablearialcell1" ><%=coa.getCode() + " - " + coa.getName()%></td>
                                                                                            <td class="tablearialcell1" >
                                                                                                <div align="left"> 
                                                                                                    <%
                                                                                            ...
                                                                                            <td class="tablearialcell1"><%=getSubstring(pp.getMemo())%></td>                                                                                            
                                                                                            <td class="tablearialcell1"> 
                                                                                                <div align="center"> 
