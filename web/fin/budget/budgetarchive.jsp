...
<%-- 
    Document   : budgetarchive
    Created on : Mar 11, 2016, 11:43:51 AM
    Author     : Roy
--%>
...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_ARCHIVE);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_ARCHIVE, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_ARCHIVE, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_ARCHIVE, AppMenu.PRIV_ADD);
...
<%
            ...
            if (lang == LANG_ID) {
                ...
                langBudget = langID;
                String[] langBudgetItemID = {"No.", "Nama Akun", "Keterangan", "Diajukan Oleh", "Sudah Terpakai", "Total Terpakai", "Budget YTD", "Selisih","Diketahui Oleh"};
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cmdSearch(){  
                ...
                document.frmbudgetarchive.action="budgetarchive.jsp";
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (segments != null && segments.size() > 0) {
                ...
                for (int i = 0; i < listBudgetRequest.size(); i++) {
                    ...
                    User uApp = new User();
                    try {
                        uApp = DbUser.fetch(br.getApproval1Id());
                    } catch (Exception e) {
                    }
                    ...
                    try {
                        totalRequest = DbBudgetRequestDetail.getSum(DbBudgetRequestDetail.colNames[DbBudgetRequestDetail.COL_BUDGET_REQUEST_ID] + "=" + br.getOID());
                                                                                                                ...
                                                                                                                <tr height="24">
                                                                                                                    ...
                                                                                                                    <td class="<%=style%>" align="left" style="padding:3px;"><%=uApp.getFullName()%></td>
