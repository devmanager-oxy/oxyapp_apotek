...
<%-- 
    Document   : budgetchecked
    Created on : Mar 18, 2016, 3:03:17 AM
    Author     : Roy
--%>
...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_CHECKED);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_CHECKED, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_CHECKED, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_CHECKED, AppMenu.PRIV_ADD);
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_BUDGET, AppMenu.M2_MENU_BUDGET_ARCHIVE, AppMenu.PRIV_DELETE);
%>
<%!
...
<%
            ...
            String[] langBudgetItem = {"Number", "Account Name", "Description", "Request By", "Used", "Total Used", "Budget YTD", "Balance"};
            String[] langNav = {"Budget", "Budget Archive"};

            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Tanggal Transaksi", "Lokasi", "Sampai", "Periode", "Abaikan", "Total Budget", "Data tidak ditemukan"};
                langBudget = langID;
                String[] langBudgetItemID = {"No.", "Nama Akun", "Keterangan", "Diajukan Oleh", "Sudah Terpakai", "Total Terpakai", "Budget YTD", "Selisih"};
                langBudgetItem = langBudgetItemID;
                String[] navID = {"Anggaran", "Arsip Anggaran"};
                langNav = navID;
            }
            ...
            String whereClause = DbBudgetRequest.colNames[DbBudgetRequest.COL_STATUS]+" = "+DbBudgetRequest.DOC_STATUS_APPROVED;
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function cmdSearch(){  
                ...
                document.frmbudgetarchive.action="budgetchecked.jsp";
            ...
            function cmdEdit(oidBudgetRequest,keyUniqId){
                ...
                document.frmbudgetarchive.command.value="<%=JSPCommand.EDIT%>";
                document.frmbudgetarchive.prev_command.value="<%=prevJSPCommand%>";
                document.frmbudgetarchive.action="budgetrequest.jsp";
                document.frmbudgetarchive.submit();
                <%}%>
            }
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (segments != null && segments.size() > 0) {
                                                                                                        ...
                                                                                                        <td class="container">
                                                                                                            <table cellpadding="0" cellspacing="1" border="0">
                                                                                                                <tr height="26">
                                                                                                                    ...
                                                                                                                    <td class="tablearialhdr" width="300"><%=langBudgetItem[2]%></td>      
                                                                                                                    <td class="tablearialhdr" width="130"><%=langBudget[6]%></td>                                                                                                                    
                                                                                                                    <td class="tablearialhdr" width="50">Status</td>                                                                                                                    
                                                                                                                </tr> 
                ...
                for (int i = 0; i < listBudgetRequest.size(); i++) {
                    ...
                    try {
                        totalRequest = DbBudgetRequestDetail.getSum(DbBudgetRequestDetail.colNames[DbBudgetRequestDetail.COL_BUDGET_REQUEST_ID] + "=" + br.getOID());
                    } catch (Exception e) {
                    }
                                                                                                                %>     
                                                                                                                <tr height="24">
                                                                                                                    ...
                                                                                                                    <td class="<%=style%>" align="left" style="padding:3px;"><%=br.getMemo()%></td>
                                                                                                                    <td class="<%=style%>" align="right" style="padding:3px;"><%=JSPFormater.formatNumber(totalRequest, "###,###.##")%></td>
                                                                                                                    <td class="<%=style%>" align="center" style="padding:3px;"><%=DbBudgetRequest.strStatusDocument[br.getStatus()].toUpperCase()%></td>
                                                                                                                </tr>
                                                                                                                <%
    }%>
