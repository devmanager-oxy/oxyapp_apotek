...
<!-- Jsp Block -->
<%!
    public String drawList(Vector objectClass, long termOfPaymentOid, String approot, int start, int recordToGet, String[] lang) {
        ...
        jsplist.addHeader(lang[1], "10%");
        jsplist.addHeader(lang[2], "10%");
...
//}
            ...
            /*** LANG ***/
            String[] langMD = {"Description", "Due", "Qty Disc", "Disc Percent"}; //0-3
            String[] langNav = {"Masterdata", "Term of Payment"};
            if (lang == LANG_ID) {
                String[] langID = {"Keterangan", "Jatuh Tempo", "Jumlah Diskon", "% Diskon"}; //0-3
                langMD = langID;
                String[] navID = {"Data Induk", "Term Pembayaran"};
                langNav = navID;
            }
%>
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3"> 
                                                                                                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td class="boxed1"><%=drawList(listTermOfPayment, oidTermOfPayment, approot, start, recordToGet, langMD)%></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
