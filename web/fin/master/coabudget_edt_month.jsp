...
if(iJSPCommand==JSPCommand.SAVE && listCoa!=null && listCoa.size()>0 && v!=null && v.size()>0){
	for(int i=0; i<listCoa.size(); i++){		
		...
		//for(int x=0; x<12; x++){		
			double amn = JSPRequestValue.requestDouble(request, "bgt_"+coax.getOID()+"_"+(yearx+1900));
			//out.println("<br>coa : "+coax.getOID()+", periode : "+px.getOID()+", amn : "+amn);
			long oid = DbCoaBudget.processBudget(coax.getOID(), (yearx+1900), amn, monthx);			
		//}
	}	
}
...
function cmdViewBudget(){
	document.frmcoa.command.value="<%=JSPCommand.LIST%>";
	document.frmcoa.action="coabudget_edt_month_view.jsp";
	document.frmcoa.submit();
}
                            ...
                            <tr align="left" valign="top"> 
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="70%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        <tr> 
                                          <td colspan="2" height="41" nowrap> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td width="13%" nowrap>Account 
                                                  Group&nbsp;</td>
                                                <td width="17%"> 
                                                ...
                                                <td width="15%" nowrap>&nbsp;&nbsp;Budget/Target 
                                                  Year</td>
                                                <td width="15%"> 
                                                  <%
											...
											%>
                                                ...
                                                <td width="6%">&nbsp;&nbsp;Month</td>
                                                <td width="34%">
                                                  <select name="budget_month" onChange="javascript:cmdAccGroup()">
                                                ...
                                                <td width="34%" nowrap> 
                                                  <div align="right"><a href="javascript:cmdViewBudget()">View 
                                                    Full Year Budget</a> </div>
                                                </td>
                                              </tr>
                                            </table>
                                          </td>
                                        ...
                                        <tr> 
                                          <td width="40%" class="tablehdr" height="22"> 
                                            <div align="center"><b><font color="#FFFFFF">Account</font></b></div>
                                          </td>
                                          <td class="tablehdr" height="22" width="60%"> 
                                            <%
										  switch(monthx){
										  	case 0 : out.println("Jan");
													 break;
											case 1 : out.println("Feb");
													 break;
											case 2 : out.println("Mar");
													 break;
											case 3 : out.println("Apr");
													 break;
											case 4 : out.println("May");
													 break;
											case 5 : out.println("Jun");
													 break;
											case 6 : out.println("Jul");
													 break;
											case 7 : out.println("Aug");
													 break;
											case 8 : out.println("Sep");
													 break;
											case 9 : out.println("Oct");
													 break;
											case 10 : out.println("Nov");
													 break;		 		
											case 11 : out.println("Dec");
													 break;
							  ...
							  %>
                                        <tr> 
                                          ...
                                          <td class="<%=cssString%>" width="60%"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  
										  	 CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, monthx);
										  
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt_<%=coa.getOID()+"_"+(yearx+1900)%>" size="20" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                        </tr>
                                        <%}%>
                                        <tr> 
                                          <td width="40%" class="tablecell">&nbsp;</td>
