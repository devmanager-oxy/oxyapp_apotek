...
<%
            ...
            String[] langMD = {"Records", "Editor", "Account Group", //0-2
                "Account", "Budget", "Transaction", "Budget Balance", "Account Group", "Is SP", "Level", "Department", "Section","Type","Saldo Normal"}; //3-12

            String[] langNav = {"Masterdata", "Chart of Account", "All"};

            if (lang == LANG_ID) {
                String[] langID = {"Daftar", "Editor", "Kelompok Perkiraan",
                    "Perkiraan", "Anggaran", "Transaksi", "Saldo Anggaran", "Kelompok Perkiraan", "SP", "Level", "Departemen", "Bagian","Tipe","Saldo Normal"
                };
                langMD = langID;
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdToEditor(){                
                document.frmcoa.hidden_coa_id.value=0;
                document.frmcoa.menu_idx.value=<%=menuIdx%>;                
                document.frmcoa.command.value="<%=JSPCommand.ADD%>";
                document.frmcoa.prev_command.value="<%=prevJSPCommand%>";
                document.frmcoa.action="coaedt.jsp";
                document.frmcoa.submit();
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="22" valign="middle" colspan="3" class="page"> 
                                                                                    <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td colspan="6" height="41"><font face="arial"><%=langMD[2]%></font> 
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td class="tablearialhdr" height="22" align="center"><%=langMD[3]%></td>                                                                                            
                                                                                            <td width="20%" class="tablearialhdr" height="22"><%=langMD[7]%></td>                                                                                            
                                                                                            <td width="11%" class="tablearialhdr" height="22"><%=langMD[9]%></td>
                                                                                            <td width="11%" class="tablearialhdr" nowrap height="22"><%=langMD[12]%></td>
                                                                                            <td width="14%" class="tablearialhdr" nowrap height="22"><%=langMD[13]%></td>
                                                                                        </tr>
                        ...
                        cssString = "tablearialcell1";
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="<%=cssString%>">                                                                                                 
                                                                                                ...
                                                                                                <b> 
                                                                                                    <%}%>
                                                                                                    <div align="left"><%=coa.getStatus()%></div>                                                                                                    
                                                                                                    <%if (coa.getStatus().equals("HEADER")) {%>
                                                                                                </b> 
                                                                                                <%}%>
                                                                                            </td>
                                                                                            ...
                                                                                            <td class="<%=cssString%>"> 
                                                                                                <div align="center">
                                                                                                        ...
                                                                                                        <b> 
                                                                                                            <%}%>
                                                                                                            <%=coa.getSaldoNormal().toUpperCase() %>
                                                                                                            <%if (coa.getStatus().equals("HEADER")) {%>
                                                                                                        </b> 
                                                                                                        <%}%>
                                                                                                </div>
                                                                                        ...
                                                                                        <%}%>
                                                                                        <tr> 
                                                                                            <td colspan="6" class="tablecell">&nbsp;</td>
                                                                                        </tr>
                                                                                        <%} else {%>
                                                                                        <tr> 
                                                                                            <td colspan="6" >&nbsp;</td>
