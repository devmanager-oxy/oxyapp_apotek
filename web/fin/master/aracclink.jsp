...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_AP, AppMenu.M2_MENU_ARL);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_AP, AppMenu.M2_MENU_ARL, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_AP, AppMenu.M2_MENU_ARL, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_AP, AppMenu.M2_MENU_ARL, AppMenu.PRIV_ADD);
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MENU_AP, AppMenu.M2_MENU_ARL, AppMenu.PRIV_DELETE);
%>
<!-- Jsp Block -->
<%!
    public String drawList(int iCommand, JspAccLink frmObject, AccLink objEntity, Vector objectClass, long accLinkId,
            boolean isPostableOnly, String[] lang) {
...
// Combobox Type
        ...
        for (int i = 0; i < I_Project.arAccLink.length; i++) {
            type_key.add(I_Project.arAccLink[i]);
            type_value.add(I_Project.arAccLink[i]);
        }
...
// variable declaration
            ...
            if (grpType.equals("All")) {
                for (int i = 0; i < I_Project.arAccLink.length; i++) {
                    whereClause = whereClause + " (" + DbAccLink.colNames[DbAccLink.COL_TYPE] + " = '" + I_Project.arAccLink[i] + "') or";
                }
            ...
            iErrCode = cmdAccLink.action(iCommand, oidAccLink, appSessUser.getUserOID());
            ...
            /*** LANG ***/
            String[] langAR = {"Account Type", "Bank Account", "Location", //0-2
            ...
            String[] langNav = {"Account Receiveable", "AR Acc. List"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Piutang", "AR Acc. List"};
                langNav = navID;
            }
%>
<html >
        ...
        <script language="JavaScript">            
            ...
            function cmdResetSaja(){
                if(confirm("Warning !! \nthis action will delete previows setup data, and update to the new setup, \nare you seure ?")){
                    ...
                    document.frmacclink.action="aracclink.jsp";
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                                                    ...
                                                                                                                    <td height="8"  colspan="3" valign="top"> 
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                ...
                                                                                                                                <td height="22" valign="middle" colspan="3" class="comment" width="99%"><%=langAR[0]%>&nbsp;&nbsp;<select name="groupType" onChange="javascript:cmdAccGroup()">
                                                                                                                                        <option value="All" <%if (grpType.equals("All")) {%>selected<%}%>>All</option>
                                                                                                                                        <%
            for (int i = 0; i < I_Project.arAccLink.length; i++) {
                                                                                                                                        %>
                                                                                                                                        <option value="<%=I_Project.arAccLink[i]%>" <%if (I_Project.arAccLink[i].equals(grpType)) {%>selected<%}%>><%=I_Project.arAccLink[i]%></option>
                                                                                                                                        <%
            }%>
                                                                                                                                    </select>
                                                                                                                                </td>
            ...
            try {
                                                                                                                            ...
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                ...
                                                                                                                                <td height="22" valign="middle" colspan="3" width="99%"><%= drawList(iCommand, jspAccLink, accLink, listAccLink, oidAccLink, isPostableOnly, langAR)%> 
            ...
            if (privAdd == false) {
                jspLine.setAddCaption("");
                                                                                                                            ...
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                <td height="22" valign="middle" width="1%">&nbsp;</td>
                                                                                                                                <td height="22" valign="middle" colspan="3" width="99%"><font color="#FF0000"><%=langAR[3]%></font> 
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                <td height="22" valign="middle" width="1%">&nbsp;</td>
            ...
            for (int i = 0; i < I_Project.arAccLink.length; i++) {
                                                                                                                                            ...
                                                                                                                                            <td width="18%"> 
                                                                                                                                                <div align="center">&nbsp;<a href="javascript:cmdResetSaja()"><%=langAR[5]%></a></div>
                                                                                                                                            </td>
                                                                                                                                            <td width="3%">&nbsp;</td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
