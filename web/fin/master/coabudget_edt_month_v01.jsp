...
int monthx = JSPRequestValue.requestInt(request, "budget_month");
if(yearx!=0){
	yearx = yearx - 1900;
	dt.setYear(yearx);
}
...
if(iJSPCommand==JSPCommand.SAVE && listCoa!=null && listCoa.size()>0 && v!=null && v.size()>0){
	for(int i=0; i<listCoa.size(); i++){		
		...
		for(int x=0; x<12; x++){		
			double amn = JSPRequestValue.requestDouble(request, "bgt"+x+"_"+coax.getOID()+"_"+(yearx+1900));
			//out.println("<br>coa : "+coax.getOID()+", periode : "+px.getOID()+", amn : "+amn);
			long oid = DbCoaBudget.processBudget(coax.getOID(), (yearx+1900), amn, x);			
		}
	}	
}
...
function cmdAdd(){
	...
	document.frmcoa.action="coabudget_edt_month.jsp";
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        <tr> 
                                          <td colspan="13" height="41" nowrap>
<table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td width="8%">Account Group&nbsp;</td>
                                                <td width="17%"> 
											...
											%>
                                                ...
                                                <td width="45%"> 
                                                  <select name="budget_month">
                                                    <option value="0" <%if(monthx==0){%>selected<%}%>>Jan</option>
                                                    <option value="1" <%if(monthx==1){%>selected<%}%>>Feb</option>
                                                    <option value="2" <%if(monthx==2){%>selected<%}%>>Mar</option>
                                                    <option value="3" <%if(monthx==3){%>selected<%}%>>Apr</option>
                                                    <option value="4" <%if(monthx==4){%>selected<%}%>>May</option>
                                                    <option value="5" <%if(monthx==5){%>selected<%}%>>Jun</option>
                                                    <option value="6" <%if(monthx==6){%>selected<%}%>>Jul</option>
                                                    <option value="7" <%if(monthx==7){%>selected<%}%>>Aug</option>
                                                    <option value="8" <%if(monthx==8){%>selected<%}%>>Sep</option>
                                                    <option value="9" <%if(monthx==9){%>selected<%}%>>Oct</option>
                                                    <option value="10" <%if(monthx==10){%>selected<%}%>>Nov</option>
                                                    <option value="11" <%if(monthx==10){%>selected<%}%>>Dec</option>
                                                  </select>
                                                </td>
                                              </tr>
                                            </table>
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablehdr" height="22">Jan</td>
                                          <td class="tablehdr" height="22">Feb</td>
                                          <td class="tablehdr" height="22">Mar</td>
                                          <td class="tablehdr" height="22">Apr</td>
                                          <td class="tablehdr" height="22">May</td>
                                          <td class="tablehdr" height="22">Jun</td>
                                          <td class="tablehdr" height="22">Jul</td>
                                          <td class="tablehdr" height="22">Aug</td>
                                          <td class="tablehdr" height="22">Sep</td>
                                          <td class="tablehdr" height="22">Oct</td>
                                          <td class="tablehdr" height="22">Nov</td>
                                          <td class="tablehdr" height="22">Dec</td>
                                        </tr>
							  ...
							  %>
                                        <tr> 
										  ...
										  if(!coa.getStatus().equals("HEADER")){
										  	 ...
										  	 CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 0);
										  
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt0_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
										  ...
										  if(!coa.getStatus().equals("HEADER")){
											...
											CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 1);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt1_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 2);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt2_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 3);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt3_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 4);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt4_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 5);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt5_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 6);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt6_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 7);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt7_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 8);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt8_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 9);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt9_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
										  if(!coa.getStatus().equals("HEADER")){
										  	CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 10);
										  %>
                                            <div align="center"> 
                                              <input type="text" name="bgt10_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                            <%
											if(!coa.getStatus().equals("HEADER")){
												CoaBudget cBudget = DbCoaBudget.getBudget(coa.getOID(), yearx+1900, 11);
											%>
                                            <div align="center"> 
                                              <input type="text" name="bgt11_<%=coa.getOID()+"_"+(yearx+1900)%>" size="12" value="<%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%>" onClick="this.select()" onBlur="javascript:checkNumber(this)" style="text-align:right">
                                            </div>
                                            <%}%>
                                          </td>
                                        </tr>
