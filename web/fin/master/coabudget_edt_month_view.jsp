                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        <tr> 
                                          <td colspan="14" height="41" nowrap> 
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablehdr" height="22">Year</td>
                                        </tr>
							  ...
							  %>
                                        <tr> 
										  ...
										  if(!coa.getStatus().equals("HEADER")){
											 ...
											 totalYearBudget = totalYearBudget + cBudget.getAmount();
										  
										  %>
                                              <%=(cBudget.getAmount()==0) ? "" : JSPFormater.formatNumber(cBudget.getAmount(), "#,###")%> 
                                              <%}%>
                                            </div>
                                          </td>
                                          <td class="<%=cssString%>"> 
                                          ...
                                          <td class="<%=cssString%>"> 
											...
											if(!coa.getStatus().equals("HEADER")){
												...
												totalYearBudget = totalYearBudget + cBudget.getAmount();
											%>
                                              <%=(totalYearBudget==0) ? "" : JSPFormater.formatNumber(totalYearBudget, "#,###")%> 
                                              <%}%>
                                            </div>
                                          </td>
                                        </tr>
