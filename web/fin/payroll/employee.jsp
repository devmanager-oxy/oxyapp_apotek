...
<!-- Jsp Block -->
<%!
    public String drawList(Vector objectClass, long employeeId, String[] lang) {
        ...
        cmdist.addHeader(lang[0], "");
        cmdist.addHeader(lang[1], "10%");
        cmdist.addHeader(lang[2], "25%");
        cmdist.addHeader(lang[3], "15%");
        cmdist.addHeader(lang[4], "20%");
        cmdist.addHeader(lang[5], "10%");
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(employee.getCountryName());
            rowx.add(employee.getEmpType());
            if (employee.getEmpStatus().equals(I_Project.STATUS_ACTIVE)) {
                rowx.add("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr height=\"20\"><td bgcolor=\"72D5BF\" align=\"center\" ><font face=\"arial\" >" + employee.getEmpStatus() + "</font><td></tr></table>");
            } else {
                rowx.add("<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr height=\"20\"><td bgcolor=\"D4543A\" align=\"center\"><font face=\"arial\" >" + employee.getEmpStatus() + "</font><td></tr></table>");
            }
...
<%
            ...
            long dept = JSPRequestValue.requestLong(request, "dept");
            String name = JSPRequestValue.requestString(request, "txt_name");
            String address = JSPRequestValue.requestString(request, "txt_address");
            String nip = JSPRequestValue.requestString(request, "txt_nip");
            String sts = JSPRequestValue.requestString(request, "sts");
            int ign = 1;

            if (iJSPCommand == JSPCommand.SEARCH) {
                ign = JSPRequestValue.requestInt(request, "ign");
            }

            Date dob = new Date();

            String strDob = JSPRequestValue.requestString(request, "txt_dob");
            if (strDob != null && strDob.length() > 0 && ign == 0) {
                try {
                    dob = JSPFormater.formatDate(strDob, "dd/MM/yyyy");
                } catch (Exception e) {
                }
            }
            ...
            if (name != null && name.length() > 0) {
                ...
                whereClause = whereClause + DbEmployee.colNames[DbEmployee.COL_NAME] + " like '%" + name + "%'";
            }
            ...
            if (nip != null && nip.length() > 0) {
                ...
                whereClause = whereClause + DbEmployee.colNames[DbEmployee.COL_EMP_NUM] + " like '%" + nip + "%'";
            }
            ...
            if (address != null && address.length() > 0) {
                ...
                whereClause = whereClause + DbEmployee.colNames[DbEmployee.COL_ADDRESS] + " like '%" + address + "%'";
            }
            ...
            if (!sts.equalsIgnoreCase("")) {
                ...
                whereClause = whereClause + DbEmployee.colNames[DbEmployee.COL_EMP_STATUS] + " like '" + sts + "'";
            }
            ...
            if (dept != 0) {
                ...
                whereClause = whereClause + DbEmployee.colNames[DbEmployee.COL_DEPARTMENT_ID] + " = '" + dept + "'";
            }
            ...
            if (ign == 0) {
                ...
                whereClause = whereClause + " to_days(" + DbEmployee.colNames[DbEmployee.COL_DOB] + ") = to_days('" + JSPFormater.formatDate(dob, "yyyy-MM-dd") + "')";
            }

            String orderClause = DbEmployee.colNames[DbEmployee.COL_NAME];
            ...
            String[] langNav = {"Masterdata", "Employee", "Name", "Date Of Birth", "Nip", "Address", "Department", "Status", "Ignore", "Data employee not found"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Data Induk", "Pegawai", "Nama", "Tanggal Lahir", "Nip", "Alamat", "Departemen", "Status", "Abaikan", "Data pengguna tidak ditemukan"};
                langNav = navID;
            }
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdSearch(){                
                document.frmemployee.command.value="<%=JSPCommand.SEARCH %>";
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="8" valign="middle" colspan="3" class="page"> 
                                                                                                <table border="0" cellspacing="1" cellpadding="0">
                                                                                                    <tr height="22">                                                                                                        
                                                                                                        <td width="80" class="tablearialcell1">&nbsp;<%=langNav[2]%></td>
                                                                                                        <td width="5" class="fontarial">:</td>
                                                                                                        <td width="250"><input type="text" name="txt_name" size="20" value="<%=name%>"></td>
                                                                                                        <td width="80" class="tablearialcell1">&nbsp;<%=langNav[3]%></td>
                                                                                                        <td width="5" class="fontarial">:</td>
                                                                                                        <td>
                                                                                                            <table border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    <td>
                                                                                                                        <input name="txt_dob" value="<%=JSPFormater.formatDate((dob == null) ? new Date() : dob, "dd/MM/yyyy")%>" size="11" style="text-align:center" readOnly>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                        <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmemployee.txt_dob);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt="visit date"></a>
                                                                                                                    </td>
                                                                                                                    <td>
                                                                                                                    <input type="checkbox" name="ign" value="1" <%if (ign == 1) {%> checked <%}%> >
                                                                                                                           </td>
                                                                                                                    <td class="fontarial">&nbsp;<%=langNav[8]%></td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    </tr>  
                                                                                                    <tr height="22">                                                                                                        
                                                                                                        <td class="tablearialcell1">&nbsp;<%=langNav[4]%></td>
                                                                                                        <td>:</td>
                                                                                                        <td><input type="text" name="txt_nip" size="20" value="<%=nip%>"></td>
                                                                                                        <td class="tablearialcell1">&nbsp;<%=langNav[5]%></td>
                                                                                                        <td>:</td>
                                                                                                        <td><input type="text" name="txt_address" size="20" value="<%=address%>"></td>
                                                                                                    </tr> 
                                                                                                    <tr height="22">                                                                                                        
                                                                                                        <td class="tablearialcell1">&nbsp;<%=langNav[6]%></td>
                                                                                                        <td>:</td>
                                                                                                        <td>
                                                                                                            <select name="dept" class="fontarial">
                ...
                for (int i = 0; i < deps.size(); i++) {
                    ...
                    if (d.getOID() == dept) {
                        str_selected = "selected";
                                                                                                                ...
                                                                                                                %>
                                                                                                                <option value="<%=d.getOID()%>" <%=str_selected%> ><%=d.getCode()%> - <%=d.getName()%></option>
                                                                                                                <%}
            }%>
                                                                                                            </select>
                                                                                                        </td>
                                                                                                        <td class="tablearialcell1">&nbsp;<%=langNav[7]%></td>
                                                                                                        <td>:</td>
                                                                                                        <td>
                                                                                                            <select name="sts" class="fontarial">
                                                                                                            <option value="" selected>- All Status -</option>
                                                                                                            <%
            for (int i = 0; i < I_Project.statusArray2.length; i++) {
                String str_selected = "";
                if (I_Project.statusArray2[i].equalsIgnoreCase(sts)) {
                    str_selected = "selected";
                }
                                                                                                            %>
                                                                                                            <option value="<%=I_Project.statusArray2[i]%>" <%=str_selected%> > <%=I_Project.statusArray2[i]%></option>
                                                                                                            <%
            }
                                                                                                            %>
                                                                                                        </td>
                ...
                if (listEmployee.size() > 0) {
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3"> 
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr> 
                                                                                                        <td class="boxed1"><%= drawList(listEmployee, oidEmployee, langMD)%></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%  } else {%>
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3" class="fontarial"> 
                                                                                                <i><%=langNav[9]%>...</i>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%}
