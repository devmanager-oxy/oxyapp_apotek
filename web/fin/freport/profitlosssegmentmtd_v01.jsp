...
<%-- 
    Document   : profitlosssegmentmtd_v01
    Created on : Apr 6, 2013, 6:53:15 PM
    Author     : Roy Andika
--%>
...
<%!
    ...
    public String strDisplayPersen(double amount, String coaStatus) {
        String displayStr = "";
        if (amount < 0) {
            displayStr = "(" + JSPFormater.formatNumber(amount * -1, "#,###.##") + ") %";
        } else if (amount > 0) {
...
%>
<%
            if (session.getValue("PROFIT0MDT") != null) {
                session.removeValue("PROFIT0MDT");
            }

            if (session.getValue("PERIODMTDID") != null) {
                session.removeValue("PERIODMTDID");
            }

            if (session.getValue("SEGMENT1MTDID") != null) {
                session.removeValue("SEGMENT1MTDID");
            }
            ...
            if (lang == LANG_ID) {
                ...
                String[] monthID = {"Januari", "Pebruari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"};
                month = monthID;
            }

            session.putValue("PERIODMTDID", "" + periodeId);
            session.putValue("SEGMENT1MTDID", "" + segment1Id);
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdGO(){
                document.frmcoa.action="profitlosssegmentmtd_v01.jsp";
            ...
            function cmdPrintJournalXLS(){	 
                window.open("<%=printroot%>.report.RptProfitLossSegmentMTDXLS?oid=<%=appSessUser.getLoginId()%>");
                }
                                                                            ...
                                                                            <tr align="center" valign="top">
                                                                                <td valign="middle" colspan="3"> 
                                                                                    <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">                                        
                                                                                        <tr> 
                                                                                            <%if (segment1Id == 0) {%>
                                                                                            <td valign="middle" align="center"><font face="arial" size="3"><b>KONSOLIDASI</b></font></td>
                                                                                            <%} else {
    ...
    try {
        sdx = DbSegmentDetail.fetchExc(segment1Id);
                                                                                            ...
                                                                                            %>
                                                                                            <td valign="middle" align="center"><font face="arial" size="3"><b><%=sdx.getName().toUpperCase()%></b></font></td>
                                                                                            <%}%>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            ...
                                                                            <%
    String prevPeriod = month[startDate.getMonth()] + " " + JSPFormater.formatDate(startDate, "yyyy");
    String openPeriod = month[periode.getStartDate().getMonth()] + " " + JSPFormater.formatDate(periode.getStartDate(), "yyyy");
                                                                            %>
                                                                            <tr align="center" valign="top"> 
                                                                                <td valign="middle" colspan="3"> 
                                                                                    <font face="arial" size="2"><b><i>( <%=prevPeriod%> & <%=openPeriod%> )</i></b></font>
                                                                                </td>
                                                                            </tr>
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="30" valign="middle" colspan="3"></td>
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="22" valign="middle" colspan="3" class="page"> 
                                                                                    <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                                                                        <tr height="28"> 
                                                                                            <td class="tablehdr" height="22" nowrap><%=langFR[6]%></td>                                                                                            
                                                                                            <td width="250" class="tablehdr" height="22" nowrap><%=prevPeriod%></td>
                                                                                            <td width="50" class="tablehdr" height="22" nowrap>%</td>
                                                                                            <td width="250" class="tablehdr" height="22" nowrap><%=openPeriod%></td>
                                                                                            <td width="50" class="tablehdr" height="22" nowrap>%</td>
                                                                                        </tr>
    ...
    double groupRev = DbCoa.getIsCoaBalanceByGroupMTD(listCoa, "CD", whereMd, periode);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        double totalHeaderPrev = 0;

        String nameHeader = "";
        double totHeaderPrev = 0;
        double totHeader = 0;
        String strHeader = "";
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_REVENUE)) {
                ...
                double amount = DbCoa.getCoaBalancePNLMTD(coa, whereMd, periode, "CD");
                ...
                if (valShowList == 1) { // perkiraan dengan transaksi
                    if (amount != 0) {

                        double balancePrev = DbCoa.getCoaBalancePNLMTD(coa, whereMd, lastPeriod, "CD");

                        if (coa.getStatus().equals("HEADER")) {
                            totalHeaderPrev = balancePrev;
                        }

                        if (status.equals("POSTABLE") && coa.getStatus().equals("HEADER")) {%>
                                                                                        <tr height="24"> 
                                                                                            <td class="tablecell"><span class="level2"><b><%=strHeader%><%="TOTAL " + nameHeader%></b></span></td>
                                                                                            <td class="tablecell" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(totHeaderPrev, "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            ...
                                                                                            <td class="tablecell" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(totHeader, "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                        ...
                                                                                        <tr> 
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="90%" class="<%=cssString%>"> 
                                                                                                            ...
                                                                                                            <%
                                                                                                                    ...
                                                                                                                    totHeaderPrev = totHeaderPrev + balancePrev;
                                                                                                                }
                                                                                                            %>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                            ...
                                                                                            <%
                                                                                                                double persen = 0;
                                                                                                                if (totalHeaderPrev != 0) {
                                                                                                                    persen = (balancePrev / totalHeaderPrev) * 100;
                                                                                                                }
                                                                                            %>
                                                                                            <td class="<%=cssString%>" nowrap>
                                                                                                <%if (!coa.getStatus().equals("HEADER")) {%>
                                                                                                <div align="right"><%=strDisplayPersen(persen, coa.getStatus())%></div>
                                                                                                <%}%>
                                                                                            </td>
                                                                                            <%
                                                                                                                vSesDep = new Vector();
                                                                                            ...
                                                                                            <%
                                                                                                                if (totalHeader != 0) {
                                                                                                                    persen = (amount / totalHeader) * 100;
                                                                                                                }
                                                                                            %>
                                                                                            <td class="<%=cssString%>" nowrap><div align="right">
                                                                                                    <%if (!coa.getStatus().equals("HEADER")) {%>
                                                                                                    <%=strDisplayPersen(persen, coa.getStatus())%>
                                                                                                    <%}%>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%
                                                                                                            ...
                                                                                                            if (status.equals("POSTABLE") && coa.getStatus().equals("HEADER")) {%>
                                                                                        <tr height="24"> 
                                                                                            <td class="tablecell"><b><%=strTotal%><%="T O T A L " + nameHeader%></b></td>
                                                                                            <td class="tablecell" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            %>
                                                                                            <td class="<%=cssString%>"><div align="right"><%=strDisplayPersen(persen, coa.getStatus())%></div></td>                                                                                            
                                                                                            <%
                                                                                                            if (!coa.getStatus().equals("HEADER")) {
                                                                                                                totalRev = totalRev + amount;
                                                                                                                totHeader = totHeader + amount;
...
%>
                                                                                        <tr height="24"> 
                                                                                            <td class="tablecell"><b><%=strHeader%><%="TOTAL " + nameHeader%></b></td>
                                                                                            <td class="tablecell" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="fontarial"> 
                                                                                                            <div align="right"><b><%=strDisplay(totHeaderPrev, "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                        ...
                                                                                        <tr height="24"> 
                                                                                            <td class="tablecell"><span class="level2"><b><%="TOTAL " + I_Project.ACC_GROUP_REVENUE.toUpperCase()%></b></span></td>
                                                                                            <td class="tablecell" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
    ...
    if (valShowList != 1 || groupRev != 0) {//add Space
        ...
        listReport.add(sesReport);
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablecell1" colspan="4"></td>
                                                                                        </tr>
                                                                                        <%}%>                                                                                              
                                                                                        <!--level 2-->
                                                                                        <!--level ACC_GROUP_COST_OF_SALES-->
            <%
    listCoa = DbCoa.list(0, 0, DbCoa.colNames[DbCoa.COL_ACCOUNT_GROUP] + " ='Cost Of Sales'", DbCoa.colNames[DbCoa.COL_CODE]);
    double groupCOS = DbCoa.getIsCoaBalanceByGroupMTD(I_Project.ACC_GROUP_COST_OF_SALES, "DC", whereMd, periode);
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_COST_OF_SALES)) {
                ...
                if (valShowList == 1) {
                    if (amount != 0) {
                        ...
                        //if (!coa.getStatus().equals("HEADER")) {
                        //openingBalancePrev = DbCoa.getCoaBalancePNLMTD(coa, whereMd, lastPeriod, "DC");
                        //totalHeaderPrev = openingBalancePrev;
                        //}
                        double balancePrev = DbCoa.getCoaBalancePNLMTD(coa, whereMd, lastPeriod, "DC");
                        ...
                        if (status.equals("POSTABLE") && coa.getStatus().equals("HEADER")) {%>
                                                                                        ...
                                                                                        <tr height="24"> 
                                                                                            <td bgcolor="#F4D684" class="fontarial"><b><%="TOTAL " + I_Project.ACC_GROUP_COST_OF_SALES%></b></td>                                                                                            
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                            ...
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"><div align="right"><b><%=strDisplayPersen(totalPrevCOS / totalPrevRev * 100, "")%></b></div></td>                                                                                            
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(totalCOS, "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"><div align="right"><b><%=strDisplayPersen(totalCOS / totalRev * 100, "")%></b></div></td> 
                                                                                        </tr>
                                                                                        <%							//add Group Footer
            sesReport = new SesReportBs();
            sesReport.setType("Footer Group Level");
    ...
    if (groupCOS != 0 || valShowList != 1) {	//add Space
        ...
        listReport.add(sesReport);
                                                                                        ...
                                                                                        <%}%>
                                                                                        <tr height="24"> 
                                                                                            <td bgcolor="#F4D684" class="fontarial"><b>Gross Profit</b></td>                                                                                            
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(totalPrevRev - totalPrevCOS, "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"><div align="right"><b><%=strDisplayPersen((totalPrevRev - totalPrevCOS) / (totalPrevRev) * 100, "")%></b></div></td> 
                                                                                            <%

    displayStr1 = strDisplay(totalRev - totalCOS, "");
                                                                                            ...
                                                                                            <td bgcolor="#F4D684" class="fontarial" align="right"><div align="right"><b><%=strDisplayPersen((totalRev - totalCOS) / (totalRev) * 100, "")%></b></div></td> 
                                                                                        </tr>
                                                                                        <tr> 
                                                                                            <td class="tablecell1" height="15"></td>
                                                                                            <td class="tablecell1" colspan="4"></td>
                                        ...
                                        <%
    double groupExp = DbCoa.getIsCoaBalanceByGroupMTD(I_Project.ACC_GROUP_EXPENSE, "DC", whereMd, periode);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_EXPENSE)) {
                ...
                str1 = switchLevel1(coa.getLevel());
                double amount = 0;
                double balanceByHeader = 0;

                if (!coa.getStatus().equals("HEADER")) {
                    amount = DbCoa.getCoaBalancePNLMTD(coa, whereMd, periode, "DC");
                } else {
                    balanceByHeader = DbCoa.getCoaBalancePNLMTD(coa, whereMd, periode, "DC");
                    totalHeader = balanceByHeader;
                }
                ...
                if (valShowList == 1) {
                    if (((!coa.getStatus().equals("HEADER")) && amount != 0) || (coa.getStatus().equals("HEADER") && balanceByHeader != 0)) {
                        double openingBalancePrev = DbCoa.getCoaBalancePNLMTD(coa, whereMd, lastPeriod, "DC");
                        if (coa.getStatus().equals("HEADER")) {
                            totalHeaderPrev = openingBalancePrev;
                        }
                        ...
                        if (status.equals("POSTABLE") && coa.getStatus().equals("HEADER")) {%>
                                                                                        <tr height="24"> 
                                                                                            <td class="tablecell"><b><%=strTotal%><%="Total " + nameHeader%></b></td>
                                                                                            <td class="tablecell" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <%
                                                                                                            vSesDep = new Vector();
                                                                                                            amount = DbCoa.getCoaBalancePNLMTD(coa.getOID(), whereMd, periode, "DC");
    ...
    if (valShowList != 1 || groupExp != 0) {	//add Space
        ...
        listReport.add(sesReport);
            ...
            <%
    double groupORev = DbCoa.getIsCoaBalanceByGroupMTD(I_Project.ACC_GROUP_OTHER_REVENUE, "CD", whereMd, periode);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_OTHER_REVENUE)) {
                ...
                double amount = 0;
                if (!coa.getStatus().equals("HEADER")) {
                    amount = DbCoa.getCoaBalancePNLMTD(coa.getOID(), whereMd, periode, "CD");
                }
                ...
                double balanceByHeader = DbCoa.getIsCoaBalanceByHeaderMTD(coa.getOID(), "CD", whereMd, periode);
                if (valShowList == 1) {
                    if ((coa.getStatus().equals("HEADER") && balanceByHeader != 0) || ((!coa.getStatus().equals("HEADER")) && amount != 0)) {
                        double openingBalancePrev = DbCoa.getCoaBalancePNLMTD(coa.getOID(), whereMd, lastPeriod, "CD");
                                                                                        %>
                                                                                        <tr> 
                                                                                            <td class="<%=cssString%>" nowrap> 
                                                                                                <%if (coa.getStatus().equals("HEADER")) {%>
    ...
    if (groupORev != 0 || valShowList != 1) {	//add Space
        ...
        listReport.add(sesReport);
                                        ...
                                        <%
    double groupOExp = DbCoa.getIsCoaBalanceByGroupMTD(I_Project.ACC_GROUP_OTHER_EXPENSE, "DC", whereMd, periode);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_OTHER_EXPENSE)) {
                ...
                double balanceByHeader = DbCoa.getIsCoaBalanceByHeaderMTD(coa.getOID(), "DC", whereMd, periode);

                if (valShowList == 1) {
                    if ((coa.getStatus().equals("HEADER") && balanceByHeader != 0) || ((!coa.getStatus().equals("HEADER")) && amount != 0)) {

                        double openingBalancePrev = DbCoa.getCoaBalancePNLMTD(coa.getOID(), whereMd, lastPeriod, "DC");
                                                                                        %>
                                                                                        <tr> 
                                                                                            <td class="<%=cssString%>" nowrap> 
                                                                                                <%if (coa.getStatus().equals("HEADER")) {%>
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <%
                                                                                        vSesDep = new Vector();
                                                                                        amount = DbCoa.getCoaBalancePNLMTD(coa.getOID(), whereMd, lastPeriod, "DC");
                                                                                        totalOExp = totalOExp + amount;
                                                                                        displayStr1 = strDisplay(amount, coa.getStatus());
                                                                                        vSesDep.add("" + amount);
                                                                                            %>
    ...
    listReport.add(sesReport);
                                                                ...
                                                                <%session.putValue("PROFIT0MDT", listReport);%>
                                                                <tr align="left" valign="top"> 
                                                                    <td height="8" valign="middle" colspan="3">&nbsp; </td>
                                                                </tr>
                                                                <%if (iJSPCommand == JSPCommand.LIST) {%>
