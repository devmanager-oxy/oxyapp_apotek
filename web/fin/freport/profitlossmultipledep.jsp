...
<%
            ...
            long departmentId = JSPRequestValue.requestLong(request, "src_department_id");
            ...
            Vector tempDps = DbDepartment.list(0, 0, "", "");
            if (departmentId == 0 && tempDps != null && tempDps.size() > 0) {
                Department dep = (Department) tempDps.get(0);
                departmentId = dep.getOID();
            }
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdChangeList(){
                document.frmcoa.action="profitlossmultipledep.jsp";
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/print2.gif','../images/printxls2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                ...
                                                                                <td height="10" valign="middle" colspan="3"> 
                                                                                    <table width="50%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="86%"> 
                                                                                                <select name="src_department_id" onChange="javascript:cmdChangeList()">
                                                                                                    <%
            if (tempDps != null && tempDps.size() > 0) {
                for (int i = 0; i < tempDps.size(); i++) {
                    Department dep = (Department) tempDps.get(i);
                                                                                                    %>
                                                                                                    <option value="<%=dep.getOID()%>" <%if (departmentId == dep.getOID()) {%>selected<%}%>><%=dep.getName()%></option>
                                                                                                    <%
                }
            }%>
                                                                                                </select>
                ...
                Periode per = (Periode) temp.get(ix);
                                                                                 ...
                                                                                 <%
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_REVENUE, temp, "CD") != 0 || valShowList != 1) {	//add Group Header
            ...
            if (listCoa != null && listCoa.size() > 0) {
                ...
                for (int i = 0; i < listCoa.size(); i++) {
                    ...
                    if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_REVENUE)) {
                        ...
                        if (valShowList == 1) {
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "CD", temp) != 0) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "CD") != 0)) {	//add detail
                                sesReport = new SesReportBs();
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <%				}
                                                                                                                    ...
                                                                                                                    if ((coa.getStatus().equals("HEADER")) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "CD") != 0)) {	//add detail
                                                                                                                        sesReport = new SesReportBs();
                                                                                                                        sesReport.setType(coa.getStatus());
                                                                                                                        sesReport.setDescription(strTotal1 + str1 + coa.getCode() + " - " + coa.getName());
                                                                                                                        sesReport.setAmount(DbCoa.getCoaBalance(coa.getOID(), temp, "CD"));
                                                                                        ...
                                                                                        <%					}
                                                                                            ...
                                                                                            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_REVENUE, temp, "CD") != 0 || valShowList != 1) {	//add Group Footer
                                                                                                sesReport = new SesReportBs();
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_REVENUE, temp, "CD") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                ...
                listReport.add(sesReport);
                                                                                 ...
                                                                                 <%
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_COST_OF_SALES, temp, "DC") != 0 || valShowList != 1) {	//add Group Header
                sesReport = new SesReportBs();
                sesReport.setType("Group Level");
            ...
            if (listCoa != null && listCoa.size() > 0) {
                ...
                for (int i = 0; i < listCoa.size(); i++) {
                    ...
                    if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_COST_OF_SALES)) {
                        ...
                        str1 = switchLevel1(coa.getLevel());
                        if (valShowList == 1) {
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "DC", temp) != 0) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "DC") != 0)) {	//add detail
                                sesReport = new SesReportBs();
                                sesReport.setType(coa.getStatus());
                                sesReport.setDescription(strTotal1 + str1 + coa.getCode() + " - " + coa.getName());
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <%				}
                                                                                                                    ...
                                                                                                                    if ((coa.getStatus().equals("HEADER")) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "DC") != 0)) {	//add detail
                                                                                                                        sesReport = new SesReportBs();
                                                                                                                        sesReport.setType(coa.getStatus());
                                                                                                                        sesReport.setDescription(strTotal1 + str1 + coa.getCode() + " - " + coa.getName());
                                                                                                                        sesReport.setAmount(DbCoa.getCoaBalance(coa.getOID(), temp, "DC"));
                                                                                        ...
                                                                                        <%					}
                                                                                            ...
                                                                                            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_COST_OF_SALES, temp, "DC") != 0 || valShowList != 1) {	//add Group Footer
                                                                                                sesReport = new SesReportBs();
                                                                                                sesReport.setType("Footer Group Level");
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_COST_OF_SALES, temp, "DC") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                sesReport.setDescription("");
                vSesDep = new Vector();
                ...
                listReport.add(sesReport);
                                                                                        ...
                                                                                        <!--level ACC_GROUP_EXPENSE-->
                                                                                 <%
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_EXPENSE, temp, "DC") != 0 || valShowList != 1) {	//add Group Header
                sesReport = new SesReportBs();
                sesReport.setType("Group Level");
                            ...
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "DC", temp) != 0) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "DC") != 0)) {	//add detail
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <%					}
                                                                                            ...
                                                                                            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_EXPENSE, temp, "DC") != 0 || valShowList != 1) {	//add Group Footer
                                                                                                sesReport = new SesReportBs();
                                                                                                sesReport.setType("Footer Group Level");
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_EXPENSE, temp, "DC") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                sesReport.setDescription("");
                vSesDep = new Vector();
                ...
                listReport.add(sesReport);
                                                                                 ...
                                                                                 <%
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_REVENUE, temp, "CD") != 0 || valShowList != 1) {	//add Group Header
                sesReport = new SesReportBs();
                sesReport.setType("Group Level");
                            ...
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "CD", temp) != 0) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "CD") != 0)) {	//add detail
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <%					}
                                                                                            ...
                                                                                            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_REVENUE, temp, "CD") != 0 || valShowList != 1) {	//add Group Footer
                                                                                                sesReport = new SesReportBs();
                                                                                                sesReport.setType("Footer Group Level");
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_REVENUE, temp, "CD") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                sesReport.setDescription("");
                vSesDep = new Vector();
                ...
                listReport.add(sesReport);
                                                                                 ...
                                                                                 <%
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, temp, "DC") != 0 || valShowList != 1) {	//add Group Header
                sesReport = new SesReportBs();
                sesReport.setType("Group Level");
                            ...
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "DC", temp) != 0) || ((!coa.getStatus().equals("HEADER")) && DbCoa.getCoaBalance(coa.getOID(), temp, "DC") != 0)) {	//add detail
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <%					}
                                                                                            ...
                                                                                            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, temp, "DC") != 0 || valShowList != 1) {	//add Group Footer
                                                                                                sesReport = new SesReportBs();
                                                                                                sesReport.setType("Footer Group Level");
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, temp, "DC") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                sesReport.setDescription("");
                vSesDep = new Vector();
