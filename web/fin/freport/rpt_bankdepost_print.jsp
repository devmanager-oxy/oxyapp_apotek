...
<%-- 
    Document   : rpt_bankdepost_print
    Created on : Dec 30, 2011, 10:02:40 AM
    Author     : Roy Andika
--%>
                ...
                if (vbankDepositDetail != null && vbankDepositDetail.size() > 0) {
                    ...
                    while (vbankDepositDetail != null && vbankDepositDetail.size() > 0) {
                        ...
                        <tr>
                            ...
                            <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-first' ><%=JSPFormater.formatNumber(bankDepositDetail.getAmount(), "#,###.##")%></td>
                        </tr> 
                        <%} else {%>
                        <tr>
                            ...
                            <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-second' ><%=JSPFormater.formatNumber(bankDepositDetail.getAmount(), "#,###.##")%></td>
                        </tr> 
                        <%}%>
                        <%
