...
<%-- 
    Document   : rpt_pettycashpayment_main
    Created on : Jan 24, 2012, 9:22:46 AM
    Author     : Roy Andika
--%>
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <%
            out.print("<a href=\"../freport/rpt_pettycashpayment_main_print.jsp?pettycashPayment_id=" + pettycashPayment.getOID() + "\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a>");
                                    %>
                                </td>                                            
                            </tr>                            
                        </table>    
