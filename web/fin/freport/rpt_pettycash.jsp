...
<%-- 
    Document   : rpt_pettycash
    Created on : Dec 30, 2011, 9:29:09 AM
    Author     : Roy Andika
--%>
...
<table align="center" width="900px" border="0">
    <tr>
        ...
        <td width="51%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="25%">&nbsp;</td>
                    <td><font class id = 'string-tidak-putus-2'>No. BKK : <%=pettycashPayment.getJournalNumber()%></font></td>
                </tr>   
            </table> 
        </td>    
    </tr>         
        ...
        <td width="50%">
            <table width="100%" border ="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="4%" valign="top" align="center"><font class id = 'string-tidak-putus'>:</font></td>
                    <td width="68%" valign="top"><font class id = 'string-tidak-putus'><%=idr%>&nbsp;<%=JSPFormater.formatNumber(pettycashPayment.getAmount(), "#,###.##")%> (<%=numberSpeller.spellNumberToIna(Double.parseDouble(amount.replaceAll(",", ""))) + " Rupiah"%>)</font></td>
                </tr>
            </table>    
        </td>
        <td width="5%">&nbsp</td>
    ...
    <tr>
        <td width="100%" colspan="3">
            ...
            try {
                Approval approval_6 = DbApproval.getListApproval(I_Crm.TYPE_APPROVAL_BKK, DbApproval.URUTAN_6);
            ...
            try {
                Approval approval_7 = DbApproval.getListApproval(I_Crm.TYPE_APPROVAL_BKK, DbApproval.URUTAN_7);
            ...
            try {
                Approval approval_8 = DbApproval.getListApproval(I_Crm.TYPE_APPROVAL_BKK, DbApproval.URUTAN_8);
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    <%
            out.print("<a href=\"../freport/rpt_pettycashpayment_print.jsp?pettycashPayment_id=" + pettycashPayment.getOID() + "\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
                                    %>
                                </td>                                            
                            </tr>
                        </table>    
