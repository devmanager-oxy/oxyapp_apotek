...
<%-- 
    Document   : rpt_bankdepost
    Created on : Dec 30, 2011, 10:02:11 AM
    Author     : Roy Andika
--%>
...
<table align="center" width="900px" border="0">
    <tr>
        ...
        <td width="51%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="25%">&nbsp;</td>
                    <td><font class id = 'string-tidak-putus-2'>No. BKM : <%=bankDeposit.getJournalNumber()%></font></td>
                </tr>   
            </table> 
        </td>    
    </tr>         
    <tr>                
        ...
        <td width="50%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="25%">&nbsp;</td>
                    <td><font class id = 'string-tidak-putus-2'>Tanggal : <%=JSPFormater.formatDate(bankDeposit.getTransDate(), "dd/MM/yy")%></font></td>
                </tr>   
            </table> 
        </td>
    </tr>    
        ...
        <td width="50%">
            <table width="100%" border ="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="4%" valign="top" align="center"><font class id = 'string-tidak-putus'>:</font></td>
                    <td width="68%" valign="top"><font class id = 'string-tidak-putus'><%=idr%>&nbsp;<%=JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##")%> (<%=numberSpeller.spellNumberToIna(Double.parseDouble(amount.replaceAll(",", ""))) + " Rupiah"%>)</font></td>
                </tr>
            </table>    
        </td>
        <td width="5%">&nbsp</td>
    ...
    <tr>
        <td width="100%" colspan="3">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="5" class id='string-garis-bawah-putus' height="5px">&nbsp;</td>
                </tr>
                <tr>
            ...
            <% } %>
                <tr>
                    ...
                    <td width="15%" class id='string-garis-atas-kiri-padding-left'>No. Rekening</td>
                    <td width="15%" class id='string-garis-atas-kiri-kanan-center'>J U M L A H</td>
                    <td width="30%" class id='string-garis-atas-kiri-kanan-center'>P E N J E L A S A N</td>
                </tr> 
                <tr>
                    <td colspan="5" height="2px"></td>
                </tr> 
                        ...
                        for (int i = 0; i < max_limit; i++) {
                            ...
                            try {
                                if (bankDepositDetail.getCoaId() != 0) {
                                    result = DbCoa.getCodeCoa(bankDepositDetail.getCoaId());
                                    noRek = "" + result.get(0);
                                    nama = "" + result.get(1);
                                }
                            } catch (Exception e) {
                ...
                <tr>
                    ...
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-first'><%=noRek%></td>
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-first' ><%=JSPFormater.formatNumber(bankDepositDetail.getAmount(), "#,###.##")%></td>
                    <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-first' ><%=penjelasan%></td>
                </tr> 
                <%} else {%>
                <tr>
                    ...
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-second'><%=noRek%></td>
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-second' ><%=JSPFormater.formatNumber(bankDepositDetail.getAmount(), "#,###.##")%></td>
                    <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-second' ><%=penjelasan%></td>
                </tr> 
                <%}%>
                <%
                ...
                <tr>
                    ...
                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-first'><%=nama%></td>
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-first'><%=noRek%></td>
                    <td width="15%" class id='string-garis-atas-kiri-kanan-center-top-first' ><%=JSPFormater.formatNumber(bankDepositDetail.getAmount(), "#,###.##")%></td>
                    <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-first' ><%=penjelasan%></td>
                </tr> 
                <%} else {%>
                <tr>
                ...
                <tr height="20px">
                    ...
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-second-last'>&nbsp;</td>
                    <td width="15%" class id='string-garis-atas-kiri-padding-left-top-second-last'>&nbsp;</td>
                ...
                <tr>
                    <td width="55%" colspan="3" class id='string-garis-atas-kiri-center'>T O T A L</td>                    
                    <td width="15%" class id='string-garis-atas-kiri-kanan-center' ><%=JSPFormater.formatNumber(payment, "#,###.##")%></td>
