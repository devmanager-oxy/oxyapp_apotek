...
//out.println(company.getDepartmentLevel());
            ...
            if (lang == LANG_ID) {
                ...
                langFR = langID;
                String[] navID = {"Laporan Keuangan", "Laba Rugi Standar"};
                langNav = navID;
            }
%>
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/print2.gif','../images/printxls2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                    ...
                                                                    <td height="8"  colspan="3" class="container"> 
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                ...
                                                                                <span class="level1"><font size="+1"><b><%=langFR[3]%></b></font></span></td>
                                                                            </tr>                          
                                                                            <%
            ...
            listReport.add(sesReport);
                                                                                        %>										
                                                                                        <tr> 
                                                                                            <td width="21%" class="tablecell2"><span class="level2"><b><%=langFR[7]%></b></span></td>
                                                                                            <td width="11%" class="tablecell2" align="right">
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr>
                                                                                                        <td width="5%"></td>
