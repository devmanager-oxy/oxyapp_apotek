...
<%
            ...
            StringTokenizer strTokenizer = new StringTokenizer("510111=410111;510112=410112;510113=410113",";");
                        ...
                        if (status.equals("POSTABLE") && coa.getStatus().equals("HEADER")) {
                            ...
                            vSesDep = new Vector();
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            %>
                                                                                            <td class="<%=cssString%>" style="padding:5px;">AAA                                                                                                
                        ...
                        if (status.equals("POSTABLE") && coa.getStatus().equals("HEADER")) {
                            ...
                            vSesDep = new Vector();
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <%
                                                                                                                ...
                                                                                                                for (int ix = (temp.size() - 1); ix >= 0; ix--) {
                                                                                                                    ...
                                                                                                                    if(valRev != null && valRev.size() > 0){
                                                                                                                        try{
                                                                                                                            amountRev = Double.parseDouble(String.valueOf(valRev.get(ix)));
                                                                                                                        }catch(Exception e){}
                                                                                                                    }
                                                                                            ...
                                                                                            %>
                                                                                            <td class="<%=cssString%>" style="padding:5px;">                                                                                                
                                                                                                CCC<div align="right"><%=strDisplay(amount, coa.getStatus(),onlyHeader)%></div>
                                                                                            </td>
                                                                                            <td class="<%=cssString%>" style="padding:5px;">
                                                                                                <div align="right"><%=strDisplay(persen, coa.getStatus(),onlyHeader)%><%if (!coa.getStatus().equals("HEADER")) {%>%<%}%></div>
                                                                                            </td>
