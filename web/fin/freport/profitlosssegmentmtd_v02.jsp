...
<%-- 
    Document   : profitlosssegmentmtd_v02
    Created on : Apr 10, 2013, 2:32:44 PM
    Author     : PNCI
--%>
...
%>
<%
            if (session.getValue("PROFIT0MDTMULTIPLE") != null) {
                session.removeValue("PROFIT0MDTMULTIPLE");
            }
            
            if (session.getValue("PERIODMTDIDMULTIPLE") != null) {
                session.removeValue("PERIODMTDIDMULTIPLE");
            }
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdGO(){
                document.frmcoa.action="profitlosssegmentmtd_v02.jsp";
            ...
            function cmdPrintJournal(){	 
                ...
                function cmdPrintJournalXLS(){	 
                    window.open("<%=printroot%>.report.RptProfitLossSegmentMTDV02XLS?oid=<%=appSessUser.getLoginId()%>&year=<%=yearselect%>");
                    }
    ...
    listReport.add(sesReport);
                                                                ...
                                                                <%
            session.putValue("PROFIT0MDTMULTIPLE", listReport);
            session.putValue("PERIODMTDIDMULTIPLE", temp);
