...
<%-- 
    Document   : paymentpettycash_priview
    Created on : Jul 11, 2011, 9:06:47 PM
    Author     : PNCI
--%>
...
<%
            ...
            long pettycashpayment_id = Long.parseLong(request.getParameter("pettycashpayment_id"));
            
            PettycashPayment pettycashPayment = new PettycashPayment();
            
            try{
                pettycashPayment = DbPettycashPayment.fetchExc(pettycashpayment_id);
            }catch(Exception e){
...
<table width="100%" border="0">
    ...
    <tr>
        ...
        <td width="45%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="25%">&nbsp;</td>
                    <td><font class id = 'string-tidak-putus-2'>No. BKM : </font></td>
                </tr>   
            </table>  
        </td>    
        <td width="5%">&nbsp</td>
    ...
    <tr>
        ...
        <td width="45%" align="left">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="25%">&nbsp;</td>
                    <td><font class id = 'string-tidak-putus-2'>Tanggal : <%=JSPFormater.formatDate(pettycashPayment.getTransDate(),"dd/MM/yy")%></font></td>
                </tr>   
            </table> 
        </td>
        <td width="5%">&nbsp</td>
    ...
    <tr>
        <td width="5%">&nbsp</td>
        <td width="40%" ><font class id = 'string-tidak-putus-2'>Diterima dari &nbsp;&nbsp;&nbsp;&nbsp;: <%=cst%></font></td>
        <td width="5%">&nbsp</td>
        <td width="45%" ></td>
        <td width="5%">&nbsp</td>
    </tr>
    ...
    <tr>
        <td width="100%" colspan="5">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="5%">&nbsp</td>
                    <td ><font class id = 'string-tidak-putus-2'>Jumlah dgn. angka  : <%=idr%>&nbsp;<%=JSPFormater.formatNumber(pettycashPayment.getAmount(),"#,###.##")%></font><td>                
                    <td width="5%">&nbsp</td>
                </tr>
            </table>   
        </td>    
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            if(vPettycashPaymentDetail != null && vPettycashPaymentDetail.size() > 0){
                                ...
                                for(int i = 0 ; i < vPettycashPaymentDetail.size(); i++){
                                    
                                    PettycashPaymentDetail pettycashPaymentDetail = (PettycashPaymentDetail)vPettycashPaymentDetail.get(i);
                            ...
                            <%if(i==0){%>
                                <tr>
                                    <td width="10%" class id='string-isi-tabel-first'><%=pettycashPaymentDetail.getMemo().compareTo("")==0 && JSPFormater.formatNumber(pettycashPaymentDetail.getAmount(), "#,###.##").compareTo("")==0 ? "&nbsp" : ""+no %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-first'><%=pettycashPaymentDetail.getMemo().compareTo("")==0 ? "-" : pettycashPaymentDetail.getMemo() %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-first'><%=pettycashPaymentDetail.getMemo().compareTo("")==0 ? "&nbsp" : "-" %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-first' ><%=JSPFormater.formatNumber(pettycashPaymentDetail.getAmount(), "#,###.##")%></td>
                                </tr> 
                            <%}else{%>
                                <tr>
                                    <td width="10%" class id='string-isi-tabel-second'><%=pettycashPaymentDetail.getMemo().compareTo("")==0 && JSPFormater.formatNumber(pettycashPaymentDetail.getAmount(), "#,###.##").compareTo("")==0 ? "&nbsp" : ""+no %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-second'><%=pettycashPaymentDetail.getMemo().compareTo("")==0 ? "-" : pettycashPaymentDetail.getMemo() %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-second'><%=pettycashPaymentDetail.getMemo().compareTo("")==0 ? "&nbsp;" : "-" %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-kanan-center-top-second' ><%=JSPFormater.formatNumber(pettycashPaymentDetail.getAmount(), "#,###.##")%></td>
                                </tr> 
                            <%}%>
                            <%
                                }
                ...
                System.out.println("[exception] "+e.toString());
                                        ...
                                        <tr height="80px">
                                            ...
                                            <td colspan="3" class id='string-garis-kiri-kanan-center'>
                                                <table align="center">
                                                    ...
                                                    <tr>
                                                        <td><font class id = 'string-tidak-putus-2'>Nama jelas : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; a/n.</font></td>       
                                                    </tr>
                                               </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="6" align="center">
                                                <%
                                                out.print("<a href=\"../freport/paymentpettycash_print.jsp?pettycashpayment_id=" + pettycashPayment.getOID()+"\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
                                                %>
                                            </td>                                            
                                        </tr>
                                    </table>    
