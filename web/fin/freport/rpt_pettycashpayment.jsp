...
<%-- 
    Document   : rpt_pettycashpayment
    Created on : Jun 21, 2011, 9:30:53 AM
    Author     : Roy Andika
--%>
...
<%
            ...
            Vector tmpPettycashPaymentDetail = DbPettycashPaymentDetail.list(0, 0, whereClause, null);
        ...
        <td colspan="3">            
            ...
            try {
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <%   
                            int pages = 0;                            
                            int totDatas = tmpPettycashPaymentDetail.size();                            
                            ...
                            <tr>
                                <td colspan="5" align="center">
                                 ...
                                 out.print("<a href=\"../freport/rpt_pettycashpayment_print.jsp?pettycashPayment_id=" + pettycashPayment.getOID() + "&idPage="+i+"&lastPg="+last+"&max="+max_hal+"&payment="+payment+"\" target='_blank'>page "+idx+"</a>");
                                 %>
                                <%}%>   
                                </td>                                            
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <%
            out.print("<a href=\"../freport/rpt_pettycashpayment_print.jsp?pettycashPayment_id=" + pettycashPayment.getOID() + "&max="+max_hal+"&payment="+payment+"&all="+1+"\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a>");
                                    %>
                                </td>                                            
                            </tr>
                            <%}%>
