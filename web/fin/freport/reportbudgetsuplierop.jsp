...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
                                                                                ...
                                                                                <td colspan="2">
                                                                                    <table width="800" cellpadding="0" cellspacing="1">                                                                                        
                                                                                        <tr height="25">
                                                                                            ...
                                                                                            <td class="tablehdr" width="15%"><input name="bg_checkall" value="1" type="checkbox" onChange="cmdSelectAll()"></td>
                                                                                        </tr>
                                                                                        <%
    String v = "";
    double tot = 0;
    ...
    if (counter == srbs.getCounter()) {
        ...
        v = srbs.getSuplier();
                                                                        ...
                                                                        <table align="left" height="10" cellpadding="0" cellspacing="0">
                                                                            <%if (list != null && list.size() > 0) {%>
                                                                            <tr>
