...
<%
            ...
            Vector temp = DbRptFormat.list(0, 0, DbRptFormat.colNames[DbRptFormat.COL_REPORT_TYPE] + "=" + DbRptFormat.REPORT_TYPE_PROFITLOSS, DbRptFormat.colNames[DbRptFormat.COL_CREATE_DATE]);
            ...
            String[] langFR = {"Show List", "Account With Transaction", "All", "BALANCE SHEET", "PERIOD", //0-4
                                "Description", "Total","Select report"}; //5-7
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Tampilkan Daftar", "Perkiraan Dengan Transaksi", "Semua", "NERACA", "PERIODE", //0-4
                                    "Keterangan", "Total","Pilih Laporan"}; //5-7
                langFR = langID;
                      ...
                      <td><img src="<%=approot%>/images/title-sp.gif" width="584" height="1"></td> 
                                                ...
                                                <tr> 
                                                    <td><!-- #BeginEditable "content" --> 
                                                        <form id="form1" name="frmneraca" method="post" action="profitloss_report.jsp">
