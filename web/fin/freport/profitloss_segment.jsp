...
<%-- 
    Document   : profitloss_segment
    Created on : Oct 16, 2014, 8:12:33 PM
    Author     : Roy
--%>
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdGO(){
                document.frmcoa.action="profitloss_segment.jsp";
    ...
    double groupRev = DbCoa.getIsCoaBalanceByGroupMTD(listCoa, temp, "CD", whereMd);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_REVENUE)) {
                ...
                double tmpYTD = 0;//DbCoa.getCoaBalancePNLYTD(coa, whereMd, period, "CD");
                for (int ix = (temp.size() - 1); ix >= 0; ix--) {
                    Periode p = (Periode) temp.get(ix);
                    double amount = DbCoa.getCoaBalancePNLMTD(coa, whereMd, p, "CD");
                    if (amount != 0) {
    ...
    double groupCos = DbCoa.getIsCoaBalanceByGroupMTD(listCoa, temp, "DC", whereMd);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_COST_OF_SALES)) {
                ...
                for (int ix = (temp.size() - 1); ix >= 0; ix--) {
                    Periode p = (Periode) temp.get(ix);
                    double amount = DbCoa.getCoaBalancePNLMTD(coa, whereMd, p, "DC");
                    if (amount != 0) {
                        amountBalance = amount;
                    }
                    tmpYTD = tmpYTD + amount;
    ...
    double groupExpense = DbCoa.getIsCoaBalanceByGroupMTD(listCoa, temp, "DC", whereMd);
    ...
    double groupOtherRevenue = DbCoa.getIsCoaBalanceByGroupMTD(listCoa, temp, "CD", whereMd);
...
<!--level ACC_OTHER EXPENSE-->
    ...
    double groupOtherExpense = DbCoa.getIsCoaBalanceByGroupMTD(listCoa, temp, "DC", whereMd);
