...
<%-- 
    Document   : banknonpo_priview_main
    Created on : Mar 2, 2012, 5:01:56 PM
    Author     : Roy Andika
--%>
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    <%
            out.print("<a href=\"../freport/banknonpo_print_main.jsp?banknonpopayment_id=" + banknonpoPayment.getOID() + "\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
                                    %>
                                </td>                                            
                            </tr>
                        </table>    
