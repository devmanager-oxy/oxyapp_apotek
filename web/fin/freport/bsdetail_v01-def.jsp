                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td><!-- #BeginEditable "content" --> 
                              ...
                              <td height="8"  colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <%
									...
									String openPeriod = "BULAN "+JSPFormater.formatDate(periode.getStartDate(), "MMMM yyyy");//+ " - " + JSPFormater.formatDate(periode.getEndDate(), "dd MMM yyyy");        
								  %>        
								  <tr align="left"> 
                                    ...
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        <tr> 
                                          ...
                                          <td width="12%" class="tablehdr" height="22"><font size="1">Total 
                                            Corporate</font></td>
                                        </tr>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1">Activa</font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <!--level Liquid Assets-->
                                        <%	//add Top Header
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1"><%=strTotal+I_Project.ACC_GROUP_LIQUID_ASSET%></font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <%	}	%>
                                        <%
						if(listCoa!=null && listCoa.size()>0)
						{
							...
							for(int i=0; i<listCoa.size(); i++)
							{
							  ...
							  %>
                                        <tr> 
                                          <td width="21%" class="<%=cssString%>" nowrap><font size="1"> 
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1"><%=" Sub Total "+I_Project.ACC_GROUP_LIQUID_ASSET%></font></b></span></td>
					...
					%>
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1"><%=strTotal+I_Project.ACC_GROUP_FIXED_ASSET%></font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <%	}	%>
                                        <%
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1"><%=strTotal+" Sub Total "+I_Project.ACC_GROUP_FIXED_ASSET%></font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
					...
					%>
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1"><%=strTotal+I_Project.ACC_GROUP_OTHER_ASSET%></font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <% 	}	%>
                                        <%
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1"><%=strTotal+" Sub Total "+I_Project.ACC_GROUP_OTHER_ASSET%></font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
					...
					%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1">Total 
                                            Activa</font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
                                        ...
                                        <tr> 
                                          <td width="21%" class="tablecell1" height="15"><font size="1"></font></td>
                                          <td width="11%" class="tablecell1"><font size="1"></font></td>
                                        </tr>
                                        <!--level 2-->
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1">Liabilities</font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1"><%=strTotal+I_Project.ACC_GROUP_CURRENT_LIABILITIES%></font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <%	}	%>
                                        <%
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1"><%=strTotal+" Sub Total "+I_Project.ACC_GROUP_CURRENT_LIABILITIES%></font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
					...
					%>
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1"><%=strTotal+I_Project.ACC_GROUP_LONG_TERM_LIABILITIES%></font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <%	}	%>
                                        <%
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1"><%=strTotal+" Sub Total "+I_Project.ACC_GROUP_LONG_TERM_LIABILITIES%></font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
					...
					%>
                                        ...
                                        <!--level 3-->
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1">Equity</font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <!--level equity-->
                                        <%	//add Top Header
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><font size="1"><%=strTotal+I_Project.ACC_GROUP_EQUITY%></font></b></td>
                                          <td width="12%" class="tablecell"><font size="1"></font></td>
                                        </tr>
                                        <%	}	%>
                                        <%
						if(listCoa!=null && listCoa.size()>0)
						{
							...
							for(int i=0; i<listCoa.size(); i++)
							{
								...
								if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_EQUITY))
								{
									...
									if (valShowList==1)
									{										
										if ((coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNING")) && amount!=0)
										|| coa.getCode().equals(DbSystemProperty.getValueByName("ID_HEADER_CURRENT_EARNING")) 
										|| (coa.getStatus().equals("HEADER") && (DbCoa.getCoaBalanceByHeader(coa.getOID(),"CD"))!=0) 
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1"><%=strTotal+" Sub Total "+I_Project.ACC_GROUP_EQUITY%></font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
					...
					%>
                                        ...
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><font size="1">Total 
                                            Liabilities & Equity</font></b></span></td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell2">&nbsp;</td>
                                          <td width="11%" class="tablecell2" align="right"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                              <tr> 
                                                <td width="5%"></td>
