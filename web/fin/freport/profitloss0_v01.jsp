...
<%
            ...
            Vector deps = DbDepartment.list(0, 0, ""+DbDepartment.colNames[DbDepartment.COL_LEVEL]+"="+DbDepartment.LEVEL_DEPARTMENT, "");
            Department dep = new Department();
            if (departmentId == 0 && deps != null && deps.size() > 0) {
                dep = (Department) deps.get(0);
                departmentId = dep.getOID();
            } else {
                try {
                    dep = DbDepartment.fetchExc(departmentId);
                } catch (Exception e) {
                }
            }
            
            Vector locs = DbLocation.list(0, 0, "", DbLocation.colNames[DbLocation.COL_CODE]);
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdChangeList(){
                document.frmcoa.action="profitloss0_v01.jsp";
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/printxls2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="2">
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="8" valign="middle" colspan="3"> 
                                                                                    <table width="280" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr align="left" valign="middle"> 
                                                                                            <td width="100"><%=langFR[5]%></td>
                                                                                            <td width="180" colspan="0"> 
                                                                                                 <select name="department_id" onChange="javascript:cmdChangeList()">
                                                                                                    <%
            if (deps != null && deps.size() > 0) {
                for (int i = 0; i < deps.size(); i++) {
                    Department depx = (Department) deps.get(i);
                                                                                                    %>
                                                                                                    <option value="<%=depx.getOID()%>" <%if (depx.getOID() == departmentId) {%>selected<%}%>><%=depx.getName()%></option>
                                                                                                    <%}
            }%>
                                                                                                </select>
                                                                                            </td>
                                                                                ...
                                                                                <td height="22" valign="middle" colspan="3" class="page"> 
                                                                                    <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="120" class="tablehdr" height="22" nowrap><%=langFR[7]%></td>
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_REVENUE, "CD") != 0 || valShowList != 1){//add Group Header
                ...
                listReport.add(sesReport);
                                                                                 %>
                                                                                        ...
                                                                                        <%}
            listCoa = DbCoa.list(0, 0, "account_group='Revenue' and department_id=" + dep.getOID(), "code");
                                                                                                ...
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="90%" class="<%=cssString%>"> 
                                                                                                            <div align="right"><%=strDisplay(DbCoaOpeningBalance.getOpeningBalance(periode, coa.getOID()), coa.getStatus())%></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(DbCoa.getCoaOpeningBalanceByGroup(I_Project.ACC_GROUP_REVENUE, "CD"), "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
            ...
            listCoa = DbCoa.list(0, 0, "account_group='Cost Of Sales' and department_id=" + dep.getOID(), "code");
                                                                                            ...
                                                                                            <td class="tablecell2" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(DbCoa.getCoaOpeningBalanceByGroup(I_Project.ACC_GROUP_COST_OF_SALES, "DC"), "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
            ...
            listCoa = DbCoa.list(0, 0, "account_group='Expense' and department_id=" + dep.getOID(), "code");
                                                                                            ...
                                                                                            <td class="tablecell2" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(DbCoa.getCoaOpeningBalanceByGroup(I_Project.ACC_GROUP_EXPENSE, "DC"), "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
            ...
            listCoa = DbCoa.list(0, 0, "account_group='Other Revenue' and department_id=" + dep.getOID(), "code");
                                                                                            ...
                                                                                            <td class="tablecell2" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(DbCoa.getCoaOpeningBalanceByGroup(I_Project.ACC_GROUP_OTHER_REVENUE, "CD"), "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_REVENUE, "CD") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                vSesDep = new Vector();
                for (int i = 0; i < vDep.size(); i++) {
            ...
            listCoa = DbCoa.list(0, 0, "account_group='Other Expense' and department_id=" + dep.getOID(), "code");
                                                                                            ...
                                                                                            <td class="tablecell2" align="right"> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        <td width="5%"></td>
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%=strDisplay(DbCoa.getCoaOpeningBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, "DC"), "")%></b></div>
                                                                                                        </td>
                                                                                                        <td width="5%"></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="90%" class="tablecell2"> 
                                                                                                            <div align="right"><b><%
            if (amountDep < 0) {
                displayStr = "(" + JSPFormater.formatNumber(amountDep * -1, "#,###.##") + ")";
            } else if (amountDep > 0) {
                displayStr = JSPFormater.formatNumber((amountDep), "#,###.##");
            } else if (amountDep == 0) {
                displayStr = "";
            }
                                                                                                                    %>
