...
<%-- 
    Document   : rpt_cashreceive_main
    Created on : Jan 24, 2012, 11:35:46 AM
    Author     : Roy Andika
--%>
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    <%
            out.print("<a href=\"../freport/rpt_cashreceive_main_print.jsp?cash_receive_id=" + cashReceive.getOID() + "\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
                                    %>
                                </td>                                            
                            </tr>
                        </table>    
