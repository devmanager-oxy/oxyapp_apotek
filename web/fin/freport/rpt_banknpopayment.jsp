<%-- 
    Document   : rpt_banknpopayment
    Created on : Dec 30, 2011, 10:07:55 AM
    Author     : Roy Andika
--%>
    ...
    <tr>
        ...
        <td width="45%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="25%">&nbsp;</td>
                    <td><font class id = 'string-tidak-putus-2'>No. BKK : </font></td>
                </tr>   
            </table>  
        </td>    
        <td width="5%">&nbsp</td>
                ...
                <tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <%if(i==0){%>
                                <tr>
                                    <td width="10%" class id='string-isi-tabel-first'><%=banknonpoPaymentDetail.getMemo().compareTo("")==0 && JSPFormater.formatNumber(banknonpoPaymentDetail.getAmount(), "#,###.##").compareTo("")==0 ? "&nbsp" : ""+no %></td>
                ...
                System.out.println("[exception] "+e.toString());
                                        ...
                                        <tr>
                                            <td colspan="6" align="center">
                                                <%
                                                out.print("<a href=\"../freport/rpt_banknonpopayment_print.jsp?banknonpopayment_id=" + banknonpoPayment.getOID()+"\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
                                                %>
                                            </td>                                            
                                        </tr>
                                    </table>    
