...
<%
            ...
            double coaSummary6SD_lastYear = 0;
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Tampilkan Daftar", "Perkiraan Dengan Transaksi", "Semua", "LAPORAN LABA RUGI", "PERIODE", "Keterangan", "Total", "Pendapatan Bersih"}; //0-6
                langFR = langID;
                String[] navID = {"Laporan Keuangan", "Laba Rugi Dengan Budget"};
                langNav = navID;
            }
%>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdChangeList(){
                document.frmcoa.action="profitloss_budget.jsp";
...
<td><img src="<%=approot%>/images/title-sp.gif" width="584" height="1"></td> 
            ...
            String openPeriod = JSPFormater.formatDate(periode.getStartDate(), "dd MMM yyyy") + " - " + JSPFormater.formatDate(periode.getEndDate(), "dd MMM yyyy");
                                                                            %>
                                                                            <tr align="left" valign="top"> 
                                                                                <td colspan="3" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; text-align:center; font-weight:bold ; color:#2b5e04;" >PERIODE <%=openPeriod%></td>
                                                                            </tr> 
                                                                            <tr align="left" valign="top"> 
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td colspan="3">
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">                                                                                        
                                                                                        <tr>
                                                                                            <td rowspan="4" style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">URAIAN</td>
                                                                                            <td height="38" colspan="5" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=JSPFormater.formatDate(periode.getEndDate(), "MMMM yyyy") %></td>
                                                                                            <td colspan="5" style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">S/D <%=JSPFormater.formatDate(periode.getEndDate(), "MMMM yyyy") %></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">REALISASI</td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">ANGGARAN</td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">REALISASI</td>
                                                                                            <td colspan="2" rowspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">%</td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">REALISASI</td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">ANGG</td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">REALISASI</td>
                                                                                            <td colspan="2" rowspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">%</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=JSPFormater.formatDate(periode.getEndDate(), "MMMM") %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=JSPFormater.formatDate(periode.getEndDate(), "MMMM") %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=JSPFormater.formatDate(periode.getEndDate(), "MMMM") %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">S/D <%=JSPFormater.formatDate(periode.getEndDate(), "MMMM") %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">S/D <%=JSPFormater.formatDate(periode.getEndDate(), "MMMM") %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">S/D <%=JSPFormater.formatDate(periode.getEndDate(), "MMMM") %></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=periode.getEndDate().getYear() + 1900 - 1 %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=periode.getEndDate().getYear() + 1900 %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=periode.getEndDate().getYear() + 1900 %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=periode.getEndDate().getYear() + 1900 - 1  %></td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;">ANGG</td>
                                                                                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; text-align:center; font-weight:bold; background-color:#609836; color:#FFFFFF;"><%=periode.getEndDate().getYear() + 1900 - 1 %></td>
...
%>
                                                                                        <tr>
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;"><%=I_Project.ACC_GROUP_REVENUE%></td>
            ...
            if (listCoa != null && listCoa.size() > 0) {
                ...
                for (int i = 0; i < listCoa.size(); i++) {
                    ...
                    if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_REVENUE)) {
                        ...
                        displayStrSD = strDisplay(amountSD, coa.getStatus());
                        displayStrSD_lastYear = strDisplay(amountSD_lastYear, coa.getStatus());
                                ...
                                if (coa.getStatus().equals("HEADER")) {
                                    ...
                                    if(anggSD != 0){
                                        ...
                                        strPersenAnggaranSD = "0.00";
                                                                                        ...
                                                                                        %>
                                                                                        <tr>                                                                                            
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><%if (coa.getStatus().equals("HEADER")) {%><b><%}%><%=strTotal + str + coa.getCode() + " - " + coa.getName()%><%if (coa.getStatus().equals("HEADER")) {%></b><%}%></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStr_lastYear%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strAnggaran%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStr%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersnThdRealisasi%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersenAnggaran%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStrSD_lastYear%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strAnggaranSD%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStrSD%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersnThdRealisasiSD%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersenAnggaranSD%></div></td>
                                                                                        </tr>
                                                                                        <%				}
                                                                                                    } else {
                                                                                        ...
                                                                                        <tr>                                                                                            
                                                                                            ...
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStr%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersnThdRealisasi%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersenAnggaran%></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStrSD_lastYear%></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strAnggaranSD%></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=displayStrSD%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersnThdRealisasiSD%></div></td>
                                                                                            <td class="<%=cssString%>" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=strPersenAnggaranSD%></td>
                                                                                        </tr>                                         
                                                                                        <%					}
                                                                                                    }
                                                                                                }
                                                                                        ...
                                                                                        %>
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><span class="level2"><b><%="Total " + I_Project.ACC_GROUP_REVENUE%></b></span></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=anggaran1%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr%></b></div></td>
                                                                                            <td class="tablecell2" >&nbsp;</td>
                                                                                            <td class="tablecell2" >&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=anggaran1SD%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD%></b></div></td>
                                                                                            <td class="tablecell2">&nbsp;</td>
                                                                                            <td class="tablecell2">&nbsp;</td>
                                                                                        </tr>                                                                                        
                                                                                        <%
...
%>
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;"><span class="level2"><b><%=I_Project.ACC_GROUP_COST_OF_SALES%></b></span></td>
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
            ...
            if (listCoa != null && listCoa.size() > 0) {
                ...
                for (int i = 0; i < listCoa.size(); i++) {
                    ...
                    if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_COST_OF_SALES)) {
                        ...
                        displayStrSD = strDisplay(amount, coa.getStatus());                        
                        displayStrSD_lastYear = strDisplay(amountSD_lastYear, coa.getStatus());
                        ...
                        if (valShowList == 1) {
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "DC") != 0) || ((!coa.getStatus().equals("HEADER")) && amount != 0)) {	//add detail
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        %>
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><span class="level2"><b><%="Total " + I_Project.ACC_GROUP_COST_OF_SALES%></b></span></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran2%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran2SD%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                        </tr> 
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_COST_OF_SALES,
                    "DC") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                sesReport.setDescription("");
                listReport.add(sesReport);
                                                                                        ...
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                ...
                listReport.add(sesReport);
                                                                                 %>     
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;"><%=I_Project.ACC_GROUP_EXPENSE%></td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;font-weight:bold;">&nbsp;</td>
                        ...
                        if (valShowList == 1) {
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "DC") != 0) || ((!coa.getStatus().equals("HEADER")) && amount != 0)) {	//add detail
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><span class="level2"><b><%="Total " + I_Project.ACC_GROUP_EXPENSE%></b></span></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran3%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran3SD%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                        </tr> 
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_EXPENSE,
                    "DC") != 0 || valShowList != 1) {	//add Space
                sesReport = new SesReportBs();
                sesReport.setType("Space");
                sesReport.setDescription("");
                ...
                listReport.add(sesReport);
                                                                                 %>
                                                                                        ...
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><b><%=I_Project.ACC_GROUP_OTHER_REVENUE%></b></td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                        ...
                        if (valShowList == 1) {
                            if ((coa.getStatus().equals("HEADER") && DbCoa.getCoaBalanceByHeader(coa.getOID(), "CD") != 0) || ((!coa.getStatus().equals("HEADER")) && amount != 0)) {	//add detail
                                ...
                                listReport.add(sesReport);
                                                                                        ...
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><span class="level2"><b><%="Total " + I_Project.ACC_GROUP_OTHER_REVENUE%></b></span></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran4%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran4SD%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                        </tr>                                                                                       
            ...
            if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, "DC") != 0 || valShowList != 1) {	//add Group Header
                ...
                listReport.add(sesReport);
                                                                                 %>
                                                                                        ...
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><b><%=I_Project.ACC_GROUP_OTHER_EXPENSE%></b></td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell1" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                ...
                if (DbCoa.getCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, "DC") != 0 || valShowList != 1) {	//add Group Footer
                    ...
                    listReport.add(sesReport);
                                                                                        %>
                                                                                        <tr>                                                                                            
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><span class="level2"><b><%="Total " + I_Project.ACC_GROUP_OTHER_EXPENSE%></b></span></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran5%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStr%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD_lastYear%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><%=anggaran5SD%></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;"><div align="right"><b><%=displayStrSD%></b></div></td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                            <td class="tablecell2" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">&nbsp;</td>
                                                                                        </tr>
            ...
            session.putValue("PROFIT", listReport);
                                                                ...
                                                                <tr align="left" valign="top"> 
                                                                    <td height="8" valign="middle" colspan="3" class="container"> 
                                                                        <%if (listCoa != null && listCoa.size() > 0 && false) {%>
