...
<%-- 
    Document   : rpt_cashreceivedetail_print
    Created on : Dec 28, 2011, 10:02:05 AM
    Author     : Roy Andika
--%>
    ...
    <tr>
        <td width="100%" colspan="3">            
            ...
            if (vCashReceiveDetail != null && vCashReceiveDetail.size() > 0) {
                ...
                <%if (i == 0) {%>
                <tr>
                    <td class id = 'D-FIRST-LEFT' style = "padding-top:15px; border-left : dashed <%=printDesign.getBorderDataDetail()%>px ; border-top : dashed <%=printDesign.getBorderDataDetail()%>px;" align="center"><font face="<%=printDesign.getFontDataDetail()%>"><%=cashReceiveDetail.getMemo().compareTo("") == 0 && JSPFormater.formatNumber(cashReceiveDetail.getAmount(), "#,###.##").compareTo("") == 0 ? "&nbsp" : "" + no %>.</font></td>
                    ...
                    <td class id = 'D-FIRST-LEFT' style = "padding-top:15px; border-left : dashed <%=printDesign.getBorderDataDetail()%>px ; border-top : dashed <%=printDesign.getBorderDataDetail()%>px;" align="right"><font face="<%=printDesign.getFontDataDetail()%>"><%=JSPFormater.formatNumber(cashReceiveDetail.getAmount(), "#,###.##")%></font></td>
                ...
                <%} else {%>
                <tr>
                    <td class id = 'D-FIRST-LEFT' style = "border-left : dashed <%=printDesign.getBorderDataDetail()%>px ;" align="center"><font face="<%=printDesign.getFontDataDetail()%>"><%=cashReceiveDetail.getMemo().compareTo("") == 0 && JSPFormater.formatNumber(cashReceiveDetail.getAmount(), "#,###.##").compareTo("") == 0 ? "&nbsp" : "" + no %>.</font></td>
                    ...
                    <td class id = 'D-FIRST-LEFT' style = "border-left : dashed <%=printDesign.getBorderDataDetail()%>px ;" align="right"><font face="<%=printDesign.getFontDataDetail()%>"><%=JSPFormater.formatNumber(cashReceiveDetail.getAmount(), "#,###.##")%></font></td>
