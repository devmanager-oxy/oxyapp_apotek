...
<%-- 
    Document   : rpt_cashreceive_detail_print
    Created on : Jun 20, 2011, 2:47:03 PM
    Author     : Roy Andika
--%>
...
<html>
    ...
    <body onload='printpage()'>
        <%
            ...
            try {
                useMaxPrint = Integer.parseInt(DbSystemProperty.getValueByName("USE_MAX_PRINT_PAGE_BKM"));
            } catch (Exception E) { useMaxPrint = 0;}

            try {
                max_print = Integer.parseInt(DbSystemProperty.getValueByName("MAX_PRINT_PAGE_BKM"));
            } catch (Exception E){}
            ...
            Vector vCashReceiveDetail = DbCashReceiveDetail.list(start, end, whereClause, null);
