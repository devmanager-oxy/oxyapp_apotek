...
<table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
  ...
  <tr>
    <td class="container"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr> 
                              <td> 
                                <div align="center"><span class="level1"><font size="+1"><b>NERACA AKHIR</b></font></span></div>
                              </td>
                            </tr>
                            <%
                            ...
                            <tr> 
                              <td>
								  ...
								  for(int i=0; i<temp.size(); i++){
									 ...
									 double amount = DbCoa.getCoaBalanceByHeader(coa.getOID(),"DC");
									 double amountPrevYear = DbCoa.getCoaBalanceByHeaderPrevYear(coa.getOID(),"DC");
								  ...
								  for(int i=0; i<temp.size(); i++){
								  	 Coa coa = (Coa)temp.get(i);
									 double amount = DbCoa.getCoaBalanceByHeader(coa.getOID(),"CD");
									 double amountPrevYear = DbCoa.getCoaBalanceByHeaderPrevYear(coa.getOID(),"CD");
								  ...
								  for(int i=0; i<temp.size(); i++){
									 ...
									 if (!coa.getCode().equals(DbSystemProperty.getValueByName("ID_HEADER_CURRENT_EARNING"))){
												...
												amountPrevYear = DbCoa.getCoaBalanceByHeaderPrevYear(coa.getOID(),"CD");
									 }									
												...
												amount = totalIncome + DbCoaOpeningBalance.getOpeningBalanceByHeader(periode, coa.getOID());
												amountPrevYear = totalIncomePrevYear + DbCoaOpeningBalance.getOpeningBalanceByHeaderPrevYear(periode, coa.getOID());
