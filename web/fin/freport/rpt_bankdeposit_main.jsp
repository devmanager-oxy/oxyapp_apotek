...
<%-- 
    Document   : rpt_bankdeposit_main
    Created on : Jan 26, 2012, 3:54:32 PM
    Author     : Roy Andika
--%>
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <%
    out.print("<a href=\"../freport/rpt_bankdeposit_main_print.jsp?bankdeposit_id=" + bankDeposit.getOID() + "\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");                                   
                                    %>
                                </td>                                            
                            </tr>                            
                        </table>    
