...
<%-- 
    Document   : rpt_cashreceive_detail
    Created on : June 20, 2011, 11:39:32 AM
    Author     : Roy Andika
--%>
...
<table align="center" width="<%=printDesign.getWidthPrint()%>" border="0">
        ...
        <td colspan="3">
            ...
            try {
                ...
                System.out.println("[exception] " + e.toString());
                            ...
                            <%
            int pages = 0;
            int totDatas = tmpCashReceiveDetail.size();
    ...
    out.print("<a href=\"../freport/rpt_cashreceive_detail_print.jsp?cash_receive_id=" + cashReceive.getOID() + "&idPage=" + i + "&lastPg=" + last + "&max=" + max_hal + "&payment=" + payment + "\" target='_blank'>page " + idx + "</a>");
                                    %>
                                    <%}%>   
                                </td>                                            
                            </tr>       
