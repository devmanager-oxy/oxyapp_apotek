...
<%-- 
    Document   : cashreceive_priview
    Created on : Jul 11, 2011, 8:24:53 PM
    Author     : PNCI
--%>
...
<%
            ...
            String whereClause = DbCashReceive.colNames[DbCashReceive.COL_CASH_RECEIVE_ID]+"="+cashReceive.getOID();
            ...
            try{
                Customer cust = DbCustomer.fetchExc(cashReceive.getCustomerId());
                cst = cust.getName();
            }catch(Exception e){
                System.out.println("[exception] "+e.toString());
            }
    ...
    <tr>
        <td width="100%" colspan="5">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="5%">&nbsp</td>
                    <td ><font class id = 'string-tidak-putus-2'>Jumlah dgn. angka  : <%=idr%>&nbsp;<%=JSPFormater.formatNumber(cashReceive.getAmount(),"#,###.##")%></font><td>                
                    <td width="5%">&nbsp</td>
                </tr>
            </table>   
        </td>    
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <%if(i==0){%>
                                <tr>
                                    ...
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-first'><%=cashReceiveDetail.getMemo().compareTo("")==0 ? "-" : cashReceiveDetail.getMemo() %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-first'><%=cashReceiveDetail.getMemo().compareTo("")==0 ? "&nbsp" : "-" %></td>
                            ...
                            <%}else{%>
                                <tr>
                                    ...
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-second'><%=cashReceiveDetail.getMemo().compareTo("")==0 ? "-" : cashReceiveDetail.getMemo() %></td>
                                    <td width="30%" class id='string-garis-atas-kiri-padding-left-top-second'><%=cashReceiveDetail.getMemo().compareTo("")==0 ? "&nbsp;" : "-" %></td>
                ...
                System.out.println("[exception] "+e.toString());
                                        ...
                                        <tr>
                                            <td colspan="6" align="center">
                                                <%
                                                out.print("<a href=\"../freport/rpt_cashreceive_detail_print.jsp?cash_receive_id=" + cashReceive.getOID()+"\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
                                                %>
                                            </td>                                            
                                        </tr>
                                    </table>    
