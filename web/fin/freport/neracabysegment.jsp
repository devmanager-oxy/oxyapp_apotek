...
//if periode 13 then get prev period 13
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Laporan Keuangan", "Penjelasan", "Laporan Neraca", "Periode", "Preview", "Lokasi"};
                langNav = navID;
            ...
            Hashtable amountNeraca = new Hashtable();            
%>
<html>
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (iJSPCommand == JSPCommand.LIST) {
                try {
                    amountNeraca = SessGenNeraca.Neraca(lastPeriod,period,segment1ID);                    
                } catch (Exception e) {}
                                                                            %>
                                                                            <tr> 
                                                                            ...
                                                                            <tr> 
                                                                                <td height="23" colspan="4"> 
                                                                                    <div align="center"><b><font face="arial" size="2"><%=langFR[3]%></font></b></div>
                                                                                </td>                                                                                
                                                                            </tr>
                                                                            <%
                                                                                if (segment1ID != 0) {
                                                                                ...
                                                                                for (int x = 0; x < I_Project.accGroup.length; x++) {
                                                                                    ...
                                                                                    if (tempCoas != null && tempCoas.size() > 0) {
                                                                                        for (int i = 0; i < tempCoas.size(); i++) {
                                                                                            ...
                                                                                            double amountLY = 0;
                                                                                            double amountTY = 0;
                                                                                            SessNeraca amount = (SessNeraca)amountNeraca.get(""+coa.getCoaId());

                                                                                            if (lastPeriod.getOID() != 0) {                                                                                                
                                                                                                try {
                                                                                                    amountLY = amount.getBalancePrevious();
                                                                                                } catch (Exception e) {
                                                                                                }
                                                                                            }

                                                                                            try {
                                                                                                amountTY = amount.getBalance();
                                                                                            } catch (Exception e) {
                                                                                            }                                                                                            
