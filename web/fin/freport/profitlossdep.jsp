...
function cmdChangeList(){
	document.frmcoa.action="profitlossdep.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">Financial Report</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Profit & Loss Standard</span></font>";
					  %>
                                    ...
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">                                        
                                        <tr> 
                                          ...
                                          <td width="12%" class="tablehdr" height="22"><%=department.getName()%></td>
                                        </tr>
<!--level ACC_GROUP_REVENUE-->
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><%=I_Project.ACC_GROUP_REVENUE%></b></td>
					...
					<%
						if(listCoa!=null && listCoa.size()>0)
						{
							...
							for(int i=0; i<listCoa.size(); i++)
							{
							  ...
							  %>
                                        <tr> 
                                          <td width="21%" class="<%=cssString%>" nowrap><%if(coa.getStatus().equals("HEADER")){ %><b><%}%><%=strTotal+str+coa.getCode()+" - "+coa.getName()%><%if(coa.getStatus().equals("HEADER")){ %></b><%}%></td>                                          
					...
					<%					}
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><%="Total "+I_Project.ACC_GROUP_REVENUE%></b></span></td>
...
<!--level ACC_GROUP_EXPENSE-->
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><%=I_Project.ACC_GROUP_COST_OF_SALES%></b></td>
                                          <td width="12%" class="tablecell"></td>
                                        </tr>
										<%	}	%>									
					<%
					...
					<%					}
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><%="Total "+I_Project.ACC_GROUP_COST_OF_SALES%></b></span></td>
                                          <td width="11%" class="tablecell2" align="right">
											<table width="100%" border="0" cellpadding="0" cellspacing="1">
											  <tr>
											  	<td width="5%"></td>
...
<!--level ACC_GROUP_EXPENSE-->
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><%=I_Project.ACC_GROUP_EXPENSE%></b></td>
                                          <td width="12%" class="tablecell"></td>
                                        </tr>	
										<%	}	%>								
					<%
					...
					<%					}
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><%="Total "+I_Project.ACC_GROUP_EXPENSE%></b></span></td>
                                          <td width="11%" class="tablecell2" align="right">
											<table width="100%" border="0" cellpadding="0" cellspacing="1">
											  <tr>
											  	<td width="5%"></td>
...
<!--level ACC_GROUP_OTHER_REVENUE-->
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><%=I_Project.ACC_GROUP_OTHER_REVENUE%></b></td>
                                          <td width="12%" class="tablecell"></td>
                                        </tr>									
										<% 	} %>
					<%
					...
					<%					}
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><%="Total "+I_Project.ACC_GROUP_OTHER_REVENUE%></b></span></td>
                                          <td width="11%" class="tablecell2" align="right">
											<table width="100%" border="0" cellpadding="0" cellspacing="1">
											  <tr>
											  	<td width="5%"></td>
...
<!--level ACC_GROUP_OTHER_EXPENSE-->
										...
										%>
                                        <tr> 
                                          <td width="21%" class="tablecell"><b><%=I_Project.ACC_GROUP_OTHER_EXPENSE%></b></td>
                                          <td width="12%" class="tablecell"></td>
                                        </tr>	
										<%	}	%>								
					<%
					...
					<%					}
						...
						%>
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b><%="Total "+I_Project.ACC_GROUP_OTHER_EXPENSE%></b></span></td>
                                          <td width="11%" class="tablecell2" align="right">
											<table width="100%" border="0" cellpadding="0" cellspacing="1">
											  <tr>
											  	<td width="5%"></td>
					...
					%>
										...
										%>										
                                        <tr> 
                                          <td width="21%" class="tablecell2"><span class="level2"><b>Net Income</b></span></td>
                                          <td width="11%" class="tablecell2" align="right">
											<table width="100%" border="0" cellpadding="0" cellspacing="1">
											  <tr>
											  	<td width="5%"></td>
