...
<%-- 
    Document   : profitlosssegment_v02
    Created on : Mar 7, 2013, 1:16:29 PM
    Author     : Roy Andika
--%>
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdGO(){
                document.frmcoa.action="profitlosssegment_v02.jsp";
    ...
    if (vSeg != null && vSeg.size() > 0) {
        ...
        for (int xs = 0; xs < vSeg.size(); xs++) {
            ...
            long seg_id = JSPRequestValue.requestLong(request, "JSP_SEGMENT" + pgs + "_ID");
                                                                                                            %>
                                                                                                            <tr height="20">
                                                                                                                <td width="100" class="fontarial"><%=oSegment.getName()%></td>
                                                                                                                <td width="280">
                                                                                                                    <%
    ...
    for (int ix = 0; ix < temp.size(); ix++) {
        Periode per = (Periode) temp.get(ix);
                                                                                 ...
                                                                                 <%
    double groupRev = DbCoa.getIsCoaBalanceByGroup(I_Project.ACC_GROUP_REVENUE, temp, "CD", whereMd, whereLocation);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_REVENUE)) {
                ...
                double amountBalance = DbCoa.getCoaBalanceCD(coa.getOID(), temp, whereMd, whereLocation);
                double amountHeader = DbCoa.getIsCoaBalanceByHeader(coa.getOID(), "CD", whereMd, temp, whereLocation);
                    ...
                    if ((coa.getStatus().equals("HEADER") && amountHeader != 0) || ((!coa.getStatus().equals("HEADER")) && amountBalance != 0)) {	//add detail
                        ...
                        double totAmount = 0;
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <%for (int ix = 0; ix < temp.size(); ix++) {
                                                                                                                ...
                                                                                                                if (!coa.getStatus().equals("HEADER")){
                                                                                                                    amount = DbCoa.getCoaBalancePNLYTD(coa.getOID(), whereMd, p, whereLocation, "CD");
                                                                                                                }
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            double amount = 0;
                                                                                            if (!coa.getStatus().equals("HEADER")){        
                                                                                                amount = DbCoa.getCoaBalancePNLYTD(coa.getOID(), whereMd, per, whereLocation, "CD");
                                                                                            }        
                                                                                            totAmount = totAmount + amount;
                                                                                            vSesDep.add("" + amount);
                                                                                            totalRev[ix] = totalRev[ix] + amount;
    ...
    if (groupRev != 0 || valShowList != 1) {	//add Space
        ...
        listReport.add(sesReport);
                                                                                 ...
                                                                                 <%
    double groupCOS = DbCoa.getIsCoaBalanceByGroup(I_Project.ACC_GROUP_COST_OF_SALES, temp, "DC", whereMd, whereLocation);
    ...
    if (listCoa != null && listCoa.size() > 0) {
        ...
        for (int i = 0; i < listCoa.size(); i++) {
            ...
            if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_COST_OF_SALES)) {
                ...
                double amountBalance = DbCoa.getCoaBalance(coa.getOID(), temp, whereMd, whereLocation);
                double amountHeader = DbCoa.getIsCoaBalanceByHeader(coa.getOID(), "DC", whereMd, temp, whereLocation);
                        ...
                        vSesDep = new Vector();
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <%for (int ix = 0; ix < temp.size(); ix++) {
                                                                                                                ...
                                                                                                                double amount = 0;
                                                                                                                if (!coa.getStatus().equals("HEADER")){
                                                                                                                     amount = DbCoa.getCoaBalancePNLYTD(coa.getOID(), whereMd, per, whereLocation, "DC");
                                                                                                                }
                                                                                                                vSesDep.add("" + amount);
    ...
    if (groupCOS != 0 || valShowList != 1) {	//add Space
        ...
        listReport.add(sesReport);
                                                                                        ...
                                                                                        <!--level ACC_GROUP_EXPENSE-->
                                                                                 <%
    double groupExp = DbCoa.getIsCoaBalanceByGroup(I_Project.ACC_GROUP_EXPENSE, temp, "DC", whereMd, whereLocation);
    ...
    double groupORev = DbCoa.getIsCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_REVENUE, temp, "CD", whereMd, whereLocation);
    ...
    if (groupORev != 0 || valShowList != 1) {	//add Space
        ...
        listReport.add(sesReport);
                                                                                 ...
                                                                                 <%
    double groupOExp = DbCoa.getIsCoaBalanceByGroup(I_Project.ACC_GROUP_OTHER_EXPENSE, temp, "DC", whereMd, whereLocation);
