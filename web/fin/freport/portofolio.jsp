                                  ...
                                  <tr> 
                                    <td> 
                                      <table width="1800" border="0" cellspacing="1" cellpadding="1">
										...
										for(int i=0; i<listCoaPortofolioSetup.size(); i++){
											...
											//jika type tidak sama buatkan totalnya
												...
												*/
												...
												//----------grand total---------
												//out.println("grandTotalTargetLaba : "+grandTotalTargetLaba +", totalTargetLaba : "+totalTargetLaba );
												//out.println("pf.getType() : "+pf.getType() +", DbCoaPortofolioSetup.TYPE_PORTO_INCOME : "+DbCoaPortofolioSetup.TYPE_PORTO_INCOME );
												
												//if(pf.getType()==DbCoaPortofolioSetup.TYPE_PORTO_INCOME 
												//|| pf.getType()==DbCoaPortofolioSetup.TYPE_PORTO_OTHER_INCOME){  
												if(pfType==DbCoaPortofolioSetup.TYPE_PORTO_INCOME 
												|| pfType==DbCoaPortofolioSetup.TYPE_PORTO_OTHER_INCOME){  
										...
										//out.println("grandTotalTargetLaba : "+grandTotalTargetLaba);
