...
String[] langNav = {"Financial Report", "Balance Sheet Standard"};
...
if(lang == LANG_ID) {
	...
	String[] navID = {"Laporan Keuangan", "Buku Besar Standar"};
	langNav = navID;
}
...
function cmdChangeList(){
	document.frmcoa.action="bsstandard.jsp";
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">                                        
                                        <tr> 
                                          <td width="21%" class="tablehdr" height="22"><div align="center">
                                          <b><font color="#FFFFFF"><%=langFR[5]%></font></b></div></td>
...
<!--level equity-->
					...
					<%
						if(listCoa!=null && listCoa.size()>0)
						{
							...
							for(int i=0; i<listCoa.size(); i++)
							{
								...
								if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_EQUITY))
								{
									...
									if (valShowList==1)
									{	
										if (coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNING")) || coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNINGS")) || (coa.getStatus().equals("HEADER") && (DbCoa.getCoaBalanceByHeader(coa.getOID(),"CD"))!=0) || ((coa.getStatus().equals("HEADER")) && amount!=0))									
										//if ((coa.getStatus().equals("HEADER") && (DbCoa.getCoaBalanceByHeader(coa.getOID(),"CD"))!=0) || ((coa.getStatus().equals("HEADER")) && amount!=0))
										{	//add detail
											sesReport = new SesReportBs();
											sesReport.setType(coa.getStatus());
						...
						<%				}
									...
									{	
										if (coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNING")) || coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNINGS")) || (coa.getStatus().equals("HEADER")) || ((coa.getStatus().equals("HEADER")) && amount!=0))
										{	//add detail
											sesReport = new SesReportBs();
											sesReport.setType(coa.getStatus());
											sesReport.setDescription(strTotal1+strTotal1+str1+coa.getCode()+" - "+coa.getName());
                                        ...
                                        <tr> 
                                          ...
                                          <td width="11%" class="tablecell2" align="right">
											<table width="100%" border="0" cellpadding="0" cellspacing="1">
											  <tr>
											  	<td width="5%"></td>
												<td width="90%" class="tablecell2"><div align="right"><b><font color="red"><%=displayStr%></font></b></div></td>
												<td width="5%"></td>
											  </tr>
											</table>
										  </td>
