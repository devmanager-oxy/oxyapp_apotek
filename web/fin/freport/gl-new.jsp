                                                                            ...
                                                                            <tr> 
                                                                                <td> 
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        ...
                                                                                        <%	//Detail Report PDF
                                                                                //Vector temp = new Vector();//DbGlDetail.getGeneralLedger(startDate, endDate, coa.getOID(), whereMd, status);
                                                                                ...
                                                                                if (!(coa.getAccountGroup().equals("Expense") || coa.getAccountGroup().equals("Other Expense") ||
                                                                                    ...
                                                                                    openingBalance = DbGlDetail.getGLOpeningBalanceLocation(startDate, coa, whereMd, status, whereMd2);
