...
//jika periode adalah peride 13 lawannya period 13 tahun lalu
            ...
            /*** LANG ***/
            String[] langFR = {"Period", "Format", "UNTIL", "AND", "NO", "DESCRIPTION", "REALIZATION", "BUDGET", "AGAINST"}; //0-8
            String[] langNav = {"Financial Report", "Profit & Loss"};

            if (lang == LANG_ID) {
                String[] langID = {"Periode", "Format", "S/D", "DAN", "NO", "URAIAN", "REALISASI", "ANGGARAN", "TERHADAP"};
                langFR = langID;
...
<html >
    ...
    <head>
        ...
        <script type="text/javascript">
            <!--
            <%if (selFormat == 1) {%>
            window.location="profitloss_rpt_mth.jsp?rpt_format_id=<%=oidRptFormat%>&period_id=<%=periodId%>&rpt_format=<%=selFormat%>&menu_idx=<%=menuIdx%>";
            <%}%>
            ...
            function cmdGO(){
                document.frmneraca.action="profitloss_report.jsp";
                ...
                out.println(langFR[1]);
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                <td width="41%" height="23"> 
                                                                                    <div align="center"><font face="arial"><b><%=company.getName().toUpperCase()%></b></font></div>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="41%" height="23"> 
                                                                                    <div align="center"><font face="arial"><b><%=title.toUpperCase()%></b></font></div>
                                                                                </td>
                                                                                <td width="33%" height="23">&nbsp;</td>
                                                                            </tr>
                                                                            <tr> 
                                                                                ...
                                                                                <td width="41%" height="23"> 
                                                                                    <div align="center"><b><font face="arial"><%=langFR[2]%> <%=(JSPFormater.formatDate(dtx, "dd MMM yyyy")).toUpperCase()%> <%=langFR[3]%> <%=(JSPFormater.formatDate(reportDate, "dd MMM yyyy")).toUpperCase()%></font></b></div>
                                                                                </td>
                                                                                <td width="33%" height="23">&nbsp;</td>
                                                                            </tr>
                                                                            <tr> 
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                            <tr> 
                                                                                ...
                                                                                <td rowspan="2" class="tablehdr"><%=langFR[5]%></td>
                                                                                <td rowspan="2" class="tablehdr"><%=langFR[6]%><br><%=langFR[2]%><br><%=JSPFormater.formatDate(dtx, "dd MMM yyyy")%></td>
                                                                                <td rowspan="2" class="tablehdr">
                                                                                    <%if(isGereja){%>                                                                                    
                                                                                        <%=langFR[7]%><br><%=langFR[2]%><br><%=JSPFormater.formatDate(reportDate, "yyyy")%>
                                                                                    <%}else{%>
                                                                                        <%=langFR[7]%><br><%=langFR[2]%><br><%=JSPFormater.formatDate(reportDate, "dd MMM yyyy")%>
                                                                                    <%}%>
                                                                                </td>
                                                                                <td rowspan="2" class="tablehdr"><%=langFR[6]%><br><%=langFR[2]%><br><%=JSPFormater.formatDate(reportDate, "dd MMM yyyy")%></td>
                                                                                <td colspan="2" class="tablehdr" height="24">% <%=langFR[8]%></td>
                                                                            </tr>
                                                                            <tr> 
                                                                                <td width="9%" class="tablehdr"><%=JSPFormater.formatDate(dtx, "yyyy")%></td>
                                                                                <td width="8%" class="tablehdr"><%=langFR[7]%></td>
                                                                            </tr>
                                                                            <tr> 
                                                                                <td width="2%" height="3"> 
            ...
            if (rptDetails != null && rptDetails.size() > 0) {
                ...
                for (int i = 0; i < rptDetails.size(); i++) {
                    ...
                    if (isGereja) {
                        ...
                        amountLY = DbGlDetail.getProfitLossRealisasiLastYear(rpd.getOID(), period, whereMd);
                        //budgetTY = DbCoaBudget.getRealisasiCurrentYear(rpd.getOID(), period);
                        budgetTY = DbModuleBudget.getRealisasiCurrentYear(rpd.getOID(), period,whereMd);
                        amountTY = DbGlDetail.getProfitLossRealisasiCurrentYear(rpd.getOID(), period, whereMd);
                        ...
                        if ((vSeg != null && vSeg.size() > 0)) {
                            ...
                            amountLY = DbGlDetail.getProfitLossRealisasiLastYear(rpd.getOID(), period);
                            budgetTY = DbCoaBudget.getRealisasiCurrentYear(rpd.getOID(), period);
                            amountTY = DbGlDetail.getProfitLossRealisasiCurrentYear(rpd.getOID(), period);
                        }
                    }
                        ...
                        seq = seq - 1;
                                                                            ...
                                                                            <tr> 
                                                                                ...
                                                                                <td width="15%" class="tablecell"> 
                                                                                    <div align="right"><%=(countCoas > 0) ? getFormated(amountLY, isBold) : ""%></div>
                                                                                </td>
                                                                                <td width="16%" class="tablecell"> 
                                                                                    <div align="right"><%=(countCoas > 0) ? getFormated(budgetTY, isBold) : ""%></div>
                                                                                </td>
                                                                                <td width="17%" class="tablecell"> 
                                                                                    <div align="right"><%=(countCoas > 0) ? getFormated(amountTY, isBold) : ""%></div>
                                                                                </td>
                                                                                <td width="9%" class="tablecell"> 
                                                                                    <div align="center"><%=(countCoas > 0) ? getFormated((amountTY / amountLY) * 100, isBold) : ""%></div>
                                                                                </td>
                                                                                <td width="8%" class="tablecell"> 
                                                                                    <div align="center"><%=(countCoas > 0) ? getFormated((amountTY / budgetTY) * 100, isBold) : ""%></div>
                                                                                </td>
                                                                            </tr>
                                                                            <%
                                                                                if (rpd.getType() == DbRptFormatDetail.RPT_TYPE_TOTAL) {
