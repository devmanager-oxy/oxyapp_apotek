...
<%
            ...
            } catch (Exception e) { Header = ""; System.out.println("[exception] " + e.toString());}
...
<table align="center" width="<%=printDesign.getWidthPrint()%>" border="0">
    ...
    <tr>
        <td colspan="6" align="center">
            <a href="../freport/gl_print.jsp?gl_id=<%=gl.getOID()%>" target='_blank'><img src="../images/print.gif" name="print" height="22" border="0">
        </td>
    </tr>    
    <tr>
