...
<%
	...
	String whereClause = "account_group='Revenue' or account_group='Other Revenue'";
	String orderClause = "code";
	Vector listCoa = new Vector(1,1);
	Coa coa = new Coa();

	/* get record to display */
	//listCoa = DbCoa.list(0,0, whereClause , orderClause);
...
function cmdChangeList(){
	...
	document.frmcoa.action="pendapatan_v01.jsp";
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="20" valign="middle" align="center" colspan="3"><span class="level1"><font size="+1"><b> 
                                      REALISASI PENDAPATAN </b></font></span></td>
                                  </tr>
                                  <%
									...
									Date dtx = (Date)startDate.clone();//new Date();
									int yearx = dtx.getYear()+1900;
									int monthx = dtx.getMonth();
                                    ...
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">
                                        ...
                                        <%	
											...
											sesReport.setDescription("PENDAPATAN");//I_Project.ACC_GROUP_EXPENSE);
											sesReport.setCode("5");
											//sesReport.setFont(1);
										...
										%>
                                        <tr> 
                                          <td width="31%" class="tablecell"><b><font size="1"><%="PENDAPATAN"%> 
										...
										if(listCoa!=null && listCoa.size()>0){
											...
											for(int i=0; i<listCoa.size(); i++){
													...
													double budgetYr = DbCoaBudget.getTYBudgetRecursif(coa, yearx);//DbCoaBudget.getBudgetRecursif(coa, yearx);
													double budget = DbCoaBudget.getTMBudgetRecursif(coa, yearx, monthx);//budgetYr/12;
													double budgetSD = DbCoaBudget.getUntilTMBudgetRecusrsif(coa, yearx, monthx);;//budget*(startDate.getMonth()+1);
													...
													double amount = DbCoa.getCoaBalanceCDRecursif(coa);//DbCoa.getCoaBalanceYTDRecursif(coa, periode, "CD");//DbCoa.getCoaBalanceCDRecursif(coa);
													double amountMth = DbCoa.getCoaBalanceRecursif(coa,periode,"CD");
													double amountLMth = amount - amountMth;//DbCoa.getCoaBalanceRecursif(coa,periode,"CD");
									  ...
									  %>
                                        ...
                                        <%
											...
											sesReport = new SesReportBs();										
											sesReport.setType("Group Level");
											sesReport.setDescription("PENDAPATAN LAIN-LAIN");//I_Project.ACC_GROUP_OTHER_EXPENSE);
											sesReport.setCode("");
											//sesReport.setFont(1);
											sesReport.setLevel(9);												
											listReport.add(sesReport);
										%>
                                        <tr> 
                                          <td width="31%" class="tablecell"><b><font size="1"><%="PENDAPATAN LAIN-LAIN"%> 
									  ...
									  %>
                                        <tr> 
                                          ...
                                          <td width="9%" class="<%=cssString%>" nowrap> 
                                            <div align="right"> <font size="1"><%=displayStrBudgetSD%> </font></div>
                                          </td>
                                          <td width="9%" class="<%=cssString%>" nowrap> 
                                        ...
                                        <%
											...
											displayStr = strDisplay(coaSummary5);
											displayStrBudget = strDisplay(bgtSumOthExpense);
											displayStrBudgetYr = strDisplay(bgtSumOthExpenseYr);
											displayStrBudgetSD = strDisplay(bgtSumOthExpenseSD);
											displayStrMth = strDisplay(sumOthExpenseMth);
											displayStrLMth = strDisplay(sumOthExpenseLMth);
                                        ...
                                        <tr> 
                                          ...
                                          <td width="6%" class="tablecell2" align="right" nowrap> 
                                            <div align="center"> <font size="1"><b> 
                                              <%=(bgtSumOthExpenseSD==0 || coaSummary5==0) ? "" : JSPFormater.formatNumber((coaSummary5/bgtSumOthExpenseSD)*100,"#,###")%>% </b> </font></div>
                                          </td>
                                          <td width="6%" class="tablecell2" align="right" nowrap> 
                                            <div align="center"><font size="1"><b> 
                                              <%=(bgtSumOthExpense==0 || sumOthExpenseMth==0) ? "" : JSPFormater.formatNumber((sumOthExpenseMth/bgtSumOthExpense)*100,"#,###")%>% </b> </font></div>
                                          </td>
                                        </tr>
                                        <%
