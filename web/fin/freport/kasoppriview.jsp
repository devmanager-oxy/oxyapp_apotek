...
<table align="center" cellpadding="1" cellspacing="0"  width="<%=printDesign.getWidthPrint()%>" border="0"  >
    ...
    <tr>        
        <td colspan="11" align="center">
            <%
            out.print("<a href=\"../freport/kasopprint.jsp?DATE_KAS='" + JSPFormater.formatDate(dtKas, "yyyy-MM-dd") + "'&tot=" + tot + "\" target='_blank'><img src=\"../images/print.gif\" name=\"delete\" height=\"22\" border=\"0\"></a></td>");
            %>
