...
<%-- 
    Document   : subledgerbankdaily
    Created on : Apr 26, 2016, 3:51:38 PM
    Author     : Roy
--%>
...
<%
            boolean priv = QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MN_B, AppMenu.M2_MN_BANK_REPORT);
            boolean privView = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_B, AppMenu.M2_MN_BANK_REPORT, AppMenu.PRIV_VIEW);
            boolean privUpdate = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_B, AppMenu.M2_MN_BANK_REPORT, AppMenu.PRIV_UPDATE);
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_B, AppMenu.M2_MN_BANK_REPORT, AppMenu.PRIV_ADD);
            boolean privDelete = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MN_B, AppMenu.M2_MN_BANK_REPORT, AppMenu.PRIV_DELETE);
%>
<%!
...
<%
            ...
            String[] langNav = {"Bank Transaction", "Cash Register", "Date", "Data not found", "Please click search button to show report", "Account - Description"};
            ...
            if (lang == LANG_ID) {
                ...
                langFR = langID;
                String[] navID = {"Transaksi Bank", "Laporan Bank Harian", "Tanggal", "Data tidak ditemukan", "Click tombol search untuk menampilkan report", "Perkiraan"};
                langNav = navID;
            }
%>
                                                                            ...
                                                                            <tr> 
                                                                                <td> 
                                                                                    <table>
                                                                                        ...
                                                                                        <%           
            Vector listAcc = DbAccLink.getLinkCoas(I_Project.ACC_LINK_ACCOUNT_BANK, sysLocation.getOID());
