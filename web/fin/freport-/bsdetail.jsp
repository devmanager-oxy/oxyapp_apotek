...
%>
<%
	if(session.getValue("BS_DETAIL")!=null){
		session.removeValue("BS_DETAIL");
	}
...
function cmdPrintJournal(){	 
	window.open("<%=printroot%>.report.RptBSDetailPDF?oid=<%=appSessUser.getLoginId()%>");
}

function cmdPrintJournalXLS(){	 
	window.open("<%=printroot%>.report.RptBSDetailXLS?oid=<%=appSessUser.getLoginId()%>");
}
              ...
              <tr> 
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Financial Report </span> &raquo; <span class="level1">Balance Sheet</span> 
                        &raquo; <span class="level2">Detail<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                            ...
                            <tr align="left" valign="top"> 
                              <td height="8"  colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr align="left" valign="top"> 
                                    <td height="20" valign="middle" align="center" colspan="3"><span class="level1"><font size="+1"><b>BALANCE SHEET DETAIL</b></font></span></td>
                                  </tr>                          
								  <%
                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3" class="page"> 
                                      <table width="100%" border="0" cellpadding="1" height="20" cellspacing="1">                                        
                                        <tr> 
                                          <td width="21%" class="tablehdr" height="22"><div align="center"><b><font color="#FFFFFF">Description</font></b></div></td>
                                          <td width="12%" class="tablehdr" height="22">Total Corporate</td>
                                        </tr>
                                        <tr> 
					...
					<%
						if(listCoa!=null && listCoa.size()>0)
						{
							...
							for(int i=0; i<listCoa.size(); i++)
							{
								...
								double openBalance = DbCoaOpeningBalance.getOpeningBalance(periode, coa.getOID());																
							  ...
							  %>
                                        <tr> 
										  ...
										  <td width="12%" class="<%=cssString%>"></td>
                                        </tr>									
							<%
										...
										<tr> 
                                          <td width="100%" colspan="2">
											  ...
											  <tr>
											  	<td width="7%"></td>
												<td width="93%">
													<table width="100%"  height="20" cellpadding="1" cellspacing="1">
													  <tr>
														<td width="13%" class="tablecell" align="center"><b>Transaction Date</b></td>
														<td width="10%" class="tablecell" align="center"><b>Journal Number</b></td>
														<td width="47%" class="tablecell" align="center"><b>Memo</b></td>
														<td width="15%" class="tablecell" align="center"><b>Amount</b></td>																																										
														<td width="15%" class="tablecell" align="center"><b>Balance</b></td>
													  </tr>
													  <tr>
														<td class="tablecell1" align="center"><%=JSPFormater.formatDate((periode.getStartDate()),"dd  MMM yyyy")%></td>
														<td class="tablecell1" align="center">-</td>
														<td class="tablecell1" align="left">Opening Balance</td>
														<td class="tablecell1" align="right">-</td>																																										
														<td class="tablecell1" align="right"><%=JSPFormater.formatNumber(openBalance,"#,###.##")%></td>
													  </tr>													  
													  <%
													  		sesReport = new SesReportBs();													  		
															sesReport.setTemp("Detail Header");
															listReport.add(sesReport);
															
													  		sesReport = new SesReportBs();
													  		sesReport.setTransDate(periode.getStartDate());
															sesReport.setJournalNumber("-");		
															sesReport.setMemo("Opening Balance");
															sesReport.setAmount(0);
															sesReport.setBalance(openBalance);
															sesReport.setTemp("Detail");
															listReport.add(sesReport);										
															
													  		Vector vGl = new Vector();															
															CONResultSet crs = null;
															String sql = "select gl.* from "+DbGlDetail.DB_GL_DETAIL+ " as gld "+
																" inner join "+DbGl.DB_GL+" as gl on gld."+DbGlDetail.colNames[DbGlDetail.COL_GL_ID]+"=gl."+DbGl.colNames[DbGl.COL_GL_ID]+" where gld."+DbGlDetail.colNames[DbGlDetail.COL_COA_ID]+"="+ coa.getOID() +
															...
															if(vGl!=null && vGl.size()>0)
															{
																for(int iy=0; iy<vGl.size(); iy++)
																{
																	...
																	amount = DbGl.getAmountByCoa(coa.getOID(),periode,gl.getOID());
																	sumAmount = sumAmount + amount;
																	displayStr = strDisplay(amount, "");								
																	sumAmount1 = openBalance+sumAmount;
																	displayStr1 = strDisplay(sumAmount1, "");								
													  %>
													  <tr>
														<td class="tablecell1"><div align="center"><%=JSPFormater.formatDate((gl.getTransDate()),"dd  MMM yyyy")%></div></td>
														<td class="tablecell1"><div align="center"><%=gl.getJournalNumber()%></div></td>
														<td class="tablecell1"><%=gl.getMemo()%></td>
														<td class="tablecell1"><div align="right"><%=displayStr%></div></td>
														<td class="tablecell1"><div align="right"><%=displayStr1%></div></td>
													  </tr>
													  <%
													  				sesReport = new SesReportBs();
													  				sesReport.setTransDate(gl.getTransDate());
																	sesReport.setJournalNumber(gl.getJournalNumber());		
																	sesReport.setMemo(gl.getMemo());
																	sesReport.setAmount(amount);
																	sesReport.setBalance(openBalance+sumAmount);
																	sesReport.setTemp("Detail");
																	listReport.add(sesReport);
													  			}
															}
															sumAmount1 = openBalance+sumAmount;
															displayStr1 = strDisplay(sumAmount1, "");								
															displayStr2 = strDisplay(sumAmount, "");								
															
															sesReport = new SesReportBs();
															sesReport.setAmount(sumAmount);
															sesReport.setBalance(sumAmount1);
															sesReport.setTemp("Detail Footer");
															listReport.add(sesReport);
													  %>
													  <tr>
														<td class="tablecell" height="15"></td>
														<td class="tablecell"></td>
														<td class="tablecell"><div align="right"><b>Total <%=baseCurrency.getCurrencyCode()%></b></div></td>
														<td class="tablecell"><div align="right"><b><%=displayStr2%></b></div></td>
														<td class="tablecell"><div align="right"><b><%=displayStr1%></b></div></td>
													  </tr>
													  <tr>
														<td class="" height="3" colspan="5"></td>
													  </tr>														
													</table>
												</td>
											  </tr>
						...
						%>
                                        <tr> 
										  ...
										  <td width="11%" class="tablecell2" align="right"><div align="right"><b><%=displayStr%></b></div></td>
										</tr>
					<%	
											}
						}
													  ...
													  <%
															...
															if(vGl!=null && vGl.size()>0)
															{
																for(int iy=0; iy<vGl.size(); iy++)
																{
																	...
																	amount = DbGl.getAmountByCoaCD(coa.getOID(),periode,gl.getOID());
																	sumAmount = sumAmount + amount;
																	displayStr = strDisplay(amount, "");								
																	sumAmount1 = openBalance+sumAmount;
																	displayStr1 = strDisplay(sumAmount1, "");								
...
<!--level equity-->
						...
						if(listCoa!=null && listCoa.size()>0)
						{
							...
							for(int i=0; i<listCoa.size(); i++)
							{
								...
								if (coa.getAccountGroup().equals(I_Project.ACC_GROUP_EQUITY))
								{
									...
									{
										amountx = DbCoa.getCoaBalance(coa.getOID());//DbCoaOpeningBalance.getSumOpeningBalance();
									}

									if(amountx<0)
										displayStr = "("+JSPFormater.formatNumber(amountx*-1,"#,###.##")+")";
									else										
										displayStr = JSPFormater.formatNumber(amountx,"#,###.##");


									coaSummary6 = coaSummary6 + amountx;
									if (valShowList==1)
									{
										//if ((coa.getStatus().equals("HEADER")) || ((!coa.getStatus().equals("HEADER")) && amountx!=0))
										//{										
										if (coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNING")) || (coa.getStatus().equals("HEADER") && (DbCoa.getCoaBalanceByHeader(coa.getOID(),"CD"))!=0) || ((!coa.getStatus().equals("HEADER")) && amountx!=0))
										{	//add detail
											sesReport = new SesReportBs();
											sesReport.setType(coa.getStatus());
											sesReport.setDescription(strTotal1+strTotal1+str1+coa.getCode()+" - "+coa.getName());
											sesReport.setAmount(amountx);
											if(coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNINGS")) || coa.getCode().equals(DbSystemProperty.getValueByName("ID_BEGINING_BALANCE")))
												sesReport.setStrAmount(""+amountx);
											sesReport.setFont(coa.getStatus().equals("HEADER") ? 1 : 0);											
											sesReport.setTemp("Standard");
											listReport.add(sesReport);
											if(coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNINGS")) || coa.getCode().equals(DbSystemProperty.getValueByName("ID_BEGINING_BALANCE")))
							  ...
							  %>
                                        <tr> 
                                          <td width="21%" class="<%=cssString%>" nowrap><%if(coa.getStatus().equals("HEADER")){ %><b><%}%><%=strTotal+strTotal+str+coa.getCode()+" - "+coa.getName()%><%if(coa.getStatus().equals("HEADER")){ %></b><%}%></td>                                          
										  <td width="12%" class="<%=cssString%>"><div align="right"><%=displayStr%></div></td>
                                        </tr>
							<%
											}else
											{
							...
							<%
											...
											if (!coa.getStatus().equals("HEADER") && !coa.getCode().equals(DbSystemProperty.getValueByName("ID_RETAINED_EARNINGS")) && !coa.getCode().equals(DbSystemProperty.getValueByName("ID_BEGINING_BALANCE"))) 
											{																	
							%>										
										<tr> 
                                          <td width="100%" colspan="2">
					...
					%>
							...
							<%
								session.putValue("BS_DETAIL", listReport);							
/*
