                                  ...
                                  <tr align="left" valign="top"> 
                                    <td height="22" valign="middle" colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" height="20" cellspacing="1">                                        
                                        <tr> 
                                          <td width="400" class="tablehdr" height="22" rowspan="2" nowrap align="center"><div align="center"><b><font color="#FFFFFF">Description</font></b></div></td>
										  <%
											  	if(vDep!=null && vDep.size()>0){
													for(int i=0; i<vDep.size(); i++){
														Department dep = (Department)vDep.get(i);												
										  ...
										  <%	}	}	%>
										  <td width="150" class="tablehdr" height="22" rowspan="2" nowrap>Total Corporate</td>
                                        </tr>
										<tr>											
										  <%
											  	if(vDep!=null && vDep.size()>0){
