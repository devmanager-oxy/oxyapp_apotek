...
<script language="JavaScript">
    ...
    function cmdCurMonth(){
        document.frm_data.cld_d.value="0";
        document.frm_data.cld_m.value="0";
        document.frm_data.cld_y.value="0";
        document.frm_data.action="home.jsp";
        document.frm_data.submit();
    }
    
    function cmdPrevMonth(){
        document.frm_data.cld_m.value="<%=(cldM - 1)%>";	
        document.frm_data.action="home.jsp";
        document.frm_data.submit();
    }
...
<table width="180" border="0" cellspacing="0" cellpadding="0" class="list">
    <tr> 
        <td class="tablearialhdr" height="17" width="15">&nbsp;</td>
        <td class="tablearialhdr" colspan="5" height="17"> 
            <div align="center"><%=JSPFormater.formatDate(currdt, "MMMM yyyy")%></div>
        </td>
        <td class="tablehdr" height="17" width="15">&nbsp;</td>
    </tr>
    <tr> 
        <td height="17" width="15" class="fontarial"> 
    ...
    <tr>         
        <td height="17" width="15" class="fontarial"><font color="#0000FF"></font></td>
        <td height="17" width="15" class="fontarial"> 
            <div align="center"><a href="javascript:cmdPrevMonth()"><img src="<%=approot%>/images/dtprev.gif" width="9" height="14" border="0"></a></div>
        </td>
        <td height="17" colspan="3" class="fontarial"> 
            <div align="center"> <a href="javascript:cmdCurMonth()" title="<%=JSPFormater.formatDate(new Date(), "dd MMMM yyyy")%>">Today</a> 
             </div>
        </td>
        <td height="17" width="15" class="fontarial"> 
            <div align="center"><a href="javascript:cmdNextMonth()"><img src="<%=approot%>/images/dtnext.gif" width="9" height="14" border="0"></a></div>
        </td>
