...
<%
            ...
            boolean gereja = DbModule.getModSysPropGereja();
        ...
        function cmdChangeMenu(idx){
            ...
            switch(parseInt(idx)){
                ...
                case 1 :
					...
					<%if (cashRecPriv || cashRecAdPriv || cashPPayPriv || cashPayPriv || cashPPARriv || cashPRPriv || cashRPPriv || cashArPriv || cashArcPriv) {%>
            ...
            String strCTAdvanceReceipt = "Advance Receipt";
            String strCTPettyCash = "Petty Cash";
            String strCTCashPayment = "Disbushment";
            String strCTCashPay = "Cash Payment";
            String strCTKasbon = "Advance";
//String strCTCashPayment = "Cash Payment";disbushment
            String strCTReplenishment = "Replenishment";
            String strCTArchives = "Archives";
            String strCTCashRegister = "Kas Register";
            ...
            String strBTPaymentOfPO = "Payment of PO";
            String strBTCashPayment = "Cash Payment";
            String strBTNonPOPayment = "Non PO Payment";
            ...
            String strARTransaction = "Transaction";
            String strARNewInvoice = "New Invoice";
            String strARPayment = "Payment";
            String strARAgingAnalysis = "Aging Analysis";
            String strARArchives = "Archives";
            String strARMaster = "Master";
            String strARBankAccount = "Bank Account";
            String strARCustomer = "Customer";
            String strARAccList = "AR Acc. List";

            String strAP = "Account Payable";
            String strAPIncomingGoodsList = "Incoming Good List";
            String strAPInvoiceList = "Invoice List";
            String strAPAgingAnalysis = "Aging Analysis";
            String strAPPurchaseAccList = "Purchase Acc. List";

            String strDP = "Deposit/Titipan";
            String strDPMemberOrUnit = "Member/Unit";
            String strDPNew = "New Deposit";
            String strDPReturn = "Return Deposit";
            String strDPSaldo = "Deposit Saldo";
            String strDPArchives = "Archives";

            String strBYMHD = "BYMHD";
            String strBYMHDList = "BYMHD List";
            String strBYMHDNew = "New BYMHD";
            String strBYMHDPayment = "BYMHD Payment";
            String strBYMHDSaldo = "BYMHD Saldo";
            String strBYMHDArchives = "Archives";
            ...
            String strMs = "Membership";
            String strMsMember = "Member";
            String strMsMemberList = "Member List";
            String strMsNewMember = "New Member";
            String strMsSimpanPinjam = "Simpan Pinjam";
            String strMsDaftarBank = "Daftar Bank";
            String strMsPinjamanKoperasi = "Pinjaman Koperasi";
            String strMsAngsuran = "Angsuran";
            String strMsArsipKoperasi = "Arsip Pinjaman Koperasi";
            String strMsPinjamanBank = "Pinjaman Bank";
            String strMsAngsuranBank = "Angsuran Pinjaman Bank";
            String strMsArsipBank = "Arsip Pinjaman Bank";
            String strMsRekapPotonganGaji = "Rekap Potongan Gaji";
            String strMsDaftarPinjaman = "Daftar Pinjaman";

            String strPO = "Purchase Order";
            String strPONew = "New Order";
            String strPOVendor = "Vendor";
            String strPOArchives = "Archives";
            String strPOPurchaseAccList = "Purchase Acc. List";

            String strJournal = "Journal";
            String strGJ = "General Journal";
            String strGJNew = "New Journal";
            String strGJAdvance = "Advance Journal";
            ...
            String strFRPenjelasan = "Detail";
            String strFRPenjelasanNeraca = "Balance Sheet";
            String strFRPenjelasanIncome = "Profit & Loss";
            String strFRPenjelasanExpense = "Expenses";
            String strFRBsStandard = "Standard";
            String strFRDetail = "Detail";
            String strFRMultiplePeriods = "Multiple Periods";
            String strFRProfitLoss = "Profit & Loss";
            String strFRPlStandard = "Standard";
            String strFRPlStandardBudget = "Budget Base";
            String strFRPlRekapAll = "Rekap Biaya Seluruhnya";
            String strFRBiayaOperasiDireksi = "Biaya Operasi Direksi";
            String strFRDepartmental = "Departmental Base";
            String strFRSectional = "Sectional Base";
            String strFRMultiplePeriod = "Multiple Period";
            String strFRAdditionalReport = "Additioanal Report";
            String strFRNeraca = "Balance Sheet";
            String strFRNeracaAkhir = "Neraca Akhir";
            String strFRNeracaSP = "Neraca SP";
            String strFRNeracaNSP = "Neraca NSP";
            String strFRPortofolio = "Portofolio";
//String strFRPenjelasanNeraca = "Penjelasan Neraca";
            String strFRBiaya = "Biaya";
            String strFRPendapatan = "Pendapatan";
            String strFRRasio = "Analisa Rasio";
            String strFRIktisarLabaRugi = "Iktisar Laba Rugi";
            String strFRKinerja = "Kinerja";
            String strFROustandingKasbon = "Oustanding Advance";
            String strFRSaldoBYMHD = "Saldo BYMHD";
            String strFRTitipan = "Saldo Titipan";
            String strFRAktivaTetap = "Aktiva Tetap";

            String strDR = "Aktivitas";
            ...
            String strDS = "Data Synchronization";
            String strDSBackup = "Backup";
            String strDSTransfer = "Transfer To File";
            String strDSMaintenance = "Maintenance";
            String strDSUpload = "Upload";

            String strMD = "Master Data";
            String strMDSystemConfiguration = "System Configuration";
            ...
            String strMDWorkplan = "Workplan Data";
            ...
            String strMDEmployeeList = "User";
            String strMDDepartmentList = "Department List";
            ...
            String strCPActivityClosing = "Activity Closing";
            ...
            if (lang == LANG_ID) {
                ...
                strCTAdvanceReceipt = "Penerimaan Kasbon";
                strCTPettyCash = "Kas Kecil";
                //strCTCashPayment = "Pelunasan Tunai";
                strCTCashPayment = "Pengakuan Biaya";
                strCTCashPay = "Pembayaran Tunai";
                strCTKasbon = "Kasbon";
                strCTReplenishment = "Pengisian Kembali";
                strCTArchives = "Arsip";
                ...
                strBTPaymentOfPO = "Order Pembelian";
                strBTCashPayment = "pembelian Tunai";
                strBTNonPOPayment = "Pembelian Langsung";
                ...
                strAR = "Piutang";
                strARTransaction = "Transaksi";
                strARNewInvoice = "Faktur Baru";
                strARPayment = "Pelunasan";
                strARAgingAnalysis = "Aging Analysis";
                strARArchives = "Arsip";
                strARMaster = "Data Induk";
                strARBankAccount = "Perkiraan Bank";
                strARCustomer = "Pelanggan";
                strARAccList = "AR Acc. List";

                strAP = "Hutang";
                strAPIncomingGoodsList = "Daftar Penerimaan Barang";
                strAPInvoiceList = "Daftar Faktur";
                strAPAgingAnalysis = "Aging Analysis";
                strAPPurchaseAccList = "Purchase Acc. List";

                strDP = "Deposit/Titipan";
                strDPMemberOrUnit = "Member/Unit";
                strDPNew = "New Deposit";
                strDPReturn = "Return Deposit";
                strDPSaldo = "Deposit Saldo";
                strDPArchives = "Archives";

                strBYMHD = "BYMHD";
                strBYMHDList = "BYMHD List";
                strBYMHDNew = "New BYMHD";
                strBYMHDPayment = "BYMHD Payment";
                strBYMHDSaldo = "BYMHD Saldo";
                strBYMHDArchives = "Archives";
                ...
                strMs = "Keanggotaan";
                strMsMember = "Anggota";
                strMsMemberList = "Daftar Anggota";
                strMsNewMember = "Tambah Anggota";
                strMsSimpanPinjam = "Simpan Pinjam";
                strMsDaftarBank = "Daftar Bank";
                strMsPinjamanKoperasi = "Pinjaman Koperasi";
                strMsAngsuran = "Angsuran";
                strMsArsipKoperasi = "Arsip Pinjaman Koperasi";
                strMsPinjamanBank = "Pinjaman Bank";
                strMsAngsuranBank = "Angsuran Pinjaman Bank";
                strMsArsipBank = "Arsip Pinjaman Bank";
                strMsRekapPotonganGaji = "Rekap Potongan Gaji";
                strMsDaftarPinjaman = "Daftar Pinjaman";

                strPO = "Purchase Order";
                strPONew = "Order Baru";
                strPOVendor = "Vendor";
                strPOArchives = "Arsip";
                strPOPurchaseAccList = "Purchase Acc. List";

                strJournal = "Jurnal";
                strGJ = "Jurnal Umum";
                strGJNew = "Jurnal Baru";
                strGJAdvance = "Jurnal Kasbon";
                strGJArchives = "Arsip";
                strGJ13 = "Journal Periode-13";
                strGJNew13 = "Journal Baru 13";
                strGJArchives13 = "Arsip 13";

                strJR = "Jurnal Reversal";
                strJRNew = "Jurnal Baru";
                strJRDo = "Proses";
                strJRPosted = "Jurnal Pembalikkan";
                strJRArchives = "Arsip";

                strPostJurnal = "Posting Jurnal";
                strPostJurnal13 = "Posting Jurnal 13";

                strFR = "Laporan Keuangan";
                strFRJournalDetail = "Jurnal Detail";
                strFRGeneralLedger = "Buku Besar";
                strFRBalanceSheet = "Neraca";
                strFRPenjelasan = "Penjelasan";
                strFRPenjelasanNeraca = "Neraca";
                strFRPenjelasanIncome = "Laba Rugi";
                strFRPenjelasanExpense = "Biaya";
                strFRBsStandard = "Standar";
                strFRDetail = "Detail";
                strFRMultiplePeriods = "Multi Periode";
                strFRProfitLoss = "Laba Rugi";
                strFRPlStandard = "Standar";
                strFRPlStandardBudget = "Laba Rugi Dengan Budget";
                strFRPlRekapAll = "Rekap Biaya Seluruhnya";
                strFRBiayaOperasiDireksi = "Biaya Operasi Direksi";
                strFRDepartmental = "Berdasarkan Departemen";
                strFRSectional = "Berdasarkan Bagian";
                strFRMultiplePeriod = "Multi Periode";
                strFRAdditionalReport = "Laporan Lainnya";
                strFRNeraca = "Neraca";
                strFRNeracaAkhir = "Neraca Akhir";
                strFRNeracaSP = "Neraca SP";
                strFRNeracaNSP = "Neraca NSP";
                strFRPortofolio = "Portofolio";
                //strFRPenjelasanNeraca = "Penjelasan Neraca";
                strFRBiaya = "Biaya";
                strFRPendapatan = "Pendapatan";
                strFRRasio = "Analisa Rasio";
                strFRIktisarLabaRugi = "Iktisar Laba Rugi";
                strFRKinerja = "Kinerja";
                strFROustandingKasbon = "Kasbon Outstanding";
                strFRSaldoBYMHD = "Saldo BYMHD";
                strFRTitipan = "Saldo Titipan";
                strFRAktivaTetap = "Aktiva Tetap";
                ...
                strDS = "Sinkronisasi Data";
                strDSBackup = "Backup";
                strDSTransfer = "Simpan ke File";
                strDSMaintenance = "Perawatan";
                strDSUpload = "Upload";

                strMD = "Data Induk";
                strMDSystemConfiguration = "Pengaturan Sistem";
                ...
                strCPActivityClosing = "Activity Closing";
                strCPPer13Closing = "Tutup Periode 13";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id="cash"> 
                                <td class="submenutd"> 
                                    <table class="submenu" width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <%if (cashRecPriv) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/cashreceivedetail.jsp?menu_idx=1"><%=strCTCashReceipt%></a></td>
                                        </tr>
                                        <%}%>	
                                        <%if (cashRecAdPriv) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/penerimaan_kasbon.jsp?menu_idx=1"><%=strCTAdvanceReceipt%></a></td>
                                        </tr>
                                        <%}%>
                                        <%
                                        ...
                                        <%if (cashPPayPriv) {%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/pettycashpaymentdetail.jsp?menu_idx=1"><%=strCTCashPayment%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (cashPayPriv) {%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/cash_receive.jsp?menu_idx=1"><%=strCTCashPay%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if(cashPPARriv){%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/kasbon.jsp?menu_idx=1"><%=strCTKasbon%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (cashPRPriv) {%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/pettycashreplenishment.jsp?menu_idx=1"><%=strCTReplenishment%></a></td>
                                        </tr>
                                        <%}
    }%>
                                        <%if (cashRPPriv) {%>
                                        <tr>  
                                            <td class="menu1"><a href="<%=approot%>/transaction/casharchivepost.jsp?menu_idx=1"><%=strPostJournal%></a></td>
                                        </tr>
                                        <%}%>
                                        
                                        <%if (cashArPriv) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/casharchive.jsp?menu_idx=1"><%=strCTArchives%></a></td>
                                        </tr>
                                        <%}%>                                        
                                        <%if (cashArcPriv) {%>
                                        <tr> 
                            ...
                            <tr id="bank"> 
                                <td class="submenutd"> 
                                    <table class="submenu" width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <%if (bankDepPriv){%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/bankdepositdetail.jsp?menu_idx=2"><%=strBTBankDeposit%></a></td>
                                        </tr>
                                        <%}%>
                                        ...
                                        <%if (bankPOPriv) {%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/bankpopaymentsrc.jsp?menu_idx=2"><%=strBTPaymentOfPO%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if(bankCpPriv){%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/pelunasanbank.jsp?menu_idx=2"><%=strBTCashPayment%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if(bankNonPriv) {%>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/transaction/banknonpopaymentdetail.jsp?menu_idx=2"><%=strBTNonPOPayment%></a></td>
                                        </tr>
                                        <%}%>
                                        <%}%>
                                        <%if(bankPostPriv) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/posting_transaksi_bank.jsp?menu_idx=2"><%=strBTNPost%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (bankArcPriv) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/bankarchive.jsp?menu_idx=2"><%=strBTArchives%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (bankLinkPriv) {%>
                                        <tr> 
                            ...
                            <tr id="titip"> 
                                <td class="submenutd"> 
                                    <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                                        ...
                                        <%if (newDepo) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/titipanbaru.jsp?menu_idx=16"><%=strDPNew%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (returDepo) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/kembalikantitipan.jsp?menu_idx=16"><%=strDPReturn%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (sadloDepo) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/saldotitipan.jsp?menu_idx=16"><%=strDPSaldo%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (depoArchives) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/titipanarchive.jsp?menu_idx=16"><%=strDPArchives%></a></td>
                                        </tr>
                                        <%}%>
                                        <tr> 
                                            <td height="18" width="90%"> </td>
                            ...
                            <tr id="bymhd"> 
                                <td class="submenutd"> 
                                    <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                                        ...
                                        <%if (newBymhd) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/bymhdnew.jsp?menu_idx=18"><%=strBYMHDNew%></a></td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/bymhd.jsp?menu_idx=18"><%=strBYMHDPayment%></a></td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/bymhdsaldo.jsp?menu_idx=18"><%=strBYMHDSaldo%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (bymhdArchives) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/bymhdarchive.jsp?menu_idx=18"><%=strBYMHDArchives%></a></td>
                                        </tr>
                                        <%}%>
                                        <tr> 
                                            <td height="18" width="90%"> </td>
    ...
    if (daftarBank) {%>
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/invoicearchive.jsp?menu_idx=11"><%=strMsRekapPotonganGaji%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (akunPinjaman) {%>
                                        <tr> 
            ...
            if (1 == 2) {
                if ((purchaseOrdPriv || purchaseVndPriv || purchaseLinkPriv || purchaseArcPriv)) {%>
                            ...
                            <tr id="ap"> 
                                <td class="submenutd"> 
                                    <table class="submenu" width="99%" cellpadding="0" cellspacing="0">
                                        <%if (purchaseOrdPriv) {%>
                                        <tr> 
                                            <td height="19" width="90%" class="menu1"><a href="<%=approot%>/transaction/purchaseitem.jsp?menu_idx=3"><%=strPONew%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (purchaseVndPriv) {%>
                                        <tr> 
                    ...
                    <%if (purchaseArcPriv) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/purchasearchive.jsp?menu_idx=3"><%=strPOArchives%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (purchaseLinkPriv) {%>
                                        <tr> 
                            ...
                            <%if(glPriv || postGlPriv || (per13x.getOID() != 0 && (gl13Priv || postGl13Priv))){%>
                            <tr id="gl1"> 
                            ...
                            <tr id="gl"> 
                                <td class="submenutd"> 
                                    <table class="submenu" width="99%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/gldetail.jsp?menu_idx=9"><%=strGJNew%></a></td>
                                        </tr>                                        
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/glkasbon.jsp?menu_idx=9"><%=strGJAdvance%></a></td>
                                        </tr>
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/glarchive.jsp?menu_idx=9"><%=strGJArchives%></a></td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/journalreversal.jsp?menu_idx=9"><%=strJRNew%></a></td>
                                        </tr>
                                        
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/glreverse.jsp?menu_idx=9"><%=strJRPosted%></a></td>
                                        </tr>
                                        
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/glreversearchive.jsp?menu_idx=9"><%=strJRArchives%></a></td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/akrualsetup.jsp?menu_idx=9"><%=strATSetup%></a></td>
                                        </tr>
                                        
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/akrualproses.jsp?menu_idx=9"><%=strATProcess%></a></td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/akrualarsip.jsp?menu_idx=9"><%=strATArchives%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if(postGlPriv){%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/transaction/posting_gl.jsp?menu_idx=9"><%=strPostJurnal%></a></td>
                                        </tr>                                                                                
                                        <%}%>
                                        ...
                                        <%if (gl13Priv){%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/gldetail13.jsp?menu_idx=9"><%=strGJNew13%></a></td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/glarchive13.jsp?menu_idx=9"><%=strGJArchives13%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if (postGl13Priv) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/posting_gl13.jsp?menu_idx=9"><%=strPostJurnal13%></a></td>
                                        </tr>
                                        <%}%>                                        
                                        <%}%>
                                        <tr> 
                            ...
                            <tr id="frpt"> 
                                <td class="submenutd"> 
                                    <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">                                        
                                        ...
                                        <%if(fnCR){%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/cashregister.jsp?menu_idx=4"><%=strCTCashRegister%></a></td>
                                        </tr>
                                        <%}%>
                                        <%if(fn){%>
                                        <tr> 
                    ...
                    <!--tr> 
                      <td height="18" width="90%" class="menu2"><a href="< %=approot%>/freport/bsstandard_classv01.jsp?id_class=1&menu_idx=4">< %=strFRNeracaNSP%></a></td>
                                        ...
                                        <%if (1 == 2) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/bymhdsaldo.jsp?menu_idx=4"><%=strFRSaldoBYMHD%></a></td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%" class="menu2"><a href="<%=approot%>/transaction/saldotitipan.jsp?menu_idx=4"><%=strFRTitipan%></a></td>
                                        </tr>
                                        <tr> 
                                    ...
                                    <table class="submenu" width="99%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/datasync/backupcheck.jsp?menu_idx=7"><%=strDSTransfer%></a></td>
                                                    </tr>
                                                    <tr> 
