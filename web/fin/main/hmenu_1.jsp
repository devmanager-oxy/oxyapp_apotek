  ...
  <tr> 
    <td width="526">
      <table border="0" cellspacing="0" cellpadding="0" width="526">
        ...
        <tr><td style="background:url(<%=approot%>/images/head-line.gif) repeat-x"><img src="<%=approot%>/images/head-corner.gif" width="119" height="50" /></td></tr>
      </table>
    </td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td rowspan="2" height="74" valign="middle"><BR><BR>
                    <%
                    String nmcmpxxxxx = ""; Vector vcmpxx = DbCompany.listAll();                    
        ...
        <tr> 
          <td style="background:url(<%=approot%>/images/head-icon-bg.gif) repeat-x">
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><a href="javascript:cmdEnterApp(2)" title="Retail System"><img src="<%=approot%>/images/button-inventory.gif" width="50" height="45" border="0" /></a></td>
                <td>&nbsp;</td>                 
                <td><a href="javascript:cmdEnterApp(3)" title="Sales System"><img src="<%=approot%>/images/button-simpan.gif" width="50" height="45" border="0" /></a></td>
                <td>&nbsp;</td>
                <td><img src="<%=approot%>/images/button-finance2.gif" width="50" height="45" border="0" /></td>
                <td>&nbsp;</td>                
                <%if(false){%><td><a href="javascript:cmdEnterApp(4)" title="Property System"><img src="<%=approot%>/images/button-property.gif" width="50" height="45" border="0" /></a></td><%}%>
                <td>&nbsp;</td>               
              </tr>
            </table>
          </td>
