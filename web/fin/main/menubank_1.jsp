                ...
                if (bankPOPriv) {
                                                                                                        ...
                                                                                                        <td valign="top">
                                                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td align="center" width="90">                                                                                                                        
                                                                                                                        <a href="<%=approot%>/<%=transactionFolder%>/bankpopaymentsrc.jsp?menu_idx=3"><img src="<%=approot%>/images/mn08.jpg" border="0"></a>
                                                                                                                    </td>
                                                                                                                </tr>                                                                                                            
                                                                                                                <tr>
                                                                                                                    <td align="center" width="90">                                                                                                                        
                                                                                                                        <a href="<%=approot%>/<%=transactionFolder%>/bankpopaymentsrc.jsp?menu_idx=3" style="text-decoration: none"><font face="arial" color="#07770A"><%=strBTPaymentOfPO%></font></a>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>     
                                                                                                        ...
                                                                                                        <td valign="top">
                                                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td align="center" width="90">                                                                                                                        
                                                                                                                        <a href="<%=approot%>/<%=transactionFolder%>/bankpopaymentlist.jsp?menu_idx=3"><img src="<%=approot%>/images/mn09.jpg" border="0"></a>
                                                                                                                    </td>
                                                                                                                </tr>                                                                                                            
                                                                                                                <tr>
                                                                                                                    <td align="center" width="90">                                                                                                                        
                                                                                                                        <a href="<%=approot%>/<%=transactionFolder%>/bankpopaymentlist.jsp?menu_idx=3" style="text-decoration: none"><font face="arial" color="#07770A"><%=strBTPaymentPO%></font></a>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>     
                                                                                                ...
                                                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                                                    ...
                                                                                                    <td valign="top">
                                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td align="center" width="90">                                                                                                                        
                                                                                                                    <a href="<%=approot%>/<%=transactionFolder%>/posting_transaksi_bank.jsp?menu_idx=3"><img src="<%=approot%>/images/mn09.jpg" border="0"></a>
                                                                                                                </td>
                                                                                                            </tr>                                                                                                            
                                                                                                            <tr>
                                                                                                                <td align="center" width="90">                                                                                                                        
                                                                                                    ...
                                                                                                    <td valign="top">
                                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td align="center" width="90">                                                                                                                        
                                                                                                                    <a href="<%=approot%>/freport/reportbudgetsuplier.jsp?menu_idx=3"><img src="<%=approot%>/images/mn16.jpg" border="0"></a>
                                                                                                                </td>
                                                                                                            </tr>                                                                                                            
                                                                                                            <tr>
                                                                                                                <td align="center" width="90">                                                                                                                        
                                                                                                                    <a href="<%=approot%>/freport/reportbudgetsuplier.jsp?menu_idx=3" style="text-decoration: none"><font face="arial" color="#07770A"><%=strFRBudgetSulier%></font></a>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>     
