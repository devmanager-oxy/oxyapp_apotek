...
function cmdPrintJournal(oidPettycashReplenishment){
	...
	document.frmpettycashreplenishment.action="pettycashreplenishmentclosing.jsp";
...
<body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/print2.gif','../images/post_journal2.gif','../images/close2.gif')">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Closing Period
                        </span> &raquo; <span class="level2">Petty Cash Replenishment<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="11%"> 
                                                  <div align="center">
													...
													<%}else{%>													
														...
														<a href="<%=approot%>/closing/closinglist.jsp?menu_idx=13"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new11','','../images/close2.gif',1)"><img src="../images/close.gif" name="new11"  border="0"></a> 
														<%}%>
                                                    <%}}%>
                                                  </div>
                                                </td>
                                                ...
                                                <td width="55%"> 
												  ...
												  <table border="0" cellpadding="5" cellspacing="0" class="info" width="222" align="right">
                                                    <tr> 
                                                      <td width="20"><img src="../images/inform.gif" width="20" height="20"></td>
                                                      <td width="180" nowrap>Replenishment 
                                                        is ready to print</td>
                                                    </tr>
                                                  </table>
												  <%}%>
                                                </td>
