...
function cmdActivity(oid){
	...
	<%if(gl.getActivityStatus().equals(I_Project.NA_NOT_POSTED_STATUS)){%>
			document.frmglarchive.action="glactivityclosing.jsp";
			document.frmglarchive.command.value="<%=JSPCommand.NONE%>";
	<%}else{%>	
		document.frmglarchive.action="glactivityclosingprint.jsp";
	<%}%>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Closing Period
                        </span> &raquo; <span class="level2">Journal<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
											  ...
											  <tr> 
												...
												<%
													String msg = "";
													String msgx = "";
													if(gl.getActivityStatus().equals("Posted"))
													{
                                        ...
                                        <tr> 
                                          <td> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                              <tr > 
                                                <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="30" height="10"></td>
