...
<%if(iJSPCommand==JSPCommand.SAVE && isOK){%>
	window.location="pettycashpaymentactivityclosing.jsp?hidden_pettycash_payment_id=<%=oidPettycashPayment%>&command=<%=JSPCommand.ADD%>&select_idx=-1";
<%}%>
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="pettycashpaymentactivityclosingpredefined.jsp";
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><span class="level1">Closing Period
                        </span> &raquo; <span class="level1">Petty Cash Payment Activity
                        </span> 
                        &raquo; <span class="level2">Predefined Activity <br>
                        </span></td>
                    </tr>
                    <tr> 
