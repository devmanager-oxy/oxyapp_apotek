...
long oidBanknopoPayment = JSPRequestValue.requestLong(request, "hidden_bankarchive");
...
try{
	banknonpoPayment = DbBanknonpoPayment.fetchExc(oidBanknopoPayment);
}
catch(Exception e){
}

//out.println("oidBanknopoPayment : "+oidBanknopoPayment);

Vector listBanknonpoPaymentActivity = DbTransactionActivityDetail.list(0,0, "transaction_id="+banknonpoPayment.getOID(), "");
...
int cntActivity = DbTransactionActivityDetail.getCount("transaction_id="+oidBanknopoPayment); 
if(cntActivity>0){
	listBanknonpoPaymentActivity = DbTransactionActivityDetail.list(0,0, "transaction_id="+banknonpoPayment.getOID(), "");
}

//out.println(listBanknonpoPaymentActivity);
...
function cmdPrintJournal(){	 
	window.open("<%=printroot%>.report.RptBanknonpoPaymentActPDF?oid=<%=appSessUser.getLoginId()%>&nonpo_id=<%=banknonpoPayment.getOID()%>");
}
...
function cmdGetBalance(){
	...
	var x = document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_COA_ID]%>.value;
	//alert(x);
	...
	%>
		if(x=='<%=c.getOID()%>'){
			document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_ACCOUNT_BALANCE]%>.value="<%=JSPFormater.formatNumber(c.getOpeningBalance(),"###.##")%>";
...
function checkNumber(){
	var st = document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value;		
	var ab = document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_ACCOUNT_BALANCE]%>.value;		
	...
	document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value = formatFloat(result, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace); 
}

function checkNumber2(){
	var main = document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value;		
	...
	if(parseFloat(idx)<0){
		...
		document.frmpettycashpaymentdetail.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value = formatFloat(amount, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace); 	
...
function cmdBanknonpoPayment(oid){
	document.frmpettycashpaymentdetail.hidden_bankarchive.value=oid;
	document.frmpettycashpaymentdetail.command.value="<%=JSPCommand.EDIT%>";
	document.frmpettycashpaymentdetail.prev_command.value="<%=prevJSPCommand%>";
	document.frmpettycashpaymentdetail.action="banknonpopaymentdetailprint.jsp";
	document.frmpettycashpaymentdetail.submit();
}
...
function cmdAdd(){
	...
	document.frmpettycashpaymentdetail.hidden_bankarchive.value="0";
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Bank</span> 
                        &raquo; <span class="level1">Archives</span> &raquo; <span class="level1">Non 
                        PO &raquo; Payment &raquo; </span>  <span class="level2"></span> 
                        <span class="level2"> Activity<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmpettycashpaymentdetail" method ="post" action="">
                          ...
                          <input type="hidden" name="hidden_bankarchive" value="<%=oidBanknopoPayment%>">
						  <input type="hidden" name="hidden_casharchive" value="<%=oidBanknopoPayment%>">
                                    ...
                                    <td height="8" valign="top" colspan="3"> 
                                          ...
                                          <td colspan="4"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td colspan="2" valign="top"><%=vx.getAddress()%></td>
                                                <td width="54%">&nbsp;</td>
                                              </tr>
                                              <tr> 
                                                <td width="14%" nowrap>&nbsp;</td>
									  ...
									  %>
										...
										%>
                                              ...
                                              <tr> 
                                                <td width="14%">Memo</td>
                                                <td colspan="3" valign="top"><%=banknonpoPayment.getMemo()%></td>
                                              </tr>
                                              <tr> 
                                                <td width="10%">&nbsp;</td>
                                                <td width="22%" valign="top">&nbsp;</td>
                                              ...
                                              <tr> 
                                                      ...
                                                      <td> 
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                          <tr > 
                                                            ...
                                                            <td class="tabin"><a href="javascript:cmdBanknonpoPayment('<%=oidBanknopoPayment%>')" class="tablink">Disbursement</a></td>
                                                            ...
                                                            <td width="100%" class="page"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                <tr> 
                                                                  ...
                                                                  <td class="tablehdr" width="26%" height="20">Account</td>
                                                                  <td class="tablehdr" width="38%" height="20">Activity</td>
												...
												%>
                                                                <tr> 
                                                                  ...
                                                                  <td width="26%" class="<%=cssString%>" nowrap height="17"> 
                                                                    <%
																	  Coa xcoa = new Coa();
																	  try{
                                                                  ...
                                                                  <td width="38%" class="<%=cssString%>" nowrap height="17"> 
                                                                  ...
                                                                  <td width="21%" class="<%=cssString%>" height="17"> 
