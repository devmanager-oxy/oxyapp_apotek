...
/*** LANG ***/
String[] langMD = {"Name", "Start Date", "End Date", "Input Tolerance", "Status", "required", "please click Save & Close button to complete the process"}; //0-5
String[] langNav = {"Close Period", "Open New Accounting Period", "Yearly Closing"};
if (lang == LANG_ID) {
	String[] langID = {"Nama", "Tanggal Mulai", "Tanggal Berakhir", "Batas Akhir Memasukkan Data", "Status", "harus diisi", "Silahkan klik tombol Save & Close untuk memproses periode baru"};
	langMD = langID;
...
<%if(iJSPCommand==JSPCommand.SAVE && result.length()==0){%>
	window.location="../closing/periodenew.jsp";
<%}%>
...
function cmdSave(){
	...
	document.frmactivityperiod.action="openperiod.jsp";
	document.frmactivityperiod.submit();
}

function cmdBack(){
	document.frmactivityperiod.command.value="<%=JSPCommand.BACK%>";
	document.frmactivityperiod.action="../closing/periodenew.jsp";
	document.frmactivityperiod.submit();
}
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td colspan="2"><font color="#FF0000"><%=langMD[6]%>.</font></td>
                                              </tr>
                                              <tr> 
                                                <td width="17%">&nbsp;</td>
                                                <td width="83%">&nbsp;</td>
										...
										<tr id="closemsg" align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                              ...
                                              <tr> 
												...
												<%}else{%>
													<font color="#006600">
													proses sedang dilakukan, mohon menunggu 												
                                            		</font>	
												<%}%>
												</td>
											  </tr>
