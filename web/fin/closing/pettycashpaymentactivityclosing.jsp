...
function cmdResetPredefined(){
	...
	document.frmpettycashpaymentdetail.action="pettycashpaymentactivityclosing.jsp";
...
function cmdPettycashPayment(oid){
	...
	document.frmpettycashpaymentdetail.prev_command.value="<%=prevJSPCommand%>";
	document.frmpettycashpaymentdetail.action="pettycashpaymentclosing.jsp";
	document.frmpettycashpaymentdetail.submit();
	<%}else{%>
...
function cmdPredefined(oid){
		...
		document.frmpettycashpaymentdetail.command.value="<%=JSPCommand.EDIT%>";
		document.frmpettycashpaymentdetail.prev_command.value="<%=prevJSPCommand%>";
		document.frmpettycashpaymentdetail.action="pettycashpaymentactivityclosingpredefined.jsp";
		document.frmpettycashpaymentdetail.submit();
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="pettycashpaymentactivityclosing.jsp";
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Closing Period
                        </span> &raquo; <span class="level2">Petty Cash Payment Activity<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
