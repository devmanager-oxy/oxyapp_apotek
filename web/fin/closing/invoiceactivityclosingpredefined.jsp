...
<%if(iJSPCommand==JSPCommand.SAVE && isOK){%>
	window.location="invoiceactivityclosing.jsp?hidden_invoice_id=<%=oidInvoice%>&command=<%=JSPCommand.ADD%>&select_idx=-1";
<%}%>
...
function cmdFixing(){	
	...
	document.frmpettycashpaymentdetail.action="invoiceactivityclosingpredefined.jsp";
...
function cmdBack(oid){
	...
	document.frmpettycashpaymentdetail.command.value="<%=JSPCommand.ADD%>";
	document.frmpettycashpaymentdetail.action="invoiceactivityclosing.jsp";
	document.frmpettycashpaymentdetail.submit();
}
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="invoiceactivityclosingpredefined.jsp";
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><span class="level1">Closing Period
                        </span> &raquo; <span class="level1">Invoice Activity
                        </span> 
                        &raquo; <span class="level2">Predefined</span><span class="level2"><br>
                        </span></td>
                    </tr>
                    <tr> 
