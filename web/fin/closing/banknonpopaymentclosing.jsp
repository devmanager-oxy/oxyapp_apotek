...
function cmdActivity(oid){
	...
	<%
		...
		{
	%>	
		document.frmbanknonpopaymentdetail.action="banknonpoactivityprint.jsp?menu_idx=13";
	<%
		}else{
	%>
		document.frmbanknonpopaymentdetail.action="banknonpoactivityclosing.jsp?menu_idx=13";
	<%
		}
	%>
	document.frmbanknonpopaymentdetail.submit();
...
function cmdBack(){
	document.frmbanknonpopaymentdetail.action = "../closing/closinglist.jsp?menu_idx=13";
	document.frmbanknonpopaymentdetail.submit();
