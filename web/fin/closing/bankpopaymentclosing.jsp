...
function cmdSubmitCommand(oidBankpoPayment){
	...
	document.frmbankpopayment.action="bankpopaymentclosing.jsp";
...
<body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/post_journal2.gif','../images/print2.gif','../images/close2.gif')">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Closing Period
                        </span> &raquo; <span class="level2">Bank PO Payment<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                              ...
                              <td height="8" valign="top" colspan="3" class="container"> 
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                  ...
                                  <tr align="left" valign="top"> 
                                    ...
                                    <td height="21" colspan="2" width="47%" class="comment"> 
                                      <%
									  int counter = DbBankpoPayment.getNextCounter();
									  String strNumber = DbBankpoPayment.getNextNumber(counter);
                                                ...
                                                <td width="100%" class="page"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
													...
													for(int i=0; i<listBankpoPaymentDetail.size(); i++){
														...
														Invoice invoice = DbInvoice.fetchExc(bpd.getInvoiceId());
												%>
                                                    <tr>  
                                                      <td class="tablecell" width="12%"> 
                                                        <div align="left"><%=invoice.getVendorInvoiceNumber()%></div>
                                                      </td>
                                                      ...
                                                      <td width="11%" class="tablecell" align="right"> 
                                                        <%=JSPFormater.formatNumber(DbInvoice.getInvoiceBalance(invoice.getOID()), "#,###.##")%>
                                                      </td>
                                                      ...
                                                      <td width="11%" class="tablecell" align="right"> 
                                                        <%=JSPFormater.formatNumber(exRateValue*DbInvoice.getInvoiceBalance(invoice.getOID()), "#,###.##")%>
                                                      </td>
                                                      <td width="13%" class="tablecell" align="right"> 
														<%=JSPFormater.formatNumber(bpd.getPaymentAmount(), "#,###.##")%>
                                                        </div>
                                                      </td>
                                                      <td width="11%" class="tablecell" align="right"> 
