...
TransactionActivityDetail banknonpoactivityclosingDetail = ctrlTransactionActivityDetail.getTransactionActivityDetail();
msgString =  ctrlTransactionActivityDetail.getMessage();

if(iJSPCommand==JSPCommand.SUBMIT){
	if(iErrCode==0){
		if(recIdx==-1){		
			listBanknonpoPaymentActivity = addNewDetail(listBanknonpoPaymentActivity, banknonpoactivityclosingDetail);
			//listBanknonpoPaymentActivity.add(banknonpoactivityclosingDetail);
		}
		else{
			//listBanknonpoPaymentActivity.set(recIdx, banknonpoactivityclosingDetail);
...
if(iJSPCommand==JSPCommand.SUBMIT && iErrCode==0 && iErrCodeMain==0 && recIdx==-1){
	iJSPCommand = JSPCommand.ADD;
	banknonpoactivityclosingDetail = new TransactionActivityDetail();
}
...
function cmdClickIt(){
	document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_AMOUNT]%>.select();
}

function cmdGetBalance(){
	
	var x = document.frmbanknonpoactivityclosing.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_COA_ID]%>.value;
	//alert(x);
	...
	%>
		if(x=='<%=c.getOID()%>'){
			document.frmbanknonpoactivityclosing.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_ACCOUNT_BALANCE]%>.value="<%=JSPFormater.formatNumber(c.getOpeningBalance(),"###.##")%>";
			...
			document.frmbanknonpoactivityclosing.pcash_balance.value="<%=JSPFormater.formatNumber(c.getOpeningBalance(),"###.##")%>";
...
function cmdPredefined(oid){
		document.frmbanknonpoactivityclosing.hidden_bankarchive.value=oid;
		document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.EDIT%>";
		document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
		document.frmbanknonpoactivityclosing.action="banknonpoactivityclosingpredefined.jsp";
		document.frmbanknonpoactivityclosing.submit();	
}

function cmdResetIsDirect(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.RESET%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}

function cmdFixing(){	
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.POST%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();	
}

function cmdNewJournal(){	
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.NONE%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();	
}
...
function checkNumber(){
	var st = document.frmbanknonpoactivityclosing.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value;		
	var ab = document.frmbanknonpoactivityclosing.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_ACCOUNT_BALANCE]%>.value;		
	...
	document.frmbanknonpoactivityclosing.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value = formatFloat(result, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace); 
}

function checkHeader(){
	var x = document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_MODULE_ID]%>.value;
	<%
	...
	%>
				...
				if(x==<%=m.getOID()%> && levelx!=postable){
					...
					document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_MODULE_ID]%>.value = 0;
				}				
	<%
			}
		}
...
function checkNumber2(){
	...
	var coaName = "";
	//combobox type
	type = document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_TYPE]%>.value;		 	
	//alert("type = "+type);
	//combobox account
	accId = document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_COA_ID]%>.value;		 	
	//alert("accId = "+accId);
	...
	//total
	var currTotal = document.frmbanknonpoactivityclosing.total_detail.value;
	currTotal = cleanNumberFloat(currTotal, sysDecSymbol, usrDigitGroup, usrDecSymbol);				
	//alert("currTotal = "+currTotal);
	var idx = document.frmbanknonpoactivityclosing.select_idx.value;
	
	//maximum NONPO on company
	var maxtransaction = document.frmbanknonpoactivityclosing.max_pcash_transaction.value;
	//alert("maxtransaction = "+maxtransaction);
	//NONPO Opening Balance
	var pbalanace = <%=balance%>;//document.frmbanknonpoactivityclosing.pcash_balance.value;
	...
	//textbox amount
	var st = document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_AMOUNT]%>.value;		
	result = removeChar(st);	
	result = cleanNumberFloat(result, sysDecSymbol, usrDigitGroup, usrDecSymbol);
	//alert("result = "+result);
	//add
	if(parseFloat(idx)<0){
		...
		if(parseFloat(amount)>parseFloat(limit)){//parseFloat(main)){		
			if(type==2){
				if(accId==0){
					...
					document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_COA_ID]%>.focus();
				}else{				
		...
		document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_AMOUNT]%>.value = formatFloat(amount, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace); 	
	}
	//edit
	else{
		var editAmount =  document.frmbanknonpoactivityclosing.edit_amount.value;		
	...
	//document.frmbanknonpoactivityclosing.<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_AMOUNT]%>.value = formatFloat(result, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace); 	
}

function cmdSubmitCommand(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.SAVE%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}
...
function cmdBanknonpoPayment(oid){
	<%if(cntActivity>0){%>
		...
		document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.EDIT%>";
		document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
		document.frmbanknonpoactivityclosing.action="banknonpopaymentclosing.jsp";
		document.frmbanknonpoactivityclosing.submit();
	<%}else{%>
...
function cmdAdd(){
	document.frmbanknonpoactivityclosing.select_idx.value="-1";
	//document.frmbanknonpoactivityclosing.hidden_banknonpo_payment_id.value="0";
	document.frmbanknonpoactivityclosing.hidden_banknonpo_payment_activity_id.value="0";
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.ADD%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}
...
function cmdAsk(idx){
	//document.frmbanknonpoactivityclosing.select_idx.value=idx;
	document.frmbanknonpoactivityclosing.hidden_banknonpo_payment_activity_id.value=0;
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.ASK%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}
...
function cmdConfirmDelete(oidTransactionActivityDetail){
	document.frmbanknonpoactivityclosing.hidden_banknonpo_payment_activity_id.value=oidTransactionActivityDetail;
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.DELETE%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}
...
function cmdSave(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.SUBMIT%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}
...
function cmdEdit(idxx){
	document.frmbanknonpoactivityclosing.select_idx.value=idxx;
	document.frmbanknonpoactivityclosing.hidden_banknonpo_payment_activity_id.value=0;
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.EDIT%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=prevJSPCommand%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
...
function cmdBack(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.BACK%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}

function cmdListFirst(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.FIRST%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=JSPCommand.FIRST%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}

function cmdListPrev(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.PREV%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=JSPCommand.PREV%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}

function cmdListNext(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.NEXT%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=JSPCommand.NEXT%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}

function cmdListLast(){
	document.frmbanknonpoactivityclosing.command.value="<%=JSPCommand.LAST%>";
	document.frmbanknonpoactivityclosing.prev_command.value="<%=JSPCommand.LAST%>";
	document.frmbanknonpoactivityclosing.action="banknonpoactivityclosing.jsp";
	document.frmbanknonpoactivityclosing.submit();
}
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="banknonpoactivityclosing.jsp";
              ...
              <tr> 
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Closing Period
                        </span> &raquo; <span class="level2">Bank Non PO Payment Activity<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmbanknonpoactivityclosing" method ="post" action="">
                                                                ...
                                                                <tr> 
                                                                  ...
                                                                  <td class="tablecell" width="8%"> 
                                                                    <div align="center"> 
                                                                      <select name="<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_TYPE]%>" onChange="javascript:checkNumber2()">
                                                                        <%for(int xx=0; xx<DbTransactionActivityDetail.activities.length; xx++){%>
                                                                        <option value="<%=xx%>" <%if(xx==banknonpoactivityclosingDetail.getType()){%>selected<%}%>><%=DbTransactionActivityDetail.activities[xx]%></option>
                                                                        <%}%>
                                                                      </select>
                                                                    </div>
                                                                  </td>
                                                                  <td width="27%" class="tablecell"> 
                                                                    <div align="center">
                                                                      <select name="<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_COA_ID]%>" onChange="javascript:checkNumber2()">
																		...
																		%>
                                                                        <option value="<%=co.getOID()%>" <%if(co.getOID()==banknonpoactivityclosingDetail.getCoaId()){%>selected<%}%>><%=co.getCode()+ " - "+co.getName()%></option>
                                                                        <%}%>
                                                                      </select>
                                                                      <%= ((jspTransactionActivityDetail.getErrorMsg(jspTransactionActivityDetail.JSP_COA_ID)).length()>0) ?  "<br>"+jspTransactionActivityDetail.getErrorMsg(jspTransactionActivityDetail.JSP_COA_ID) : "" %></div>
                                                                  </td>
                                                                      ...
                                                                      <select name="<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_MODULE_ID]%>" onChange="javascript:checkNumber2();checkHeader()">
																		...
																		for(int x=0; x<modules.size(); x++){
																			...
																			if(!d.getPositionLevel().equalsIgnoreCase(I_Project.ACCOUNT_LEVEL_POSTABLE))
																				...
																				str = str + strx;																				
																			%>
                                                                        <option value="<%=d.getOID()%>" <%if(banknonpoactivityclosingDetail.getModuleId()==d.getOID()){%>selected<%}%>><%=str%></option>
                                                                        <%}}%>
                                                                      </select>
                                                                      <%= jspTransactionActivityDetail.getErrorMsg(jspTransactionActivityDetail.JSP_MODULE_ID) %></div>
                                                                  </td>
                                                                  <td width="21%" class="tablecell"> 
                                                                    <div align="center"> 
                                                                      <input type="text" name="<%=jspTransactionActivityDetail.colNames[jspTransactionActivityDetail.JSP_AMOUNT]%>" value="<%=JSPFormater.formatNumber(banknonpoactivityclosingDetail.getAmount(), "#,###.##")%>" style="text-align:right" size="25" onBlur="javascript:checkNumber2()" onClick="javascript:cmdClickIt()">
                                                                      <%= jspTransactionActivityDetail.getErrorMsg(jspTransactionActivityDetail.JSP_AMOUNT) %> 
                                                                    </div>
                                                                  </td>
                                                                </tr>
                                                ...
                                                <td colspan="5"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                      ...
                                                      <td width="2%">&nbsp;</td>
													  <td width="9%"><a href="<%=approot%>/closing/closinglist.jsp?menu_idx=13"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new11','','../images/close2.gif',1)"><img src="../images/close.gif" name="new11"  border="0"></a></td>
                                                      <td width="49%">&nbsp;</td>
                                                      <td width="36%"> 
                                                        <div align="right" class="msgnextaction"> 
					...
					out.println(e.toString());
                          ...
                          <script language="JavaScript">
				//cmdGetBalance();
				//document.frmbanknonpoactivityclosing.<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_AMOUNT]%>.value= formatFloat('<%=totalDetail%>', '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace); 
