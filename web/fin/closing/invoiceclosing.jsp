...
<%}%>
	...
	<%
		...
		{
	%>	
		document.frm_invoice.action="invoiceactivityprint.jsp?menu_idx=13";
	<%
		}else{
	%>
		document.frm_invoice.action="invoiceactivityclosing.jsp?menu_idx=13";
	<%
		}
	%>
	...
	function cmdBack(){
		...
		document.frm_invoice.action="closinglist.jsp?menu_idx=13";
		document.frm_invoice.submit();
	}
