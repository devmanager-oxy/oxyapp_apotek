...
//get open period id
            ...
            /*** LANG ***/
            String[] langMD = {"Name", "Start Date", "End Date", "Input Tolerance", "Status", "required"}; //0-5
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/new2.gif','../images/closeperiode2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="8"  colspan="3"> 
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="25" valign="middle" colspan="3" class="comment">&nbsp;<font color="#FF0000">This 
                                                                                                    process will close the<b><%if (isYearlyClose) {%> Open period, create 13th <%} else {%> Pre Closed<%}%></b> 
                                                                                                    period and update the opening balance 
                                                                                            of <b>Open</b> status period.</font></td>
                                                                                        </tr>
                                                                                        <%
            try {
            ...
            ctrLine.setLastOnMouseOver("MM_swapImage('Image26x','','" + approot + "/images/last2.gif',1)");
                                                                                        ...
                                                                                        <%if ((listPeriode == null || listPeriode.size() < 1) && iJSPCommand != JSPCommand.ADD && iJSPCommand != JSPCommand.EDIT && iJSPCommand != JSPCommand.ASK && iErrCode == 0 && privUpdate) {%>
                                                                                        <tr align="left" valign="top"> 
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3">
                                                                                                <%if (privUpdate) {
        if (DbPeriode.isPreClosedPeriodExist() || isYearlyClose) {
                                                                                                %>
                                                                                                ...
                                                                                                <%		} else {%>
                                                                                                <font color="#FF0000">No Pre-Closed 
                                                                                                    period status to be closed. <br>
                                                                                                    Please click <b>"<a href="periodenew.jsp?menu_idx=13"><%=strCPNewPeriod%></a>"</b> to update current 
                                                                                                    open periode to pre-closed and open 
                                                                                                a new accounting period.</font> 
                                                                                                <%}
    }%>
                                                                                            </td>
                                                                                        </tr>
                                                                                ...
                                                                                <td height="8" valign="middle" colspan="3"> 
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                        <tr align="left"> 
                                                                                            ...
                                                                                            <td height="21" colspan="2" width="82%" class="comment" valign="top">*)= <%=langMD[5]%></td>
                                                                                        </tr>
                                                                                        <tr align="left"> 
                                                                                        <td height="21" valign="middle" width="18%">&nbsp;&nbsp;<%=langMD[0]%></td>
                                                                                        ...
                                                                                        * <%= jspPeriode.getErrorMsg(JspPeriode.JSP_NAME) %> 
                                                                                        <tr align="left"> 
                                                                                        <td height="21" valign="middle" width="18%">&nbsp;&nbsp;<%=langMD[1]%></td>
                                                                                        <td height="21" colspan="2" width="82%"> 
                                                                                        ...
                                                                                        * <%= jspPeriode.getErrorMsg(JspPeriode.JSP_START_DATE) %> (dd/MM/yyyy) 
                                                                                        <tr align="left"> 
                                                                                        <td height="21" valign="middle" width="18%">&nbsp;&nbsp;<%=langMD[2]%></td>
                                                                                        <td height="21" colspan="2" width="82%"> 
                                                                                        ...
                                                                                        * <%= jspPeriode.getErrorMsg(JspPeriode.JSP_END_DATE) %> (dd/MM/yyyy) 
                                                                                        <tr align="left"> 
                                                                                        <td height="21" valign="middle" width="18%">&nbsp;&nbsp;<%=langMD[3]%></td>
                                                                                        <td height="21" colspan="2" width="82%"> 
                                                                                        ...
                                                                                        (dd/MM/yyyy) 
                                                                                        <tr align="left"> 
                                                                                        <td height="21" valign="middle" width="18%">&nbsp;&nbsp;<%=langMD[4]%></td>
                                                                                        <td height="21" colspan="2" width="82%"> 
