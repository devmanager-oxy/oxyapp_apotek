...
function cmdActivity(oid){
	...
	<%
		...
		{
	%>
			document.frmcasharchive.action="pettycashpaymentactivityprint.jsp?menu_idx=13";			
	<%
		}else{
	%>	
			document.frmcasharchive.action="pettycashpaymentactivityclosing.jsp?menu_idx=13";
	<%
		}
	%>
...
function cmdBack(){
	document.frmcasharchive.action = "../closing/closinglist.jsp?menu_idx=13";
	document.frmcasharchive.submit();
}
