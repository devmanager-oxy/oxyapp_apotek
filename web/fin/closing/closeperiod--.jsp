...
if(iJSPCommand==JSPCommand.SAVE){
	...
	try{
		result = DbPeriode.closePeriod(ap);
	}catch(Exception e){
...
<%if(iJSPCommand==JSPCommand.SAVE && result.length()==0){%>
	window.location="../master/periode.jsp";
<%}%>
              ...
              <tr> 
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><!-- #BeginEditable "title" --><span class="level1">Closing</span> &raquo; <span class="level2">Monthly Closing<br>
                        </span><!-- #EndEditable --></td>
                    </tr>
                    <!--tr> 
