...
<%if(iJSPCommand==JSPCommand.SAVE && isOK){%>
	window.location="glactivityclosing.jsp?hidden_gl_id=<%=oidGl%>&command=<%=JSPCommand.ADD%>&select_idx=-1";
<%}%>
...
function cmdFixing(){	
	...
	document.frmpettycashpaymentdetail.action="glactivityclosingpredefined.jsp";
...
function cmdBack(oid){
	...
	document.frmpettycashpaymentdetail.command.value="<%=JSPCommand.ADD%>";
	document.frmpettycashpaymentdetail.action="glactivityclosing.jsp";
	document.frmpettycashpaymentdetail.submit();
}
...
function cmdDelPict(oidTransactionActivityDetail){
	...
	document.frmimage.action="glactivityclosingpredefined.jsp";
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td class="title"><span class="level1">Closing Period
                        </span> &raquo; <span class="level1">Journal Activity
                        </span> &raquo; <span class="level2">Predefined</span><span class="level2"><br>
                        </span></td>
                    </tr>
                    <tr> 
