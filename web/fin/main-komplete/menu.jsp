...
function cmdChangeMenu(idx){ 
	...
	switch(parseInt(idx)){
		...
		case 1 : 
			...
			<%if(xxMinimarketList || xxnewMinimarket || xxreturMinimarket || xxsadloMinimarket || xxMinimarketArchives){%>
			document.all.minimarket1.style.display="";
			document.all.minimarket2.style.display="none";
			document.all.minimarket.style.display="none";
			<%}%>
		...
		case 21 :
			...
			<%if(xxMinimarketList || xxnewMinimarket || xxreturMinimarket || xxsadloMinimarket || xxMinimarketArchives){%>
			document.all.minimarket1.style.display="none";
			document.all.minimarket2.style.display="";
			document.all.minimarket.style.display="";
			<%}%>
        ...
        <tr> 
          <td style="padding-left:10px"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr id="bymhd"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/saldobymhdmapping.jsp?menu_idx=18">Transaksi BYMHD</a></td>
                    </tr>
                    <%//if(newBymhd){%>
                    <!--tr> 
              ...
              <%}%>
			  <%if(true){//xxdepoList || xxnewDepo || xxreturDepo || xxsadloDepo || xxdepoArchives){%>
              <tr id="minimarket1"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('21')"> <a href="javascript:cmdChangeMenu('21')">Minimarket</a></td>
              </tr>
              <tr id="minimarket2"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('0')"> <a href="javascript:cmdChangeMenu('0')">Minimarket</a></td>
              </tr>
              <tr id="minimarket"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    <%if(true){//xxdepoList){%>
                    <!--tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/minimarket/minimarket.jsp?menu_idx=21">Anggota</a></td>
                    </tr-->
                    <tr>
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/minimarket/saldominimarketmapping.jsp?menu_idx=21">Transaksi 
                        Minimarket</a></td>
                    </tr>
                    <%}%>
                    <%//if(xxnewDepo){%>
                    ...
                    <%if(true){//xxsadloDepo){%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/minimarket/saldominimarket.jsp?menu_idx=21"> 
                        Saldo Minimarket</a></td>
                    </tr>
                    <%}%>
                    <%//if(xxdepoArchives){%>
                    <!--tr> 
              ...
              <tr id="asset"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    <%if(assetSetupPriv){%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/asset/asset.jsp?menu_idx=19">Asset List</a></td>
                    </tr>
                    <%}%>
                    <!--tr> 
						  <td height="18" width="90%" class="menu1">New Invoice</td>
              ...
              <tr id="gl"> 
                <td class="submenutd"> 
                  <table class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    ...
                    <%if(glArcPriv){%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/transaction/glarchive.jsp?menu_idx=9&command=<%=JSPCommand.NONE%>">Archives</a></td>
                    </tr>
                    <%}%>
                    <tr> 
