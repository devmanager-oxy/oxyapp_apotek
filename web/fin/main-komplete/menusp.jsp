...
function cmdChangeMenu(idx){
	...
	switch(parseInt(idx)){
		...
		case 1 : 
			...
			<%if(tabungansukarela){%>
			document.all.tabungan1.style.display="";
			document.all.tabungan2.style.display="none";
			document.all.tabungan.style.display="none";
			<%}%>
			
			<%if(laporansp){%>
			document.all.laporansp1.style.display="";
			document.all.laporansp2.style.display="none";
			document.all.laporansp.style.display="none";
			<%}%>
			
			<%if(setupsp){%>
			document.all.setupsp1.style.display="";
			document.all.setupsp2.style.display="none";
			document.all.setupsp.style.display="none";
			<%}%>
		...
		case 20 :
			...
			<%}%>
			<%if(tabungansukarela){%>
			document.all.tabungan1.style.display="none";
			document.all.tabungan2.style.display="";
			document.all.tabungan.style.display="";
			<%}%>
		...
		case 21 :
			...
			<%if(laporansp){%>
			document.all.laporansp1.style.display="none";
			document.all.laporansp2.style.display="";
			document.all.laporansp.style.display="";
			<%}%>
		...
		case 22 :
			...
			<%if(setupsp){%>
			document.all.setupsp1.style.display="none";
			document.all.setupsp2.style.display="";
			document.all.setupsp.style.display="";
			<%}%>
        ...
        <tr> 
          <td style="padding-left:10px"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr id="simpanan"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    ...
                    <%}%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/saldosimpanan.jsp?menu_idx=19">Rekap 
                        Saldo Simpanan</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%"> </td>
              ...
              <%if(tabungansukarela){%>
              <tr id="tabungan1"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('20')"> <a href="javascript:cmdChangeMenu('20')">Tabungan 
                  Sukarela </a></td>
              </tr>
              <tr id="tabungan2"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('0')"> <a href="javascript:cmdChangeMenu('0')">Tabungan 
                  Sukarela </a></td>
              </tr>
              <tr id="tabungan"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    <%if(tabungansukarela){%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/srcmembersukarela.jsp?menu_idx=20">Buku 
                        Tabungan</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/saldotabungansukarela.jsp?menu_idx=20">Rekap 
                        Saldo Tabungan</a></td>
                    </tr>
					<tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/tabungansukarelabunga.jsp?menu_idx=20">Rekap 
                        Biaya Bunga</a></td>
                    </tr>
                    <%}%>
              ...
              <%if(laporansp){%>
              <tr id="laporansp1"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('21')"> <a href="javascript:cmdChangeMenu('21')">Laporan</a></td>
              </tr>
              <tr id="laporansp2"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('0')"> <a href="javascript:cmdChangeMenu('0')">Laporan</a></td>
              </tr>
              <tr id="laporansp"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/saldohutang.jsp?menu_idx=21">Saldo 
                        Hutang</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/saldopiutang.jsp?menu_idx=21">Saldo 
                        Piutang</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/rpt_pembayaran.jsp?menu_idx=21">Arsip 
                        Pembayaran</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%"> </td>
              ...
              <%if(setupsp){%>
              <tr id="setupsp1"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('22')"> <a href="javascript:cmdChangeMenu('22')">Setup</a></td>
              </tr>
              <tr id="setupsp2"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('0')"> <a href="javascript:cmdChangeMenu('0')">Setup</a></td>
              </tr>
              <tr id="setupsp"> 
                <td class="submenutd"> 
                  <table  class="submenu" width="99%" cellpadding="0" cellspacing="0">
                    <%if(setupsp){%>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/master/pinjamanacclink.jsp?menu_idx=22">Daftar 
                        Akun Piutang</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/master/pinjamancostacclink.jsp?menu_idx=22">Daftar 
                        Akun Hutang</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/tabungansetup.jsp?menu_idx=22">Setup 
                        Tabungan</a></td>
                    </tr>
                    <tr> 
                      <td height="18" width="90%" class="menu1"><a href="<%=approot%>/pinjaman/servicetab.jsp?menu_idx=22">Service 
                        Tab. Sukarela</a></td>
                    </tr>
                    <%}%>
                    <tr> 
