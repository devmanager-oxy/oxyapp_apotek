...
<%!
    public String drawList(int iCommand, JspSystemProperty jspSystemProperty, Vector objectClass, String groupName, long lOid, String[] lang) {
        ...
        cmdist.dataFormat(lang[1], "20%", "center", "center");
        cmdist.dataFormat(lang[2], "35%", "left", "left");
        cmdist.dataFormat(lang[3], "10%", "left", "left");
        cmdist.dataFormat(lang[4], "35%", "left", "left");
...
<%
            ...
            /*** LANG ***/
            String[] langMD = {"Properties", "Name", "Value", "Value Type", "Description", //0-4
                "N O T E", "Use \"\\\\\" character when you want to input \"\\\" character in value field.", "Click 'Load new value' link when System Properties it's updated."}; //5-7
            if (lang == LANG_ID) {
                String[] langID = {"Properties", "Nama", "Nilai", "Tipe Nilai", "Keterangan",
                    "CATATAN", "Gunakan karakter \"\\\\\" sebagai pengganti karakter \"\\\" pada kolom Nilai.", "Klik link \"Load new value\" jika ada perubahan System Properties."
                };
                langMD = langID;
            }
%>
...
%>
                                                                ...
                                                                <tr> 
                                                                    <td><%=drawList(iCommand, jspSystemProperty, vctData, groupName, lOid, langMD)%></td>
                                                                </tr>
                                                                <tr> 
