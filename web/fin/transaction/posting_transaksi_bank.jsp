...
<%
            ...
            String[] langNav = {"Bank Transaction", "Post Jurnal", "Search for", "Bank Deposit", "Bank Payment (PO)", "Bank Payment", "Please click on the search button to find your data", "Data not found","process is completed"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] navID = {"Transaksi Bank", "Post Jurnal", "Pencarian", "BKM Bank", "BKK Bank (PO)", "BKK Bank", "Klik tombol search untuk mencari data", "Data tidak ditemukan","Proses selesai"};
                langNav = navID;
            }
                                                ...
                                                if (type_document == TYPE_BANK_DEPOSIT) {
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        <tr>
                                                            ...
                                                            <td width="4%" rowspan="2" class="tablehdr"><%=langCT[5]%><input type="checkbox" name="chkbox" onClick="setChecked(this)"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        for (int i = 0; i < list.size(); i++) {
                                                            ...
                                                            if (DbApprovalDoc.isPostingReady(bankDeposit.getOID())) {
                                                                size++;
                                                                Coa coa = new Coa();
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        <tr>
                                                            ...
                                                            <td colspan="2" class="tablehdr"><%=langCT[3]%></td>
                                                            <td width="35%" rowspan="2" class="tablehdr"><%=langCT[4]%></td>
                                                            <td width="5%" rowspan="2" class="tablehdr"><%=langCT[5]%><input type="checkbox" name="chkbox" onClick="setChecked(this)"></td>
                                                        </tr>
                                                        <tr>
                                                            <td width="5%" class="tablehdr"><%=langCT[6]%></td>
                                                        ...
                                                        for (int i = 0; i < list.size(); i++) {
                                                            ...
                                                            if (DbApprovalDoc.isPostingReady(bnonP.getOID())) {
                                                                size++;
                                                                Coa coa = new Coa();
