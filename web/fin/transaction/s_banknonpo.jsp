...
if(iJSPCommand == JSPCommand.SEARCH){
    ...
    listBank = DbBanknonpoPayment.list(0, 0, where, DbBanknonpoPayment.colNames[DbBanknonpoPayment.COL_JOURNAL_NUMBER]);    
}
%>
            ...
            <td colspan=2>
                <table width="100%" border=0 cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tablecell" align="left">&nbsp;<%=banknonpoPayment.getMemo()%></td>
                        <td class="tablecell" align="right"><%=JSPFormater.formatNumber(banknonpoPayment.getAmount(), "#,###.##")%>&nbsp;</td>
                    </tr> 
                    <%
                    }else{ 
                    %>
                    <tr>
                        ...
                        <td class="tablecelll" align="left">&nbsp;<%=banknonpoPayment.getMemo()%></td>
                        <td class="tablecelll" align="right"><%=JSPFormater.formatNumber(banknonpoPayment.getAmount(), "#,###.##")%>&nbsp;</td>
                    </tr> 
                    <% 
                    } 
                    %>
