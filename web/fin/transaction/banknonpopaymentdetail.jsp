...
<%
            ...
            if (isNone) {
                //Periode prePeriod = DbPeriode.getPreClosedPeriod();
                //accountBalance = DbAccLink.getBankAccountBalance(accLinks, prePeriod.getOID());
            } else {
                //accountBalance = DbAccLink.getBankAccountBalance(accLinks, banknonpoPayment.getPeriodeId());
            }
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Pemasok", "Tipe", "Pembayaran dari Perkiraan", "Cara Pembayaram", "Nomor Referensi Bank", "Jumlah", "Catatan",
...
<head>
    ...
    <script language="JavaScript">
        ...
        function cmdSearchJurnal(){
            window.open("<%=approot%>/transaction/s_banknonpo.jsp?formName=frmbanknonpopaymentdetail&txt_Id=bank_id&txt_Name=jurnal_number", null, "height=400,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
            }
...
<tr><td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"><tr><td height="96"> 
    ...
    <tr><td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            String navigator = "<font class=\"lvl1\">" + langNav[0] + "</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">" + langNav[1] + "</span></font>";
                ...
                <tr> 
                    ...
                    <input type="hidden" name="hidden_banknonpo_payment_detail_id" value="<%=oidBanknonpoPaymentDetail%>"><input type="hidden" name="hidden_banknonpo_payment_id" value="<%=oidBanknonpoPayment%>">
                    ...
                    <input type="hidden" name="max_pcash_transaction" value="<%=sysCompany.getMaxPettycashTransaction()%>"><input type="hidden" name="pcash_balance" value="">                                                            
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr align="left" valign="top"><td height="8"  colspan="3" class="container"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr align="left" valign="top"> 
                                <td height="8" valign="top" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr><td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr><td width="31%"><B><font face="arial"><u><%=langNav[4]%></u></font></B></td><td width="32%">&nbsp;</td><td width="37%"> 
                                            ...
                                            </table></td></tr><tr><td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="1">   
                                        <%
            String nom_jur = "";
            if (isLoad && reset_app != 1) {
                nom_jur = banknonpoPayment.getJournalNumber();
                                        ...
                                        %>   
                                        <tr>
                                            <td>Pencarian</td><td colspan="3"><table>
                                                    <tr><td><input size="25" readonly type="text" name="jurnal_number" value="<%=nom_jur%>"></td>
                                        ...
                                        <tr><td colspan="4" width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr> 
                                                    <td height="2">&nbsp;</td></tr><tr> <td height="2" background="../images/line.gif" ><img src="../images/line.gif"></td></tr>
                                        </table></td></tr>
                                        <tr><td width="13%" nowrap>&nbsp;</td><td width="34%">&nbsp;</td><td width="12%" nowrap>&nbsp;</td><td width="39%">&nbsp;</td>
                                        </tr><tr> 
                                            <td width="13%" nowrap><a href="javascript:cmdEditVendor()"><%=langBT[0]%></a></td>
                                            <td width="34%" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr><td width="18%"> 
                ...
                for (int i = 0; i < vendors.size(); i++) {
                    Vendor vx = (Vendor) vendors.get(i);
                                        ...
                                        <tr><td width="13%" nowrap>&nbsp;</td><td colspan="3"><b><i><textarea name="vnd_address" cols="50" rows="2" class="readonly" readOnly>Vendor address ..</textarea>
                                            </i></b></td>
                                        </tr><td colspan="4">&nbsp;</td><tr><td width="13%" nowrap><%=langNav[6]%></td><td width="34%" colspan="3"><input type="text" name="<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_PAYMENT_TO]%>" value="<%=banknonpoPayment.getPaymentTo()  %>" ></td></tr>
                                        <tr><td width="13%" nowrap><%=langBT[1]%></td>
                                            <td width="34%">
            ...
            for (int i = 0; i < 1; i++) {
                                            ...
                                            </td><td width="12%" nowrap>&nbsp;</td><td width="39%">&nbsp;</td></tr><tr><td width="13%" nowrap><%=langBT[2]%></td>
                                            <td colspan="3"><select name="<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_COA_ID]%>" >
                ...
                for (int i = 0; i < accLinks.size(); i++) {
                    ...
                    if (banknonpoPayment.getCoaId() == 0 && i == 0) {
                        banknonpoPayment.setCoaId(acl.getCoaId());
                                        ...
                                        <tr><td width="13%" nowrap><%=langBT[3]%></td><td width="34%">
                                                <%
            Vector vpm = DbPaymentMethod.list(0, 0, "", "");
                ...
                for (int i = 0; i < vpm.size(); i++) {
                    PaymentMethod pm = (PaymentMethod) vpm.get(i);
                                            ...
                                            </td><td width="12%" nowrap></td><td width="39%">
                                        ...
                                        </td></tr><tr><td width="13%"><%=langBT[4]%></td><td width="34%"> 
                                            ...
                                            <td width="12%"><%=langBT[8]%></td><td width="39%"> 
                                                <%
            ...
            if(vPreClosed != null && vPreClosed.size() > 0){
                for(int i = 0; i < vPreClosed.size(); i++){
                    ...
                    if(i== 0){ preClosedPeriod = prClosed; }
            ...
            if (banknonpoPayment.getOID() != 0 || oidBanknonpoPayment != 0) {
                strNumber = banknonpoPayment.getJournalNumber();
                                        ...
                                        <tr> 
                                            <td width="13%">&nbsp;</td><td width="34%">&nbsp;</td><td width="12%">
                                                <%if (preClosedPeriod.getOID() != 0) {%>
                                                <%=langBT[24]%>
                                                <%}else{%>
                                                &nbsp;
                                            ...
                                            <td width="39%"> 
                                                <%if (preClosedPeriod.getOID() != 0) {%>
                                                <select name="<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_PERIODE_ID]%>" onChange="javascript:reloadPeriod()">
                                                    <%
    if (periods != null && periods.size() > 0) {
        for (int t = 0; t < periods.size(); t++) {
            Periode objPeriod = (Periode) periods.get(t);
                                        ...
                                        <tr> 
                                            <td width="13%"><%=langBT[5]%><%=baseCurrency.getCurrencyCode()%></td><td width="34%"> 
                                            ...
                                            <%if (!isReconfirm) {%><%= jspBanknonpoPayment.getErrorMsg(jspBanknonpoPayment.JSP_TRANS_DATE) %> <%}%></td>
                                        </tr>
                                        <tr> 
                                            <td width="13%" height="16"><%=langBT[6]%></td><td height="8" width="34%"> 
                                            ...
                                            <td width="12%" height="16" valign="top"><%=langBT[10]%></td>
                                            <td width="39%" height="16" valign="top"><input type="text" name="<%=jspBanknonpoPayment.colNames[jspBanknonpoPayment.JSP_INVOICE_NUMBER]%>" value="<%=banknonpoPayment.getInvoiceNumber()%>" size="25"></td>
                                        </tr>
                                        <tr> 
                                            <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr><td>&nbsp;</td></tr><tr><td>&nbsp; </td></tr><tr> 
                                                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr> 
                                                                    <td width="100%" class="page"><table width="100%" border="0" cellspacing="1" cellpadding="1"><!--DWLayoutTable-->
                                                                            <tr><td  class="tablehdr" rowspan="2" width="19%"><%=langBT[12]%></td><td class="tablehdr" rowspan="2" width="15%"><%=langBT[13]%></td><td class="tablehdr" colspan="2"><%=langBT[14]%></td><td class="tablehdr" rowspan="2" width="9%"><%=langBT[17]%></td><td class="tablehdr" rowspan="2" width="12%"><%=langBT[18]%><%=baseCurrency.getCurrencyCode()%></td>
                                                                                <td class="tablehdr" rowspan="2" width="28%"><%=langBT[19]%></td>
                                                                            </tr><tr> <td class="tablehdr" width="6%"><%=langBT[15]%></td><td class="tablehdr" width="11%"><%=langBT[16]%></td></tr>
                                                                            <%if (listBanknonpoPaymentDetail != null && listBanknonpoPaymentDetail.size() > 0) {
                for (int i = 0; i < listBanknonpoPaymentDetail.size(); i++) {
                                                                            ...
                                                                            <tr> 
                                                                                <td class="tablecell" width="19%" valign="middle"> 
                                                                                    <table width="100%" height="100%"  border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr><td><div align="center"><select name="<%=jspBanknonpoPaymentDetail.colNames[jspBanknonpoPaymentDetail.JSP_COA_ID]%>">
                                                                                    ...
                                                                                    for (int x = 0; x < expenseCoas.size(); x++) {
                                                                                        ...
                                                                                        <%if (false) {%>
                                                                                        <tr id="noActivity1"> 
                                                                                            <td><div align="center"><select name="<%=jspBanknonpoPaymentDetail.colNames[jspBanknonpoPaymentDetail.JSP_COA_ID_TEMP]%>">
                                                                            ...
                                                                            <tr> 
                                                                                <td class="tablecell" width="19%" valign="middle"> 
                                                                                    ...
                                                                                    for (int x = 0; x < expenseCoas.size(); x++) {
                                                                                        ...
                                                                                        <tr id="noActivity1"> 
                                                                                            <td> 
                                                                                                <div align="center"><select name="<%=jspBanknonpoPaymentDetail.colNames[jspBanknonpoPaymentDetail.JSP_COA_ID_TEMP]%>">
                                                                                                        <%if (empAdvance != null && empAdvance.size() > 0) {
        for (int x = 0; x < empAdvance.size(); x++) {
            AccLink acl = (AccLink) empAdvance.get(x);
            Coa coax = new Coa();
            ...
            String str = "";
                                            ...
                                            <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr><td width="78%"> <table width="50%" border="0" cellspacing="0" cellpadding="0"><%if (iErrCodeMain == 0 || iErrCode != 0) {%>
                                                                <tr><td> 
                                                                        <%
    ...
    if ((iJSPCommand != JSPCommand.ADD && iJSPCommand != JSPCommand.EDIT && iJSPCommand != JSPCommand.ASK && iErrCode == 0 && iErrCodeMain == 0) || (isSave && iErrCode == 0 && iErrCodeMain == 0)) {
                                                                        ...
                                                                        <table>                                                                                                                              
                                                                            ...
                                                                            <tr><td>&nbsp;</td></tr><tr><td><a href="javascript:cmdNewJournal()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new1','','../images/newdoc2.gif',1)"><img src="../images/newdoc.gif" name="new1" height="22" border="0"></a></td></tr>
                                                                        </table>    
                                                                        <%} else {%>
                                                                ...
                                                                <%} else {%>
                                                                <tr> 
                                                                    <td align="left"><%if (privUpdate || privAdd) {%><a href="javascript:cmdSave()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('savedoc21','','../images/savenew2.gif',1)"><img src="../images/savenew.gif" name="savedoc21" height="22" border="0" width="116"></a><% }%>
                                                                    </td>
                                                                </tr><tr><td>&nbsp;</td></tr>
                                                                <tr> 
                                                                    <td>
            ...
            balance = banknonpoPayment.getAmount() - totalDetail;
                                        ...
                                        <tr> 
                                            <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td height="2">&nbsp;</td></tr><tr><td height="2" background="../images/line.gif" ><img src="../images/line.gif"></td></tr></table></td>
                                        </tr>
    ...
    out.print("<a href=\"../freport/banknonpo_priview.jsp?banknonpopayment_id=" + banknonpoPayment.getOID() + "\" onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('prt2','','../images/printdoc2.gif',1)\" onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/printdoc.gif\" name=\"prt2\" height=\"22\" border=\"0\"></a></div>");
                                                        ...
                                                        <td width="38%"><%if (isSave == true && iErrCodeMain == 0 && iErrCode == 0) {%><table border="0" cellpadding="5" cellspacing="0" class="success" align="right">
                                                                <tr><td width="20"><img src="../images/success.gif" width="20" height="20"></td><td width="220"><%=langBT[21]%></td></tr>
                                                        </table><%}%></td></tr></table></td>
                                        </tr>
                                        <%}%>
                                        ...
                                        <%if (oidBanknonpoPayment != 0) {%>
                                        <tr align="left" valign="top"><td height="5" colspan="4"><%@ include file="../printing/printing.jsp"%>&nbsp;</td></tr> 
                                        <%}%>
                                        <%if (oidBanknonpoPayment != 0) {%>
                                        <tr> 
                                            <td colspan="4"> 
