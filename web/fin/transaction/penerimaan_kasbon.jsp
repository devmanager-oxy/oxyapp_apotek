...
<%!
    ...
    public Vector addNewDetail(Vector listCashReceiveDetail, CashReceiveDetail cashReceiveDetail) {
        ...
        if (!found) { listCashReceiveDetail.add(cashReceiveDetail);}
...
<%
            ...
            String[] langCT = {"Receive to Account", "Receive From", "Amount", "Memo", "Journal Number", "Transaction Date", //0-5
                ...
                "Advance Received document is ready to be saved", "Cash Receive document has been saved successfully", "Search Journal Number", "Customer", "Search Advance",//13-17
                "Ref. Number","Period"};
            ...
            if (lang == LANG_ID) {
                ...
                String[] langID = {"Perkiraan", "Diterima Dari", "Jumlah", "Catatan", "Nomor Jurnal", "Tanggal Transaksi", //0-5
                    ...
                    "Dokumen Penerimaan Kasbon siap untuk disimpan", "Dokumen Penerimaan Tunai sudah disimpan dengan sukses", "Cari Nomor Jurnal", "Sarana", "Cari Kasbon",//13-17
                    "Ref. No","Periode"
                };
            ...
            if (oidCashReceive == 0) { oidCashReceive = cashReceive.getOID(); }

            if (oidCashReceive != 0) { cashReceive = DbCashReceive.fetchExc(oidCashReceive);}
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td colspan="4"> 
                                                                                                <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr> 
                                                                                                        <td height="23"><font face="arial"><b><u><%=langNav[5]%></u></b></face></td>
                                                                                                        <td nowrap> 
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td colspan="4" valign="top"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">                                                                                                       
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="10%"><%=langCT[17]%></td>
                                                                                                        <td width="3%">&nbsp;</td>
                                                                                                        <td width="33%">
                                                                                                            <%
            String ref_number = ""; long ref_id = 0;
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td colspan="3"> 
                                                                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                <tr>
                                                                                                                    <td><textarea name="<%=JspCashReceive.colNames[JspCashReceive.JSP_MEMO]%>" cols="47" rows="2"><%=cashReceive.getMemo()%></textarea></td>
                                                                                                                    <td valign="top"></td>
    ...
    out.print("<a href=\"../freport/rpt_cashreceive_detail.jsp?cash_receive_id=" + cashReceive.getOID() + "\" onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('prt','','../images/printdoc2.gif',1)\" onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/printdoc.gif\" name=\"prt\" height=\"22\" border=\"0\"></a></div>");
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="6" colspan="4"><%@ include file="../printing/printing.jsp"%>&nbsp;</td>
                                                                            </tr> 
                                                                            <%}%>
                                                                        </table>
                                                                    </td>
