...
<td valign="top"> 
    ...
    if (user.getEmployeeId() == apd.getEmployeeId()) {
        if (apd.getStatus() == DbApprovalDoc.STATUS_APPROVED) {
                                        %>
                                        <div align="center"><a href="javascript:cmdApproval('<%=apd.getOID()%>','2')"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('no21x<%=i%>','','../images/no1.gif',1)"><img src="../images/no.gif" name="no21x<%=i%>" border="0"  alt="Klik untuk membatalkan persetujuan"></a></div>
                                        <%	} else {%>
