    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){         
                ...
                if(x == "" && y == "" && z == ""){
                    alert("Pencarian nomor jurnal, pegawai, atau amount harus diisi");
                }else{
    ...
    <tr> 
      <td colspan=2> 
        <table width="100%" border=0 cellpadding="1" cellspacing="1">
          <tr> 
            <td class="tablehdr" width="31%">No. Journal Kasbon</td>
            <td class="tablehdr" width="32%">Pegawai</td>
            <td class="tablehdr" width="37%">Total Kasbon</td>
          </tr>
          <%
                    for (int i = 0; i < listPettycashPayment.size(); i++){
                        ...
                        if (i % 2 == 0) {
                            %>
          <tr> 
            <td class="tablecell" align="center" width="31%"> 
              <%
            ...
            <td class="tablecell" align="left" width="32%">&nbsp;<%=nm%></td>
            <td class="tablecell" align="center" width="37%"> 
          ...
          <%
                            ...
                            %>
          <tr> 
            <td class="tablecelll" align="center" width="31%"> 
              <%
                                out.println("<a style='color:blue' href=\"javascript:cmdSelect('" + pettycashPayment.getJournalNumber() + "','" + pettycashPayment.getOID() + "')\">" + pettycashPayment.getJournalNumber() + "</a>");
                                    %>
            </td>
            <td class="tablecelll" align="left" width="32%"><%=nm%></td>
            <td class="tablecelll" align="center" width="37%"> 
              <div align="right"><%=JSPFormater.formatNumber(pettycashPayment.getAmount(), "#,###.##")%></div>
            </td>
          </tr>
          <%
