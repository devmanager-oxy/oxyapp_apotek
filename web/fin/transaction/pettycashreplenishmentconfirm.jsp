...
%>
<%
boolean cashPriv = true;//QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_CASH, AppMenu.M2_MENU_CASH_PETTYCASH_REPLENISHMENT);
%>
<!-- Jsp Block -->
<%!
...
if(pcr.getOID()!=0 && iJSPCommand==JSPCommand.POST && pcr.getStatus().equals(I_Project.STATUS_POSTED)){
	DbPettycashReplenishment.postJournal(pcr, user.getOID());
}
