...
<%
            ...
            String[] langCT = {"Location", "Date Transaction", "To", "Document Status", "Ignored"};

            String[] langNav = {"Account Payable", "Adjustment Stock", "Date", "Adjusment Stock", "Records", "Search Parameters"}; // 0 - 5           
            String[] langApp = {};

            if (lang == LANG_ID) {
                String[] langID = {"Lokasi", "Tgl. Transaksi", "Sampai", "Status Dok.", "Abaikan"};
                langCT = langID;
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="8"  colspan="3"> 
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr > 
                                                                                            <td class="tab" nowrap> 
                                                                                                <div align="center">&nbsp;&nbsp;<%=langNav[4]%>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                            <td class="tabin" nowrap> 
                                                                                                <div align="center">&nbsp;<a href="javascript:cmdAdd()" class="tablink"><%=langNav[3]%></a>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3"> 
                                                                                                <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        <td width="12%"><b><i><%=langNav[5]%></i></b></td>
                                                                                                        <td width="12%">&nbsp;</td>
                                                                                                        <td width="13%">&nbsp;</td>
                                                                                                        <td width="57%">&nbsp;</td>
                                                                                                    </tr>
