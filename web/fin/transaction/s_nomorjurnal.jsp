...
<%
            ...
            if (iJSPCommand == JSPCommand.SEARCH) {
                ...
                listCashReceive = DbCashReceive.list(0, 0, where, DbCashReceive.colNames[DbCashReceive.COL_JOURNAL_NUMBER]);
            }
                    ...
                    for (int i = 0; i < listCashReceive.size(); i++) {
                        ...
                        if (i % 2 == 0) {
                            ...
                            <tr>
                                ...
                                <td class="tablecell" align="left">&nbsp;<%=cashReceive.getMemo()%></td>
                                <td class="tablecell" align="right"><%=JSPFormater.formatNumber(cashReceive.getAmount(), "#,###.##")%>&nbsp;</td>
                            </tr> 
                            <%
                            } else {
                            %>
                            <tr>
                                ...
                                <td class="tablecelll" align="left">&nbsp;<%=cashReceive.getMemo()%></td>
                                <td class="tablecelll" align="right"><%=JSPFormater.formatNumber(cashReceive.getAmount(), "#,###.##")%>&nbsp;</td>
                            </tr> 
                            <%
                                } 
                            %>
