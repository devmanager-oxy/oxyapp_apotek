...
function cmdFixing(){	
	...
	document.frmcashreceivedetail.action="kembalikandp.jsp";
...
function cmdDelPict(oidCashReceiveDetail){
	...
	document.frmimage.action="kembalikandp.jsp";
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmcashreceivedetail" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=JspCashReceive.colNames[JspCashReceive.JSP_TYPE]%>" value="<%=DbCashReceive.TYPE_DP_RETURN%>">
                                          ...
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                ...
                                                <td rowspan="2"  class="tablehdr" nowrap width="13%">Piutang 
                                                  - Keterangan</td>
