...
<%
	boolean privAdd 	= true;  boolean privUpdate	= true;  boolean privDelete	= true;  boolean masterPriv      = true;
...
<%
	...
	"Code", "Vendor", "Current", "Over 30 Days", "Over 60 Days", "Over 90 Days", "Over 120 Days", "Balance"}; //3-10
	
	String[] langNav = {"Account Payable", "Aging Analysis", "Date", "All"};
	
	if(lang == LANG_ID) {
		String[] langID = {"Pemasok", "Unit Bisnis", "Umur dihitung berdasarkan",
		"Kode", "Pemasok", "Saat Ini", "Lebih dari 30 Hari", "Lebih dari 60 Hari", "Lebih dari 90 Hari", "Lebih dari 120 Hari", "Saldo"};
		langAP = langID;
		
		String[] navID = {"Hutang", "Aging Analysis", "Tanggal", "Semua"};
		langNav = navID;
	}
%>
<html >
  ...
  <tr> 
    ...
    -->                                                                  </td>
                                                                ...
                                                                <tr> 
                                                                  ...
                                                                  <td width="13%" height="6"><a href="javascript:cmdSearch()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new2','','../images/search2.gif',1)"><img src="../images/search.gif" name="new2" border="0"></a></td>
                                                            ...
                                                            <td class="boxed1"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                <tr> 
                                                                  ...
                                                                  <td class="tablehdr" height="35" width="5%"><%=langAP[3]%></td>
                                                                  <td class="tablehdr" height="35" width="18%"><%=langAP[4]%></td>
                                                                  <td class="tablehdr" height="35" width="9%"><%=langAP[5]%></td>
                                                                  <td class="tablehdr" height="35" width="8%"><%=langAP[6]%></td>
                                                                  <td class="tablehdr" height="35" width="9%"><%=langAP[7]%></td>
                                                                  <td class="tablehdr" height="35" width="8%"><%=langAP[8]%></td>
                                                                  <td class="tablehdr" height="35" width="9%"><%=langAP[9]%></td>
                                                                  <td class="tablehdr" height="35" width="17%"><%=langAP[10]%></td>
                                                                </tr>
                                                                <%
