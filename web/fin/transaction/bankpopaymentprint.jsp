...
%>
<%
            String[] langCT = {"Payment from Account","Journal Number","Payment Method","Trans. Date","Cheque/Transfer Number","Memo", // 0- 5
                                "Invoice Number","Vendor","Currency"};
            String[] langNav = {"Bank","PO Payment Archive"};

            if (lang == LANG_ID) {

                String[] langID = {"Perkiraan","Nomor Jurnal","Cara Pelunasan","Tgl. Transfer","Cek/Nomor Transfer","Memo", // 0- 5
                                "No. Faktur","Pemasok","Mata Uang"};
                langCT = langID;

                String[] navID = {"Bank","Arsip Order Pembelian"};
                langNav = navID;
            }
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            try {
                u = DbUser.fetch(bankpoPayment.getOperatorId());
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="21" valign="middle" width="14%"><%=langCT[0]%></td>
            ...
            try {
                coa = DbCoa.fetchExc(bankpoPayment.getCoaId());
                                                                                ...
                                                                                <td height="21" valign="middle" width="13%"><%=langCT[1]%></td>
                                                                                <td height="21" colspan="2" width="47%" class="comment"> 
                                                                                    <%
            ...
            if (bankpoPayment.getOID() != 0) {
                strNumber = bankpoPayment.getJournalNumber();
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="21" valign="middle" width="14%"><%=langCT[2]%></td>
                                                                                <td height="21" valign="middle" width="26%"> 
                                                                                    <%PaymentMethod pm = DbPaymentMethod.fetchExc(bankpoPayment.getPaymentMethodId());%>
                                                                                <%=pm.getDescription()%> </td>
                                                                                <td height="21" valign="middle" width="13%"><%=langCT[3]%></td>
                                                                                <td height="21" colspan="2" width="47%" class="comment"> 
                                                                                <%=JSPFormater.formatDate(bankpoPayment.getTransDate(), "dd/MM/yyyy")%></td>
                                                                            </tr>
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="21" valign="middle" width="14%"><%=langCT[4]%></td>
                                                                                <td height="21" valign="middle" width="26%"> 
                                                                                <%=bankpoPayment.getRefNumber()%> </td>
                                                                                <td height="21" valign="middle" width="13%">&nbsp;</td>
                                                                                <td height="21" colspan="2" width="47%" class="comment">&nbsp;</td>
                                                                            </tr>
                                                                            <tr align="left" valign="top"> 
                                                                            <td height="21" valign="top" width="14%"><%=langCT[5]%></td>
                                                                            <td height="21" valign="top" colspan="4"> 
                                                                            <%=bankpoPayment.getMemo()%></td>
                                                                            <tr align="left" valign="top"> 
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="100%" class="page"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                <tr> 
                                                                                                                    <td  class="tablehdr" width="8%"><font size="1">Invoice Number </font></td>
                                                                                                                    <td class="tablehdr" width="20%"><font size="1">Vendor</font></td>
                                                                                                                    <td class="tablehdr" width="5%"><font size="1">Currency</font></td>
                                                                                                                    <td class="tablehdr" width="8%"><font size="1">Unit 
                                                                                                                    Usaha</font></td>
                                                                                                                    <td class="tablehdr" width="7%"><font size="1">Balance</font></td>
                                                                                                                    <td class="tablehdr" width="7%"><font size="1">Booked 
                                                                                                                    Rate </font></td>
                                                                                                                    <td class="tablehdr" width="10%"><font size="1">Balance 
                                                                                                                    <%=baseCurrency.getCurrencyCode()%></font></td>
                                                                                                                    <td class="tablehdr" width="9%"><font size="1">Payment 
                                                                                                                    <%=baseCurrency.getCurrencyCode()%></font></td>
                                                                                                                    <td class="tablehdr" width="11%"><font size="1">Payment 
                                                                                                                            By Invoice<br>
                                                                                                                    Currency</font></td>
                                                                                                                    <td class="tablehdr" width="15%"><font size="1">Description</font></td>
                                                                                                                </tr>
                                                                                                                <%
                        ...
                        vnd = DbVendor.fetchExc(receive.getVendorId());
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    <td class="tablecell" width="8%"> 
                                                                                                                        <div align="left"><font size="1"><%=receive.getInvoiceNumber() + "/" + receive.getDoNumber()%></font></div>
                                                                                                                    </td>
                                                                                                                    <td width="20%" class="tablecell"><font size="1"><%=vnd.getName()%></font></td>
                                                                                                                    ...
                                                                                                                    <td width="8%" class="tablecell" align="right"> 
                                                                                                                        <div align="left"><font size="1"><%=us.getName()%></font></div>
                                                                                                                    </td>
                                                                                                                    <td width="7%" class="tablecell" align="right"> 
                                                                                                                    <font size="1"><%=JSPFormater.formatNumber(DbReceive.getInvoiceBalance(receive.getOID()), "#,###.##")%> </font></td>
                                                                                                                    <td width="7%" class="tablecell" align="right"> 
                                                                                                                        <font size="1"> 
                                                                                                                            <%
                                                                                                                    ...
                                                                                                                    <font size="1"><%=JSPFormater.formatNumber(exRateValue * DbReceive.getInvoiceBalance(receive.getOID()), "#,###.##")%> </font></td>
                                                                                                                    <td width="9%" class="tablecell" align="right"> 
                                                                                                                    <font size="1"><%=JSPFormater.formatNumber(bpd.getPaymentAmount(), "#,###.##")%> </font></td>
                                                                                                                    <td width="11%" class="tablecell" align="right"> 
                                                                                                                    <font size="1"><%=JSPFormater.formatNumber(bpd.getPaymentByInvCurrencyAmount(), "#,###.##")%> </font></td>
                                                                                                                    <td width="15%" class="tablecell"> 
                                                                                                                    <font size="1"><%=bpd.getMemo()%> </font></td>
                                                                                                                </tr>
                                                                                                                <%}
            }%>
                                                                                                            </table>
