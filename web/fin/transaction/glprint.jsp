...
<%
            ...
            String[] langGL = {"Journal Number", "Transaction Date", "Reference Number", "Memo", "Journal", "Activity", "GL with no expense account (Non activity transaction)", //0-6
                "Account - Description", "Department", "Currency", "Booked Rate", "Debet", "Credit", "Description", "Code", "Amount"}; //7-15
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Tanggal Transaksi", "Nomor Referensi", "Memo", "Jurnal", "Aktivitas", "Jurnal tanpa perkiraan biaya (Tidak ada aktifitas transaksi)",
                    "Perkiraan", "Departemen", "Mata Uang", "Kurs Transaksi", "Debet", "Credit", "Keterangan", "Kode", "Jumlah"
                };
                langGL = langID;
                                                                                            ...
                                                                                            <td> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr > 
                                                                                                        ...
                                                                                                        <td class="tab">&nbsp;&nbsp;<%=langGL[4]%>&nbsp;&nbsp;</td>
                                                                                                        <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                                        <%if (gl.getNotActivityBase() == 0) {%>
                                                                                                        <td class="tabin"><a href="javascript:cmdActivity('<%=oidGl%>')" class="tablink"><%=langGL[5]%></a></td>
                                                                                                        <%} else {%>
                                                                                                        <td nowrap class="tabheader"><font color="#FF0000">&nbsp;<%=langGL[6]%></font></td>
                                                                                                        <%}%>
                                                                                                        <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                                        <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                                            ...
                                                                                                            <table id="list" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr> 
                                                                                                                    <td> 
                                                                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                            <tr> 
                                                                                                                                <td rowspan="2"  class="tablehdr" nowrap width="25%"><%=langGL[7]%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="5%">&nbsp;</td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="24%"><%=langGL[8]%></td>
                                                                                                                                <td colspan="2" class="tablehdr"><%=langGL[9]%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="5%"><%=langGL[10]%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="8%"><%=langGL[11]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="8%"><%=langGL[12]%> <%=baseCurrency.getCurrencyCode()%> </td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="13%"><%=langGL[13]%></td>
                                                                                                                            </tr>
                                                                                                                            <tr> 
                                                                                                                                <td width="4%" class="tablehdr"><%=langGL[14]%></td>
                                                                                                                                <td width="8%" class="tablehdr"><%=langGL[15]%></td>
                                                                                                                            </tr>
                                                                                                                            <%
            if (listGlDetail != null && listGlDetail.size() > 0) {
                for (int i = 0; i < listGlDetail.size(); i++) {
    ...
    try {
        d = DbDepartment.fetchExc(oidx);
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                ...
                                                                                                                                <td width="8%" class="tablecell" height="1"> 
                                                                                                                                    <div align="right"></div>
                                                                                                                                </td>
                                                                                                                                <td width="8%" class="tablecell" height="1"> 
                                                                                                                                    <div align="right"></div>
                                                                                                                                </td>
                                                                                                                                <td width="13%" class="tablecell" height="1">&nbsp;</td>
                                                                                                                            </tr>
                                                                                                                            <tr> 
