                                                                                ...
                                                                                <td class="boxed1"> 
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablecell" width="7%"><div align="center"><a href="<%=approot%>/transaction/cash_receive_detail.jsp?menu_idx=2&hidden_pettycash_payment_id=<%=bp.getOID()%>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ok','','../images/ok2.gif',1)"><img src="../images/ok.gif" name="ok" width="49" height="22" border="0"></a></div></td>
                                                                                        </tr>
                                                                                        <%
                                                                                                } else {
                                                                                        %>                        
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablecell1" width="7%"><div align="center"><a href="<%=approot%>/transaction/pelunasanbankproses.jsp?menu_idx=2&hidden_bank_po_payment_id=<%=bp.getOID()%>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('ok','','../images/ok2.gif',1)"><img src="../images/ok.gif" name="ok" width="49" height="22" border="0"></a></div></td>
                                                                                        </tr>
                                                                                        <%
                                                                                                            }
                                                                                                        }
