...
<%-- 
    Document   : bankbkk
    Created on : Feb 27, 2012, 10:26:45 AM
    Author     : Roy Andika
--%>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdCetak(param){	
				...
				document.frmpettycashpaymentdetail.action="bankbkk.jsp";
...
function cmdDelPict(oidPettycashPaymentDetail){
    ...
    document.frmimage.action="bankbkk.jsp";
...
//-->
    ...
    out.print("<a href=\"../freport/rpt_pettycashpayment.jsp?pettycashPayment_id=" + pettycashPayment.getOID() + "\" onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('prt','','../images/printdoc2.gif',1)\" onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/printdoc.gif\" name=\"prt\" height=\"22\" border=\"0\"></a></div>");
                                                                                                                    ...
                                                                                                                    <%}%>
                                                                                                                    <td width="9%" nowrap>&nbsp;&nbsp;&nbsp;<a href="<%=approot%>/transaction/bankbkk.jsp?menu_idx=1" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new1','','../images/newdoc2.gif',1)"><img src="../images/newdoc.gif" name="new1" height="22" border="0"></a>&nbsp;&nbsp;&nbsp;</td>
        ...
        if (userEmp.getPosition().equalsIgnoreCase(employee.getPosition())) {
                                                                                                                        ...
                                                                                                                        <div align="center"> 
                                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                <tr> 
                                                                                                                                    <td> 
                                                                                                                                        <div align="center"><a href="javascript:cmdApproval('<%=apd.getOID()%>','1')"><img src="../images/success.gif" alt="Klik : Untuk Menyetujui Dokumen" border="0"></a></div>
                                                                                                                                    </td>
                                                                                                                                    <td> 
                                                                                                                                        <div align="center"><a href="javascript:cmdApproval('<%=apd.getOID()%>','2')"><img src="../images/no.gif" alt="Klik : Untuk tidak menyetujui" border="0"></a></div>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </table>
                                                                                                                        </div>
