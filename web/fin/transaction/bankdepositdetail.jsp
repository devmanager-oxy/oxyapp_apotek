...
<%
            ...
            if (load) { listBankDepositDetail = DbBankDepositDetail.list(0, 0, DbBankDepositDetail.colNames[DbBankDepositDetail.COL_BANK_DEPOSIT_ID] + "=" + bankDeposit.getOID(), null); }
            ...
            String[] langBT = {"Deposit to Account", "Amount", "Memo", "Journal Number", "Transaction Date", //0-4
                "Account - Description", "Currency", "Code", "Debet", "Booked Rate", "Amount Debet", "Description", //5-11
                "Journal is ready to be saved", "Journal has been saved", "Search Journal Number", "Customer", "Segments", "Search for Bank Deposit", "Bank Deposit Editor", "Credit", "Amount Credit", "Period","Receive From"}; //12-22
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Setoran ke Perkiraan", "Jumlah", "Catatan", "Nomor Jurnal", "Tanggal Transaksi", //0-4
                    "Perkiraan", "Mata Uang", "Kode", "Debet", "Kurs Transaksi", "Jumlah Debet", "Keterangan", //5-11
                    "Jurnal siap untuk di simpan", "Jurnal sukses di simpan", "Cari Nomor Jurnal", "Konsumen", "Segmen", "Pencarian", "Editor Bank Deposit", "Credit", "Jumlah Credit", "Periode","Diterima Dari"}; //12-22
...
<html >
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearchJurnal(){
                window.open("<%=approot%>/transaction/s_bankdeposit.jsp?formName=frmbankdepositdetail&txt_Id=bankdeposit_id&txt_Name=jurnal_number", null, "height=400,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                }
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/new2.gif','../images/savedoc2.gif','../images/close2.gif','../images/post_journal2.gif','../images/print2.gif','../images/cancel2.gif','../images/savenew2.gif','../images/newdoc2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="8" valign="top" colspan="3"> 
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        ...
                                                                                        <tr><td colspan="4"><font face = "arial"><b><u><%=langBT[17].toUpperCase()%></u></b></font></td></tr>
                                                                                        <tr><td colspan="4">&nbsp;</td></tr>    
                                                                                        <tr> 
                                                                                            <td colspan="4" valign="top"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        <td width="13%"><%=langBT[14]%></td>
                                                                                                        <td width="33%"> 
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr> 
                                                                                                                    <td width="27%" nowrap> 
            ...
            if (isLoad && reset_app != 1) { jur_number = bankDeposit.getJournalNumber(); bangdepositId = bankDeposit.getOID(); }
                                                                                                                        %>
                                                                                                                        <input size="30" readonly type="text" name="jurnal_number" value="<%=jur_number%>">
                                                                                                                        <input type="hidden" name="bankdeposit_id" value="<%=bangdepositId%>">
                                                                                                                    </td>
                                                                                                                    <td width="73%" nowrap>&nbsp;<a href="javascript:cmdSearchJurnal()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new21','','../images/search.jpg',1)"><img src="../images/search2.jpg" name="new211" height="17" border="0" style="padding:0px"></a></td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr><td colspan="4" height="20"><font face = "arial"><b><u><%=langBT[18].toUpperCase()%></u></b></font></td></tr>
        ...
        for (int t = 0; t < periods.size(); t++) {
                    ...
                    if (bankDeposit.getCoaId() == 0 && i == 0) {
                        bankDeposit.setCoaId(accLink.getCoaId());
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="33%"> 
                                                                                                            <input type="text" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_AMOUNT]%>" style="text-align:right" value="<%=JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##")%>" onBlur="javascript:checkNumber()"  class="readonly" readOnly size="50">
                                                                                                        </td>
                                                                                                        <td width="12%"><div align="right"><%=langBT[15]%>&nbsp;&nbsp;</div></td>
                                                                                                        <td valign="top">
                                                                                                            <%
                ...
                for (int iC = 0; iC < vCustomer.size(); iC++) {
                    Customer objCustomer = (Customer) vCustomer.get(iC);
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="12%" valign="top"><div align="right"><%=langBT[22]%>&nbsp;&nbsp;</div></td>
                                                                                                        <td valign="top"><input type="text" size="25" name="<%=JspBankDeposit.colNames[JspBankDeposit.JSP_RECEIVE_FROM]%>" value="<%=bankDeposit.getReceiveFrom()%>"> </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
            ...
            try {
                                                                            ...
                                                                            <tr align="left" valign="top"> 
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr> 
                                                                                            <td class="boxed1">                                                                                                 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        <td rowspan="2" class="tablehdr" width="15%" nowrap><%=langBT[5]%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="15%" nowrap>Department</td>
                                                                                                        <td colspan="3" class="tablehdr" width="20%"><%=langBT[6]%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="15%"><%=langBT[9]%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="10%"><%=langBT[10]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="10%"><%=langBT[20]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                        <td rowspan="2" class="tablehdr" width="15%"><%=langBT[11]%></td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td width="4%" class="tablehdr"><%=langBT[7]%></td><td width="8%" class="tablehdr"><%=langBT[8]%></td><td width="8%" class="tablehdr"><%=langBT[19]%></td>
                                                                                                    </tr>
                                                                                                    <%
                                                                                if (listBankDepositDetail != null && listBankDepositDetail.size() > 0) {
                                                                                    for (int i = 0; i < listBankDepositDetail.size(); i++) {
                                                                                        ...
                                                                                        if (((iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK) || (iJSPCommand == JSPCommand.SUBMIT && iErrCode != 0)) && i == recIdx) {%>
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                                <input type="text" name="<%=JspBankDepositDetail.colNames[JspBankDepositDetail.JSP_FOREIGN_CREDIT_AMOUNT]%>" size="15" value="<%=JSPFormater.formatNumber(crd.getForeignCreditAmount(), "#,###.##")%>" style="text-align:right" onBlur="javascript:cmdUpdateExchange()" onClick="javascript:cmdClickMeCredit()">
                                                                                                            <%= jspBankDepositDetail.getErrorMsg(jspBankDepositDetail.JSP_FOREIGN_CREDIT_AMOUNT) %> </div>
                                                                                                        </td>
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                        ...
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                                <input type="hidden" name="edit_amount" value="<%=crd.getAmount()%>">
                                                                                                                <input type="text" name="<%=JspBankDepositDetail.colNames[JspBankDepositDetail.JSP_CREDIT_AMOUNT]%>" value="<%=JSPFormater.formatNumber(crd.getCreditAmount(), "#,###.##")%>" style="text-align:right" size="15"  class="readonly rightalign" readOnly>
                                                                                                            <%= jspBankDepositDetail.getErrorMsg(JspBankDepositDetail.JSP_CREDIT_AMOUNT) %> </div>
                                                                                                        </td>
                                                                                                        <td class="tablecell"> 
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td class="<%=cssString%>"> 
                                                                                                            <div align="right"> <%=JSPFormater.formatNumber(crd.getForeignCreditAmount(), "#,###.##")%> </div>
                                                                                                        </td>
                                                                                                        <td class="<%=cssString%>"> 
                                                                                ...
                                                                                if (((iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.SAVE || iErrCodeMain > 0 || iErrCode != 0) && recIdx == -1) && !(isSave && iErrCode == 0 && iErrCodeMain == 0)) {
                                                                                                    %>
                                                                                                    <tr> 
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                        ...
                                                                                                        <td class="tablecell"><div align="center"> 
                                                                                                            ...
                                                                                                            for (int x = 0; x < deps.size(); x++) {
                                                                                                                ...
                                                                                                                switch (d.getLevel()) {
                                                                                                                    ...
                                                                                                                    %>
                                                                                                                    <option value="<%=d.getOID()%>" <%if (bankDepositDetail.getDepartmentId() == d.getOID()) {%>selected<%}%>><%=str + d.getCode() + " - " + d.getName()%></option>
                                                                                                                    <%}
                                                                                                        }%>
                                                                                                                </select>
                                                                                                        <%= jspBankDepositDetail.getErrorMsg(jspBankDepositDetail.JSP_DEPARTMENT_ID) %> </div></td>
                                                                                                        ...
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                                <input type="text" name="<%=JspBankDepositDetail.colNames[JspBankDepositDetail.JSP_FOREIGN_CREDIT_AMOUNT]%>" size="15" value="<%=JSPFormater.formatNumber(bankDepositDetail.getForeignCreditAmount(), "#,###.##")%>" style="text-align:right" onBlur="javascript:cmdUpdateExchange()" onClick="javascript:cmdClickMeCredit()">
                                                                                                            <%= jspBankDepositDetail.getErrorMsg(jspBankDepositDetail.JSP_FOREIGN_CREDIT_AMOUNT) %> </div>
                                                                                                        </td>
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                        ...
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="center"> 
                                                                                                                <input type="text" name="<%=JspBankDepositDetail.colNames[JspBankDepositDetail.JSP_CREDIT_AMOUNT]%>" value="<%=JSPFormater.formatNumber(bankDepositDetail.getCreditAmount(), "#,###.##")%>" style="text-align:right" size="15"  class="readonly rightalign" readOnly>
                                                                                                            <%= jspBankDepositDetail.getErrorMsg(JspBankDepositDetail.JSP_CREDIT_AMOUNT) %> </div>
                                                                                                        </td>
                                                                                                        <td class="tablecell"> 
                                                                                                            <div align="left"> 
    ...
    if (privAdd == false) {
        ctrLine.setAddCaption("");
                                                                                                                        ...
                                                                                                                        <a href="javascript:cmdNone()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new','','../images/new2.gif',1)"> 
                                                                                                                            <img src="../images/new.gif" name="new" width="71" height="22" border="0"> 
                                                                                                                        </a> 
                                                                                                                        <%}
    }%>
                                                                                                                    </td>
                                                                                                    ...
                                                                                                    <%}
                                                                                if (bankDeposit.getAmount() != 0 && ((iErrCode == 0 && iErrCodeMain == 0 && balance == 0) || listBankDepositDetail.size() > 0)) {%>
                                                                                                    <tr> 
                                                                                                        <td colspan="2"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                <tr> 
    ...
    if (isAkunting) {
        ...
        out.print("<a href=\"../freport/rpt_bankdeposit.jsp?bankdeposit_id=" + bankDeposit.getOID() + "\" onMouseOut=\"MM_swapImgRestore()\" onMouseOver=\"MM_swapImage('prt','','../images/printdoc2.gif',1)\" onclick=\"return hs.htmlExpand(this,{objectType: 'ajax'})\"><img src=\"../images/printdoc.gif\" name=\"prt\" height=\"22\" border=\"0\"></a></div>");
                                                                            ...
                                                                            <%if (bankDeposit.getOID() != 0){%>
                                                                            <tr align="left" valign="top">
                                                                              <td valign="middle" colspan="3"><%@ include file="../printing/printing.jsp"%>&nbsp;</td>
                                                                            </tr>
                                                                            <%}%>
                                                                            <%if (bankDeposit.getOID() != 0){%>
                                                                            <tr align="left" valign="top"> 
        ...
        for (int i = 0; i < temp.size(); i++) {
            ...
            if (apd.getStatus() == DbApprovalDoc.STATUS_APPROVED || apd.getStatus() == DbApprovalDoc.STATUS_NOT_APPROVED) {
                ...
                nama = employee.getName();
                                                                                        ...
                                                                                        %>
                                                                                        <tr> 
                                                                                            <td width="11%"><%=apd.getSequence()%></td><td width="13%"><%=employee.getPosition()%></td>
    ...
    if (user.getEmployeeId() == apd.getEmployeeId()) {
        if (apd.getStatus() == DbApprovalDoc.STATUS_APPROVED) {
                                                                                        ...
                                                                                        <tr><td width="11%">&nbsp;</td><td width="13%">&nbsp;</td><td width="20%">&nbsp;</td><td width="13%">&nbsp;</td><td width="11%">&nbsp;</td><td width="20%">&nbsp;</td><td width="12%">&nbsp;</td>
                                                                                        </tr>
                                                                                    </table>                                                                                    
                                                                                </td>
                                                                            </tr> 
