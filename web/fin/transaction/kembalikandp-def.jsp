                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">DP</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Pengembalian DP</span></font>";
					  %>
                                    ...
                                    <td height="8" valign="top" colspan="3" width="99%"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> 
										  ...
										  %>
                                              ...
                                              <tr> 
                                                <td width="12%" nowrap>Dikembalikan 
                                                  Dari Akun</td>
                                                <td width="1%">&nbsp;</td>
                                                <td colspan="3"> 
                                              ...
                                              <tr> 
                                                <td width="12%">Dikembalikan Oleh</td>
                                                <td width="1%">&nbsp;</td>
                                                <td width="33%"> 
                                                  <%
									  ...
									  %>
										  ...
										  %>
                                                ...
                                                <td width="42%"> 
                                                  <%
									  int counter = DbCashReceive.getNextCounter(DbCashReceive.TYPE_CASH_LIABILITY_PAYMENT);
									  String strNumber = DbCashReceive.getNextNumber(counter,DbCashReceive.TYPE_CASH_LIABILITY_PAYMENT);
                                      ...
                                      <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td rowspan="2"  class="tablehdr" nowrap width="10%">Supplier</td>
