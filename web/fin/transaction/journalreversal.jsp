...
<%
            ...
            String[] langJR = {"Journal Number", "Transaction Date", "Reference Number", "Reversal Type", "Journal Detail", //0-4
                ...
                "Out of Balance", "Journal is ready to be saved.", "Error!, tidak bisa posting journal dengan detail gabungan SP dan NSP.", "Journal has been saved successfully.", "Search Journal Number","Memo","Period"}; //14-20
            ...
            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Tanggal Transaksi", "Nomor Referensi", "Tipe Reversal", "Detail Jurnal",
                    ...
                    "Out of Balance", "Jurnal siap disimpan.", "Error, tidak bisa posting journal dengan detail gabungan SP dan NSP.", "Jurnal sukses disimpan.", "Cari Nomor Jurnal","Memo","Periode"
                };
                langJR = langID;
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr> 
                                                                                            <td colspan="4"> 
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr> 
                                                                                                        <td width="31%"><B><U><%=langNav[3]%></U></B></td>
                                                                                                        <td width="32%">&nbsp;</td>
                                                                                                        <td width="37%"> 
            ...
            if (isLoad) {
                ...
                glId = gl.getOID();
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="23%"> 
                                                                                                            <%
            Vector periods = new Vector();Periode preClosedPeriod = new Periode();
            ...
            if (gl.getOID() != 0) {
                strNumber = gl.getJournalNumber();
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="10%" valign="top"><%=langJR[19]%></td><td width="3%">&nbsp;</td>
                                                                                                        <td width="23%" valign="top">
                                                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td><textarea name="<%=JspGl.colNames[JspGl.JSP_MEMO]%>" cols="40" rows="3"><%=gl.getMemo()%></textarea></td>
                                                                                            ...
                                                                                            <td> 
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr > 
                                                                                                        ...
                                                                                                        <td class="tab" nowrap><%=langJR[4]%></td>
                                                                                                        ...
                                                                                                        <%} else {%>
                                                                                                        <td nowrap class="tabheader"><font color="#FF0000">&nbsp;GL with no expense account, ( Non activity transaction )</font></td>
                                                                                                        <%}%>
                                                                                                        <%}%>
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr> 
                                                                                                        <td width="100%" class="page"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                <tr> 
                                                                                                                    <td rowspan="2"  class="tablehdr" nowrap width="21%"><%=langJR[5]%></td><td rowspan="2" class="tablehdr"><%=langJR[6]%></td>
                                                                                                                    <td rowspan="2" class="tablehdr">&nbsp;</td><td colspan="2" class="tablehdr"><%=langJR[7]%></td>
                                                                                                                    <td rowspan="2" class="tablehdr" width="7%"><%=langJR[10]%></td><td rowspan="2" class="tablehdr" width="15%"><%=langJR[11]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    <td width="4%" class="tablehdr"><%=langJR[8]%></td><td width="19%" class="tablehdr"><%=langJR[9]%></td>
                                                                                                                </tr>
                                                                                                                <%
            if (listGlDetail != null && listGlDetail.size() > 0){
                int ct = 0;
     ...
     if (currencies != null && currencies.size() > 0) {
         for (int x = 0; x < currencies.size(); x++) {
             Currency c = (Currency) currencies.get(x);
                                                                                                                ...
                                                                                                                <%}%>
                                                                                                                <tr> 
                                                                                                                    <td class="tablecell" colspan="6" height="1"></td><td width="15%" class="tablecell" height="1"> <div align="right"></div></td>
                                                                                                                    <td width="15%" class="tablecell" height="1"><div align="right"></div></td><td width="15%" class="tablecell" height="1">&nbsp;</td>
                                                                                                                </tr>
                                                                                                                <tr> 
...
%>
                                                                                            ...
                                                                                            <td width="23%" class="boxed1"> 
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="59%"><div align="right"><b><a id="tot_balance"></a></b></div></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
                ...
                System.out.println("[exception] " + exc.toString());
                                                                            ...
                                                                            <%} else {%>
                                                                            <tr align="left" valign="top"><td valign="middle" colspan="3"> <font color="#FF0000"><%=langJR[16]%></font></td></tr>
                                                                            <%}
            }%>
                                                                            <%if (gl.getOID() != 0) {%>
                                                                            <tr align="left" valign="top"> 
                                                                                            ...
                                                                                            <td width="38%"> 
                                                                                                ...
                                                                                                <div align="right" class="msgnextaction"> 
                                                                                                    <table border="0" cellpadding="5" cellspacing="0" class="success" align="right">
                                                                                                        <tr><td width="20"><img src="../images/success.gif" width="20" height="20"></td><td width="220"><%=langJR[17]%></td></tr>
                                                                                                    </table>
                                                                                                </div>
                                                                                                <%}%>
                                                                                            </td>
                                                                                ...
                                                                                <td valign="middle" colspan="3"> 
                                                                                    <div align="left" class="msgnextaction"> 
                                                                                        <table border="0" cellpadding="5" cellspacing="0" class="success" align="left">
                                                                                            <tr><td width="20"><img src="../images/success.gif" width="20" height="20"></td><td width="150">Posted</td></tr>
                                                                                        </table>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
