...
<!-- Jsp Block -->
<%!
    public String drawList(Vector objectClass, int start, String[] lang) {
...
<%
            ...
            String srcStatus = I_Project.DOC_STATUS_APPROVED;
            ...
            /*** LANG ***/
            String[] langAP = {"Search Parameters", "Vendor", "PO Between", "and", "Ignored", "Document Status", //0-5
                "No", "Number", "Date", "Reference", "Receive Loc.", "Vendor", "Amount", "Status", "Notes"}; //6-14

            String[] langNav = {"Account Payable", "Incoming Goods List", "Date"};

            if (lang == LANG_ID) {
                String[] langID = {"Parameter Pencarian", "Pemasok", "Pembelian Tanggal", "sampai", "Abaikan", "Status Dokumen", //0-5
                    "No", "Nomor Faktur", "Tanggal", "Referensi", "Lokasi Penerimaan", "Pemasok", "Jumlah", "Status", "Catatan"}; //6-14
                langAP = langID;

                String[] navID = {"Hutang", "Daftar Penerimaan Barang", "Tanggal"};
                langNav = navID;
            }
%>
<html >
            ...
            try {
                if (listReceive.size() > 0){
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            ...
                                                                                            <%= drawList(listReceive, start, langAP)%> </td>
                                                                                        </tr>
                                                                                        <tr align="left" valign="top"> 
