...
<%
            ...
            String[] langCT  = {"Vendor","Address","Receive In","Incoming Number","DO Number","Currency","Invoice Number","Applay VAT","Term Of Payment","Payment Type","Notes","Doc Status","Date","Location" // 0-13
                                ,"Group/Category/Code - Name","Price","Qty","Discount","Total","Unit","AP Coa","Sub Total","Discount","VAT","Grand Total","Set Status to" //14 - 25
            };  
                     
            String[] langNav = {"Account Payable","Incoming Goods","Date","Incoming Goods","Records"}; // 0 - 4            
            String[] langApp = {};
            if (lang == LANG_ID) {
                String[] langID = {"Pemasok","Alamat","Lokasi Penerimaan","No. Incoming","No. Surat Jalan","Mata Uang","No. Faktur","Menggunakan Pajak","Jangka Waktu Pemb.","Type Pembayaran","Memo","Status Dok.","Tanggal","Lokasi" // 0 - 13
                ,"Group/Kategori/Kode - Nama","Harga","Jumlah","Diskon","Total","Unit","Coa Hutang","Sub Total","Diskon","Ppn","Total","Status" // 14 - 25
                };
                langCT = langID;
                
                String[] navID = {"Hutang","Barang Masuk","Tanggal","Barang Masuk","Arsip"}; // 0 - 4
                langNav = navID;
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/new2.gif','../images/yes2.gif','../images/cancel2.gif','../images/print2.gif','../images/close2.gif','../images/savedoc2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (receive.getPurchaseId() != 0) {
                ...
                try {
                    purchase = DbPurchase.fetchExc(receive.getPurchaseId());
                                                                                                    ...
                                                                                                    <%}%>
                                                                                                    <tr align="left"> 
                                                                                                        <td height="20" width="12%">&nbsp;&nbsp;<%=langCT[0]%></td>
            ...
            if (receive.getVendorId() == 0) {%>
                                                                                                        ...
                                                                                                        <td height="20" width="11%"><%=langCT[2]%></td>
        ...
        ig.setReceiveIn(loc.getCode() + " - " + loc.getName());
            ...
            if (receive.getOID() == 0) {
                ...
                ig.setDocNumber(number);
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="21" width="12%">&nbsp;&nbsp;<%=langCT[4]%></td>
            ...
            out.println(curr.getCurrencyCode());
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="21" width="12%">&nbsp;&nbsp;<%=langCT[6]%></td>
                                                                                                        <td height="21" width="30%"> 
            ...
            if (receive.getStatus() == null || receive.getStatus().length() == 0) {
                ...
                receive.setStatus(I_Project.DOC_STATUS_DRAFT);
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="21" width="12%">&nbsp;&nbsp;<%=langCT[12]%></td>
                                                                                                        <td height="21" width="30%"> 
            ...
            payment_value.add(I_Project.PAYMENT_TYPE_CREDIT);
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="21" width="12%" valign="top">&nbsp;&nbsp;<%=langCT[10]%></td>
                                                                                                        <td height="21" width="30%"> 
                                                                                                        <textarea name="<%=JspReceive.colNames[JspReceive.JSP_NOTE]%>" cols="45" rows="2"><%=receive.getNote()%></textarea>
                                                                                                        <%ig.setNotes(receive.getNote());%>
                                                                                                        </td>
                                                                                                        <td height="21" width="11%" valign="top"></td>
            ...
            String strList = (String) x.get(0); Vector rptObj = (Vector) x.get(1);
                                                                                                            %>
                                                                                                    ...
                                                                                                    <tr align="left" > 
                                                                                                        <td colspan="5" valign="top"> 
                                                                                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                ...
                                                                                                                                <td width="14%"> 
                                                                                                                                    <select name="<%=JspReceive.colNames[JspReceive.JSP_STATUS]%>" onChange="javascript:cmdClosedReason()">
                                                                                                                                        ...
                                                                                                                                        <option value="<%=I_Project.DOC_STATUS_CHECKED%>" <%if (receive.getStatus().equals(I_Project.DOC_STATUS_CHECKED)) {%>selected<%}%>>CHECKED AS INVOICE 
                                                                                                                ...
                                                                                                                <%if(isItemOk == false){%>
                                                                                                                <tr>    
                                                                                                                    <td colspan="4" class="errfont">Can't save, Item master is empty</td>
                                                                                                                </tr> 
                                                                                                                <tr>    
                                                                                                                    <td colspan="4" >&nbsp;</td>
                                                                                                                </tr>
                                                                                                                <%}%>
                                                                                                                <tr> 
                                                                                                                    <%if ((!receive.getStatus().equals(I_Project.DOC_STATUS_CHECKED) || iErrCode != 0) && isItemOk){%>
