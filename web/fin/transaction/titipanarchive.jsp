...
<%}%>
	...
	function cmdSearch(){
		...
		document.frmcasharchive.action="titipanarchive.jsp";
                                              ...
                                              <tr> 
												...
												%>
                                                  <select name="<%=jspCashArchive.colNames[jspCashArchive.JSP_SEARCH_FOR] %>" onChange="javascript:cmdSearch()">
												  	<%if(cashRecView){%>
                                                    <option value="cashreceive" <%if(cashArchive.getSearchFor().equals("cashreceive")){%> selected <%}%>>Titipan Uang</option>
													<option value="cashpayment" <%if(cashArchive.getSearchFor().equals("cashpayment")){%> selected <%}%>>Pengembalian Titipan</option>
													<%}%>
                                                  </select>
                                                </td>
                                    ...
                                    <td class="boxed1">
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          ...
                                          <td width="13%" class="tablehdr">Penitip/Unit</td>
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablecell" width="13%"><%=v.getCode()+ " - "+v.getName()%></td>
                                        ...
                                        <tr> 
                                          ...
                                          <td class="tablecell1" width="13%"><%=v.getCode()+ " - "+v.getName()%></td>
