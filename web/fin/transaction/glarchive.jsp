...
<%
            ...
            String src_debet = JSPRequestValue.requestString(request, "src_debet");
            ...
            System.out.println("periode id " + glArchive.getPeriodeId());
            ...
            whereClause = DbGl.colNames[DbGl.COL_IS_REVERSAL] + " = " + DbGl.IS_NOT_REVERSAL;
            ...
            vectSize = DbGl.getCountGLReguler(DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, 0, 0, null, type,src_memo,src_debet);
            ...
            if ((iCommand == JSPCommand.FIRST || iCommand == JSPCommand.PREV) ||
                ...
                listGlArchive = DbGl.getGLReguler(DbGl.IS_NOT_REVERSAL, glArchive.getJournalNumber(), glArchive.getIgnoreTransactionDate(), glArchive.getTransactionDate(), glArchive.getPeriodeId(), glArchive.getIgnoreInputDate(), glArchive.getStartDate(), glArchive.getEndDate(), srcRefNumber, start, recordToGet, orderClause, type,src_memo,src_debet);
            }

            /*** LANG ***/
            String[] langGL = {"Journal Number", "Reference Number", "Input Date", "to", "Ignore", //0-4
                "Period", "Transaction Date", "General Journal List", "Memo", "Please click search button to get your data.", "Data not found.", "Debet", "Credit","Advance Journal","Notes","Debet"}; //5-15

            String[] langNav = {"General Journal", "Archives", "Date", "General Journal", "Advance Journal", "Type"};

            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Nomor Referensi", "Tanggal Dibuat", "sampai", "Abaikan", //0-4
                    "Periode", "Tanggal Transaksi", "Daftar Jurnal Umum", "Memo", "Silahkan tekan tombol pencarian untuk menampilkan data.", "Data tidak ditemukan.", "Debet", "Credit","Daftar Jurnal Kasbon","Memo","Debet"}; //5-15
                langGL = langID;

                String[] navID = {"Jurnal Umum", "Arsip", "Tanggal", "Jurnal Umum", "Jurnal Kasbon", "Type"};
                langNav = navID;
            }
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdEditGl(oidGl){
                ...
                document.frmglarchive.action="gldetail.jsp";
                document.frmglarchive.submit();
            ...
            if (p != null && p.size() > 0) {
                for (int i = 0; i < p.size(); i++) {
                    Periode period = (Periode) p.get(i);
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="13%"><%=langGL[14]%></td>
                                                                                                        <td width="26%"><input type="text" name="src_memo"  value="<%=src_memo%>"></td>
                                                                                                        <td width="10%"><%=langGL[15]%>&nbsp;</td>
                                                                                                        <td width="51%"><input type="text" name="src_debet"  value="<%=src_debet%>"></td>
                                                                                                    </tr>
                                                                                                    <%if(false){%>
                                                                                                    <tr> 
                                                                                                        <td width="13%"><%=langNav[5]%></td>
                                                                                                        <td width="26%"> 
                                                                                                            <select name="TYPE">
                                                                                                                <option value="<%=DbGl.TYPE_JURNAL_UMUM%>" <%if (type == DbGl.TYPE_JURNAL_UMUM) {%>selected<%}%>><%=langNav[3]%></option>
                                                                                                                <option value="<%=DbGl.TYPE_JURNAL_KASBON%>" <%if (type == DbGl.TYPE_JURNAL_KASBON) {%>selected<%}%>><%=langNav[4]%></option>
                                                                                                            </select>
                                                                                                        </td>
                                                                                                        <td width="10%">&nbsp;</td>
                                                                                                        <td width="51%">&nbsp;</td>
            ...
            if (listGlArchive != null && listGlArchive.size() > 0) {
                                                                            ...
                                                                            <tr> 
                                                                                <td class="boxed1"> 
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr> 
                                                                                            <td colspan="6"><b><font size="2" face="arial"><%=langGL[7]%></font></b> </td>
                                                                                        </tr>
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="15%" class="tablehdr"><%=langGL[11]%></td>
                                                                                            <td width="15%" class="tablehdr"><%=langGL[12]%></td>
                                                                                            <td width="30%" class="tablehdr"><%=langGL[8]%></td>
                                                                                        </tr>
                                                                                        <%
                                                                                for (int i = 0; i < listGlArchive.size(); i++) {
                                                                                    ...
                                                                                    try {
                                                                                        Vector result = DbGlDetail.getDebCredit(bd.getOID());
                                                                                    ...
                                                                                    if (i % 2 != 0) {
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tablecell" > 
                                                                                                <div align="center"><%=JSPFormater.formatDate(bd.getTransDate(), "dd/MM/yyyy")%></div>
                                                                                            </td>
                                                                                            <td class="tablecell" > 
                                                                                                <div align="center"><%=bd.getRefNumber()%></div>
                                                                                            </td>
