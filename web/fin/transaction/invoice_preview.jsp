...
<%!
    public Vector drawList(int iJSPCommand, JspReceiveItem frmObject,
        ...
        jsplist.addHeader(""+langCT[15], "25%");
        jsplist.addHeader(""+langCT[16], "10%");
        jsplist.addHeader(""+langCT[17], "5%");
        jsplist.addHeader(""+langCT[18], "10%");
        jsplist.addHeader(""+langCT[19], "10%");
        jsplist.addHeader(""+langCT[20], "7%");
        jsplist.addHeader(""+langCT[21], "25%");
...
<%
            ...
            String[] langCT = {"Location","Vendor","Address","DO Number","Invoice Number","Date","Payment Type","Notes",  //0 -7
            "Location","Doc Number","Currency","Status","Applay VAT","Term Of Payment","PO Number","Group/Category/Code - Name","Price","Qty","Discount","Total","Unit","AP Coa", // 8- 21
            "Sub Total","Discount","VAT","Grand Total"}; // 22 - 25
            
            String[] langNav = {"Account Payable","Invoice Detail","Invoice Data","Archives"};            
            String[] langApp = {};

            if(lang == LANG_ID){
                
                String[] langID = {"Lokasi","Pemasok","Alamat","No. Surat Jalan","No. Faktur","Tanggal","Tipe Pembayaran","Memo", // 0- 7
                "Lokasi","Nomor Dok.","Mata uang","Status","Pajak","Waktu Pemb.","No. Pembelian","Grup/Kategori/Kode - Nama","Harga","Jumlah","Diskon","Total","Satuan","COA Hutang", // 8 - 21
                "Sub Total","Diskon","Pajak","Total"}; // 22 - 25
                
                
                langCT = langID;
                String[] navID = {"Hutang","Detail Faktur","Data Faktur","Arsip"};
                langNav = navID;
 ...
 function cmdVendorChange(){
    ...
    try {
        us = DbUser.fetch(receive.getUserId());
                                                                                                    ...
                                                                                                    <%if(false){%>
                                                                                                    <tr align="left"> 
                                                                                                        <td height="20" width="12%"><b>&nbsp;&nbsp;AP for Unit Usaha</b></td>
            ...
            if (receive.getPurchaseId() != 0) {
                ...
                try {
                    purchase = DbPurchase.fetchExc(receive.getPurchaseId());
                                                                                                    ...
                                                                                                    %>
                                                                                                    <tr align="left"> 
                                                                                                        <td height="20" width="12%">&nbsp;&nbsp;<b><%=langCT[14]%></b></td>
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="20" width="12%">&nbsp;&nbsp;<b>PO Date </b></td>
                                                                                                    ...
                                                                                                    <%}%>
                                                                                                    <tr align="left"> 
                                                                                                        <td height="20" width="12%">&nbsp;&nbsp;<b><%=langCT[1]%></b></td>
                                                                                                        <td height="20" width="30%"> 
            ...
            try {
                ...
                ig.setAddress(vnd.getAddress());
                                                                                                        ...
                                                                                                        <td height="20" width="11%"><b><%=langCT[8]%></b></td>
            ...
            try {
                ...
                ig.setReceiveIn(loc.getCode() + " - " + loc.getName());
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="20" width="12%">&nbsp;&nbsp;<b><%=langCT[2]%></b></td>
                                                                                                        <td height="20" width="30%"> <%=vnd.getAddress()%> </td>
                                                                                                        <td width="11%" height="20"><b><%=langCT[9]%></b></td>
            ...
            ig.setDocNumber(number);
                                                                                                    ...
                                                                                                    <tr align="left"> 
                                                                                                        <td height="21" width="12%">&nbsp;<b>&nbsp;<%=langCT[3]%></b></td>
                                                                                                        <td height="21" width="30%"> <%=receive.getDoNumber()%> </td>
                                                                                                        <td width="11%"><b><%=langCT[10]%></b></td>
            ...
            out.println(curr.getCurrencyCode());
                                                                                                    ...
                                                                                                    <td height="5" colspan="5"></td>
                                                                                                    <tr align="left"> 
                                                                                                    <td height="21" width="12%">&nbsp;&nbsp;<b><%=langCT[7]%></b></td>
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <td width="55%"> 
                                                                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr> 
                                                                                                                                <td width="60%"> 
                                                                                                                                    <div align="right"><b><%=langCT[25]%></b></div>
                                                                                                                                </td>
                                                                                                                                <td width="17%">&nbsp;</td>
                                                                                                                                <td width="23%"> 
                                                                                                                                    <div align="right"> 
