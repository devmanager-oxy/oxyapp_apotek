    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdSearchJurnal(){
                window.open("<%=approot%>/transaction/s_nomjurnal_pattycashreplenishment.jsp?formName=frmpettycashreplenishment&txt_Id=cash_id&txt_Name=jurnal_number", null, "height=400,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                }                
