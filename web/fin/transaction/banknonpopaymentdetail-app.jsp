...
<%-- 
    Document   : banknonpopaymentdetail-app
    Created on : Feb 28, 2012, 4:47:18 PM
    Author     : Roy Andika
--%>
            ...
            if (iJSPCommand == JSPCommand.SUBMIT) {
                ...
                if (iErrCode == 0 && iErrCodeRec == 0) {
                    if (recIdx == -1) {
                        ...
                        BanknonpoPayment bdd = (BanknonpoPayment) listBanknonpoPaymentDetail.get(recIdx);
                        banknonpoPayment.setOID(bdd.getOID());
                        listBanknonpoPaymentDetail.set(recIdx, banknonpoPayment);
                    }
                }
            }
