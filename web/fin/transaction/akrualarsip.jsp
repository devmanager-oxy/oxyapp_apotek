...
/* end switch*/
            ...
            /*** LANG ***/
            String[] langAT = {"Period", "Date", "Name", "Budget", "Total Accrual", "Remains", "Accrual Amount", "User"}; //0-7

            String[] langNav = {"Recurring Journal", "Archives", "Date"};

            if (lang == LANG_ID) {
                String[] langID = {"Periode", "Tanggal", "Nama", "Anggaran", "Total Akrual", "Saldo", "Jumlah Akrual", "Pengguna"};
                langAT = langID;
...
<html >
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSrc(){
                document.frmakrualsetup.action="akrualarsip.jsp";
                                                                                ...
                                                                                <td>
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="18%" class="tablehdr"><%=langAT[2]%></td>
                                                                                            <td width="14%" class="tablehdr"><%=langAT[3]%></td>
                                                                                            <td width="16%" class="tablehdr"><%=langAT[4]%></td>
                                                                                            <td width="14%" class="tablehdr"><%=langAT[5]%></td>
                                                                                            <td width="14%" class="tablehdr"><%=langAT[6]%><br>
                                                                                            <%=selectPer.getName()%> </td>
                                                                                            <td width="13%" class="tablehdr"><%=langAT[7]%></td>
                                                                                        </tr>
