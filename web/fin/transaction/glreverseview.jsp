...
<%
            ...
            /*** LANG ***/
            String[] langLR = {"Journal Number", "Reference Number", "Memo", "Transaction Date", //0-3
                "Account - Description", "Department", "Currency", "Booked Rate", "Debet", "Credit", "Description", "Code", "Amount"}; //4-12

            String[] langNav = {"Reversal Journal", "Archives", "Date"};

            if (lang == LANG_ID) {
                String[] langID = {"Nomor Jurnal", "Nomor Referensi", "Memo", "Tanggaal Transaksi", //0-3
                    "Perkiraan", "Departemen", "Mata Uang", "Kurs Transaksi", "Debet", "Credit", "Keterangan", "Kode", "Jumlah"}; //4-12
                langLR = langID;
                                                                                                            ...
                                                                                                            <table id="list" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr> 
                                                                                                                    <td> 
                                                                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                            <tr> 
                                                                                                                                <td rowspan="2"  class="tablehdr" nowrap width="25%"><%=langLR[4]%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="5%">&nbsp;</td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="24%"><%=langLR[5]%></td>
                                                                                                                                <td colspan="2" class="tablehdr"><%=langLR[6]%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="5%"><%=langLR[7]%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="8%"><%=langLR[8]%> <%=baseCurrency.getCurrencyCode()%></td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="8%"><%=langLR[9]%> <%=baseCurrency.getCurrencyCode()%> </td>
                                                                                                                                <td rowspan="2" class="tablehdr" width="13%"><%=langLR[10]%></td>
                                                                                                                            </tr>
                                                                                                                            <tr> 
                                                                                                                                <td width="4%" class="tablehdr"><%=langLR[11]%></td>
                                                                                                                                <td width="8%" class="tablehdr"><%=langLR[12]%></td>
                                                                                                                            </tr>
                                                                                                                            <%
