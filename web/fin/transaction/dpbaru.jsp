...
%>
<%
boolean cashPriv = true;//QrUserSession.isHavePriviledge(appSessUser.getUserOID(), AppMenu.M1_MENU_CASH, AppMenu.M2_MENU_CASH_RECERIVE);
%>
<!-- Jsp Block -->
<%!
...
Vector custs = DbVendor.list(0,0,"type=0", "");
...
String wherex = "((account_group='"+I_Project.ACC_GROUP_LIQUID_ASSET+"')"+// or account_group='"+I_Project.ACC_GROUP_OTHER_REVENUE+"')"+
...
function cmdPrintJournal(){	 
	...
	window.open("<%=printroot%>.report.RptTitipanAndKembaliPDF?oid=<%=appSessUser.getLoginId()%>&crd_id=<%=cashReceive.getOID()%>&type=<%=cashReceive.getType()%>");
}
...
function cmdFixing(){	
	...
	document.frmcashreceivedetail.action="dpbaru.jsp";
...
function cmdDelPict(oidCashReceiveDetail){
	...
	document.frmimage.action="dpbaru.jsp";
                ...
                <td width="100%" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
					  ...
					  <%
					  String navigator = "<font class=\"lvl1\">DP</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">New DP</span></font>";
					  %>
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmcashreceivedetail" method ="post" action="">
						  ...
						  <input type="hidden" name="<%=JspCashReceive.colNames[JspCashReceive.JSP_TYPE]%>" value="<%=DbCashReceive.TYPE_DP%>">
                                  ...
                                  <tr align="left" valign="top"> 
                                    ...
                                    <td height="8" valign="top" colspan="3" width="99%"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										%>
                                                    <option value="<%=coax.getOID()%>" <%if(cashReceive.getCoaId()==coax.getOID()){%>selected<%}%>><%=str+coax.getCode()+" - "+coax.getName()%></option>
                                                    <%}}%>
                                                  </select>
									  ...
									  %>
										  ...
										  %>
                                                ...
                                                <td width="42%"> 
                                                  <%
									  int counter = DbCashReceive.getNextCounter(DbCashReceive.TYPE_CASH_LIABILITY);
									  String strNumber = DbCashReceive.getNextNumber(counter, DbCashReceive.TYPE_CASH_LIABILITY);
									  ...
									  %>
                                              ...
                                              <tr> 
                                                <td width="10%">Junlah <%=baseCurrency.getCurrencyCode()%></td>
                                                <td width="3%"> 
                                                  <div align="right"></div>
                                                </td>
                                                <td width="33%"> 
                                      ...
                                      <table width="99%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td class="boxed1"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                <td rowspan="2"  class="tablehdr" nowrap width="15%">Supplier</td>
                                                <td rowspan="2"  class="tablehdr" nowrap width="13%">Akun 
                                                  Kas/Bank - Keterangan</td>
                                                <td colspan="2" class="tablehdr"> 
                                                  Mata Uang</td>
                                                <td rowspan="2" class="tablehdr" width="7%">Booked 
                                                  <br>
                                                  Rate</td>
                                                <td rowspan="2" class="tablehdr" width="8%">Jumlah 
                                                  <%=baseCurrency.getCurrencyCode()%></td>
                                                <td rowspan="2" class="tablehdr" width="39%">Keterangan</td>
                                              </tr>
                                              <tr> 
									...
									if(((iJSPCommand==JSPCommand.EDIT || iJSPCommand==JSPCommand.ASK) || (iJSPCommand==JSPCommand.SUBMIT && iErrCode!=0)) && i==recIdx){%>
                                                ...
                                                <td class="<%=cssName%>" width="13%"> 
                                                  <select name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_COA_ID]%>">
                                                    <%if(accLinks!=null && accLinks.size()>0){
													  ...
													  %>
                                                    <option <%if(crd.getCoaId()==coa.getOID()){%>selected<%}%> value="<%=coa.getOID()%>"><%=coa.getCode()+" - "+coa.getName()%></option>
											...
											if(currencies!=null && currencies.size()>0){
										  	...
										  	%>
                                                ...
                                                <td width="7%" class="<%=cssName%>"> 
                                                  <div align="center"> 
                                                    <input type="text" name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_BOOKED_RATE]%>" size="5" value="<%=JSPFormater.formatNumber(crd.getBookedRate(), "#,###.##")%>"  class="readonly rightalign" readOnly>
                                                  </div>
                                                </td>
                                                <td width="8%" class="<%=cssName%>"> 
                                                  <div align="center"> 
                                              ...
                                              <%}else{%>
                                              <tr> 
                                                <td class="<%=cssName%>" nowrap width="15%"> 
                                                  <%
                                                ...
                                                <td class="<%=cssName%>" nowrap width="13%"> 
									  ...
									  %>
                                                ...
                                                <td width="39%" class="<%=cssName%>"><%=crd.getMemo()%></td>
                                              </tr>
                                              <%}%>
                                              <%}}%>
                                              <%
									...
									if((iJSPCommand==JSPCommand.ADD || (iJSPCommand==JSPCommand.SUBMIT && iErrCode!=0)) && recIdx==-1 ){%>
                                                ...
                                                <td class="tablecell" width="13%"> 
                                                  <select name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_COA_ID]%>">
                                                    <%if(accLinks!=null && accLinks.size()>0){
													  ...
													  %>
                                                    <option <%if(cashReceiveDetail.getCoaId()==coa.getOID()){%>selected<%}%> value="<%=coa.getOID()%>"><%=coa.getCode()+" - "+coa.getName()%></option>
                                                    <%=getAccountRecursif(coa, cashReceive.getCoaId(), isPostableOnly)%> 
                                                    <%}}else{%>
                                                    <option>select ..</option>
                                                    <%}%>
										  ...
										  %>
                                                ...
                                                <td width="7%" class="tablecell"> 
                                                  <div align="center"> 
                                                    <input type="text" name="<%=JspCashReceiveDetail.colNames[JspCashReceiveDetail.JSP_BOOKED_RATE]%>" size="5" value="<%=JSPFormater.formatNumber(cashReceiveDetail.getBookedRate(), "#,###.##")%>" style="text-align:right"  class="readonly rightalign" readOnly>
                                                  </div>
                                                </td>
