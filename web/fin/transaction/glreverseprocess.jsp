...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    ...
    try {
     ...
     int counterx = DbSystemDocNumber.getNextCounterGl(open.getOID());

     String strNumber = DbSystemDocNumber.getNextNumberGl(counterx, open.getOID());
     ...
     //}
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="10%"><%=langGL[2]%></td>
                                                                                                        <td width="3%">&nbsp;</td>
                                                                                                        <td width="87%"><input type="text" name="<%=JspGl.colNames[JspGl.JSP_JOURNAL_NUMBER]%>" value="<%=strNumber%>" size="20"></td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td width="10%"><%=langGL[4]%></td>
                                                                                                        <td width="3%">&nbsp;</td>
