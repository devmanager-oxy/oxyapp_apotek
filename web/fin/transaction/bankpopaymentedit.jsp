...
<%
            ...
            String[] langNav = {"Bank", "PO Payment", "Date", "Invoice", "Vendor", "Currency", "Location", "Balance",
            ...
            if (lang == LANG_ID) {
                ...
                langCT = langID;
                String[] navID = {"Bank", "Order Pembelian", "Tanggal", "Tagihan", "Pemasok", "Mata uang", "Lokasi", "Balance",
