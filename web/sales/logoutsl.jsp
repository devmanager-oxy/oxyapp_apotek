...
<%
            try {
                ...
                response.sendRedirect(rootLogout);
            } catch (Exception exc) {
...
<html>
    <head>
        <title><%=titleSP%> - Logout</title>
        <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
        <link rel="stylesheet" href="css/css.css" type="text/css">
        <script language="JavaScript">            
            function cmdHome(){
                window.location="<%=approotx%>";
            }
        </script>
    </head>
                ...
                <td height="100%">
                    <table width="33%" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr> 
                            ...
                            <td height="130" width="48%" nowrap><font size="2" color="#000000"><b>System Logout</b><br>
                                    <br>
