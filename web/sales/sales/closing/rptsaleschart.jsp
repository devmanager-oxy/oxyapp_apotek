                                                        ...
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                          <tr valign="bottom"> 
                                                            <td width="60%" height="23"><b><font color="#990000" class="lvl1">Sales 
                                                              ...
                                                              <span class="lvl2">Closing Sale Report<br>
                                                              </span></font></b></td>
                                                          ...
                                                          <tr align="left" valign="top"> 
                                                            <td height="8" valign="middle" colspan="3"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                ...
                                                                <tr> 
                                                                  <td width="10%" height="14" nowrap>Date                                                                    </td>
                                                                ...
                                                                <tr> 
                                                                  ...
                                                                  <td height="14" colspan="3"> 
                                                                    ...
                                                                    <a hreft="javascript:cmdchange()">Refresh Shift</a></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                  <td height="15" colspan="4"><img src="getChart.jsp?type=bar&action=showProfits" alt="Progress chart" /></td>
                                                                </tr>
                                                                <tr>
                                                                  <td height="15">&nbsp;</td>
                                                                  <td height="15">&nbsp;</td>
