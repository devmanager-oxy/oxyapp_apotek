    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPrintJournalXls(){	                       
                window.open("<%=printroot%>.report.RptSalesClosingXLS?user_id=<%=appSessUser.getUserOID()%>&lang=<%=lang%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                }
                                                                                                                            ...
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                <td height="8" valign="middle" colspan="3"> 
                                                                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                        ...
                                                                                                                                        <tr height="22"> 
                                                                                                                                            <td width="10%" height="14" nowrap class="tablearialcell1">&nbsp;Date</td>
                                                                                                                                        ...
                                                                                                                                        <tr height="22"> 
                                                                                                                                            <td width="10%" height="14" nowrap class="tablearialcell1">&nbsp;Location</td>
            ...
            if (user.getSegment1Id() != 0) {
                ...
                for (int i = 0; i < vLoc.size(); i++) {
                    ...
                    if (lokId == 0) {
                                                                                                                                        ...
                                                                                                                                        <tr height="22">
                                                                                                                                            <td class="tablearialcell1">&nbsp;Shift </td>
                                                                                                                                            <td colspan="3">:
                                                                                                                                                <%
            Vector vShift = SQLGeneral.getShift(locationId, tanggal);
                                                                                                                                                %>
                ...
                for (int i = 0; i < vShift.size(); i++) {
                    Shift shift = (Shift) vShift.get(i);
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td height="15" colspan="4"><%@ include file ="transaksi.jsp"%></td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td height="15">&nbsp;</td>
                                                                                                                                            <td height="15">&nbsp;</td>
