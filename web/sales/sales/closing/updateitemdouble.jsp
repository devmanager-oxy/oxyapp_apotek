...
if(iJSPCommand==JSPCommand.SUBMIT){
	SQLGeneral.checkAndDeleteItemSalesNotPosted();
}
...
function cmdSearch(){
	...
	document.frmsales.action="updateitemdouble.jsp?menu_idx=<%=menuIdx%>";
                                                        ...
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                          <tr valign="bottom"> 
                                                            <td width="60%" height="23"><b><font color="#990000" class="lvl1">Sales 
                                                              ...
                                                              <span class="lvl2">Summary Sale Report<br>
                                                              </span></font></b></td>
                                                            ...
                                                            <td height="8" valign="middle" colspan="3"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                <tr> 
                                                                  ...
                                                                  <td height="33" colspan="3"><a href="javascript:cmdSearch()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('save2','','../../images/save2.gif',1)"><img src="../../images/save.gif" name="save2" border="0"></a>                                                                  </td>
                                                                </tr>
                                                                <tr> 
