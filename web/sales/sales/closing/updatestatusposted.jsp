...
if(iJSPCommand==JSPCommand.SUBMIT){
	SQLGeneral.checkAndUpdateSalesPosted();
}
...
function cmdSearch(){
	...
	document.frmsales.action="updatestatusposted.jsp?menu_idx=<%=menuIdx%>";
                                                            ...
                                                            <td height="8" valign="middle" colspan="3"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                <tr> 
                                                                  ...
                                                                  <td height="33" colspan="3"><a href="javascript:cmdSearch()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('save2','','../../images/save2.gif',1)"><img src="../../images/search.gif" name="save2" border="0"></a>                                                                  </td>
                                                                </tr>
                                                                <tr> 
