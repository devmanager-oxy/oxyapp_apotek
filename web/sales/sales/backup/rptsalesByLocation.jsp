...
<html >
                                                                                                                                            ...
                                                                                                                                            <td class="boxed1">
                                                                                                                                                <table width="1500" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                                    ...
                                                                                                                                                    <tr> 
                                                                                                                                                        ...
                                                                                                                                                        <td class="tablearialhdr" colspan="2" >PPH</td>                                                                                        
                                                                                                                                                    </tr>
                                                                                                                                                    <tr>
    ...
    dQty = dQty + (sd.getQty());
                                                                                                                                                        ...
                                                                                                                                                        <td class="tablearialcell" > 
                                                                                                                                                            <div align="right">       
                                                                                                                                                                <%=(temp.size() == 1) ? "<B>" : ""%>
                                                                                                                                                                <%=JSPFormater.formatNumber(sales.getPphPercent(), "#,###.##")%> 
                                                                                                                                                                <%=(temp.size() == 1) ? "</B>" : ""%>
                                                                                                                                                            </div>
                                                                                                                                                        </td>
                                                                                                                                                        <td class="tablearialcell" > 
                                                                                                                                                            <div align="right">                                                                                             
                                                                                                                                                                <%=(temp.size() == 1) ? "<B>" : ""%>
                                                                                                                                                                <%=JSPFormater.formatNumber(sales.getPphAmount(), "#,###.##")%> 
                                                                                                                                                                <%=(temp.size() == 1) ? "</B>" : ""%>
                                                                                                                                                            </div>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                                                                                                                                                    ...
                                                                                                                                                    <tr height="22">
                                                                                                                                                        ...
                                                                                                                                                        <td height="2" class="tablearialcell1"> 
                                                                                                                                                            <div align="right"><b><%=JSPFormater.formatNumber(sales.getPphPercent(), "#,###.##")%></b></div>
                                                                                                                                                        </td>
                                                                                                                                                        <td height="2" class="tablearialcell1"> 
                                                                                                                                                            <div align="right"><b><%=JSPFormater.formatNumber(sales.getPphAmount(), "#,###.##")%></b></div>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%}%>                                                                                    
                                                                                                                                                    <%}
                                                                                                                                                    ...
                                                                                                                                                    <tr height="25">  
                                                                                                                                                        ...
                                                                                                                                                        <td height="19" bgcolor="#3366CC"><div align="right"><b><font face="arial" color="#FFFFFF"><%=JSPFormater.formatNumber(0.00, "#,###.##")%></font></b></div></td>
                                                                                                                                                        <td height="19" bgcolor="#3366CC"><div align="right"><b><font face="arial" color="#FFFFFF"><%=JSPFormater.formatNumber(0.00, "#,###.##")%></font></b></div></td>
                                                                                                                                                    </tr>
                                                                                                                                                    <tr> 
                                                                                                                                                        <td coslpan="18">&nbsp;</td>                                                                                       
