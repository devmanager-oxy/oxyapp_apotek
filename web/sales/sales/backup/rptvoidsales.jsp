...
<%
            ...
            if (locationId == 0) {
                memo = "Location : All Location";
            } else {
                Location l = new Location();
                try {
                    l = DbLocation.fetchExc(locationId);
                    if (l.getOID() != 0) {
                        memo = "Location : " + l.getName();
                    }
                } catch (Exception e) {
                }
                                                                                                                            ...
                                                                                                                            <tr height="23">
                                                                                                                                ...
                                                                                                                                <td colspan="3">
                                                                                                                                    <select name="src_location_id" class="fontarial">
                                                                                                                                        <%if (userLocations.size() == totLocationxAll) {%>
                                                                                                                                        <option value="0"> - All Location -</option>
                                                                                                                                        <%}%>
                                                                                                                                        <%if (userLocations != null && userLocations.size() > 0) {
                for (int i = 0; i < userLocations.size(); i++) {
                    Location us = (Location) userLocations.get(i);
                                                                                                                                        %>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td height="8"  colspan="3" class="container"> 
                                                                                                                        <table width="1100" cellpadding="0" cellspacing="1">
                                                                                                                            ...
                                                                                                                            <tr height="20">
                                                                                                                                <td colspan="10" class="fontarial"><b><i><%=memo%></i></b></td>
                                                                                                                            </tr>    
                                                                                                                            <%}%>
                                                                                                                            <tr height="23">
