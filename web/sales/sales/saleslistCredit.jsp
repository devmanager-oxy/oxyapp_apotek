...
function targetPage(oidSales){
	...
	<%}
		...
		window.location="creditPayment.jsp?menu_idx=<%=menuIdx%>&command=<%=JSPCommand.LIST%>&hidden_sales_id="+oidSales;
	<%}%>
}

function cmdSearch(){
	document.frmsales.command.value="<%=JSPCommand.SUBMIT%>";
	document.frmsales.action="saleslistCredit.jsp?menu_idx=<%=menuIdx%>";
                                                        ...
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                          <tr valign="bottom"> 
                                                            <td width="60%" height="23"><b><font color="#990000" class="lvl1">Sales 
                                                              ...
                                                              <span class="lvl2">sales Credit list
                                                              <br>
                                                              </span></font></b></td>
                                                          ...
                                                          <tr align="left" valign="top"> 
                                                            <td height="8" valign="middle" colspan="3"> 
                                                              <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                ...
                                                                <tr> 
                                                                  <td width="8%" height="14" nowrap>Code/Member ID 
                                                                    </td>
                                                                  <td width="38%" height="14"> 
                                                                    <input type="text" name="member_code" value="<%=(code_member==null) ? "" : code_member%>" size="35">
                                                                  </td>
                                                                  <td width="54%" height="15">&nbsp;</td>
                                                                </tr>
                                                                <tr> 
                                                                  <td width="8%" height="14">Location
                                                                     </td>
                                                                  <td width="38%" height="14"> 
                                                                    <%
                                                              ...
                                                              <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr> 
                                                                              ...
                                                                              <td width="38%" class="tablecell" align="right"> 
                                                                                  <div align="right"><b><%=JSPFormater.formatNumber(totalPaidCus, "#,###.##")%></b> </div>
                                                                              </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr> 
                                                                              ...
                                                                              <td width="38%" class="tablecell" align="right"> 
                                                                                <div align="right"><b><%=JSPFormater.formatNumber(totalBalance,"#,###.##")%></b> </div>
                                                                              </td>
                                                                            </tr>
