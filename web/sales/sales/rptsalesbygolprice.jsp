...
<%
            ...
            boolean privPrint = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_SALES_REPORT, AppMenu.M2_SAL_REPORT_BY_LOCATION, AppMenu.PRIV_UPDATE);
%>
<!-- Jsp Block -->
<%
            ...
            if (iJSPCommand == JSPCommand.SEARCH || iJSPCommand == JSPCommand.FIRST || iJSPCommand == JSPCommand.PREV ||
                ...
                vectSize = SessCogsBySection.getCountSalesByGolPriceReport(startDate, endDate, srcGroupCat, golPrice);
                ...
                result = SessCogsBySection.getSalesByGolPriceReport(start, recordToGet, startDate, endDate, srcGroupCat, golPrice, sortBy, sortType,where);
                ...
                session.putValue("REPORT_GOL_PRICE", rptParam);
                session.putValue("REPORT_GOL_PRICE_USER", user.getLoginId());

                dayx = DateCalc.dayDifference(startDate, endDate) + 1;
    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdPrintJournal(){	                       
                window.open("<%=printroot%>.report.RptSalesByGolPriceXLS?user_id=<%=appSessUser.getUserOID()%>&lang=<%=lang%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                }
                
                function cmdSearch(){
                    document.frmsales.command.value="<%=JSPCommand.SEARCH%>";
                    document.frmsales.action="rptsalesbygolprice.jsp?menu_idx=<%=menuIdx%>";
                    document.frmsales.submit();
                }
                
                function cmdListFirst(){
                    document.frmsales.command.value="<%=JSPCommand.FIRST%>";
                    document.frmsales.action="rptsalesbygolprice.jsp";
                    document.frmsales.submit();
                }
                                                                                                                            ...
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                <td height="22" valign="middle" colspan="4"> 
                                                                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                                                                        <tr height="20"> 
                                                                                                                                            <td colspan="5"><i><font color="#0000FF">Total 
                                                                                                                                                        of days <%=JSPFormater.formatNumber(days, "#,###")%> 
                                                                                                                                                        = <%=JSPFormater.formatNumber(months, "#,###.##")%> 
                                                                                                                                                        months = <%=JSPFormater.formatNumber(weeks, "#,###.##")%> 
                                                                                                                                            weeks </font></i></td>
                                                                                                                                            <td class="tablehdr" colspan="2"><font size="1">Stock</font></td>
                                                                                                                                            <td class="tablehdr" colspan="2"><font size="1">Sales/Month 
                                                                                                                                            </font></td>
                                                                                                                                            <td class="tablehdr" colspan="2"><font size="1">Sales/Week 
                                                                                                                                            </font></td>
                                                                                                                                        </tr>
                                                                                                                                        <tr height="20"> 
                                                                                                                                            <td class="tablehdr" width="6%" nowrap><font size="1">SKU</font></td>
                                                                                                                                            <td class="tablehdr" width="16%" nowrap ><font size="1">Item</font></td>
                                                                                                                                            <td class="tablehdr" width="8%" nowrap><font size="1">Cogs</font></td>
                                                                                                                                            <td class="tablehdr" width="11%" nowrap><font size="1">Selling 
                                                                                                                                            Price </font></td>
                                                                                                                                            <td class="tablehdr" width="8%" nowrap><font size="1">Margin</font></td>
                                                                                                                                            <td class="tablehdr" width="5%" nowrap><font size="1">Qty</font></td>
                                                                                                                                            <td class="tablehdr" width="9%" nowrap><font size="1">Amount</font></td>
                                                                                                                                            <td class="tablehdr" width="5%" nowrap><font size="1">Qty</font></td>
                                                                                                                                            <td class="tablehdr" width="8%" nowrap><font size="1">Amount</font></td>
                                                                                                                                            <td class="tablehdr" width="6%" nowrap><font size="1">Qty</font></td>
                                                                                                                                ...
                                                                                                                                for (int i = 0; i < result.size(); i++) {
                                                                                                                                    ...
                                                                                                                                    double lastPrice = Double.parseDouble((String) v.get(8));
                                                                                                                                    double selingPrice = Double.parseDouble((String) v.get(9));
                                                                                                                                    double margin = (selingPrice > 0) ? ((selingPrice - cogs) / cogs) * 100 : 0;
                                                                                                                                    ...
                                                                                                                                    double weekSales = Double.parseDouble((String) v.get(16));
                                                                                                                                        ...
                                                                                                                                        <tr height="20"> 
                                                                                                                                            ...
                                                                                                                                            <td class="tablecell" align="right" width="8%" nowrap><font size="1"><%=JSPFormater.formatNumber(cogs, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="11%" nowrap><font size="1"><%=JSPFormater.formatNumber(selingPrice, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="8%" nowrap><font size="1"><%=JSPFormater.formatNumber(margin, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="5%" nowrap><font size="1"><%=JSPFormater.formatNumber(stock, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="9%" nowrap><font size="1"><%=JSPFormater.formatNumber(stockAmount, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="5%" nowrap><font size="1"><%=JSPFormater.formatNumber(monthQty, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="8%" nowrap><font size="1"><%=JSPFormater.formatNumber(monthSales, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="6%" nowrap><font size="1"><%=JSPFormater.formatNumber(weekQty, "#,###.##")%></font></td>
                                                                                                                                            <td class="tablecell" align="right" width="10%" nowrap><font size="1"><%=JSPFormater.formatNumber(weekSales, "#,###.##")%></font></td>
                                                                                                                                        </tr>
                                                                                                                                        <%}%>
                                                                                                                                        <tr> 
                                                                                                                                        ...
                                                                                                                                        <tr> 
                                                                                                                                            <td colspan="11"><span class="command"> 
                                                                                                                                                    <%
                                                                                                                                int cmd = 0;
