                    ...
                    Merk v = (Merk) listMerk.get(i);
                                                                                        ...
                                                                                        <td height="21" colspan="5"> 
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
																								...
																								<tr>
                                                                                                    <td width="12%">&nbsp;&nbsp;Use Expired Date</td>
                                                                                                    <td width="9%"> 
                                                                                                        <input type="checkbox" name="<%=jspItemMaster.colNames[JspItemMaster.JSP_USE_EXPIRED_DATE] %>"  value="1" <%if (itemMaster.getIsActive() == 1) {%>checked<%}%> class="formElemen">
                                                                                                    </td>
                                                                                                    <td colspan="6">
                                                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width="13%">Apply Stock Code Sales</td>
                                                                                                                <td width="2%"> 
                                                                                                                ...
                                                                                                                <td width="15%">Optional Stock Code Sales</td>
                                                                                                                <td width="2%"> 
                                                                                                                ...
                                                                                                                <td width="15%">Non Stock Code Sales</td>
                                                                                                                <td>&nbsp;</td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
