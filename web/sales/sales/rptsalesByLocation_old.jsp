...
<html >
                                                                                                                                        ...
                                                                                                                                        <tr>                                                                                                                                            
                                                                                                                                            <td class="tablecell1" >                                                                                                                                                
                                                                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1" style="border:1px solid #ABA8A8">
                                                                                                                                                    ...
                                                                                                                                                    <tr> 
                                                                                                                                                        <td width="5" height="14" nowrap></td>
                                                                                                                                                        <td width="100" height="14" nowrap class="fontarial">Date Between</td>
                                                                                                                                                        <td height="14"> 
                                                                                                                                                    ...
                                                                                                                                                    <tr>
                                                                                                                                                        <td width="5" height="14" nowrap></td>
                                                                                                                                                        <td height="14" nowrap class="fontarial">Cashier Location</td>
                                                                                                                                                        <td height="14"> 
                                                                                                                                                            <%
            Vector vLoc = userLocations;
                ...
                for (int i = 0; i < vLoc.size(); i++) {
                    Location us = (Location) vLoc.get(i);
                                                                                                                                                    ...
                                                                                                                                                    <tr>
                                                                                                                                                        <td width="5" height="14" nowrap></td>
                                                                                                                                                        <td height="14" class="fontarial">Sales Type </td>
                                                                                                                                                        <td height="14"> 
    ...
    dQty = dQty + (sd.getQty());
                                                                                                                                                            %>
                                                                                                                                                            <%=JSPFormater.formatNumber(sd.getQty(), "###,###.##")%>
                                                                                                                                                            <%}%>
                                                                                                                                                            </div>
                                                                                                                                                        </td>
                                                                                                                                                        <td <%if (temp.size() == 1) {%>class="tablearialcell1"<%} else {%>class="tablearialcell"<%}%> nowrap > 
                                                                                                                                                        ...
                                                                                                                                                        <td <%if (temp.size() == 1) {%>class="tablearialcell1"<%} else {%>class="tablearialcell"<%}%> nowrap >  
                                                                                                                                                            ...
                                                                                                                                                            <%} else {%>
                                                                                                                                                            <%=JSPFormater.formatNumber((sd.getQty() * sd.getSellingPrice()), "#,###.##")%> 
                                                                                                                                                        ...
                                                                                                                                                        <td <%if (temp.size() == 1) {%>class="tablearialcell1"<%} else {%>class="tablearialcell"<%}%> nowrap > 
                                                                                                                                                            <div align="right"><font size="1"><%=((temp.size() == 1) ? "<b>" : "")%> 
                                                                                                                                                                ...
                                                                                                                                                                %>
                                                                                                                                                                <%=JSPFormater.formatNumber(sd.getDiscountPercent()*-1, "#,###.##")%>
                                                                                                                                                                <%}else{%>
