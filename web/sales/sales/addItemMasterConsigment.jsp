...
listItemMaster = DbItemMaster.listConsigment(start,recordToGet, whereClause , orderClause);
...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemMasterConsigment.jsp";
...
function cmdAsk(oidItemMaster){
	...
	document.frmitemmaster.prev_command.value="<%=prevJSPCommand%>";
	document.frmitemmaster.action="itemlistConsigment.jsp";
	document.frmitemmaster.submit();
}
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster  
        self.opener.document.frmsalesproductdetail.x_product_master_id.value=oidItemMaster  
