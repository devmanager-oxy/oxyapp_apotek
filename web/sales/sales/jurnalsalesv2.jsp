...
<html >
                                                                                                                                        ...
                                                                                                                                        <tr> 
                                                                                                                                            <td colspan="2">                                                                                                                                                
                                                                                                                                                <table width="100%" cellpadding="0" cellspacing="1">  
                                                                                                                                                    ...
                                                                                                                                                    <tr height="22">                                                                                                                                                                    
                                                                                                                                                        <td width="100" class="tablearialcell">&nbsp;&nbsp;Date</td>
                                                                                                                                                        ...
                                                                                                                                                        <td width="7"></td>
                                                                                                                                                        <td width="80" class="tablearialcell">&nbsp;&nbsp;Period</td>
                                                                                                                                                        <td>
                                                                                                                                                            <%
                                                                                                                                            ...
                                                                                                                                            <td height="15" colspan="4">
                                                                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                                    ...
                                                                                                                                                    <tr height="22">
                                                                                                                                                        ...
                                                                                                                                                        <td align="center" class="tablearialhdr"><input type="checkbox" name="chkbox" onClick="setChecked(this)"></td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%}%>
                                                                                                                                                    <%if (list != null && list.size() > 0) {%>
                                                                                                                                                    <tr height="22">
                                                                                                                                                        <td colspan="14" class="tablearialcell1"><b>&nbsp;SALES DATA</b></td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%}%>
                                                                                                                                                    <%
    // tootal       
    ...
    totSubAmount = totSubAmount + subAmount;
                                                                                                                                                    ...
                                                                                                                                                    <%if (iJSPCommand == JSPCommand.POST) {%>
                                                                                                                                                    <tr height="17">
                                                                                                                                                        <td colspan="10" height="15" class="fontarial"><i>Posting Journal finish..</i></td>
                                                                                                                                                    </tr>                                                                                    
                                                                                                                                                    <%}%>
                                                                                                                                                    <%} else {%>
                                                                                                                                                    <%if (iJSPCommand == JSPCommand.SUBMIT) {%>
                                                                                                                                                    <tr height="17">
                                                                                                                                                        <td colspan="10" height="15" class="fontarial"><i>Data not found...</i></td>
                                                                                                                                                    </tr>                                                                                    
                                                                                                                                                    <%} else {%>
                                                                                                                                                    <tr height="17">
                                                                                                                                                        <td colspan="10" height="15" class="fontarial"><i>Posting Journal finish..</i></td>
