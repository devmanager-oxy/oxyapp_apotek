...
<%-- 
    Document   : jurnalsales_single
    Created on : Jun 3, 2015, 5:02:13 PM
    Author     : Roy
--%>
...
<%
            ...
            long oidBiaya = 0;
            double totalSubCash[];
            totalSubCash = new double[currencys.size()];

            if (tanggal == null) {
                tanggal = new Date();
            }

            Vector vLoc = DbSegmentDetail.listLocation(user.getOID());
            if (locationId == 0 && vLoc != null && vLoc.size() > 0) {
                Location l = (Location) vLoc.get(0);
                locationId = l.getOID();
            }

            Vector vShift = SessPostSales.getShift(locationId, tanggal);
            ...
            if (iJSPCommand == JSPCommand.SUBMIT) {
                list = SessPostSales.getDataJournal(tanggal, locationId, cashCashierId, 0);
                listG = SessPostSales.getDataJournal(tanggal, locationId, cashCashierId, 1);
            }

            if (iJSPCommand == JSPCommand.POST) {

                list = SessPostSales.getDataJournal(tanggal, locationId, cashCashierId, -1);
                SessPostSales.postJournal(list, user.getOID(), periodId, sysCompany, locationId, currencys, tanggal, cashCashierId, stockable);
...
<html >
                                                                                                                                                    ...
                                                                                                                                                    <tr>                                                                                                                                            
                                                                                                                                                        <td >                                                                                                                                                
                                                                                                                                                            <table width="100%" cellpadding="0" cellspacing="1">  
                                                                                                                                                                ...
                                                                                                                                                                <tr height="20">
                                                                                                                                                                    <td width="90" bgcolor="#D3EDF5" class="fontarial" style="color:#63605C">&nbsp;&nbsp;Date</td>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            if ((list != null && list.size() > 0) || (listG != null && listG.size() > 0)) {
                                                                                                                                                ...
                                                                                                                                                if (currencys != null && currencys.size() > 0) {
                                                                                                                                                    ...
                                                                                                                                                    %>     
                                                                                                                                                    <tr >
                                                                                                                                                        <td align="center" width="20" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">NO</font></td>
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">NUMBER</font></td>
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">DATE</font></td>
                                                                                                                                                        <td align="center" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">MEMBER</font></td>
                                                                                                                                                        <td align="center" colspan="<%=colspan%>" class="tablearialhdr"><font size="1">CASH</font></td>
                                                                                                                                                        <td align="center" width="45" rowspan="<%=rowspan%>" class="tablearialhdr" nowrap><font size="1">CREDIT CARD</font></td>
                                                                                                                                                        <td align="center" width="55" rowspan="<%=rowspan%>" class="tablearialhdr" nowrap><font size="1">DEBIT CARD</font></td>                                                                                                                                                          
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">TRANSFER</font></td>
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">CREDIT(BON)</font></td>
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">DISCOUNT</font></td>
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">RETUR</font></td>
                                                                                                                                                        <td align="center" width="50" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">AMOUNT</font></td>
                                                                                                                                                        <td align="center" width="60" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">MERCHANT</font></td>
                                                                                                                                                        <td align="center" width="40" rowspan="<%=rowspan%>" class="tablearialhdr"><font size="1">STATUS</font></td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%if (colspan > 1) {%>
                                                                                                                                                    <tr>
                                                                                                                                                        <%
    for (int t = 0; t < colspan; t++) {
        Currency c = (Currency) currencys.get(t);
                                                                                                                                                    ...
                                                                                                                                                    <tr height="22">
                                                                                                                                                        <td colspan="<%=(13 + colspan)%>" bgcolor="#F9E3BC" class="fontarial" style="padding:3px;"><font size="1"><b><i>SALES DATA</i></b></font></td>
                                                                                                                                                    </tr> 
                                                                                                                                                    <%
        ...
        if (k % 2 == 0) {
            ...
            style = "tablearialcell1";
                                                                                                                                                    ...
                                                                                                                                                    <tr height="22">
                                                                                                                                                        ...
                                                                                                                                                        <td align="left" class="<%=style%>" style="padding:3px;"><%=salesClosing.getTglJam()%></td>
                                                                                                                                                        ...
                                                                                                                                                        <%for (int ir = 0; ir < currencys.size(); ir++) {
                                                                                                                                                                ...
                                                                                                                                                                if (cs.getOID() == currId) {
                                                                                                                                                                    totalSubCash[ir] = totalSubCash[ir] + salesClosing.getCash();
                                                                                                                                                        ...
                                                                                                                                                        <%} else {
                                                                                                                                                            totalSubCash[ir] = totalSubCash[ir] + 0;
                                                                                                                                                            totalCash[ir] = totalCash[ir] + 0;
                                                                                                                                                        %>
                                                                                                                                                        <td align="right" class="<%=style%>" style="padding:3px;"><%=JSPFormater.formatNumber(0.00, "###,###.##")%></td>
                                                                                                                                                        <%}
                                                                                                                                                            }%>
                                                                                                                                                        ...
                                                                                                                                                        <td align="left" class="<%=style%>" style="padding:3px;"><%=salesClosing.getMerchantName()%></td>     
                                                                                                                                                        <%
    ...
    totSubAmount = subAmount;
                                                                                                                                                    %>                                                                                 
                                                                                                                                                    <tr height="22">                                                                                       
                                                                                                                                                        <td bgcolor="#FCDBA0" class="fontarial" colspan="4" align="center"><b>SUB TOTAL</b></td>
                                                                                                                                                        <%for (int ir = 0; ir < currencys.size(); ir++) {%>                                                                                                                                                        
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totalSubCash[ir], "###,###.##")%></b></td>
                                                                                                                                                        <%}%>                                                                                                                                                        
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subCard, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subDebit, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subTransfer, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subBon, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subDiscount, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subRetur, "###,###.##")%></b></td>                                                                                        
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(subAmount, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#FCDBA0" class="fontarial" style="padding:3px;" colspan="2">&nbsp;</td>                                                                                        
                                                                                                                                                    </tr>
        ...
        totalSubCash[ir] = 0;
                                                                                                                                                    ...
                                                                                                                                                    <tr height="22">
                                                                                                                                                        <td colspan="<%=(13 + colspan)%>" bgcolor="#F9E3BC" class="fontarial" style="padding:3px;"><font size="1"><b><i>SERVICES DATA</i></b></font></td>
                                                                                                                                                    </tr>                                                                                   
                                                                                                                                                    <%}%>
                                                                                                                                                    <%
                                                                                                                                            subCash = 0;
                                                                                                                                            ...
                                                                                                                                            totSubAmount = totSubAmount + subAmount;
                                                                                                                                                    ...
                                                                                                                                                    <%if ((list != null && list.size() > 0) || (listG != null && listG.size() > 0)) {%>
                                                                                                                                                    <tr height="22">
                                                                                                                                                        <td colspan="4" bgcolor="#F5C46D" class="fontarial" align="center"><b>GRAND TOTAL</b></td>
                                                                                                                                                        <%for (int ir = 0; ir < currencys.size(); ir++) {%>                                                                                                                                                        
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totalCash[ir], "###,###.##")%></b></td>
                                                                                                                                                        <%}%>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubCard, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubDebit, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubTransfer, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubBon, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubDiscount, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubRetur, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;"><b><%=JSPFormater.formatNumber(totSubAmount, "###,###.##")%></b></td>
                                                                                                                                                        <td align="right" bgcolor="#F5C46D" class="fontarial" style="padding:3px;" colspan="2">&nbsp;</td> 
                                                                                                                                                    </tr>
                                                                                                                                                    <tr>
                                                                                                                                                        ...
                                                                                                                                                        if (totSubBon != 0) {
                                                                                                                                                            ...
                                                                                                                                                            if (nomor % 2 == 0) {
                                                                                                                                                                ...
                                                                                                                                                                <tr height="20">
                                                                                                                                                                    ...
                                                                                                                                                                    <td align="right" class="fontarial" bgcolor="<%=bg%>" style="padding:3px;"><%=JSPFormater.formatNumber(totSubBon, "###,###.##")  %></td>
                                                                                                                                                                    <td align="right" class="fontarial" bgcolor="<%=bg%>" style="padding:3px;"><%=JSPFormater.formatNumber(0.00, "###,###.##")  %></td>
                                                                                                                                                                </tr> 
                                                                                                                                                                <%
                                                                                                                                                            totDebit = totDebit + totSubBon;
                                                                                                                                                            nomor++;
                                                                                                                                                        }
