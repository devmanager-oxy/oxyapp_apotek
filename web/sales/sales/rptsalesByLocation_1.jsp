                                                                        ...
                                                                        <tr>
                                                                            <td class="boxed1">
                                                                                <table width="1200" border="0" cellspacing="1" cellpadding="1">
                                                                                    ...
                                                                                    <tr> 
                                                                                        <td class="tablearialhdr" width="2%">No</td>
                                                                                        <td class="tablearialhdr" width="5%">Date</td>
                                                                                        <td class="tablearialhdr" width="7%">Sales No.</td>
                                                                                        <td class="tablearialhdr" >Cashier</td>
                                                                                        <td class="tablearialhdr" width="17%">Description</td>
                                                                                        <td class="tablearialhdr" width="11%">Group</td>
                                                                                        <td class="tablearialhdr" width="11%">Customer</td>
                                                                                        <td class="tablearialhdr" width="4%">Qty</td>
                                                                                        <td class="tablearialhdr" width="6%">Price</td>
                                                                                        <td class="tablearialhdr" width="7%">Amount</td>
                                                                                        <td class="tablearialhdr" width="6%">Discount%</td>
                                                                                        <td class="tablearialhdr" width="6%">Discount Amount</td>
                                                                                        <td class="tablearialhdr" width="6%">PPN</td>
                                                                                        <td class="tablearialhdr" width="6%">Kwitansi</td>
                                                                                        <td class="tablearialhdr" width="6%">HPP</td>
                                                                                        <td class="tablearialhdr" width="6%">Laba</td>
                                                                                        <td class="tablearialhdr" width="6%">PPH%</td>
                                                                                        <td class="tablearialhdr" width="6%">PPH Amount</td>
                                                                                    </tr>
                                                                                    <%
                                                                    double totalQty = 0;
                                                                        ...
                                                                        for (int i = 0; i < listSales.size(); i++) {
                                                                            ...
                                                                            if (temp != null && temp.size() > 0) {
                                                                                ...
                                                                                for (int xx = 0; xx < temp.size(); xx++) {
                                                                                    ...
                                                                                    <td <%if (1 == 0) {%>class="tablecell1"<%} else {%>class="tablecell"<%}%> width="7%"><font size="1"><%=(xx == 0) ? usr.getFullName() : ""%></font></td>
