...
<html >
                                                                                                                                ...
                                                                                                                                for (int i = 0; i < vARInvoice.size(); i++) {
                                                                                                                                    ...
                                                                                                                                    if (cId != ai.getCustomerId()) {
                                                                                                                                        ...
                                                                                                                                        <tr height="20">
                                                                                                                                            ...
                                                                                                                                            <td class="tablearialcell1">&nbsp;</td>
                                                                                                                                            <td class="tablearialcell1">&nbsp;</td>                                                                                                                                            
                                                                                                                                            <td class="tablearialcell1" align="right"><B><%=JSPFormater.formatNumber(bal, "###,###.##")%></B></td>
                                                                                                                                        </tr> 
                                                                                                                                        <tr height="3">
    ...
    if (ai.getDueDate().before(new Date())) {
                                                                                                                                            ...
                                                                                                                                            <td class="tablearialcell" align="right"><%=JSPFormater.formatNumber(aiTotal, "###,###.##")%></td>
                                                                                                                                            <td class="tablearialcell" align="center"><%=JSPFormater.formatDate(ai.getDueDate(), "dd MMM yyyy")%></td>
                                                                                                                                            <td class="tablearialcell" align="right"><%=JSPFormater.formatNumber(paid, "###,###.##")%></td>
                                                                                                                                            <td class="tablearialcell" align="right"><%=JSPFormater.formatNumber(balance, "###,###.##")%></td>
                                                                                                                                        </tr>
                                                                                                                                        <%
