...
<%-- 
    Document   : itemproduk
    Created on : Jun 3, 2014, 9:49:31 AM
    Author     : Roy Andika
--%>
...
<%!
    public String drawList(Vector objectClass, long itemMasterId, int start) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            lstData.add(rowx);
            lstLinkData.add(String.valueOf(itemMaster.getOID())+"','"+itemMaster.getName());
        }
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){                
                ...
                document.frmitemmaster.action="itemproduk.jsp";
                document.frmitemmaster.submit();
            }
            
            function cmdEdit(oidItemMaster,name){                
                self.opener.document.frmsales.produk_id.value=oidItemMaster; 
                self.opener.document.frmsales.produk_name.value=name;                                               
                self.close();  
            }           
