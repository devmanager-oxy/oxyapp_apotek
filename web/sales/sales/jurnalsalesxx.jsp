...
<%
            ...
            if (salesType != -1) {
                ...
                whereClause = whereClause + " ( type= 0 or type=1 or type= 2 or type= 3) ";
            }
            ...
            if (iJSPCommand == JSPCommand.POST && periodId != 0) {
                ...
                if (listSales != null && listSales.size() > 0) {
                    ...
                    if (temp != null && temp.size() > 0) {
                        DbSales.postJournal(temp, user.getOID(), periodId);
                    }
                }
                                                                                                    ...
                                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                                                        <tr valign="bottom"> 
                                                                                                            <td width="60%" height="23"><b><font color="#990000" class="lvl1">Sales 
                                                                                                                        ...
                                                                                                                        <span class="lvl2">Post Journal<br>
                                                                                                            </span></font></b></td>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="33%" height="14"> 
                                                                                                                            <select name="sales_type">
                                                                                                                                ...
                                                                                                                                <option value="2" <%if (salesType == 2) {%>selected<%}%>>CREDIT</option>
                                                                                                                                <option value="3" <%if (salesType == 3) {%>selected<%}%>>CREDIT</option>
                                                                                                                    ...
                                                                                                                    for (int i = 0; i < listSales.size(); i++) {
                                                                                                                        ...
                                                                                                                        if (sales.getType() == DbSales.TYPE_RETUR_CASH || sales.getType() == DbSales.TYPE_RETUR_CREDIT) {
                                                                                                                            ...
                                                                                                                            if (temp != null && temp.size() > 0) {
                                                                                                                                ...
                                                                                                                                %>
                                                                                                                                <tr> 
                                                                                                                                    <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> align="center">
                                                                                                                                        <%
                                                                                                                                                    if (xx == 0) {
                                                                                                                                        %>
                                                                                                                                        <%=no%>
                                                                                                                                ...
                                                                                                                                <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="6%"><font size="1"><%=(xx == 0) ? JSPFormater.formatDate(sales.getDate(), "dd/MM/yyyy") : ""%></font></td>
                                                                                                                                <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="6%"><font size="1"><%=(xx == 0) ? sales.getNumber() : ""%></font></td>
                                                                                                                                <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="17%" nowrap><font size="1"><%=im.getName()%></font></td>
                                                                                                                                <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="15%"><font size="1"><%=ig.getName()%></font></td>
                                                                                                                                    <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="3%"> 
                                                                                                                                        <div align="right"><font size="1"><%=sd.getQty()%></font></div>
                                                                                                                                    </td>
                                                                                                                                    <%totalQty = totalQty + sd.getQty();%>
                                                                                                                                    <td <%if (1 == 0) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="7%"> 
                                                                                                                                    ...
                                                                                                                                    <td <%if (temp.size() == 1) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="8%"> 
                                                                                                                                        <div align="right"> 
                                                                                                                                        <font size="1"> 
                                                                                                                                            <%
                                                                                                                                                    double xz = sd.getTotal() + sales.getVatAmount();
                                                                                                                                                    if (xz > 0) {
                                                                                                                                            %>
                                                                                                                                    ...
                                                                                                                                    <td <%if (temp.size() == 1) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="7%"> 
                                                                                                                                        ...
                                                                                                                                        <font size="1"> 
                                                                                                                                            <%
                                                                                                                                                    double x2 = sd.getCogs() * sd.getQty();
                                                                                                                                                    if (x2 > 0) {
                                                                                                                                            %>
                                                                                                                                    ...
                                                                                                                                    <td <%if (temp.size() == 1) {%>class="tablecellx1"<%} else {%>class="tablecelxl"<%}%> width="8%"> 
                                                                                                                                        ...
                                                                                                                                        <font size="1"> 
                                                                                                                                            <%
                                                                                                                                                    x2 = sd.getTotal() - (sd.getCogs() * sd.getQty());
                                                                                                                                                    if (x2 > 0) {
                                                                                                                                            %>
...
%>
                                                                                                                                <tr> 
                                                                                                                                    ...
                                                                                                                                    <td height="2" class="tablecellx1">
                                                                                                                                        <%
    double x2 = sales.getAmount() + sales.getVatAmount();
    if (x2 > 0) {
                                                                                                                                        %>
                                                                                                                                    ...
                                                                                                                                    <td height="2" class="tablecellx1">&nbsp;</td>
                                                                                                                                </tr>
                                                                                                                                <%}%>
                                                                                                                                <tr> 
                                                                                                                            ...
                                                                                                                            grandTotalLaba = grandTotalLaba + totallaba;
                                                                                                                                ...
                                                                                                                                <tr> 
                                                                                                                                    ...
                                                                                                                                    <td width="8%" height="19" bgcolor="#3366CC"> 
                                                                                                                                        <div align="right"><font size="1"><b><font color="#FFFFFF"><%=JSPFormater.formatNumber(totalKwitansi, "#,###")%></font></b></font></div>
                                                                                                                                    </td>
                                                                                                                                    <td width="7%" height="19" bgcolor="#3366CC"> 
