...
<%-- 
    Document   : needposting
    Created on : Oct 9, 2012, 3:42:54 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            String orderLocation = DbLocation.colNames[DbLocation.COL_NAME];

            Vector vLoc = DbLocation.list(0, 0, "", orderLocation);

            Vector result = new Vector();

            if (iJSPCommand == JSPCommand.LIST) {
                result = DbSales.listNeedPosting(locationId);
            }
%>
<html >
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdSearch(){
                ...
                document.frmsales.action="needposting.jsp?menu_idx=<%=menuIdx%>";
                                                                                                                        ...
                                                                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                                                                            <tr valign="bottom"> 
                                                                                                                                <td width="60%" height="23"><b><font color="#990000" class="lvl1">Report 
                                                                                                                                            ...
                                                                                                                                            <span class="lvl2">Posting Report<br>
                                                                                                                                </span></font></b></td>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td height="15" colspan="4">
                                                                                                                                                <table width="700" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                                    ...
                                                                                                                                                    <tr>
                                                                                                                                                        <td align="center" class="tablehdr">Location</td>
                                                                                                                                                        <td align="center" class="tablehdr">Date</td>
                                                                                                                                                        <td align="center" class="tablehdr">#Data</td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%   
                                                                                                                                                    for(int i = 0; i < result.size() ; i++){
                                                                                                                                                        NeedPosting np = (NeedPosting)result.get(i);
                                                                                                                                                    %>
                                                                                                                                                    <tr>
                                                                                                                                                        <td align="center" class="tablecell"><%=np.getLocationName()%></td>
                                                                                                                                                        <td align="center" class="tablecell"><%=JSPFormater.formatDate(np.getDateTransaction(),"yyyy-MM-dd")%></td>
                                                                                                                                                        <td align="center" class="tablecell"><%=np.getCountData()%></td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%
                                                                                                                                                    }    
                                                                                                                                                    %>
                                                                                                                                                    ...
                                                                                                                                                    <tr height="20">
                                                                                                                                                        <td colspan="10" height="15" class="tablecell">&nbsp;No data that need to be posted</td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%}%>
                                                                                                                                                    <%}%>
                                                                                                                                                    ...
                                                                                                                                                    <%if (iJSPCommand == JSPCommand.NONE) {%>
                                                                                                                                                    <tr height="20">
                                                                                                                                                        <td colspan="10" height="15" class="tablecell">&nbsp;Klik search to searching data</td>
                                                                                                                                                    </tr>
                                                                                                                                                    <%}%>    
                                                                                                                                                </table>
                                                                                                                                            </td>
