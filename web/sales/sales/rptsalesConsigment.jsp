...
function cmdSearch(){
	...
	document.frmsales.action="rptsalesConsigment.jsp?menu_idx=<%=menuIdx%>";
                                                                  ...
                                                                  <td class="boxed1">
                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                      ...
                                                                      <tr> 
                                                                        ...
                                                                        <td width="11%" height="19" bgcolor="#9b7934"> 
                                                                        ...
                                                                        <td width="11%" height="19" bgcolor="#9b7934">&nbsp;</td>
                                                                        <td width="4%" height="19" bgcolor="#9b7934"> 
                                                                          <div align="center"><font size="1"><b><font color="#FFFFFF"><%=totalQty%></font></b></font></div>
                                                                        </td>
                                                                        <td width="6%" height="19" bgcolor="#9b7934"><font size="1"></font></td>
                                                                        ...
                                                                        <td width="6%" height="19" bgcolor="#9b7934"> 
                                                                        ...
                                                                        <td width="6%" height="19" bgcolor="#9b7934">&nbsp;</td>
                                                                        <td width="6%" height="19" bgcolor="#9b7934">&nbsp;</td>
                                                                      </tr>
                                                                      <tr> 
                                                                        <td width="2%">&nbsp;</td>
