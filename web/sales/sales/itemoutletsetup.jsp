                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmitemmaster" method ="post" action="">
						  ...
						  <%
									  String navigator = "<font class=\"lvl1\">Item Outlet</font><font class=\"tit1\">&nbsp;&raquo;&nbsp;<span class=\"lvl2\">Setup</span></font>";
									  %>
                                              ...
                                              <tr align="left" valign="top">
                                                <td height="22" valign="middle" colspan="3">
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    <tr> 
                                                      <td class="tablehdr">Group/Category</td>
                                                      <td class="tablehdr">Code</td>
                                                      <td class="tablehdr">Name</td>
                                                      <td class="tablehdr">Selling 
                                                        Price</td>
