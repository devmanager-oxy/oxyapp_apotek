...
<%
            ...
            if (iJSPCommand == CMD_LOGIN) {
                if (dologin == QrUserSession.DO_LOGIN_OK) {                    
                    if (v != null && v.size() > 0) {
                        response.sendRedirect("homesl.jsp");
                    } else {
...
<html>
    <head>
        ...
        <script language="javascript"> 
            ...
            function cmdLogin()
            {	
                document.frmLogin.action = "indexsl.jsp";
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
                                        <tr> 
                                            <td align="right" width="37%"> 
                                                <div align="left"><b><font size="2" color="#0000FF">SALES 
                                                SYSTEM LOGIN</font></b></div>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td align="right" width="37%"> 
                                                <div align="left"><strong><font color="#FF3300">Username</font></strong></div>
                                            </td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                            <td align="right" width="37%"> 
                                                <div align="left"><strong><font color="#FF3300">Password</font></strong></div>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td align="right" width="37%"> 
