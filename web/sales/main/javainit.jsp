...
<%
            String approot = rootapproot + "/sales";
            String imageroot = rootimageroot + "/sales/";
            ...
            String globalDiskon = "N";            
            try{
                globalDiskon = DbSystemProperty.getValueByName("SALES_REPORT_GLOBAL_DISKON");
            }catch(Exception e){}
            
            String reportFolder = "sales";
            if(globalDiskon.equals("Y")){
                reportFolder = "salesglobal";
            }
%>
