...
<%
	...
	try{
		if(Integer.parseInt(command)==11){
				...
				String sql = "select * from logs1 where table_name in('customer','sysuser','pos_shift','pos_price_type','pos_item_group','pos_unit','pos_location','currency','pos_item_category'," +
					"'member','bank','merchant') " +
