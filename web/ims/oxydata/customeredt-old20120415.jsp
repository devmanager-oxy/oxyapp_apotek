...
if(iJSPCommand==JSPCommand.SAVE){
	 java.io.File f = new java.io.File("//home//bestvilla//tomcat//webapps//oxysystem_retail//oxydata//customer.txt");
        if (f.exists())
         {
               f.delete();
	...
	try{
		...
		String sql = "SELECT * INTO OUTFILE '//home//bestvilla//tomcat//webapps//oxysystem_retail//oxydata//customer.txt' FROM customer";
		CONHandler.execQueryResult(sql);
		//SQLGeneral.executeSQL(sql);
	}catch(Exception e){%>
                                                              ...
                                                              <table width="31%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr> 
                                                                  ...
                                                                  <td nowrap width="20" id="name_title1"> 
                                                                    <!--input type="text" name="<%=jspCustomer.fieldNames[JspCustomer.JSP_MIDDLE_NAME] %>"  value="<%= (customer.getMiddleName()==null) ? "" : customer.getMiddleName() %>" class="formElemen" size="2" maxlength="1"-->
                                                                  </td>
                                                                  <td width="2" nowrap><img src="../images/spacer.gif" width="2" height="1"></td>
                                                                  <td width="50" id="name_title2" nowrap> 
                                                                    <!--input type="text" name="<%=jspCustomer.fieldNames[JspCustomer.JSP_LAST_NAME] %>"  value="<%= (customer.getLastName()==null) ? "" : customer.getLastName() %>" class="formElemen" size="15"-->
                                                                  </td>
                                                                </tr>
                                                              </table>
                                      ...
                                      <table width="70%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          ...
                                          <td width="76%"> Ignored </td>
                                                          ...
                                                          <tr align="left"> 
                                                            <td height="8" width="11%">Personal Discount</td>
                                                            <td height="8" width="26%"> 
                                                              <input type="text" name="<%=jspCustomer.fieldNames[JspCustomer.JSP_PERSONAL_DISCOUNT] %>"  value="<%= customer.getPersonal_discount() %>" class="formElemen" size="5">%
                                                            </td>
                                                            <td height="8" width="13%"> 
                                                              <div align="right">Code</div>
                                                            </td>
                                                            <td height="8" width="49%"> 
                                                              <input type="text" name="<%=jspCustomer.fieldNames[JspCustomer.JSP_CODE] %>"  value="<%= customer.getCode() %>" class="formElemen" size="40">
                                                            </td>
                                                          </tr>
                                                          <tr align="left"> 
