                              ...
                              <td class="container"> 
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                  <tr > 
                                    ...
                                    <td class="tab" nowrap> <b>Payment Term</b></td>
                                  ...
                                  <tr>
                                    <td class="page">
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        ...
                                        <tr> 
                                          <td width="10%"><b>Product Group</b></td>
                                          <td width="22%"> Pemasangan Septic Tank</td>
                                          ...
                                          <td colspan="4"> 
                                            <table width="80%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                ...
                                                <td width="9%" class="tablehdr">Type</td>
                                                <td width="45%" class="tablehdr">Description</td>
                                                <td width="13%" class="tablehdr">Status</td>
                                                <td width="14%" class="tablehdr">Due 
                                                  Date </td>
                                              ...
                                              <tr> 
                                                ...
                                                <td width="9%" class="tablecell" height="37">Down 
                                                  Payment</td>
                                                <td width="45%" class="tablecell" height="37">Pembayaran 
                                                  DP sebesar 50% pada saat setelah 
                                                  tanda tangan kontrak dilakukan 
                                                  oleh kedua belah pihak.</td>
                                                <td width="13%" class="tablecell" height="37"> 
                                                ...
                                                <td width="15%" class="tablecell" height="37"> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="9%" class="tablecell1" height="32">Payment</td>
                                                <td width="45%" class="tablecell1" height="32">Pembayaran 
                                                  sebesar 20% pada saat setelah 
                                                  pengiriman 20 tabung septic 
                                                  tank dilakukan, dan barang diterima 
                                                  oleh konsumen</td>
                                                <td width="13%" class="tablecell1" height="32"> 
                                                  <div align="center">-</div>
                                                </td>
                                                <td width="14%" class="tablecell1" height="32"> 
                                                  <div align="center">-</div>
                                                </td>
                                                <td width="15%" class="tablecell1" height="32"> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="9%" class="tablecell" height="35">Payment</td>
                                                <td width="45%" class="tablecell" height="35">Pembayaran 
                                                  sebesar 20% pada saat setelah 
                                                  pengiriman kedua 15 tabung septic 
                                                  tank dilakukan, dan barang diterima 
                                                  oleh konsument</td>
                                                <td width="13%" class="tablecell" height="35"> 
                                                  <div align="center">-</div>
                                                </td>
                                                <td width="14%" class="tablecell" height="35"> 
                                                  <div align="center">-</div>
                                                </td>
                                                <td width="15%" class="tablecell" height="35"> 
                                                  <div align="right">40.000.000,-</div>
                                                </td>
                                              </tr>
                                              <tr> 
                                                ...
                                                <td width="9%" class="tablecell1" height="28"> 
                                                  <select name="select">
                                                    <option selected>Down Payment</option>
                                                    <option>Payment</option>
                                                  </select>
                                                </td>
                                                <td width="45%" class="tablecell1" height="28"> 
                                                  <textarea name="textfield" cols="50" rows="3">Pembayaran sebesar 10% pada saat installasi dilakukan</textarea>
                                                </td>
                                                <td width="13%" class="tablecell1" height="28"> 
                                                  <div align="center"> 
                                                    <select name="select2">
                                                ...
                                                <td width="15%" class="tablecell1" height="28"> 
                                                  <div align="right"> 
                                              ...
                                              <tr> 
                                                ...
                                                <td width="45%" class="tablecell" height="22">&nbsp;</td>
                                                <td width="13%" class="tablecell" height="22">&nbsp;</td>
                                                <td width="14%" class="tablecell" height="22"> 
                                                  <div align="center"><b>Total 
                                                    : </b></div>
                                                </td>
                                                <td width="15%" class="tablecell" height="22"> 
