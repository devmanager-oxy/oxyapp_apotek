...
<%
            ...
            if (iJSPCommand == CMD_LOGIN) {
                ...
                String userKey = JSPRequestValue.requestString(request, "user_key");
                String remoteIP = request.getRemoteAddr();
                QrUserSession userQr = new QrUserSession(remoteIP);

                dologin = userQr.doLogin(loginID, passwd, userKey);
            ...
            if (iJSPCommand == CMD_LOGIN) {
                if (dologin == QrUserSession.DO_LOGIN_OK) {
                    ...
                    msg = "Login ID or password or user key invalid";
                }
            }
%>
<html>
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
                                        <tr> 
                                            <td align="right" width="37%"> 
                                                <div align="left"><b><font size="2" color="#003399">OXY-RETAIL</font></b></div>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td align="right" width="37%"> 
                                        ...
                                        <tr> 
                                            <td align="right" width="37%"> 
                                                <div align="left"><strong><font color="#009900"><i>User Key</i></font></strong></div>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td align="right" width="37%"> 
                                                <div align="left"> 
                                                    <input type="password" name="user_key" class="input_text" value="" size="30" onClick="this.select()">
                                                </div>
                                            </td>
                                        </tr>
