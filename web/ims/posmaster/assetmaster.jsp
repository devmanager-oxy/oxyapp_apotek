...
<%
            ...
            Vector categories = DbItemCategory.list(0, 0, "group_type=" + I_Ccs.TYPE_CATEGORY_ASSET, DbItemCategory.colNames[DbItemCategory.COL_ITEM_GROUP_ID] + "," + DbItemCategory.colNames[DbItemCategory.COL_NAME]);
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                ...
                                                                                <td height="8"  colspan="3"> 
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                                        <tr valign="bottom"> 
                                                                                            ...
                                                                                            <span class="lvl2">Asset List </span></font></b></td>
            ...
            if (categories != null && categories.size() > 0) {
                for (int i = 0; i < categories.size(); i++) {
                     ...
                     */
                    itemcategoryid_key.add("" + ic.getOID());
                    itemcategoryid_value.add(ic.getName());
                }
            }
                                                                                            %>
                                                                                        ...
                                                                                        * <%= jspItemMaster.getErrorMsg(JspItemMaster.JSP_NAME) %> 
                                                                                        ...
                                                                                        <td height="21" colspan="2" width="62%">&nbsp; 
                                                                                        <tr align="left"> 
                                                                                        <td height="21" colspan="2" nowrap>&nbsp;&nbsp;<b><u>Sales 
                                                                                                    ...
                                                                                                    <td colspan="4"> 
                                                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                            <tr> 
                                                                                                                ...
                                                                                                                <td width="2%"><input type="checkbox" name="<%=jspItemMaster.colNames[JspItemMaster.JSP_APPLY_STOCK_CODE] %>"  value="1" <%if (itemMaster.getApplyStockCode() == 1) {%>checked<%}%> class="formElemen"></td>
                                                                                                                <td width="54%">&nbsp;</td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </td>
