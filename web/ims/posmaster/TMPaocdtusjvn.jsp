...
<%@ include file = "file:///F|/user/ngurah/sipadu-inv/web/main/javainit.jsp" %>
<% int appObjCode = 1;// AppObjInfo.composeObjCode(AppObjInfo.--, AppObjInfo.--, AppObjInfo.--); %>
<%@ include file = "file:///F|/user/ngurah/sipadu-inv/web/main/check.jsp" %>
<%
            /* Check privileges except VIEW, view is already checked on checkuser.jsp as basic access*/
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <title><%=titleIS%></title>
        <link href="file:///F|/user/ngurah/sipadu-inv/web/css/css.css" rel="stylesheet" type="text/css" />
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            <%@ include file="file:///F|/user/ngurah/sipadu-inv/web/main/hmenu.jsp"%>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                    ...
                                    <tr> 
                                        <td width="165" height="100%" valign="top" background="<%=approot%>/images/leftbg.gif"> 
                                            <!-- #BeginEditable "menu" --> 
                  <%@ include file="file:///F|/user/ngurah/sipadu-inv/web/main/menu.jsp"%>
                                            <!-- #EndEditable -->
                                        </td>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                                        <tr valign="bottom"> 
                                                                                            ...
                                                                                            <td width="40%" height="23"> 
                                                                                                <%@ include file = "file:///F|/user/ngurah/sipadu-inv/web/main/userpreview.jsp" %>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr > 
...
%>
                ...
                for (int i = 0; i < categories.size(); i++) {
                    ...
                    itemcategoryid_value.add("" + ig.getName() + " - " + ic.getName());
                                                                                        ...
                                                                                        * <%= jspItemMaster.getErrorMsg(JspItemMaster.JSP_NAME) %> 
                                                                                        ...
                                                                                        Price</td>
                                                                                        <td height="21" width="16%"> 
                                                                                            <input type="text" name="<%=jspItemMaster.colNames[JspItemMaster.JSP_SELLING_PRICE] %>"  value="<%= JSPFormater.formatNumber(itemMaster.getSellingPrice(), "#,###.##") %>" class="formElemen" size="20" style="text-align:right" onBlur="javascript:checkNumber()" onClick="this.select()">
                                                                                        </td>
                                                                                        <td height="21" width="10%"> 
                                                      ...
                                                      <td width="2%">
                                                        <input type="checkbox" name="<%=jspItemMaster.colNames[JspItemMaster.JSP_APPLY_STOCK_CODE] %>"  value="1" <%if (itemMaster.getApplyStockCode() == 1) {%>checked<%}%> class="formElemen">
                                                      </td>
    ...
    Vector listVendorItem = DbVendorItem.list(0, 0, DbVendorItem.colNames[DbVendorItem.COL_ITEM_MASTER_ID] + "=" + itemMaster.getOID(), DbVendorItem.colNames[DbVendorItem.COL_UPDATE_DATE]);
            ...
            <%@ include file="file:///F|/user/ngurah/sipadu-inv/web/main/footer.jsp"%>
                                <!-- #EndEditable -->
                            </td>
                        </tr>
                    </table>
