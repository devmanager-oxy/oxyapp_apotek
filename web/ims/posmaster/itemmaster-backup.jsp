                                                                                ...
                                                                                <td height="8"  colspan="3"> 
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                            <%if (itemMaster.getOID() != 0 && mstViewCogs) {%>
...
%>
    ...
    if (itemMaster.getForSale() == 1 && itemMaster.getNeedBom() == 1) {
                                                                                            ...
                                                                                            <%if (oidItemMaster != 0 && mstViewCogs) {%>
                                                                                            <td class="tabin" nowrap><div align="center">
                ...
                for (int i = 0; i < listMerk.size(); i++) {
                    Merk v = (Merk) listMerk.get(i);
                                                                                            ...
                                                                                            <td height="21" colspan="2" width="62%">
                                                                                                <input type="text"  class="readonly" name="<%=jspItemMaster.colNames[JspItemMaster.JSP_COGS] %>"  value="<%= JSPFormater.formatNumber(itemMaster.getCogs(), "#,###.##") %>" class="formElemen" size="20" style="text-align:right" onBlur="javascript:checkNumber1()" onClick="this.select()"> 
                                                                                            </td>
                                                                                            <%} else {%>
            ...
            Vector listVnd = DbVendor.list(0, 0, "", "name");
                ...
                for (int i = 0; i < listVnd.size(); i++) {
                    Vendor v = (Vendor) listVnd.get(i);
                                                                                        ...
                                                                                        <td height="21" colspan="5"> 
                                                                                            <table width="700" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr> 
                                                                                                    ...
                                                                                                    <td width="5">&nbsp;</td>
                                                                                                    <td width="60" align="left">Need BOM</td>
                                                                                        ...
                                                                                        <tr align="left"> 
                                                                                            <td height="21" colspan="2">&nbsp;&nbsp;<b><u>Stockable</u><u></u><i><u><br><br></u></i></b></td>
                                                                                            <td height="21" width="10%">&nbsp;</td>
                                                                                            <td height="21" colspan="2" width="62%">&nbsp;</td> 
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr align="left"> 
                                                                                            <td height="21" colspan="2">&nbsp;&nbsp;<b><u>Auto Replenishment</u><u></u><i><u><br><br></u></i></b></td>
                                                                                            <td height="21" width="10%">&nbsp;</td>
                                                                                            <td height="21" colspan="2" width="62%">&nbsp;</td> 
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="8">
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                    <tr align="left"> 
                                                                                                        <td height="21" width="20%">&nbsp;Is Auto Order</td>
            ...
            if (units != null && units.size() > 0) {
                for (int i = 0; i < units.size(); i++) {
                    ...
                    uomrecipeid_value.add("" + uo.getUnit());
                                                                                        ...
                                                                                        <tr align="left"> 
                                                                                            <td height="21" width="12%">&nbsp;&nbsp;Unit Sales</td>
                                                                                            <td height="21" width="16%"> 
    ...
    for (int i = 0; i < vLog.size(); i++) {
        LogOperation log = (LogOperation) vLog.get(i);
                                                                                        %>
                                                                                        <tr>
                                                                                            <td align="center" class="tablecell"><font size="1"><%=JSPFormater.formatDate(log.getDate(), "dd/MM/yyyy HH:mm:ss")%></font></td>
