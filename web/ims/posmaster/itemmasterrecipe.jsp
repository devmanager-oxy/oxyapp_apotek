					...
					%>
					   ...
					   %>
									...
									%>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                              <tr > 
                                                ...
                                                <td class="tabin" nowrap> 
                                                  <div align="center">&nbsp;&nbsp;<a href="javascript:cmdToEditor()" class="tablink">Vendor</a>&nbsp;&nbsp;</div>
                                                </td>
                                                <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                <td class="tab"> 
                                                  <div align="center">&nbsp;&nbsp;Recipe&nbsp;&nbsp;</div>
                                                </td>
                                                <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                <td class="tabin"> 
                                                  <div align="center">&nbsp;&nbsp;<a href="javascript:cmdToEditor()" class="tablink">Overhead</a>&nbsp;&nbsp;</div>
                                                </td>
                                                <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                        ...
                                        <%
										Vector listRecipes = DbRecipe.list(0,0, DbRecipe.colNames[DbRecipe.COL_ITEM_MASTER_ID]+"="+itemMaster.getOID() , DbRecipe.colNames[DbRecipe.COL_LAST_UPDATE]+" desc");
										%>
                                        <tr> 
                                          <td colspan="4" class="page"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td> 
                                                  ...
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
													...
													Recipe rc = (Recipe)listRecipes.get(i);
													
											  		%>
                                                    <tr> 
                                                      <td width="25%" class="tablecell"></td>
                                                      <td width="29%" class="tablecell"></td>
                                              ...
                                              <tr> 
                                                <td><a href="javascript:cmdEditRecipe()"><img src="../images/add2.gif" width="49" height="22" border="0"></a></td>
                                              </tr>
                                              <tr> 
                                                <td>&nbsp;</td>
                                              </tr>
