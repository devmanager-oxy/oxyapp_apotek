                ...
                for (int i = 0; i < listMerk.size(); i++) {
                    Merk v = (Merk) listMerk.get(i);
                                                                                        ...
                                                                                        <tr align="left"> 
                                                                                            ...
                                                                                            <td height="21" width="10%">
                                                                                                <div align="right">Base Price&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td height="21" colspan="2" width="62%"> 
                                                                                                <input type="text" name="<%=jspItemMaster.colNames[JspItemMaster.JSP_NEW_COGS] %>"  value="<%= JSPFormater.formatNumber(itemMaster.getNew_cogs(), "#,###.##") %>" class="formElemen" size="20" style="text-align:right" onBlur="javascript:checkNumber1()" onClick="this.select()"> 
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr align="left"> 
