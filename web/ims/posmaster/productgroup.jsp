...
<%!
...

	{
		...
		jsplist.addHeader("Sales Account Cash","10%");
		jsplist.addHeader("Sales Account Credit","10%");
		...
		status_value.add(""+I_Ccs.TYPE_CATEGORY_CIVIL_WORK);
		status_key.add(I_Ccs.strCategoryType[I_Ccs.TYPE_CATEGORY_CIVIL_WORK]);
		...
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(index == i && (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK)){
				...
				rowx.add(itemGroup.getAccountSalesCash());
...
function cmdAdd(){
	...
	document.frmitemgroup.action="productgroup.jsp";
...
function cmdDelPict(oidItemGroup){
	...
	document.frmimage.action="productgroup.jsp";
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                      ...
                                      </font><span class="lvl2">Product Category 
                                      </span></b></td>
