...
<%!
...

	{
		...
		Vector igroup = DbItemGroup.list(0,0, "type="+I_Ccs.TYPE_CATEGORY_ASSET, "");
...
String whereClause = "group_type="+I_Ccs.TYPE_CATEGORY_ASSET;
...
function cmdAdd(){
	...
	document.frmitemcategory.action="assetcategory.jsp";
...
function cmdDelPict(oidItemCategory){
	...
	document.frmimage.action="assetcategory.jsp";
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                      ...
                                      </font> <span class="lvl2">Asset Sub Category 
                                      </span></b></td>
