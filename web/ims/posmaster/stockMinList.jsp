...
if(srcMerkId!=0){
	...
	whereClause = whereClause + DbItemMaster.colNames[DbItemMaster.COL_MERK_ID]+"="+srcMerkId;
}
...
function cmdSearch(){
	...
	document.frmitemmaster.action="stockMinList.jsp";
...
function cmdEdit(oidItemMaster){
	document.frmitemmaster.hidden_item_master_id.value=oidItemMaster;
	document.frmitemmaster.command.value="<%=JSPCommand.LOAD%>";
	document.frmitemmaster.prev_command.value="<%=prevJSPCommand%>";
                                                ...
                                                <td height="8" valign="middle" colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="6%">Code</td>
                                                      <td width="14%"> 
                                                        <input type="text" name="src_code" size="10" value="<%=srcCode%>">
                                                      </td>
                                                      <td width="6%">Merk</td>
                                                      <td width="15%">
                                                          <%
													  Vector Vmerk = DbMerk.list(0,0, "", "");
													  %>
                                                        <select name="src_merk">
                                                          <option value="0" <%if(srcMerkId==0){%>selected<%}%>>All 
                                                          ..</option>
                                                          <%if(Vmerk!=null && Vmerk.size()>0){
														  		for(int i=0; i<Vmerk.size(); i++){
																	Merk mer = (Merk)Vmerk.get(i);
																%>
                                                          <option value="<%=mer.getOID()%>" <%if(srcMerkId==mer.getOID()){%>selected<%}%>><%=mer.getName()%></option>
                                                          <%}}%>
                                                        </select>
                                                      </td>
                                                      <td width="42%">&nbsp;</td>
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="42%"><a href="javascript:cmdSearch()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('search','','../images/search2.gif',1)"><img src="../images/search.gif" name="search"  border="0"></a> 
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="5%">&nbsp;</td>
