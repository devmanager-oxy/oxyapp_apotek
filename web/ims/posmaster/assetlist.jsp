...
<%!
...

	{
		...
		jsplist.addHeader("Group","15%");
		jsplist.addHeader("Category","15%");
...
String whereClause = "type="+I_Ccs.TYPE_CATEGORY_ASSET;
...
function cmdSearch(){
	...
	document.frmitemmaster.action="assetlist.jsp";
...
function cmdToProduct(){
	...
	document.frmitemmaster.prev_command.value="<%=prevJSPCommand%>";
	document.frmitemmaster.action="assetmaster.jsp";
	document.frmitemmaster.submit();
}
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                        <tr valign="bottom"> 
                                          <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                            ...
                                            </font><font class="tit1"><span class="lvl2">Asset 
                                            List </span></font></b></td>
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="8" valign="middle" colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                      <td colspan="6" nowrap><b><u>Search 
                                                        Option</u></b></td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="5%">&nbsp;</td>
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="11%"> 
                                                        <%
													  Vector groupsx = DbItemGroup.list(0,0, "type="+I_Ccs.TYPE_CATEGORY_ASSET, "");
													  %>
                                                      ...
                                                      <td width="6%"><img src="../images/spacer.gif" width="10" height="1"></td>
                                                      <td width="6%">Code</td>
                                                      <td width="14%"> 
                                                        <input type="text" name="src_code" size="10" maxlength="5" value="<%=srcCode%>">
                                                      </td>
                                                      <td width="64%">&nbsp; </td>
                                                    </tr>
                                                    <tr> 
                                                      ...
                                                      <td width="11%"> 
                                                        <%
													  Vector categoryx = DbItemCategory.list(0,0, "group_type="+I_Ccs.TYPE_CATEGORY_ASSET, "");
													  %>
                                                      ...
                                                      <td width="64%"><a href="javascript:cmdSearch()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('search','','../images/search2.gif',1)"><img src="../images/search.gif" name="search"  border="0"></a> 
                                                      </td>
                                                    </tr>
                                                    <tr> 
                                                      <td width="5%">&nbsp;</td>
                                                    ...
                                                    <tr> 
                                                      <td colspan="6" background="../images/line1.gif"><img src="../images/line1.gif" width="47" height="3"></td>
                                                    </tr>
                                                    <tr> 
                                                      <td colspan="6">&nbsp;</td>
                                                    </tr>
