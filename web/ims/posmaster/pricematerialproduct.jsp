...
<%-- 
    Document   : pricematerialproduct
    Created on : Nov 25, 2011, 4:24:57 PM
    Author     : Roy Andika
--%>
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdToRecords(){
                ...
                document.frmpricematerial.action="productlist.jsp";
            ...
            function cmdToEditor(){
                ...
                document.frmpricematerial.prev_command.value="<%=prevJSPCommand%>";
                document.frmpricematerial.action="productmaster.jsp";
                document.frmpricematerial.submit();
            }
            ...
            function cmdAdd(){
                ...
                document.frmpricematerial.command.value="<%=JSPCommand.ADD%>";
                document.frmpricematerial.prev_command.value="<%=prevJSPCommand%>";
                document.frmpricematerial.action="pricematerialproduct.jsp";
                document.frmpricematerial.submit();
            }
            ...
            function cmdToVendor(){
                ...
                document.frmpricematerial.command.value="<%=JSPCommand.LIST%>";
                document.frmpricematerial.prev_command.value="<%=prevJSPCommand%>";
                document.frmpricematerial.action="vendorproduct.jsp";
                document.frmpricematerial.submit();
            }
