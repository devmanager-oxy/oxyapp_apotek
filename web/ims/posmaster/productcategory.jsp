...
<%!
...

	{
		...
		//Vector igroup = DbItemGroup.list(0,0, "type="+I_Ccs.TYPE_CATEGORY_FINISH_GOODS+" or type="+I_Ccs.TYPE_CATEGORY_CIVIL_WORK+" or type="+I_Ccs.TYPE_CATEGORY_ASSET, "");
		Vector igroup = DbItemGroup.list(0,0, "type="+I_Ccs.TYPE_CATEGORY_FINISH_GOODS+" or type="+I_Ccs.TYPE_CATEGORY_CIVIL_WORK, "");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(index == i && (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK)){
				...
				//rowx.add("<div align=\"center\">"+JSPCombo.draw(frmObject.colNames[JspItemCategory.JSP_PRIORITY],null, ""+itemCategory.getPriority(), priority_value , priority_key, "formElemen", "")+"</div>");
				//rowx.add("<div align=\"center\">"+"<input type=\"text\" name=\""+frmObject.colNames[JspItemCategory.JSP_ACCOUNT_CODE] +"\" value=\""+itemCategory.getAccountCode()+"\" class=\"formElemen\">"+"</div>");
			}else{
				...
				//rowx.add("<div align=\"center\">"+String.valueOf(itemCategory.getPriority())+"</div>");
				//rowx.add(itemCategory.getAccountCode());
			} 
		...
		if(iJSPCommand == JSPCommand.ADD || (iJSPCommand == JSPCommand.SAVE && frmObject.errorSize() > 0)){ 
				...
				//rowx.add("<div align=\"center\">"+JSPCombo.draw(frmObject.colNames[JspItemCategory.JSP_PRIORITY],null, ""+objEntity.getPriority(), priority_value , priority_key, "formElemen", "")+"</div>");
				//rowx.add("<div align=\"center\">"+"<input type=\"text\" name=\""+frmObject.colNames[JspItemCategory.JSP_ACCOUNT_CODE] +"\" value=\""+objEntity.getAccountCode()+"\" class=\"formElemen\">"+"</div>");
...
String whereClause = "group_type="+I_Ccs.TYPE_CATEGORY_FINISH_GOODS+" or group_type="+I_Ccs.TYPE_CATEGORY_CIVIL_WORK;//+" or group_type="+I_Ccs.TYPE_CATEGORY_ASSET;
String orderClause = "code";//DbItemCategory.colNames[DbItemCategory.COL_ITEM_GROUP_ID];
...
function cmdAdd(){
	...
	document.frmitemcategory.action="productcategory.jsp";
...
function cmdDelPict(oidItemCategory){
	...
	document.frmimage.action="productcategory.jsp";
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                      ...
                                      </font> <span class="lvl2">Product Sub Category 
                                      </span></b></td>
