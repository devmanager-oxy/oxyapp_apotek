...
<%!
	...
	public String drawList(Vector objectClass ,  long itemMasterId, int start)

	{
		...
		jsplist.addHeader("Name","34%");
                //jsplist.addHeader("Merk","10%");	
		jsplist.addHeader("Category","10%");
		jsplist.addHeader("Sub Category","20%");
		
		//jsplist.addHeader("Unit Purchase","11%");
		//jsplist.addHeader("Unit Recipe","11%");
		jsplist.addHeader("Unit Stock","3%");
		jsplist.addHeader("Unit Cost","10%");
                jsplist.addHeader("Gol 1","10%");
				//jsplist.addHeader("M1%","10%");
				jsplist.addHeader("Gol 2","10%");
				//jsplist.addHeader("M2%","10%");
				jsplist.addHeader("Gol 3","10%");
				//jsplist.addHeader("M3%","10%");
				jsplist.addHeader("Gol 4","10%");
				//jsplist.addHeader("M4%","10%");
				jsplist.addHeader("Gol 5","10%");
				//jsplist.addHeader("M5%","10%");
				jsplist.addHeader("Gol 6","10%");
				//jsplist.addHeader("M6%","10%");
				jsplist.addHeader("Gol 7","10%");
				//jsplist.addHeader("M7%","10%");
				jsplist.addHeader("Gol 8","10%");
				//jsplist.addHeader("M8%","10%");
				jsplist.addHeader("Gol 9","10%");
				//jsplist.addHeader("M9%","10%");
				jsplist.addHeader("Gol 10","10%"); 
				//jsplist.addHeader("M10%","10%"); 
		//jsplist.addHeader("Uom Sales Id","11%");
		//jsplist.addHeader("Margin(%)","7%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			//rowx.add("<div align=\"center\">"+itemMaster.getCode()+"</div>");
                       ...
                       // Merk merk = new Merk();
                        ...
                        //try{
                        //    merk= DbMerk.fetchExc(itemMaster.getMerk_id());
                        //}catch(Exception e){
                            
                        //}
                        
                        //rowx.add("<div align=\"left\">"+merk.getName()+"</div>");
			...
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_2", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_3", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_4", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_5", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_6", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_7", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_8", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_9", itemMaster.getOID()), "#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(DbPriceType.getPrice(1, "gol_10", itemMaster.getOID()), "#,###.##")+"</div>");
			*/ 
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol1(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol1_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol2(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol2_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol3(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol3_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol4(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol4_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol5(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol5_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol6(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol6_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol7(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol7_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol8(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol8_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol9(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol9_margin(),"#,###.##")+"</div>");
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol10(), "#,###.##")+"</div>");
			//rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(pt.getGol10_margin(),"#,###.##")+"</div>");
...
if(srcIgnore==1){
    ...
    whereClause = whereClause + DbItemMaster.colNames[DbItemMaster.COL_IS_ACTIVE]+"=0";
}else{
    if(whereClause.length()>0){
        whereClause = whereClause +" and ";
    }
...
if(iJSPCommand!=JSPCommand.LIST){
    Vector vRptItem = new Vector();
  
    if(srcVendorId!=0){
        vItem = DbItemMaster.listByVendor(0,0, whereClause , orderClause);
    }else{
        vItem = DbItemMaster.list(0,0, whereClause , orderClause);
    }
    if(vItem.size()>0){
        ItemMaster im = new ItemMaster();
        PriceType pt = new PriceType();
        for(int i=0;i<vItem.size();i++){
            RptItemMasterL rim = new RptItemMasterL();
            im = (ItemMaster)vItem.get(i);
            pt=DbPriceType.getPriceType(im.getOID());
            
            rim.setBarcode(im.getBarcode());
            rim.setCode(im.getCode());
            rim.setName(im.getName());
            rim.setGol1(pt.getGol1());
            rim.setGol2(pt.getGol2());
            rim.setGol3(pt.getGol3());
            rim.setGol4(pt.getGol4());
            rim.setGol5(pt.getGol5());
            rim.setMGol1(pt.getGol1_margin());
            rim.setMGol2(pt.getGol2_margin());
            rim.setMGol3(pt.getGol3_margin());
            rim.setMGol4(pt.getGol4_margin());
            rim.setMGol5(pt.getGol5_margin());
            
            Vector vVItem = new Vector();
            vVItem= DbVendorItem.list(0, 0, "vendor_id=" + im.getDefaultVendorId() + " and item_master_id="+ im.getOID(), "");
            VendorItem vendorItem = new VendorItem();
            if(vVItem.size()>0){
                vendorItem = (VendorItem)vVItem.get(0);
            }
            rim.setLastPrice(vendorItem.getLastPrice());
...
Vector temprpt = new Vector(); 
temprpt.add(whereClause);
temprpt.add(orderClause);
temprpt.add(srcVendorId+"");
session.putValue("DETAIL", temprpt); 
...
double printTime = 15; //menit
double printSize = 33400;

printTime = (printTime * vectSize)/printSize;
...
function cmdPrintXLS(){	 
			if(confirm('You are about to download <%=vectSize%> lines data\ndownload will approximate - <%=JSPFormater.formatNumber(printTime, "###")%> MINUTES ! \nproceed anyway ?')){
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;&nbsp;<a href="javascript:cmdToProduct()" class="tablink">Editor</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                ...
                                                <td height="8" valign="middle" colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="6%">Non Active</td>
                                                      <td width="6%"><input type="checkbox" name="src_ignore" value="1" <%if(srcIgnore==1){%>checked<%}%>></td>
							...
							%>
                                              <tr align="left" valign="top"> 
                                                <td height="22" valign="middle" colspan="3"> 
                                                  <%= drawList(listItemMaster,oidItemMaster, start)%> </td>
                                              </tr>
                                              <%  } 
						  }catch(Exception exc){ 
						  }%>
					...
					%>
                                              <tr align="left" valign="top"> 
                                                ...
                                                <%//if(vItem.size()>0){%>
                                                <td height="8" align="left" class="command"><a href="javascript:cmdPrintXLS()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('close211111','','../images/print2.gif',1)"><img src="../images/print.gif" name="close211111" border="0"></a></td>
                                                <%//}%>
                                              </tr>
                                              <%}%>
