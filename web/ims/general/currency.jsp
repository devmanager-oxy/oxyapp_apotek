...
<%!
...

	{
		...
		cmdist.addHeader("Currency Code","30%");
		cmdist.addHeader("Description","70%");
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                      ...
                                      </span>&raquo;</font> <span class="lvl2">Currency</span></b></td>
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="50%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td class="boxed1"><%= drawList(iJSPCommand,jspCurrency, currency,listCurrency,oidCurrency)%></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
