...
<%-- 
    Document   : customerinduklist
    Created on : Feb 2, 2015, 4:44:00 PM
    Author     : Roy
--%>
...
<%!
    public String drawList(int start, Vector objectClass, long customerId) {
        ...
        cmdist.setRowSelectedStyle("tablecell1");
        cmdist.setHeaderStyle("tablehdr");
        cmdist.addHeader("No", "20");
        cmdist.addHeader("Name", "20%");
        cmdist.addHeader("Address", "");
        cmdist.addHeader("Telp", "15%");
        cmdist.addHeader("Contact", "25%");
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                            <tr valign="bottom"> 
                                                                                <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                                                                        ...
                                                                                        </font><span class="lvl2">Group Member List 
                                                                                </span></b></td>
                                                                            ...
                                                                            <tr align="left" valign="top">
                                                                                <td valign="middle" colspan="3">
                                                                                    <table width="600" border="0" cellspacing="1" cellpadding="1">
                                                                                        <tr>
                                                                                            <td colspan="3" class="fontarial"><i>Pencarian</i></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td width="15%" class="tablearialcell1">&nbsp;&nbsp;Nama</td>
                                                                                            <td width="150">:<input type="text" name="src_name"  value="<%= srcCus.getName() %>" class="formElemen" size="20">                                        </td>
