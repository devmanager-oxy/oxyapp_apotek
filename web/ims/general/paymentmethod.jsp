...
<%!
	...
	public String drawList(int iJSPCommand,JspPaymentMethod frmObject, PaymentMethod objEntity, Vector objectClass,  long paymentMethodId)

	{
		...
		ctrlist.addHeader("Description","100%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(index == i && (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK)){
				...
				rowx.add("<input type=\"text\" size=\"100\" name=\""+frmObject.colNames[JspPaymentMethod.JSP_DESCRIPTION] +"\" value=\""+paymentMethod.getDescription()+"\" class=\"formElemen\">");
			}else{
		...
		if(iJSPCommand == JSPCommand.ADD || (iJSPCommand == JSPCommand.SAVE && frmObject.errorSize() > 0)){ 
				rowx.add("<input type=\"text\" size=\"100\" name=\""+frmObject.colNames[JspPaymentMethod.JSP_DESCRIPTION] +"\" value=\""+objEntity.getDescription()+"\" class=\"formElemen\">");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
  ...
  <tr>
                                  ...
                                  <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="70%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td class="boxed1"><%= drawList(iJSPCommand,jspPaymentMethod, paymentMethod,listPaymentMethod,oidPaymentMethod)%></td>
                                              </tr>
                                            </table>
                                          </td>
                                  </tr>
					...
					%>
                        ...
                        <span class="level1">Master 
                        Maintenance </span> &raquo; <span class="level1">General</span> 
                        &raquo; <span class="level2">Payment Method<br>
                        </span><!-- #EndEditable -->
                      </td>
                    </tr>
