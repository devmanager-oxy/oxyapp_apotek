...
<%
	...
	// switch statement
	iErrCode = cmdShipAddress.action(iJSPCommand , oidShipAddress);
	...
	{
		start = cmdShipAddress.actionList(iJSPCommand, start, vectSize, recordToGet);
	} 
...
<script language="JavaScript">
	...
	function cmdAdd(){
		...
		document.frmshipaddress.prev_command.value="<%=prevJSPCommand%>";
					...
					%>
                            ...
                            <tr align="left"> 
                              <td height="8" valign="top" colspan="3"><br>
                                <%if((iJSPCommand ==JSPCommand.ADD)||(iJSPCommand==JSPCommand.SAVE)&&(jspShipAddress.errorSize()>0)||(iJSPCommand==JSPCommand.EDIT)||(iJSPCommand==JSPCommand.ASK)){%>
                        ...
                        Maintenance </span> &raquo; General &raquo; <span class="level2">Ship 
                        Address<br>
                        </span><!-- #EndEditable -->
                      </td>
                    </tr>
