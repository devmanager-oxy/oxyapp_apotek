            ...
            if (vctCtr != null && vctCtr.size() > 0) {
                for (int i = 0; i < vctCtr.size(); i++) {
                    ...
                    countryid_value.add("" + ctr.getName());
                                                                                                                            ...
                                                                                                                            <input type="hidden" name="<%=jspCustomer.colNames[JspCustomer.JSP_DOB]%>" value="1">
                                                                                                                            <%if(true){%>
                                                                                                                            <tr height="23">                                                                                                                             
                                                                                                                                ...
                                                                                                                                <td class="tablearialcell">&nbsp;&nbsp;Price Zone</td> 
                ...
                try {
                    cus = DbCustomer.fetchExc(oidCustomer);
                                                                                                                            ...
                                                                                                                            <tr height="23"> 
                                                                                                                                ...
                                                                                                                                <td width="1" class="fontarial">:</td>
                                                                                                                                <td >                                                                                                                                     
                                                                                                                                    <input type="text" name="<%=jspCustomer.colNames[JspCustomer.JSP_PHONE] %>"  value="<%= (customer.getPhone() == null) ? "" : customer.getPhone() %>" class="formElemen" size="20"><%=jspCustomer.getErrorMsg(jspCustomer.JSP_PHONE)%> *
                                                                                                                                </td>
                                                                                                                                ...
                                                                                                                                <td >
                                                                                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td><%=jspCustomer.getErrorMsg(jspCustomer.JSP_ID_NUMBER)%> *</td>
                                                                                                                                            </tr>
                                                                                                                                            </table>
                                                                                                                                </td>
                                                                                                                                <%if(false){%>
            ...
            for (int i = 0; i < I_Project.idTypeArray.length; i++) {
                ...
                idtype_value.add(I_Project.idTypeArray[i]);
                                                                                                                            ...
                                                                                                                            <tr align="left" height="23"> 
                                                                                                                                ...
                                                                                                                                <td class="fontarial">:</td>
                                                                                                                                <td ><input type="text" name="<%=jspCustomer.colNames[JspCustomer.JSP_CREDIT_LIMIT] %>"  value="<%=JSPFormater.formatNumber(customer.getCreditLimit(), "###,###.##")%>" style="text-align:right" size="20"></td>                                                                                                                                
                                                                                                                            ...
                                                                                                                            <tr align="left" height="23"> 
                                                                                                                                ...
                                                                                                                                <td class="fontarial">:</td>
                                                                                                                                <td ><input type="text" name="<%=jspCustomer.colNames[JspCustomer.JSP_JATUH_TEMPO] %>"  value="<%=customer.getJatuhTempo()%>" style="text-align:right" class="fontarial" size="20"> Day(s)</td>                                                                                                                               
                                                                                                                                <td ></td>
                                                                                                                                <td ></td>
                                                                                                                                <td ></td>  
                                                                                                                            </tr>
