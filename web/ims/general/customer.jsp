...
<%
            ...
            String allowDOB = "Y";
            try {
                allowDOB = DbSystemProperty.getValueByName("ALLOW_DOB_MEMBER");
            } catch (Exception e) {
            }
            ...
            int dobIgnore = 1;
            if (allowDOB.equals("Y")) {
                if (iJSPCommand == JSPCommand.NONE) {
                    dobIgnore = 1;
                } else {
                    dobIgnore = JSPRequestValue.requestInt(request, "dob_ignore");
                }
            }
            ...
            if (!(golPrice.equalsIgnoreCase("0")) && !(golPrice.equalsIgnoreCase(""))) {
                whereClause = whereClause + " and " + DbCustomer.colNames[DbCustomer.COL_GOL_PRICE] + " = '" + golPrice + "'";
            }
        ...
        <!-- #EndEditable -->
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                            <tr valign="bottom"> 
                                                                                <td width="60%" height="23"><b><font color="#990000" class="lvl1">Master 
                                                                                        ...
                                                                                        </font><span class="lvl2">Member List 
                                                                                </span></b></td>
                                                                            ...
                                                                            <tr  id="searching"> 
                                                                                <td height="14" valign="top" colspan="3" class="comment" width="99%"> 
                                                                                    <table border="0" cellspacing="1" cellpadding="0">
                                                                                        ...
                                                                                        <tr height="22"> 
                                                                                            <td nowrap class="tablearialcell1" style="padding:3px;">Type</td>
                                                                                            <td class="fontarial">:</td>
                                                                                            <td >
                                                                                                <select name="type" class="fontarial">
                                                                                                    <option value="<%=-1%>" <%if (type == -1) {%> selected<%}%> >- All Type -</option>
                                                                                                    <option value="<%=DbCustomer.CUSTOMER_TYPE_REGULAR%>" <%if (type == DbCustomer.CUSTOMER_TYPE_REGULAR) {%> selected<%}%> ><%=DbCustomer.customerGroup[DbCustomer.CUSTOMER_TYPE_REGULAR]%> </option>
                                                                                                    <option value="<%=DbCustomer.CUSTOMER_TYPE_COMMON_AREA%>" <%if (type == DbCustomer.CUSTOMER_TYPE_COMMON_AREA) {%> selected<%}%> ><%=DbCustomer.customerGroup[DbCustomer.CUSTOMER_TYPE_COMMON_AREA]%> </option>
                                                                                                </select>
                                                                                            </td>
                                                                                            <td class="tablearialcell1" style="padding:3px;">Registrasi Date</td>
                                                                                            <td class="fontarial">:</td>
                                                                                            <td >
                                                                                        ...
                                                                                        <tr height="23"> 
                                                                                            ...
                                                                                            <%if (allowDOB.equals("Y")) {%>
                                                                                            <td class="tablearialcell" style="padding:3px;">Date Of Birth</td>
                                                                                            <td class="fontarial">:</td>
                                                                                            <td >
                                                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
            ...
            if (locations != null && locations.size() > 0) {
                for (int i = 0; i < locations.size(); i++) {
                    Location d = (Location) locations.get(i);
                                                                                            ...
                                                                                            <td nowrap class="tablearialcell1">&nbsp;Price Type</td>
                                                                                            <td class="fontarial">:</td>
                                                                                            <td>
                                                                                                <select name="src_gol_price"> 
                                                                                                    <option value="0" <%if (golPrice.equalsIgnoreCase("0")) {%>selected<%}%>>- All -</option>
                                                                                                    <%for (int i = 0; i < DbCustomer.golPrice.length; i++) {%>                                                                                                                                               
                                                                                                    <option <%if (golPrice.equalsIgnoreCase(DbCustomer.golPrice[i])) {%>selected<%}%> value="<%=DbCustomer.golPrice[i]%>"><%=DbCustomer.golPrice[i]%></option>
                                                                                                    <%}%>
                                                                                                </select>
                                                                                            </td>
            ...
            try {
                if (listCustomer.size() > 0) {
                                                                                ...
                                                                                <td height="22" valign="middle" colspan="3" width="99%"> 
                                                                                    <table width="1150" border="0" cellpadding="1" cellspacing="1">
                                                                                        <tr height="24">
                                                                                            ...
                                                                                            <td class="tablearialhdr" width="60">Price Zone</td>
                                                                                            <td class="tablearialhdr" width="60">Credit Limit</td>
                                                                                            <td class="tablearialhdr" width="70">Reg. Date</td>
                                                                                            <td class="tablearialhdr" >Name</td>
                                                                                            <td class="tablearialhdr" width="100">Term Of Payment (Days)</td>
                                                                                    ...
                                                                                    for (int i = 0; i < listCustomer.size(); i++) {
                                                                                        ...
                                                                                        <tr height="23">
                                                                                            ...
                                                                                            <td class="<%=style%>" align="left" style="padding:3px;"><%=c.getGolPrice()%> </td>
                                                                                            <td class="<%=style%>" align="right" style="padding:3px;"><%= JSPFormater.formatNumber(c.getCreditLimit(), "#,###.##")  %> </td>
                                                                                            <td class="<%=style%>" align="center" style="padding:3px;"><%=strReg%></td>
                                                                                            <td class="<%=style%>" align="left" style="padding:3px;"><%=c.getName()%></td>
                                                                                            <td class="<%=style%>" align="center" style="padding:3px;"><%=(c.getJatuhTempo())%></td>
                                                                            ...
                                                                            %>
                                                                            <tr align="left" valign="top"> 
                                                                                <td height="8" align="left" colspan="3" class="fontarial" width="99%"> 
                                                                                    <i>Data not found</i>
                                                                                </td>
                                                                            </tr>
                                                                            <%
                                                                                ...
                                                                                <td colspan="3">
                                                                                    <table>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="15"></td>
                                                                                            <%}%>
                                                                                            <%if (privPrint && listCustomer != null && listCustomer.size() > 0) {%>
