...
if(iJSPCommand!=JSPCommand.NONE){
	listReport = SessStockReport.getItemStock(srcCode, srcName, srcLocationId, srcGroupId, orderBy,DbStock.TYPE_CONSIGMENT);
}
...
function cmdSearch(){
	...
	document.frmadjusment.action="stock-location-consigment.jsp";
