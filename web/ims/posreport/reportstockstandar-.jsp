...
<%!
    public String drawList(Vector objectClass, int start) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add("" + ss.getCode());
            rowx.add("" + ss.getBarcode());
            rowx.add("" + ss.getItemName());
...
//get value for report
            ...
            if (srcFromLocationId != 0) {
                ...
                Location loc = (Location) vlocFrom.get(0);
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td width="91%"> 
                                                                                                            <select name="src_fromlocation_id">
                                                                                                                ...
                                                                                                                <%
            if (vlocFrom != null && vlocFrom.size() > 0) {
                for (int i = 0; i < vlocFrom.size(); i++) {
                    Location d = (Location) vlocFrom.get(i);
