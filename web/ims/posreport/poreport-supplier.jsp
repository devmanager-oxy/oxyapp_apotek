...
listReport = DbPurchase.getPuchaseOrderMainData(srcStartDate, srcEndDate, vendorNames, order, srcStatus);
...
function cmdSearch(){
	...
	document.frmadjusment.action="poreport-supplier.jsp";
                                            ...
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                ...
                                                <td class="tablehdr" width="10%">PO 
                                                  Number</td>
                                                <td class="tablehdr" width="29%">Vendor</td>
                                                <td class="tablehdr" width="12%">Amount</td>
                                                <td class="tablehdr" width="8%">Tax</td>
                                                <td class="tablehdr" width="9%">Discount</td>
                                                <td class="tablehdr" width="12%">Total</td>
											  ...
											  for(int i=0; i<listReport.size(); i++){
													...
													totalAmount = totalAmount + purchase.getTotalAmount()-purchase.getDiscountTotal()+purchase.getTotalTax();
                                              ...
                                              <tr> 
                                                ...
                                                <td class="tablecell" width="8%"><%=JSPFormater.formatDate(purchase.getPurchDate(), "dd/MM/yyyy")%></td>
                                                <td class="tablecell" width="10%"><%=purchase.getNumber()%></td>
                                                <td class="tablecell" width="29%"><%=vendor.getName()%></td>
                                                <td class="tablecell" width="12%"> 
                                                  <div align="right"><%=JSPFormater.formatNumber(purchase.getTotalAmount(), "#,###")%></div>
                                                </td>
                                                <td class="tablecell" width="8%"> 
                                                  <div align="right"><%=JSPFormater.formatNumber(purchase.getTotalTax(), "#,###")%></div>
                                                </td>
                                                <td class="tablecell" width="9%"> 
                                                  <div align="right"><%=JSPFormater.formatNumber(purchase.getDiscountTotal(), "#,###")%></div>
                                                </td>
                                                <td class="tablecell" width="12%"> 
                                                  <div align="right"><%=JSPFormater.formatNumber(purchase.getTotalAmount()-purchase.getDiscountTotal()+purchase.getTotalTax(), "#,###")%></div>
                                                </td>
                                                <td class="tablecell" width="9%"> 
                                                  <div align="center"><%=purchase.getStatus()%></div>
                                                </td>
                                              </tr>
                                              <%}else{%>
                                              <tr> 
                                                ...
                                                <td class="tablecell1" width="8%"><%=JSPFormater.formatDate(purchase.getPurchDate(), "dd/MM/yyyy")%></td>
                                                <td class="tablecell1" width="10%"><%=purchase.getNumber()%></td>
                                                <td class="tablecell1" width="29%"><%=vendor.getName()%></td>
                                              ...
                                              <tr> 
                                                ...
                                                <td width="29%" height="25" bgcolor="#CCCCCC"> 
                                                ...
                                                <td width="8%" height="25" bgcolor="#CCCCCC">&nbsp;</td>
                                                <td width="9%" height="25" bgcolor="#CCCCCC"> 
