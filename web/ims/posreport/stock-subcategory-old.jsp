...
<%!
	public Vector drawList(Vector objectClass, int start){
		...
		cmdist.addHeader("Sub Category Name","30%");
...
listReport = SessStockReport.getStockByLocation(srcLocationId, 2, DbStock.TYPE_NON_CONSIGMENT);
...
function cmdSearch(){
	...
	document.frmadjusment.action="stock-subcategory.jsp";
