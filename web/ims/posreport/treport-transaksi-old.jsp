...
<%!
	public Vector drawList(Vector objectClass, int start, int groupBy){
		...
		cmdist.addHeader("Doc Number","15%");
		cmdist.addHeader("Date","10%");
                cmdist.addHeader("From Location","15%");
		cmdist.addHeader("To Location","15%");
                cmdist.addHeader("Total Qty","15%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add("<div align=\"center\">"+(start+i+1)+"</div>");
				...
				detail.setDoc(transferReport.getPurchNumber());
                        rowx.add(""+transferReport.getDate());
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tab" nowrap> 
                                            <div align="center">&nbsp;By Transaction&nbsp;&nbsp;</div>
                                          </td>
