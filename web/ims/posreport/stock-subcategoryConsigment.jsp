...
listReport = SessStockReport.getStockByLocation(srcLocationId, I_Project.GROUP_SUB_CATEGORY, DbStock.TYPE_CONSIGMENT);
...
function cmdSearch(){
	...
	document.frmadjusment.action="stock-subcategoryConsigment.jsp";
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Reports</font><font class="tit1"> 
                                      ...
                                      <span class="lvl2">Item Sub Category</span></font></b></td>
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/stock-categoryConsigment.jsp?menu_idx=3" class="tablink">By Category</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tab" nowrap> 
