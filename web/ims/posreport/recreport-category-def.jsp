...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptIRCategoryL detail = new RptIRCategoryL();
...
RptIRCategory rptKonstan = new RptIRCategory();

SrcReceiveReport srcReceiveReport = new SrcReceiveReport();
srcReceiveReport.setTypeReport(SrcReceiveReport.GROUP_BY_CATEGORY);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptIRCategoryXLS?idx=<%=System.currentTimeMillis()%>");
}
