...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			rowx.add("<div align=\"center\">"+purchaseOrderReport.getPurchNumber()+"</div>");
			rowx.add(""+purchaseOrderReport.getVendorName());
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Transaction 
                                      </font><font class="tit1">&raquo; </font><b><font color="#990000" class="lvl1">Report
                                      </font><font class="tit1">&raquo; <span class="lvl2">Purchase Order Report</span></font></b></td>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="javascript:cmdAdd()" class="tablink">Report by Category</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          ...
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="12%"><select name="src_location_id">
                                                ...
                                                <td width="57%"><select name="src_vendor_id">
                                              ...
                                              <tr> 
                                                <td height="5">Document Status </td>
                                                <td height="5"><select name="src_status">
                                                ...
                                                <td height="5" align="right">Group By </td>
                                                <td height="5"><select name="group_by">
                                                  <option value="" >- All -</option>
