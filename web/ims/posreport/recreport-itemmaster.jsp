...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptIRItemL detail = new RptIRItemL();
...
RptIRItem rptKonstan = new RptIRItem();

SrcReceiveReport srcReceiveReport = new SrcReceiveReport();
srcReceiveReport.setTypeReport(SrcReceiveReport.GROUP_BY_ITEM);
...
srcReceiveReport.setItemCategoryId(srcCategoryId);
srcReceiveReport.setItemSubCategoryId(srcSubCategoryId);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptIRItemXLS?idx=<%=System.currentTimeMillis()%>");
}

function cmdSearch(){
	document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
	document.frmadjusment.action="recreport-itemmaster.jsp";
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/recreport-supplier.jsp?menu_idx=13" class="tablink">Report by Supplier</a>&nbsp;&nbsp;</div>
                                          </td>
