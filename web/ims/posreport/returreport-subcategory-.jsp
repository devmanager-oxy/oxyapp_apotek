...
<%!
...

	{
		...
		cmdist.addHeader("Category","25%");
		cmdist.addHeader("Number PO","13%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			ReturReport purchaseOrderReport = (ReturReport)objectClass.get(i);
			RptPRSubCategoryL detail = new RptPRSubCategoryL();
			Vector rowx = new Vector();

            rowx.add("<div align=\"center\">"+(start+i+1)+"</div>"); 
				detail.setNo((start+i+1));        
			rowx.add(""+purchaseOrderReport.getItemCategory());
				detail.setCategory(purchaseOrderReport.getItemCategory());
...
RptPRSubCategory rptKonstan = new RptPRSubCategory();
  
SrcReturReport srcReturReport = new SrcReturReport();
srcReturReport.setTypeReport(SrcReturReport.GROUP_BY_SUB_CATEGORY);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptPRSubCategoryXLS?idx=<%=System.currentTimeMillis()%>");
}

function cmdSearch(){
	document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
	document.frmadjusment.action="returreport-subcategory.jsp";
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tab" nowrap> 
										  	<div align="center">&nbsp;Report by Sub Category&nbsp;&nbsp;</div>
                                            
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/returreport-itemmaster.jsp?menu_idx=13" class="tablink">Report by Item</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                ...
                                                <td height="5" width="61%"> 
                                                  <select name="group_by">
												   <%
													...
													%>
                                                    <option value="3" <%if(groupBy==3){%>selected<%}%>>Sub Category</option>
                                                  </select>
                                                </td>
                                              </tr>
                                              <tr> 
