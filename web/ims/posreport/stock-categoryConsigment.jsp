...
<%!
	public Vector drawList(Vector objectClass, int start){
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			totalamount = totalamount + stockReportL.getAmount();
			rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(stockReportL.getAmount(), "#,###.##")+"</div>");
...
listReport = SessStockReport.getStockByLocation(srcLocationId, I_Project.GROUP_CATEGORY, DbStock.TYPE_CONSIGMENT);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptStockByCategoryXLS?idx=<%=System.currentTimeMillis()%>");
}

function cmdSearch(){
	document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
	document.frmadjusment.action="stock-categoryConsigment.jsp";
                            ...
                            <tr> 
                              <td valign="top"> 
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Reports</font><font class="tit1">&raquo; 
                                      </font><font color="#990000" class="lvl1">Stock 
                                      Report </font><font class="tit1">&raquo; 
                                      <span class="lvl2">Item Category</span></font></b></td>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/stock-location-consigment.jsp?menu_idx=3" class="tablink">By Location</a>&nbsp;&nbsp;</div>
                                          </td>
                                          ...
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/stock-subcategoryConsigment.jsp?menu_idx=3" class="tablink">By Sub Category</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
