...
<%!
	public Vector drawList(Vector objectClass, int start){
		...
		cmdist.addHeader("No","5%");
                cmdist.addHeader("Supplier","12%");
                cmdist.addHeader("Code","10%");
		cmdist.addHeader("Name","35%");
		cmdist.addHeader("Number Transfer","10%");
		cmdist.addHeader("Qty","8%");
		cmdist.addHeader("Location From","10%");
                cmdist.addHeader("Location To","10%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			Vector rowx = new Vector();
                        ...
                        //try{
                        //    loc = DbLocation.fetchExc()
                        //}
                        rowx.add("<div align=\"center\">"+(start+i+1)+"</div>");         
				detail.setNo((start+i+1));
                        if(transferReport.getVendorId()!=0){
                            Vendor ven = new Vendor();
                            try{
                                ven = DbVendor.fetchExc(transferReport.getVendorId());
                            }catch(Exception ex){
                                
                            }
                            rowx.add("<div align=\"center\">"+ven.getName() +"</div>");                 
                        }
                        
                                
                        rowx.add("<div align=\"left\">"+transferReport.getItemCode()+"</div>");
				detail.setCode(transferReport.getItemCode());        
                        rowx.add("<div align=\"left\">"+transferReport.getItemName()+"</div>");
			...
			rowx.add("<div align=\"left\">"+transferReport.getLocationName()+"</div>");         
				//((transferReport.getLocationToName()));
                        rowx.add("<div align=\"left\">"+transferReport.getLocationToName()+"</div>");         
...
srcTransferReport.setTypeReport(SrcTransferReport.GROUP_BY_SUPPLIER);
...
srcTransferReport.setCode(srcCode);
srcTransferReport.setItem_name(srcName);
srcTransferReport.setVendorId(srcVendorId);

CmdTransfer ctrlStock = new CmdTransfer(request);
int vectSize = SessTransferReport.getTransferItemCount(srcTransferReport);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptITItemXLS?idx=<%=System.currentTimeMillis()%>");
}

function cmdSearch(){
	document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
        document.frmadjusment.start.value=0;
	document.frmadjusment.action="treport-bysupplier.jsp";
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/treport-subcategory.jsp?menu_idx=13" class="tablink">By Sub Category</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                          ...
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tab" nowrap> 
                                            <div align="center">&nbsp;By Supplier&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                              ...
                                              <tr> 
                                                ...
                                                <td height="5" width="61%"> 
                                                  <select name="group_by">
                                                    ...
                                                    <%
														if(groupBy==4){
															rptKonstan.setGroupBy("Item");
														}
													%>
													<option value="4" <%if(groupBy==4){%>selected<%}%>>Item</option>
                                                  </select>
                                                </td>
                                              </tr>
                                              
                                              <tr> 
                                                <td height="5" width="15%">Code   </td>
                                                <td height="5" width="16%"> 
                                                    <input type="text" name="src_code" value="<%=srcCode%>" onChange="javascript:cmdSearch()">
                                                </td>
                                                <td height="5" align="right" width="8%">Name </td>
                                                <td height="5" width="61%"> 
                                                  <input type="text" name="src_name" size="20" value="<%=srcName%>" onChange="javascript:cmdSearch()">
                                                </td>
                                              </tr>
                                              <tr>
                                                <td width="12%" align="left">Supplier</td>
                                                <td width="16%"> 
