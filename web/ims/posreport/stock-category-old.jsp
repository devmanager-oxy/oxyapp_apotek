...
<%!
	public Vector drawList(Vector objectClass, int start){
		...
		cmdist.addHeader("Category Name","30%");
...
listReport = SessStockReport.getStockByLocation(srcLocationId, 1, DbStock.TYPE_NON_CONSIGMENT);
...
function cmdSearch(){
	...
	document.frmadjusment.action="stock-category.jsp";
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/stock-location.jsp?menu_idx=13" class="tablink">By Location</a>&nbsp;&nbsp;</div>
                                          </td>
