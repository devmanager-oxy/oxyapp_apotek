...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptPRSupplierL detail = new RptPRSupplierL();
...
srcReturReport.setTypeReport(SrcReturReport.GROUP_BY_SUPPLIER);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptPRSupplierXLS?idx=<%=System.currentTimeMillis()%>");
}

function cmdSearch(){
	document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
	document.frmadjusment.action="returreport-supplier.jsp";
                                              ...
                                              <tr> 
                                                ...
                                                <td height="5" width="61%"> 
                                                  <select name="group_by">
                                                    ...
                                                    <%
														if(groupBy==1){
															rptKonstan.setGroupBy("Supplier");
														}
													%>
													<option value="1" <%if(groupBy==1){%>selected<%}%>>Supplier</option>
                                                  </select>
                                                </td>
                                              </tr>
                                              <tr> 
