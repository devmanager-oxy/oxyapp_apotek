...
//listReport = SessReceiveReport.getReceiveReport(srcReceiveReport);
            listReport = SessReceiveReport.getReceiveMainData(srcStartDate, srcEndDate, srcReceiveReport, order);
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
        ...
        <script language="JavaScript">
            ...
            function cmdPrintXLS(){	 
                ...
                function cmdSearch(){
                    ...
                    document.frmadjusment.action="incoming-report-sumary.jsp";
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/search2.gif','../images/new2.gif','../images/print2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3"> 
                                                                                                <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="10%">Vendor/Supplier</td>
                                                                                                        <td width="90%"> 
            ...
            Vector vVen = DbVendor.list(0, 0, "", "name");

            if (vVen != null && vVen.size() > 0) {
                for (int i = 0; i < vVen.size(); i++) {
                    Vendor d = (Vendor) vVen.get(i);
                    String str = "";
                                                                                                                %>
    ...
    for (int i = 0; i < listReport.size(); i++) {
        ...
        totalAmount = totalAmount + Double.parseDouble(temp.get(4).toString()) - Double.parseDouble(temp.get(6).toString()) + Double.parseDouble(temp.get(5).toString());
        subTotal = subTotal + Double.parseDouble(temp.get(4).toString());

        Purchase purchase = new Purchase();
        try {
            purchase = DbPurchase.fetchExc(Long.parseLong(temp.get(0).toString()));

        } catch (Exception e) {
        }


        detail.setDoc(temp.get(2).toString());
        detail.setNo((i + 1));
        detail.setSupplier(temp.get(3).toString());
        detail.setTotalAmount(Double.parseDouble(temp.get(4).toString()) - Double.parseDouble(temp.get(6).toString()) + Double.parseDouble(temp.get(5).toString()));
        detail.setAmount(Double.parseDouble(temp.get(4).toString()));
        detail.setDiscount(Double.parseDouble(temp.get(6).toString()));
        detail.setTax(Double.parseDouble(temp.get(5).toString()));
        detail.setRecLocation(temp.get(8).toString());
        detail.setDate(JSPFormater.formatDate(String.valueOf("" + temp.get(1)), "dd/MM/yyyy"));
        //JSPFormater.forma
        ...
        if (i % 2 == 0) {
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td class="tablecell" width="8%"><%=JSPFormater.formatDate(detail.getDate(), "dd/MM/yyyy")%></td>
                                                                                                        <td class="tablecell" width="9%"><%=temp.get(2).toString()%></td>
                                                                                                        <td class="tablecell" width="8%"><%=purchase.getNumber()%></td>
                                                                                                        <td class="tablecell" width="25%"><%=temp.get(3).toString()%></td>
                                                                                                        <td class="tablecell" width="12%"> 
                                                                                                            <div align="right"><%=JSPFormater.formatNumber(Double.parseDouble(temp.get(4).toString()), "#,###")%></div>
                                                                                                        </td>
                                                                                                        <td class="tablecell" width="9%"> 
                                                                                                            <div align="right"><%=JSPFormater.formatNumber(Double.parseDouble(temp.get(5).toString()), "#,###")%></div>
                                                                                                        </td>
                                                                                                        <td class="tablecell" width="8%"> 
                                                                                                            <div align="right"><%=JSPFormater.formatNumber(Double.parseDouble(temp.get(6).toString()), "#,###")%></div>
                                                                                                        </td>
                                                                                                        <td class="tablecell" width="10%"> 
                                                                                                            <div align="right"><%=JSPFormater.formatNumber(Double.parseDouble(temp.get(4).toString()) - Double.parseDouble(temp.get(6).toString()) + Double.parseDouble(temp.get(5).toString()), "#,###")%></div>
                                                                                                        </td>
                                                                                                        <td class="tablecell" width="8%"> 
                                                                                                            <div align="center"><%=temp.get(7).toString()%></div>
                                                                                                        </td>
                                                                                                        <td class="tablecell" width="8%"> 
                                                                                                            <div align="center"><%=temp.get(8).toString()%></div>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <%} else {%>
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td class="tablecell1" width="8%"><%=JSPFormater.formatDate(detail.getDate(), "dd/MM/yyyy")%></td>
                                                                                                        <td class="tablecell1" width="9%"><%=temp.get(2).toString()%></td>
                                                                                                        <td class="tablecell1" width="8%"><%=purchase.getNumber()%></td>
                                                                                                        <td class="tablecell1" width="25%"><%=temp.get(3).toString()%></td>
