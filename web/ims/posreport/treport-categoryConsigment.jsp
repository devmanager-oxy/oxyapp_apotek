...
<%!
	public Vector drawList(Vector objectClass, int start, int groupBy){
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptITCategoryL detail = new RptITCategoryL();
...
RptITCategory rptKonstan = new RptITCategory();

SrcTransferReport srcTransferReport = new SrcTransferReport();
srcTransferReport.setTypeReport(SrcTransferReport.GROUP_BY_CATEGORY);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptITCategoryXLS?idx=<%=System.currentTimeMillis()%>");
}

function cmdSearch(){
	document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
	document.frmadjusment.action="treport-categoryConsigment.jsp";
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tab" nowrap> 
                                            <div align="center">&nbsp;By Category&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
