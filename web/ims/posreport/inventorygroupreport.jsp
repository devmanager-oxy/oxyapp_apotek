...
<%-- 
    Document   : inventorygroupreport
    Created on : Dec 16, 2013, 2:16:26 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            if (session.getValue("REPORT_INVENTORY_GROUP_STOCK") != null) {
                session.removeValue("REPORT_INVENTORY_GROUP_STOCK");
            }
    ...
    <head>
        ...
        <script language="JavaScript">            
            ...
            function cmdPrintJournalXls(){	                       
                window.open("<%=printroot%>.report.RptInventoryGroupXLS?user_id=<%=appSessUser.getUserOID()%>&lang=<%=lang%>&location_id=<%=locationId%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                }
                
                function cmdSearch(){
                    document.frmsalescategory.command.value="<%=JSPCommand.SEARCH%>";
                    document.frmsalescategory.action="inventorygroupreport.jsp?menu_idx=<%=menuIdx%>";
                                                                                                                            ...
                                                                                                                            <tr align="left" valign="top"> 
                                                                                                                                <td height="22" valign="middle" colspan="4"> 
                                                                                                                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                                                                                                        <tr height="20">                                                                                                                                             
                                                                                                                                            <td class="tablearialhdr" width="10%">GROUP NAME</td>                                                                                                                                            
                                                                                                                                        ...
                                                                                                                                        <%
                                                                                                                                                ...
                                                                                                                                                double grandTotStock = 0;
                                                                                                                                                double grandTotPrice = 0;
                                                                                                                                                double grandTotPriceStock = 0;
                                                                                                                                                ...
                                                                                                                                                for (int i = 0; i < vCategory.size(); i++) {
                                                                                                                                                    ...
                                                                                                                                                    try {
                                                                                                                                                        ...
                                                                                                                                                        if (ic.getOID() != 0) {
                                                                                                                                                            sql = sql + " and " + DbItemMaster.colNames[DbItemMaster.COL_ITEM_GROUP_ID] + " = " + ic.getOID();
                                                                                                                                                        }
                                                                                                                                                        ...
                                                                                                                                                        while (rs.next()) {
                                                                                                                                                            ...
                                                                                                                                                            totPriceStock = totPriceStock + ( stock * price);

                                                                                                                                                        }
                                                                                                                                                        
                                                                                                                                                        InventoryStock iStock = new InventoryStock();

                                                                                                                                                        iStock.setName(ic.getName());
                                                                                                                                                        iStock.setPrice(totPrice);
                                                                                                                                                        iStock.setStock(totStock);
                                                                                                                                                        iStock.setTotPrice(totPriceStock);
                                                                                                                                                        result.add(iStock);

                                                                                                                                                        grandTotStock = grandTotStock + totStock;
                                                                                                                                                        grandTotPrice = grandTotPrice + totPrice;
                                                                                                                                                        grandTotPriceStock = grandTotPriceStock + totPriceStock;
                                                                                                                                        %>
                                                                                                                                        <tr height="20"> 
                                                                                                                                            <td class="tablearialcell" colspan="1" align="left"><b><%=ic.getName()%></b></td>                                                                                                                                                                                                                                                                                        
                                                                                                                                            <td class="tablearialcell" align="right"><b><%=JSPFormater.formatNumber(totStock, "#,###.##") %></b></td>
                                                                                                                                            <td class="tablearialcell" align="right"><b><%=JSPFormater.formatNumber(totPrice, "#,###.##") %></b></td>
                                                                                                                                            <td class="tablearialcell" align="right"><b><%=JSPFormater.formatNumber(totPriceStock, "#,###.##") %></b></td>                                                                                    
                                                                                                                                        </tr>  
                                                                                                                                        <%} catch (Exception e) {
                                                                                                                                                    }
                                                                                                                                                }
                                                                                                                                                
                                                                                                                                                session.putValue("REPORT_INVENTORY_GROUP_STOCK",result);
                                                                                                                                        %>
                                                                                                                                        <tr height="20"> 
                                                                                                                                            <td class="tablearialcell1" colspan="1" align="center"><b>GRAND TOTAL</b></td>                                                                                                                                                                                                                                                                                        
                                                                                                                                            <td class="tablearialcell1" align="right"><b><%=JSPFormater.formatNumber(grandTotStock, "#,###.##") %></b></td>
                                                                                                                                            <td class="tablearialcell1" align="right"><b><%=JSPFormater.formatNumber(grandTotPrice, "#,###.##") %></b></td>
                                                                                                                                            <td class="tablearialcell1" align="right"><b><%=JSPFormater.formatNumber(grandTotPriceStock, "#,###.##") %></b></td>                                                                                    
                                                                                                                                        </tr> 
                                                                                                                                        <tr align="left" valign="top"> 
