...
<%!
    public Vector drawList(Vector objectClass, int start) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            RptPRCategoryL detail = new RptPRCategoryL();
...
//get value for report
            RptPRCategory rptKonstan = new RptPRCategory();

            SrcReturReport srcReturReport = new SrcReturReport();
            srcReturReport.setTypeReport(SrcReturReport.GROUP_BY_CATEGORY);
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdPrintXLS(){	 
                window.open("<%=printroot%>.report.RptPRCategoryXLS?idx=<%=System.currentTimeMillis()%>");
                }
                
                function cmdSearch(){
                    document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
                    document.frmadjusment.action="returreport-category.jsp";
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
            ...
            if (groupBy == 0) {
                rptKonstan.setGroupBy("Transaction");
                                                                                                                ...
                                                                                                                <%
            if (groupBy == 2) {
                rptKonstan.setGroupBy("Category");
            }
                                                                                                                %>
                                                                                                                <option value="2" <%if (groupBy == 2) {%>selected<%}%>>Category</option>
                                                                                                            </select>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr> 
