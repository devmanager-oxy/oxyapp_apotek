...
<%!
	public Vector drawList(Vector objectClass, int start){
		...
		cmdist.addHeader("Location From","15%");
                cmdist.addHeader("Location To","15%");
...
srcTransferReport.setTypeReport(SrcTransferReport.GROUP_BY_ITEM);
...
session.putValue("PARAMETER", srcTransferReport);
...
//if(iJSPCommand==JSPCommand.PRINT){
   // vItem = SessTransferReport.getTransferReport(srcTransferReport, DbTransfer.TYPE_NON_CONSIGMENT, 0, 0 );  
...
function cmdSearch(){
	...
	document.frmadjusment.action="treport-itemmaster.jsp";
