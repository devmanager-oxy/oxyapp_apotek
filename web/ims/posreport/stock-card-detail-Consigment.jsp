...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
                    ...
                    function cmdShowStockCode(){                   
                        ...
                        document.frmstockcardDetailCons.action="stock-card-detail-Consigment.jsp";
    ...
    <body> 
        <table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
            ...
            <td width="15%" class="tablehdr">Date</td>
                                
            <td width="37%" class="tablehdr">Description</td>
                                
            <td width="19%" class="tablehdr">Qty In</td>
                                
            <td width="19%" class="tablehdr">Qty Out</td>
                            </tr>   
                            <%
            ...
            <td width="15%" class= "tablecell"><%=JSPFormater.formatDate(stock.getDate(), "dd-MM-yyyy")%></td>
                                
            <td width="37%" class= "tablecell"><%=DbStock.strType[stock.getType()]%></td>
                                
            <td width="19%" class= "tablecell"><%=qtyIn%></td>
                                
            <td width="19%" class= "tablecell"><%=qtyOut%></td>
                            </tr>
                            <%
                            if(vStokCode != null){
            ...
            <td width="37%" class= "tablecell" ><%=stockCode.getCode()%></td>
            ...
            <td width="19%" class= "tablecell"></td>
                        ...
                        pg++;
                            ...
                            <tr>
                                ...
                                <td width="37%" class= "tablecell" align="center"><b>Total</b></td>


                                <td width="19%" class= "tablecell"><b><%=sumQtyIn%></b></td>


                                <td width="19%" class= "tablecell"><b><%=sumQtyOut%><b></td>
                            </tr>
                            <tr>
            ...
            <tr> 
               <td colspan="2">
                        <table width="100%" border="0" cellpadding="0" cellspacing="1">   
                            <tr>
                            <td width="15%"><a href="javascript:cmdShowStockCode()"> Preview Stock Code</a></td>
