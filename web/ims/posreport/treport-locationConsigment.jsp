...
<%!
	public Vector drawList(Vector objectClass, int start, int groupBy){
		...
		cmdist.addHeader("From Location","30%");
		cmdist.addHeader("To Location","30%");
		cmdist.addHeader("Doc","10%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptITLocationL detail = new RptITLocationL();
			Vector rowx = new Vector();

                rowx.add("<div align=\"center\">"+(start+i+1)+"</div>");
				detail.setNo((start+i+1));
			rowx.add(""+transferReport.getLocationName());
				detail.setLocation(transferReport.getLocationName());
			rowx.add("<div align=\"left\">"+transferReport.getLocationToName()+"</div>");
				detail.setToLocation(transferReport.getLocationToName());
			rowx.add(""+transferReport.getPurchNumber());
				detail.setDoc(transferReport.getPurchNumber());
							
			if(groupBy!=0){
				totalamount = totalamount + Double.parseDouble(transferReport.getPurchNumber());
				detail.setTotalDoc(totalamount);
			}else{
		...
		rowx.add("<div align=\"center\"><b>"+JSPFormater.formatNumber(totalamount,"##,##0.00")+"</b></div>");
		lstData.add(rowx);
...
srcTransferReport.setTypeReport(SrcTransferReport.GROUP_BY_LOCATION);
...
listReport = SessTransferReport.getTransferReport(srcTransferReport, DbTransfer.TYPE_CONSIGMENT);
...
function cmdSearch(){
	...
	document.frmadjusment.action="treport-locationConsigment.jsp";
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/treport-categoryConsigment.jsp?menu_idx=3" class="tablink">By Category</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/treport-subcategoryConsigment.jsp?menu_idx=3" class="tablink">By Sub Category</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/treport-itemmasterConsigment.jsp?menu_idx=3" class="tablink">By Item</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                              ...
                                              <tr> 
                                                ...
                                                <td height="5" width="61%"> 
                                                  <select name="group_by">
                                                    ...
                                                    <%
														if(groupBy==5){
															rptKonstan.setGroupBy("From Location");
														}
													%>
                                                    <option value="5" <%if(groupBy==5){%>selected<%}%>>From 
                                                    Location</option>
                                                    <%
														if(groupBy==6){
															rptKonstan.setGroupBy("To Location");
														}
													%>
                                                    <option value="6" <%if(groupBy==6){%>selected<%}%>>To 
                                                    Location</option>
                                                  </select>
                                                </td>
                                              </tr>
