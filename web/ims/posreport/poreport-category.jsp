...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptPoSupplierL detail = new RptPoSupplierL();
			
			Vector rowx = new Vector();
			
			Vendor vnd = new Vendor();
			try{
				vnd = DbVendor.fetchExc(purchaseOrderReport.getVendorId());
			}catch(Exception ex){
			}
			...
			rowx.add(""+purchaseOrderReport.getPurchNumber());
				detail.setDoc(purchaseOrderReport.getPurchNumber());
...
RptPoSupplier rptKonstan = new RptPoSupplier();

SrcPurchaseOrderReport srcPurchaseOrderReport = new SrcPurchaseOrderReport();
srcPurchaseOrderReport.setTypeReport(SrcPurchaseOrderReport.GROUP_BY_SUPPLIER);
...
//listReport = DbPurchase.getPuchaseOrderByItemGroup(srcStartDate, srcEndDate, vendorNames, order, srcStatus, itemCategoryId);
...
function cmdSearch(){
	...
	document.frmadjusment.action="poreport-category.jsp";
                        ...
                        <form name="frmadjusment" method ="post" action="">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <td height="8"  colspan="3"> 
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/poreport-itemmaster.jsp?menu_idx=13" class="tablink">Report by Item</a>&nbsp;&nbsp;</div>
                                          </td-->
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                    ...
                                    <td height="8"  colspan="3" class="page"> 
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                              ...
                                              <tr> 
                                                <td height="5" width="9%">PO Status 
                                                </td>
                                                <td height="5" width="91%"> 
                                              ...
                                              <tr> 
                                                <td width="9%">Order By</td>
                                                <td width="91%"> 
                                                  <select name="src_order">
                                                    <option value="0" <%if(order==0){%>selected<%}%>>Vendor 
                                                    Name</option>
                                                    <option value="1" <%if(order==1){%>selected<%}%>>PO 
                                                    Date</option>
													<option value="2" <%if(order==2){%>selected<%}%>>Item Name</option>
                                                  </select>
                                                </td>
                                              </tr>
                                              <tr> 
										...
										for(int x=0; x<groups.size(); x++){
											...
											listReport = DbPurchase.getPuchaseOrderByItemGroup(srcStartDate, srcEndDate, vendorNames, order, srcStatus, ig.getOID());
											
											if (listReport!=null && listReport.size()>0){
										%>
										<tr align="left" valign="top"> 
                                          <td height="27" align="left" colspan="3" class="command" valign="middle" bgcolor="#EAEAD5">&nbsp;<b>GROUP 
                                          ...
                                          <td class="boxed1" height="22" valign="middle" colspan="3"> 
                                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                              <tr> 
                                                ...
                                                <td class="tablehdr" width="9%">PO 
                                                  Number</td>
                                                <td class="tablehdr" width="23%">Vendor</td>
                                                <td class="tablehdr" width="27%">Item 
                                                  Desc. </td>
											  ...
											  for(int i=0; i<listReport.size(); i++){
													...
													Purchase purchase = (Purchase)temp.get(0);
													Vendor vendor = (Vendor)temp.get(1);
													ItemMaster im = (ItemMaster)temp.get(2);
													PurchaseItem pi = (PurchaseItem)temp.get(3);
													
													totalAmount = totalAmount + (pi.getAmount()*pi.getQty());//purchase.getTotalAmount()-purchase.getDiscountTotal()+purchase.getTotalTax();
													//subTotal = subTotal + purchase.getTotalAmount();
                                              ...
                                              <tr> 
                                                ...
                                                <td class="tablecell" width="8%"><font size="1"><%=JSPFormater.formatDate(purchase.getPurchDate(), "dd/MM/yyyy")%></font></td>
                                                <td class="tablecell" width="9%"><font size="1"><%=purchase.getNumber()%></font></td>
                                                <td class="tablecell" width="23%"><font size="1"><%=vendor.getName()%></font></td>
                                                <td class="tablecell" width="27%"><font size="1"><%=im.getName()%></font></td>
                                              ...
                                              <tr> 
                                                ...
                                                <td class="tablecell1" width="8%"><font size="1"><%=JSPFormater.formatDate(purchase.getPurchDate(), "dd/MM/yyyy")%></font></td>
                                                <td class="tablecell1" width="9%"><font size="1"><%=purchase.getNumber()%></font></td>
                                                <td class="tablecell1" width="23%"><font size="1"><%=vendor.getName()%></font></td>
                                                <td class="tablecell1" width="27%"><font size="1"><%=im.getName()%></font></td>
                                              ...
                                              <tr> 
                                                ...
                                                <td width="23%" height="18" bgcolor="#CCCCCC"> 
                                                  <div align="center"><b>T O T 
                                                    A L :</b></div>
                                                </td>
                                                <td width="27%" height="18" bgcolor="#CCCCCC">&nbsp;</td>
							...
							%>
                                        <%if (listReport.size()>0){%>
                                        <tr align="left" valign="top"> 
                                          <td height="8" align="left" colspan="3" class="command" valign="top">&nbsp;</td>
                                        </tr>
                                        <%}%>
                                        <tr align="left" valign="top"> 
                                          <td height="8" align="left" colspan="3" class="command" valign="top">&nbsp;</td>
