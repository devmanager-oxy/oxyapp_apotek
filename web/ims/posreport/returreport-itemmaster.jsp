...
<%!
    public Vector drawList(Vector objectClass, int start) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ReturReport receiveReport = (ReturReport) objectClass.get(i);
            RptPRItemL detail = new RptPRItemL();
            Vector rowx = new Vector();

            rowx.add("<div align=\"center\">" + (start + i + 1) + "</div>");
            detail.setNo((start + i + 1));
            rowx.add("<div align=\"left\">" + receiveReport.getItemCode() + "</div>");
            detail.setCode(receiveReport.getItemCode());
            rowx.add("<div align=\"left\">" + receiveReport.getItemName() + "</div>");
            detail.setName(receiveReport.getItemName());
            rowx.add("" + receiveReport.getPurchNumber());
            detail.setNoPo(receiveReport.getPurchNumber());
            rowx.add("<div align=\"center\">" + receiveReport.getTotalQty() + "</div>");
            detail.setQty(receiveReport.getTotalQty());
            ...
            totalQty = totalQty + receiveReport.getTotalQty();
            lstData.add(rowx);
            temp.add(detail);
...
//get value for report
            RptPRItem rptKonstan = new RptPRItem();

            SrcReturReport srcReturReport = new SrcReturReport();
            srcReturReport.setTypeReport(SrcReturReport.GROUP_BY_ITEM);
            srcReturReport.setLocationId(srcLocationId);
            srcReturReport.setVendorId(srcVendorId);
            srcReturReport.setFromDate(srcStartDate);
            srcReturReport.setToDate(srcEndDate);
            srcReturReport.setIgnoreDate(srcIgnore);
            srcReturReport.setGroupBy(groupBy);
            srcReturReport.setItemCategoryId(srcCategoryId);
            srcReturReport.setItemSubCategoryId(srcSubCategoryId);
            srcReturReport.setStatus(srcStatus);

            listReport = SessReturReport.getReturReport(srcReturReport);
    ...
    <head>
        ...
        <script language="JavaScript">
            function cmdPrintXLS(){	 
                window.open("<%=printroot%>.report.RptPRItemXLS?idx=<%=System.currentTimeMillis()%>");
                }
                
                function cmdSearch(){
                    document.frmadjusment.command.value="<%=JSPCommand.LIST%>";
                    document.frmadjusment.action="returreport-itemmaster.jsp";
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                            <tr valign="bottom"> 
                                                                                <td width="60%" height="23"><b><font color="#990000" class="lvl1">Report 
                                                                                        ...
                                                                                        Retur </font><font class="tit1">&raquo; 
                                                                                    ...
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr > 
                                                                                            <td class="tabin" nowrap> 
                                                                                                <div align="center">&nbsp;<a href="<%=approot%>/posreport/returreport-supplier.jsp?menu_idx=13" class="tablink">Report by Supplier</a>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                            <td class="tabin" nowrap> 
                                                                                                <div align="center">&nbsp;<a href="<%=approot%>/posreport/returreport-category.jsp?menu_idx=13" class="tablink">Report by Category</a>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                            <td class="tabin" nowrap> 										  	
                                                                                                <div align="center">&nbsp;<a href="<%=approot%>/posreport/returreport-subcategory.jsp?menu_idx=13" class="tablink">Report by Sub Category</a>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                            <td class="tab" nowrap> 
                ...
                for (int i = 0; i < locations.size(); i++) {
                    ...
                    if (srcLocationId == d.getOID()) {
                        rptKonstan.setLocation(d.getName());
                                                                                                        ...
                                                                                                        <td width="13%" align="right">Supplier</td>
                                                                                                        <td width="57%"> 
                ...
                for (int i = 0; i < vendors.size(); i++) {
                    ...
                    if (srcVendorId == d.getOID()) {
                        rptKonstan.setSupplier(d.getName());
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="11%">Request Between</td>
                                                                                                        <td> 
            ...
            if (groupBy == 4) {
                rptKonstan.setGroupBy("Item Master");
                                                                                                                ...
                                                                                                                %>
                                                                                                                <option value="4" <%if (groupBy == 4) {%>selected<%}%>>Item Master</option>
                                                                                                            </select>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr> 
