...
<%!
	public Vector drawList(Vector objectClass, int start, int groupBy){
		...
		cmdist.addHeader("Number Transfer","15%");
...
function cmdSearch(){
	...
	document.frmadjusment.action="treport-itemmasterConsigment.jsp";
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="<%=approot%>/posreport/treport-locationConsigment.jsp?menu_idx=3" class="tablink">By Location</a>&nbsp;&nbsp;</div>
                                          </td>
