...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			RptPoCategoryL detail = new RptPoCategoryL();
...
RptPoCategory rptKonstan = new RptPoCategory();

SrcPurchaseOrderReport srcPurchaseOrderReport = new SrcPurchaseOrderReport();
srcPurchaseOrderReport.setTypeReport(SrcPurchaseOrderReport.GROUP_BY_CATEGORY);
...
function cmdPrintXLS(){	 
	window.open("<%=printroot%>.report.RptPoCategoryXLS?idx=<%=System.currentTimeMillis()%>");
}
