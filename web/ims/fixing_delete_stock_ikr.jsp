...
if(iCommand==JSPCommand.SUBMIT){
	...
	try{
		String sql = "select s.stock_id from pos_stock s "+
					 ...
					 "where im.item_group_id=504404414977780895";
...
function cmdFix(){
	...
	document.form1.action="fixing_delete_stock_ikr.jsp";
...
<form name="form1" method="post" action="">
  <p> 
    ...
    <input type="button" name="Button" value="delete stock " onClick="javascript:cmdFix()">
    <br>
  </p>
  <p>&nbsp; </p>
</form>
