...
<!-- Jsp Block -->
<%!
    public Vector drawList(int iJSPCommand, JspRepackItemMulty frmObject,
            RepackItem objEntity, Vector objectClass,
            long costingItemId, String approot, long oidLocation,
            int iErrCode2, String status, boolean useStockCode, Vector listStockCode, Repack repack, boolean isSave, 
            boolean optionalCode, long itemMasterId) {
        ...
        jsplist.addHeader("Code/Barcode", "10%");
	...
	jsplist.addHeader("Total Cost", "10%");        
        ...
        //voutput = DbRepackItem.list(0, 0, "repack_id="+repack.getOID() + " and type=1", "");
        type_value.add(""+0);
        ...
        for (int i = 0; i < objectClass.size(); i++){
            ...
            double stockItems = DbStock.getItemTotalStock(oidLocation, repackItem.getItemMasterId());
            ...
            if ((iJSPCommand != JSPCommand.POST && index == i && (iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.VIEW || iJSPCommand == JSPCommand.ASK || (iJSPCommand == JSPCommand.SAVE && iErrCode2 != 0))) )  {
                ...
                if (vectVendMaster > 0) {
                    ...
                    rowx.add("<font color=\"red\">No item stock available for repack</font>");
                }

                rowx.add("<div align=\"center\">"+JSPCombo.draw(frmObject.colNames[JspRepackItemMulty.JSP_TYPE],null, ""+objEntity.getType(), type_value , type_key, "formElemen", "")+"</div>");
				//rowx.add(uom.getUnit());
				rowx.add("<div align=\"center\"><input type=\"text\" size=\"9\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_PERCENT_COGS] + "\" value=\""+objEntity.getPercentCogs()+"\" class=\"readonly\" readonly style=\"text-align:right\" onBlur=\"javascript:calculatePercent()\" onClick=\"this.select()\">%"+frmObject.getErrorMsg(JspRepackItemMulty.JSP_PERCENT_COGS)+"</div>");
                rowx.add("<div align=\"center\">" + "<input type=\"hidden\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_COGS] + "\" value=\""+objEntity.getCogs()+"\">"+ "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_QTY_STOCK] + "\" value=\"" + objEntity.getQtyStock() + "\" style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+frmObject.getErrorMsg(JspRepackItemMulty.JSP_QTY_STOCK)+"</div>");
                rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_QTY] + "\" value=\"" + objEntity.getQty() + "\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" onkeypress=\"cmdSaveOnEnter(event)\">"+frmObject.getErrorMsg(JspRepackItemMulty.JSP_QTY)+"</div>");
                ...
                if(repackItem.getType()==0){
                    ...
                    detail.setTipe("STOK KELUAR");
                }else{
                    rowx.add("<div align=\"center\">" + "STOCK MASUK" + "</div>"); 
                    detail.setTipe("STOCK MASUK");
                }
				//rowx.add(uom.getUnit());
        ...
        //masuk
            ...
            if (vectVendMaster > 0){
                ...
                rowx.add("<font color=\"red\">No stock item available for repack</font>");

            }
            
            rowx.add("<div align=\"center\">"+JSPCombo.draw(frmObject.colNames[JspRepackItemMulty.JSP_TYPE],null, ""+objEntity.getType(), type_value , type_key, "formElemen", "")+frmObject.getErrorMsg(JspRepackItemMulty.JSP_TYPE)+"</div>");
			//rowx.add(uom.getUnit());
	    	rowx.add("<div align=\"center\"><input type=\"text\" size=\"9\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_PERCENT_COGS] + "\" value=\""+objEntity.getPercentCogs()+"\" class=\"readonly\" readonly style=\"text-align:right\" onBlur=\"javascript:calculatePercent()\" onClick=\"this.select()\">%"+frmObject.getErrorMsg(JspRepackItemMulty.JSP_PERCENT_COGS)+"</div>");
            rowx.add("<div align=\"center\">" + "<input type=\"hidden\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_COGS] + "\" value=\""+colCombo2.getCogs()+"\">"+ "<input type=\"text\" size=\"10\" name=\""+frmObject.colNames[JspRepackItemMulty.JSP_QTY_STOCK]+"\" value=\"" + stockItems + "\" readonly class=\"readonly\" style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+frmObject.getErrorMsg(JspRepackItemMulty.JSP_QTY_STOCK)+"</div>");
            rowx.add("<div align=\"center\"><input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItemMulty.JSP_QTY] + "\" value=\"\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" onkeypress=\"cmdSaveOnEnter(event)\">"+frmObject.getErrorMsg(JspRepackItemMulty.JSP_QTY)+"</div>");			
            rowx.add("");
            rowx.add("");
...
<%
            ...
            long itemMasterId = JSPRequestValue.requestLong(request, JspRepackItemMulty.colNames[JspRepackItemMulty.JSP_ITEM_MASTER_ID]);
            ...
            CmdRepackItemMulty cmdRepackItemMulty = new CmdRepackItemMulty(request);
            if (isRefresh == true) {
                iJSPCommand = JSPCommand.REFRESH;
            }
            iErrCode2 = cmdRepackItemMulty.action(iJSPCommand, oidRepackItem, oidRepack, listStockCode.size());
            if (isRefresh == true) {
                iJSPCommand = JSPCommand.EDIT;
            }
            JspRepackItemMulty jspRepackItemMulty = cmdRepackItemMulty.getForm();
            RepackItem repackItem = cmdRepackItemMulty.getRepackItem();
            msgString2 = cmdRepackItemMulty.getMessage();
            
            //out.println("err : "+jspRepackItemMulty.getErrors());

            if (repackItem.getOID() != 0 && isEdit) {

                listStockCode = new Vector();
                String whereSc = DbStockCode.colNames[DbStockCode.COL_TRANSFER_ITEM_ID] + " = " + repackItem.getOID() + " AND " + DbStockCode.colNames[DbStockCode.COL_STATUS] + "=" + DbStockCode.STATUS_IN;
            ...
            String msgSuccsess = "";
            Vector purchItems = DbRepackItem.list(0, 0, whereClause, orderClause);
            ...
            Vector locations = userLocations;//DbLocation.list(0, 0, "", "name");
           ...
           //if (repack.getLocationId() == 0 && locations != null && locations.size() > 0) {
            //    repack.setLocationId(oidLocation);
            //}
            
           // if (repack.getLocationId() != 0 && locations != null && locations.size() > 0) {
           //     fromOid = repack.getLocationId();
            ///}
            
            

            //Vector stockItems = DbStock.getStock(repack.getLocationId(),DbStock.TYPE_NON_CONSIGMENT);
            int stockItems = DbStock.getStockItemCountByLocation(repack.getLocationId(), DbStock.TYPE_NON_CONSIGMENT);
            if(repack.getOID()==0){ 
                repack.setStatus(I_Project.DOC_STATUS_DRAFT);
            }
            ...
            /*if (iErrCode == 0 && iErrCode2 == 0 && iJSPCommand == JSPCommand.SAVE) {
                ...
                if (listStockCode != null && listStockCode.size() > 0) {
                    ...
                    //DbStockCode.deleteStockCodeByTransferItem(repackItem.getOID());
                    ...
                    for (int ixSc = 0; ixSc < listStockCode.size(); ixSc++) {
                        ...
                        //insert di repack from
                        objStockCodeFrom.setInOut(DbStockCode.STOCK_OUT);
                       //objStockCodeFrom.setLocationId(repack.getFromLocationId());
                        objStockCodeFrom.setStatus(DbStockCode.STATUS_OUT);
                        objStockCodeFrom.setType(DbStockCode.TYPE_TRANSFER);
                        //objStockCodeTo.setTransferId(repack.getOID());
                        //objStockCodeTo.setTransferItemId(repackItem.getOID());
                        ...
                        //objStockCodeTo.setLocationId(repack.getToLocationId());
            ...
            double subTotal = 0;//DbRepackItem.getTotalTransferAmount(oidRepack);

            //Vector vLocations = DbLocation.list(0, 0, DbLocation.colNames[DbLocation.COL_LOCATION_ID] + " != " + fromOid, "name");

            Vector vErr = new Vector();

            //String whereSCode = DbStockCode.colNames[DbStockCode.COL_TRANSFER_ID] + "=" + repack.getOID() + " AND " + DbStockCode.colNames[DbStockCode.COL_RECEIVE_ITEM_ID] + "=" + repackItem.getOID();
            ...
            try {
                ...
                if (isNone || isAdd || isSave || isLoad) {
                    ...
                    oidTmpCostingItem = repackItem.getItemMasterId();
                }
...
<html >
   ...
   function cmdSaveOnEnter(e){
	...
	document.frmrepack.sembunyi.focus();
	if (e.keyCode == 13)
	{
                cmdSave();
	}
   ...
   function cmdAddItemMaster(){   
    ...
    function cmdAddItemMaster2(){ 
       // var itemCode =document.frmrepack.jsp_code_item.value;
   ...
   function cmdPrintPdf(){
       ...
       function removeChar(number){
        ...
        function calculateSubTotal(){
            ...
            var qty = document.frmrepack.<%=JspRepackItemMulty.colNames[JspRepackItemMulty.JSP_QTY]%>.value;
            var tipe = document.frmrepack.<%=JspRepackItemMulty.colNames[JspRepackItemMulty.JSP_TYPE]%>.value;
            var stockQty =document.frmrepack.<%=JspRepackItemMulty.colNames[JspRepackItemMulty.JSP_QTY_STOCK]%>.value;
            ...
            document.frmrepack.<%=JspRepackItemMulty.colNames[JspRepackItemMulty.JSP_QTY]%>.value = qty;
            
            stockQty = removeChar(stockQty);
            stockQty = cleanNumberFloat(stockQty, sysDecSymbol, usrDigitGroup, usrDecSymbol);	
            //document.frmrepack.stock_qty.value = stockQty;
         ...
         function cmdVendorChange(){
             var oid = document.frmrepack.<%=jspRepack.colNames[jspRepack.JSP_LOCATION_ID]%>.value;
         <%
            if (vendors != null && vendors.size() > 0) {
                for (int i = 0; i < vendors.size(); i++) {
                    Vendor v = (Vendor) vendors.get(i);
                         %>
                             if('<%=v.getOID()%>'==oid){
                                 document.frmrepack.vnd_address.value="<%=v.getAddress()%>";
                             }
                         <%
                }
            }
         ...
         function cmdDelStockCode(stockCodeId){
             ...
             if(confirm('Are sure you want delete this item ?')){
                 ...
                 document.frmrepack.hidden_oid_stock_code_del.value=stockCodeId;
                 document.frmrepack.hidden_del_stock.value=1;
                 document.frmrepack.command.value="<%=JSPCommand.VIEW%>";
             ...
             function viewStockCodeEdit(oidTransfer,oidTransferItem){
                 ...
                 var cfrm = confirm('Are you sure want to change qty repack, and you will lose stock code data(s) ?');
                 
                 if(cfrm==true){
                     document.frmrepack.hidden_repack_id.value=oidTransfer;
                     document.frmrepack.hidden_repack_item_id.value=oidTransferItem;
                     document.frmrepack.hidden_del_stock.value=2;
                     document.frmrepack.command.value="<%=JSPCommand.REFRESH%>";
                     document.frmrepack.prev_command.value="<%=prevJSPCommand%>";
                     document.frmrepack.action="repackitemmulty.jsp";
                     document.frmrepack.submit();            
                 }
             ...
             function cmdAskMain(oidTransfer){
                 ...
                 document.frmrepack.command.value="<%=JSPCommand.ASK%>";
                 document.frmrepack.prev_command.value="<%=prevJSPCommand%>";
                 document.frmrepack.action="repack.jsp";
                 document.frmrepack.submit();
             }
             ...
             function cmdEdit(oidTransfer){
                 document.frmrepack.hidden_repack_item_id.value=oidTransfer;
                 document.frmrepack.command.value="<%=JSPCommand.EDIT%>";
                 document.frmrepack.prev_command.value="<%=prevJSPCommand%>";
                 document.frmrepack.action="repackitemmulty.jsp";
                 document.frmrepack.submit();
            ...
            <%@ include file="../main/hmenu.jsp"%>
                  ...
                  <%@ include file="../calendar/calendarframe.jsp"%>
                                                ...
                                                <tr> 
                                                    <td><!-- #BeginEditable "content" --> 
                                                        <form name="frmrepack" method ="post" action="">
                                                            ...
                                                            <input type="hidden" name="<%=JspRepackItemMulty.colNames[JspRepackItemMulty.JSP_REPACK_ID]%>" value="<%=oidRepack%>">
                                    ...
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Repack 
                                      ...
                                      Item - Multy Output</span></font></b></td>
           ...
           // rptKonstan.setNotes(repack.getNote());
                                                                                                    ...
                                                                                                    <tr align="left" > 
                                                                                                        <td colspan="5" valign="top"> 
                                                                                                            &nbsp; 
                                                                                                            <%
            Vector x = drawList(iJSPCommand, jspRepackItemMulty, repackItem, purchItems, oidRepackItem, approot, repack.getLocationId(), iErrCode2, repack.getStatus(), useStockCode, listStockCode, repack, isSave, optionalCode, itemMasterId);
    ...
    if (repack.getOID() != 0) {
                                                                                                                ...
                                                                                                                <%}%>
                                                                                                                <%if (stockItems >= 0) {
        if (repack.getOID() != 0) {                                                                              session.putValue("KONSTAN", rptRepack);
                                                                                                                %>
                                                                                                                <tr> 
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    <td colspan="2" nowrap> 
                                                                                                                        <div align="left"><font color="#FF0000"><i>No stock item available for repack </i></font></div>
                                                                                                                    </td>
                                                                                                                    <td width="97"> 
                                                ...
                                                <td colspan="5"  <%if(!jspRepack.getErrorMsg(jspRepack.JSP_APPROVAL_1).equals("")){%>bgcolor="yellow"<%}%> height="24">&nbsp;&nbsp;<font color="#FF0000"><%=jspRepack.getErrorMsg(jspRepack.JSP_APPROVAL_1)%></font><input type="hidden" name="sembunyi"></td>
                                                                                                    </tr>
                                                                                                    <tr align="left" > 
                                                                                                        <td colspan="5" valign="top">&nbsp;</td>
                                                                                                    </tr>
    ...
    session.putValue("APPROVER",approver);
                                                      ...
                                                      <td width="33%" class="tablecell1"> 
                                                        <div align="center"> <i> 
                                                          ...
                                                          <%=(repack.getEffectiveDate()==null) ? JSPFormater.formatDate(repack.getDate(), "dd MMMM yy") : JSPFormater.formatDate(repack.getEffectiveDate(), "dd MMMM yy")%> 
                                                          <%}%>
                                                          </i></div>
                                                      </td>
                                                    </tr>
                                              ...
                                              <script language="JavaScript">
                                                                ...
                                                                <%if (repack.getStatus().equals(I_Project.DOC_STATUS_DRAFT) && (iJSPCommand == JSPCommand.NONE || iJSPCommand == JSPCommand.ADD || (iJSPCommand == JSPCommand.EDIT && repackItem.getOID() != 0) || iErrCode != 0)) {%>
                                                                
                                                         <%}
            if (repack.getOID() != 0 && !repack.getStatus().equals(I_Project.DOC_STATUS_CLOSE)) {%>
