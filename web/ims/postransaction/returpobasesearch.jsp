...
<%!
    public String drawList(Vector objectClass, int start) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add("<div align=\"center\">" + receive.getStatus() + "</div>");
...
<%
            ...
            String srcStatus = "(" + DbReceive.colNames[DbReceive.COL_STATUS] + "='" + I_Project.DOC_STATUS_APPROVED + "'" +
                    " or " + DbReceive.colNames[DbReceive.COL_STATUS] + "='" + I_Project.DOC_STATUS_CHECKED + "')";
            //I_Project.DOC_STATUS_APPROVED;//JSPRequestValue.requestString(request, "src_status");
            ...
            if (srcStatus != null && srcStatus.length() > 0) {
                if (whereClause.length() > 0) {
                    whereClause = whereClause + " and " + srcStatus;//DbReceive.colNames[DbReceive.COL_STATUS]+"='"+srcStatus+"'";	
                } else {
                    whereClause = srcStatus;//DbReceive.colNames[DbReceive.COL_STATUS]+"='"+srcStatus+"'";	
                }
            }
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.frmreceive.action="returpobasesearch.jsp";
            ...
            function cmdEdit(oid){
                ...
                document.frmreceive.action="returitempo.jsp";
                document.frmreceive.submit();
            }
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                                                            <tr valign="bottom"> 
                                                                                <td width="60%" height="23"><b><font color="#990000" class="lvl1">Transaction 
                                                                                            ...
                                                                                            Goods </span>&raquo; <span class="lvl2">New 
                                                                                        ...
                                                                                        <tr align="left" valign="top"> 
                                                                                            <td height="22" valign="middle" colspan="3"> 
                                                                                                <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                                                                                    <tr> 
                                                                                                        <td colspan="4"><font color="#006600">Please, 
                                                                                                                find incoming goods document 
                                                                                                                that PO's items will be returned 
                                                                                                        ! </font></td>
                                                                                                    </tr>
                                                                                                    <tr> 
            ...
            if (vendors != null && vendors.size() > 0) {
                for (int i = 0; i < vendors.size(); i++) {
                    ...
                    String str = "";
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td width="11%">Incoming Between</td>
                                                                                                        <td colspan="3"> 
                                                                                                        ...
                                                                                                        <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmreceiverequest.src_start_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a> 
                                                                                                        &nbsp;&nbsp;and&nbsp;&nbsp; 
                                                                                                        <input name="src_end_date" value="<%=JSPFormater.formatDate((srcEndDate == null) ? new Date() : srcEndDate, "dd/MM/yyyy")%>" size="11" readonly>
                                                                                                        <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmreceiverequest.src_end_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a> 
