...
<%
            ...
            boolean privAdd = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_STOCK_MANAGEMENT, AppMenu.M2_ADJUSMENT, 1);
...
<%
            ...
            String srcNote = JSPRequestValue.requestString(request, "src_note");
...
//location id
            if (srcVendorId != 0) {
                ...
                if (userLocations != null && userLocations.size() > 0) {
                    for (int x = 0; x < userLocations.size(); x++) {
                        ...
                        whereLoc = whereLoc + DbAdjusment.colNames[DbAdjusment.COL_LOCATION_ID] + "=" + loc.getOID() + " or ";
                    }
            ...
            if (srcNumber != null && srcNumber.length() > 0) {
                if (whereClause.length() > 0) {
                    whereClause = whereClause + " and " + DbAdjusment.colNames[DbAdjusment.COL_NUMBER] + " like '%" + srcNumber + "%'";
                } else {
                    whereClause = DbAdjusment.colNames[DbAdjusment.COL_NUMBER] + " like '%" + srcNumber + "%'";
                }
            }
            ...
            if (whereClause.length() > 0) {
                whereClause = whereClause + " and " + DbAdjusment.colNames[DbAdjusment.COL_TYPE] + "=" + DbAdjusment.TYPE_NON_CONSIGMENT;
            } else {
                whereClause = DbAdjusment.colNames[DbAdjusment.COL_TYPE] + "=" + DbAdjusment.TYPE_NON_CONSIGMENT;
            }


            if (srcNote != null && srcNote.length() > 0) {
                if (whereClause.length() > 0) {
                    whereClause = whereClause + " and ";
                }
                whereClause = whereClause + "note like '%" + srcNote + "%'";
    ...
    <body onLoad="MM_preloadImages('<%=approot%>/images/home2.gif','<%=approot%>/images/logout2.gif','../images/search2.gif','../images/new2.gif')">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
                                                                                    ...
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr > 
                                                                                            ...
                                                                                            <td class="tabin" nowrap> 
                                                                                                <div align="center">&nbsp;<a href="javascript:cmdAdd()" class="tablink">Adjusment Stock</a>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                ...
                for (int i = 0; i < locations.size(); i++) {
                    ...
                    String str = "";
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td colspan="3"> 
                                                                                                            <input name="src_number" value="<%=srcNumber%>" size="30" >
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr> 
                                                                                                        <td width="18%">Note</td>
                                                                                                        <td colspan="3"> 
                                                                                                            <input name="src_note" value="<%=srcNote%>" size="30" >
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td width="18%">Document Status</td>
                                                                                                        <td colspan="3">
            ...
            ctrLine.setLastOnMouseOver("MM_swapImage('Image26x','','" + approot + "/images/last2.gif',1)");
                                                                                        ...
                                                                                        <%if (privAdd && iJSPCommand != JSPCommand.EDIT && iJSPCommand != JSPCommand.ADD && iJSPCommand != JSPCommand.ASK && iErrCode == 0) {%>
                                                                                        <tr align="left" valign="top"> 
