...
String whereClause = "for_buy=1 and is_active=1";
...
if(srcGroupId!=0){
	whereClause = " and "+DbItemMaster.colNames[DbItemMaster.COL_ITEM_GROUP_ID]+"="+srcGroupId;
}
if(srcCategoryId!=0){
...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemPurchase.jsp";
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster  
        ...
        self.opener.document.frmpurchase.itm_JSP_ITEM_MASTER_ID.value=oidItemMaster;  
