<%-- 
    Document   : addItemTransferConsigment
...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
                    Stock s = (Stock) objectClass.get(i);
                    try{
...
int vectSize = DbStock.getStockItemCount(location_id, DbStock.TYPE_CONSIGMENT);
...
listItemMaster = DbStock.getStockList(start, recordToGet, location_id, DbStock.TYPE_CONSIGMENT, srcGroupId, srcCategoryId, srcName, srcCode );
...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemTransferConsigment.jsp";
