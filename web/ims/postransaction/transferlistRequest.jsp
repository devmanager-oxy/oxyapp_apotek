...
String srcStatus = "REQUEST";//JSPRequestValue.requestString(request, "src_status");
...
orderClause = DbTransfer.colNames[DbTransfer.COL_COUNTER];
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td width="90%"> 
                                                  <select name="src_loc_from_id">
													...
													Vector vendors = DbLocation.list(0,0, "", "name");
													
												    if(vendors!=null && vendors.size()>0){
														 for(int i=0; i<vendors.size(); i++){
															Location locfrom = (Location)vendors.get(i);
															//String str = "";
													%>
                                                 ...
                                                 <select name="src_loc_to_id">
												    ...
												    if(vendors!=null && vendors.size()>0){
														 for(int i=0; i<vendors.size(); i++){
															Location locTo = (Location)vendors.get(i);
															//String str = "";
													%>
                                              ...
                                              <tr> 
                                                <td width="10%">Request Between</td>
                                                <td width="90%"> 
