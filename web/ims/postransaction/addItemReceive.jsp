...
long vendorId = JSPRequestValue.requestLong(request, "oidVendor");
//-----------------------------------------------------------------------------
...
if(srcCode!=null && srcCode.length()>0){
	...
	whereClause = whereClause + "(" + DbItemMaster.colNames[DbItemMaster.COL_BARCODE]+" like '%"+srcCode+"%')";
}
...
int vectSize =0;// DbItemMaster.getCount(whereClause);
if(vendorId!=0){
...
if (listItemMaster.size() < 1 && start > 0)
{
	 ...
	 listItemMaster = DbItemMaster.listByVendor(start,recordToGet, whereClause , orderClause);//DbItemMaster.list(start,recordToGet, whereClause , orderClause);
}
...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemReceive.jsp";
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster  
        self.opener.document.frmreceive.itm_JSP_ITEM_MASTER_ID.value=oidItemMaster  
        self.opener.document.frmreceive.submit();                
        self.close();  
	}
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmitemmaster" method ="post" action="">
                          ...
                          <input type="hidden" name="oidVendor" value="<%=vendorId%>">
                                                ...
                                                <td height="8" valign="middle" colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="6%" nowrap>&nbsp;SKU/Barcode&nbsp;</td>
                                                      <td width="14%"> 
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="14%"> 
                                                        <input type="text" name="src_name" onChange="javascript:cmdSearch()" value="<%=srcName%>">
                                                      </td>
                                                      <td width="64%">&nbsp; </td>
                                                    </tr>
                                                    <tr>
