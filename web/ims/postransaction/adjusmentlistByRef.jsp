...
function cmdSearch(){
	...
	document.frmopname.action="adjusmentlistByRef.jsp";
                        ...
                        <form name="frmopname" method ="post" action="">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td valign="top"> 
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1"> Adjustment 
							...
							%>
                                        ...
                                        <%  }else{%>
                                            <tr align="left" valign="top"> 
                                              <td class="boxed1" height="22" valign="middle" colspan="3"><font color="#FF0000"> 
                                              no APPROVED opname document available </font></td>
                                        </tr>
					<%}	  }catch(Exception exc){ 
