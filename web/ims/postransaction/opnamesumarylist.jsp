...
if(srcVendorId!=0){
	...
	if(whereClause.length()>0){
		whereClause = whereClause + " and "+DbOpname.colNames[DbOpname.COL_STATUS]+"!='DRAFTS'";	
	}else{
		whereClause = DbOpname.colNames[DbOpname.COL_STATUS]+"!='DRAFTS'";	
	}
...
function cmdSearch(){
	...
	document.frmopname.action="opnamesumarylist.jsp";
