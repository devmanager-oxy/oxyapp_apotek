...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemPromotion.jsp";
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster  
        ...
        self.opener.document.frmpromotion.JSP_ITEM_MASTER_ID.value=oidItemMaster  
        self.opener.document.frmpromotion.submit();                
        self.close();  
	}
