...
//out.println("iJSPCommand : "+iJSPCommand);
            ...
            if (iJSPCommand != JSPCommand.SAVE && iJSPCommand != JSPCommand.POST) {
                if (srcCode.length() > 0) {
                    ...
                    //if(vectSize==1){
                    String wherex = " (barcode like '%" + srcCode + "%' or code like '%" + srcCode + "%' or barcode_2 like '%" + srcCode + "%' or barcode_3 like '%" + srcCode + "%')" +
    ...
    try {
        u = DbUser.fetch(purchase.getApproval3());
            ...
            if (vendorItems != null && vendorItems.size() > 0) {
                ...
                if (iErrCode2 == 0 && ((purchase.getStatus().equals(I_Project.DOC_STATUS_DRAFT) || purchase.getStatus().equals(I_Project.DOC_STATUS_CHECKED)) && (iJSPCommand == JSPCommand.NONE || (iJSPCommand == JSPCommand.EDIT && purchaseItem.getOID() != 0) || iErrCode != 0))) {
                    if (iJSPCommand != 2) {
                                                                %>
