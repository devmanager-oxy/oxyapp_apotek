...
<!-- Jsp Block -->
<%!
    public Vector drawList(int iJSPCommand, JspRepackItem frmObject,
            RepackItem objEntity, Vector objectClass,
            long costingItemId, String approot, long oidLocation,
            int iErrCode2, String status, boolean useStockCode, Vector listStockCode, Repack repack, boolean isSave, boolean optionalCode, long itemMasterId) {
        ...
        jsplist.addHeader("Qty Stock", "10%");
        jsplist.addHeader("Qty Input/Output", "15%");
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if ((iJSPCommand != JSPCommand.POST && index == i && (iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.VIEW || iJSPCommand == JSPCommand.ASK || (iJSPCommand == JSPCommand.SAVE && iErrCode2 != 0)))) {
                        ...
                        if (listStockCode != null && listStockCode.size() > 0) {
                            ...
                            for (int xxSt = 0; xxSt < listStockCode.size(); xxSt++) {
                                ...
                                strVal += "<tr>" +
                                        ...
                                        "<input type=\"hidden\" name=\"" + JspStockCode.colNames[JspStockCode.JSP_TRANSFER_ID] + "_" + xxSt + "\" value=\"" + repack.getOID() + "\">" +
                ...
                rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"jsp_code_item\" value=\"" + colCombo2.getCode() + "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:right\"> </div>");
                ...
                if (useStockCode) {
                    rowx.add("<div align=\"right\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItem.JSP_QTY] + "\" value=\"" + objEntity.getQty() + "\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" onChange=\"javascript:viewStockCodeEdit('" + repack.getOID() + "','" + objEntity.getOID() + "')\">" + "</div>");
                } else {
                    rowx.add("<div align=\"right\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItem.JSP_QTY] + "\" value=\"" + objEntity.getQty() + "\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" >" + "</div>");
                }
                ...
                if (((status != null && status.equals(I_Project.DOC_STATUS_DRAFT)) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES")) || DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("NO")) {
                    rowx.add("<a href=\"javascript:cmdEdit('" + String.valueOf(repackItem.getOID()) + "')\">" + itemMaster.getName() + "</a>");
                ...
                rowx.add("<div align=\"center\">" + stockItems + "</div>");
                rowx.add("<div align=\"right\">" + JSPFormater.formatNumber(repackItem.getQty(), "#,###.##") + "</div>");                
                if (repackItem.getType() == 0) {
                    rowx.add("<div align=\"center\">" + "INPUT" + "</div>");
                } else {
                    rowx.add("<div align=\"center\">" + "OUTPUT" + "</div>");
                }
        ...
        if (iJSPCommand != JSPCommand.POST && isEdit == false && (iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.LOAD || (iJSPCommand == JSPCommand.SAVE && iErrCode2 != 0 && costingItemId == 0))) {
            ...
            double stockItems = DbStock.getItemTotalStock(oidLocation, itemMasterId);
            ...
            if (vectVendMaster > 0) {
                ...
                //strVal += "<tr><td colspan=\"3\"><div align=\"left\">" + JSPCombo.draw(frmObject.colNames[JspRepackItem.JSP_ITEM_MASTER_ID], null, "" + objEntity.getItemMasterId(), vect_value, vect_key, "onchange=\"javascript:parserMaster()\"", "formElemen") + frmObject.getErrorMsg(frmObject.JSP_ITEM_MASTER_ID) + "</div></td></tr>";
                //strVal += "<tr><td colspan=\"4\"><input type=\"hidden\" name=\""+frmObject.colNames[frmObject.JSP_ITEM_MASTER_ID] +"\" value=\""+colCombo2.getOID()+"\">"+"<input style=\"text-align:right\" type=\"text\" name=\"X_"+frmObject.colNames[frmObject.JSP_ITEM_MASTER_ID] +"\" value=\""+colCombo2.getName()+"\" class=\"readonly\" size=\"50\" readonly>" + "<a href=\"javascript:cmdAddItemMaster()\"height=\"20\" border=\"0\" style=\"padding:0px\"> &nbsp Search</a></td></tr>";
                strVal += "<tr><td colspan=\"4\"><input type=\"hidden\" name=\"" + frmObject.colNames[frmObject.JSP_ITEM_MASTER_ID] + "\" value=\"" + colCombo2.getOID() + "\">" + "<input style=\"text-align:right\" type=\"text\" name=\"X_" + frmObject.colNames[frmObject.JSP_ITEM_MASTER_ID] + "\" value=\"" + colCombo2.getName() + "\"  size=\"35\" onChange=\"javascript:cmdAddItemMaster()\" >" + "<a href=\"javascript:cmdAddItemMaster()\"height=\"20\" border=\"0\" style=\"padding:0px\"> &nbsp Search</a></td></tr>";
                if (useStockCode) {
            ...
            rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"jsp_code_item\" value=\"" + colCombo2.getCode() + "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:right\"> </div>");
            rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\"stock_qty\" readonly value=\"" + ((objEntity.getQty() == 0) ? 1 : objEntity.getQty()) + "\" class=\"readOnly\" readOnly style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">" + frmObject.getErrorMsg(frmObject.JSP_QTY) + "</div>");
            if (useStockCode) {
                rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItem.JSP_QTY] + "\" value=\"" + objEntity.getQty() + "\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" onChange=\"javascript:viewStockCode()\" >" + "</div>");
            } else {
                rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspRepackItem.JSP_QTY] + "\" value=\"\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" >" + "</div>");
            }
...
<%
            ...
            iErrCode2 = cmdRepackItem.action(iJSPCommand, oidRepackItem, oidRepack, listStockCode.size());
            if (isRefresh == true) {
                iJSPCommand = JSPCommand.EDIT;
            }
            JspRepackItem jspCostingItem = cmdRepackItem.getForm();
                ...
                function cmdAddItemMaster3(){   
                    ...
                    function cmdPrintPdf(){
                        ...
                        function calculateSubTotal(){
                            ...
                            var stockQty =document.frmrepack.stock_qty.value;
    ...
    if (locations != null && locations.size() > 0) {
        for (int i = 0; i < locations.size(); i++) {
            Location d = (Location) locations.get(i);
                ...
                try {
                    Location l = DbLocation.fetchExc(repack.getLocationId());
                ...
                //rptKonstan.setFrom(l.getCode() + " - " + l.getName());
                                                ...
                                                <td colspan="2" class="comment" width="52%">
                                                    ...
                                                    <%
            //rptKonstan.setTanggal(repack.getDate());
%> 
                                                </td>
                                            </tr>
                                            <tr align="left"> 
...
%>
                                            ...
                                            <tr align="left" > 
                                                <td colspan="5" valign="top"> 
                                                    &nbsp; 
                                                    <%
            Vector x = drawList(iJSPCommand, jspCostingItem, repackItem, purchItems, oidRepackItem, approot, repack.getLocationId(), iErrCode2, repack.getStatus(), useStockCode, listStockCode, repack, isSave, optionalCode, itemMasterId);
        ...
        u = DbUser.fetch(repack.getApproval1());
                                                            ...
                                                            <td width="33%" class="tablecell1"> 
                                                                <div align="center"> <i> 
                                                                        ...
                                                                        <%=JSPFormater.formatDate(repack.getDate(), "dd MMMM yy")%> 
                                                                        <%}%>
                                                                </i></div>
                                                            </td>
                                                        </tr>
