...
<%!
    public Vector drawList(int iJSPCommand, JspCostingItem frmObject,
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if ((iJSPCommand != JSPCommand.POST && index == i && (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.LOAD || iJSPCommand == JSPCommand.ASK || (iJSPCommand == JSPCommand.SAVE && iErrCode2 != 0)))) {
                isEdit = true;
                ...
                rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"20\" name=\"src_code\" value=\"" + colCombo2.getCode() + "\" onBlur=\"javascript:getDataMaster()\"></div>");
                rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"20\" readonly name=\"src_barcode\" value=\"" + colCombo2.getBarcode() + "\" class=\"readonly\"></div>");
                ...
                rowx.add("<div align=\"right\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspCostingItem.JSP_QTY] + "\" value=\"" + objEntity.getQty() + "\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\"  onkeypress=\"cmdSaveOnEnter(event)\">" + "</div>");
                ...
                if (((status != null && status.equals(I_Project.DOC_STATUS_DRAFT)) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES")) || DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("NO")) {
                    //rowx.add("<a href=\"javascript:cmdEdit('" + String.valueOf(costingItem.getOID()) + "')\">" + ig.getName() + "/" + itemMaster.getName()+ "</a>");
                    rowx.add("<a href=\"javascript:cmdEdit('" + String.valueOf(costingItem.getOID()) + "')\">" + itemMaster.getName() + "</a>");
                    detail.setName("" + itemMaster.getName());
                    detail.setBarcode("" + itemMaster.getCode());
                } else {
                    //rowx.add(ig.getName() + "/" + itemMaster.getName());
        ...
        if (iJSPCommand != JSPCommand.POST && isEdit == false && (iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.LOAD || (iJSPCommand == JSPCommand.SAVE && iErrCode2 != 0 && costingItemId == 0))) {
            ...
            rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspCostingItem.JSP_QTY] + "\" value=\"\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onClick=\"this.select()\"  onkeypress=\"cmdSaveOnEnter(event)\">" + "</div>");
    ...
    public void updateStockDateToApproveDate(Costing costing) {
        if (costing.getOID() != 0) {
            try {
                String sql = "update pos_stock set date='" + JSPFormater.formatDate(costing.getEffectiveDate(), "yyyy-MM-dd HH:mm:ss") + "' where costing_id=" + costing.getOID();
...
<%
            ...
            //Eka D
            if (iJSPCommand == JSPCommand.POST && iErrCode == 0 && costing.getOID() != 0) {
                //update effectiveDate - tanggal approve
                try {
                    costing.setEffectiveDate(new Date());
                    long oidx = DbCosting.updateExc(costing);
                    if (oidx != 0) {
                        updateStockDateToApproveDate(costing);
                    }
                } catch (Exception e) {
            ...
            if (iJSPCommand == JSPCommand.LOAD) {
                if (srcCode != null && srcCode.length() > 0) {
                    Vector temp = DbItemMaster.list(0, 1, "code='" + srcCode + "' or barcode='" + srcCode + "'", "");
                    if (temp != null && temp.size() > 0) {
                        ItemMaster imx = (ItemMaster) temp.get(0);
                        itemMasterId = imx.getOID();
                    }
                }
            }
...
<head>
    ...
    <script language="JavaScript">
        ...
        function cmdSaveOnEnter(e){
            ...
            if (e.keyCode == 13)
                {
                    document.frmcosting.sembunyi.focus();
                    calculateSubTotal();  
                    //cmdSave();
...
<td valign="top"> 
                ...
                if (costing.getStatus() == null) {
                    costing.setStatus(I_Project.DOC_STATUS_DRAFT);
                                        ...
                                        <tr align="left" height="26"> 
                                            ...
                                            <td class="tablearialcell1" valign="top">&nbsp;Cost 
                                            Location</td>
                                            <td valign="top">
    ...
    if (iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.LOAD ||
            ...
            iJSPCommand == JSPCommand.ASK || iErrCode2 != 0) {%>
                                                                <tr> 
                                                                    ...
                                                                    //out.println("oidCostingItem : "+oidCostingItem);

                                                                    if (iJSPCommand == JSPCommand.LOAD) {
                                                                        prevJSPCommand = JSPCommand.LOAD;
                                                                        if (oidCostingItem == 0) {
                                                                            iJSPCommand = JSPCommand.ADD;
                                                                        } else {
                                                                            iJSPCommand = JSPCommand.EDIT;
                                                                    ...
                                                                    <td> 
                                                                        <table border="0" cellpadding="5" cellspacing="0" class="success">
                                                                            <tr> 
                                                                                ...
                                                                                <td width="100" nowrap ><font color="FFFFFF">Delete 
                                                                                success</font></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                        ...
                                        <tr align="left" > 
                                            <td colspan="5" valign="top"> 
                                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                                    <tr> 
                                                        <td colspan="4"> 
                                                            <%if (costing.getOID() != 0 && costing.getStatus().equals(I_Project.DOC_STATUS_DRAFT)) {%>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr> 
                                                                    <td width="12%">&nbsp;</td>
                                                                    <td width="14%">&nbsp;</td>
    ...
    if (costing.getOID() != 0) {
                                                    ...
                                                    <tr> 
                                                        <td colspan="4"> 
                                                            ...
                                                            if (((costing.getStatus().equals(I_Project.DOC_STATUS_DRAFT) || costing.getStatus().equals("")) ||
                                                                    (jspCosting.getErrorMsg(jspCosting.JSP_APPROVAL_1).equals("") && iErrCode != 0)) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES")) {%>
                                        ...
                                        <tr align="left" > 
                                            ...
                                            <td colspan="5"  <%if (!jspCosting.getErrorMsg(jspCosting.JSP_APPROVAL_1).equals("")) {%>bgcolor="yellow"<%}%> height="24">&nbsp;&nbsp;<font color="#FF0000"><%=jspCosting.getErrorMsg(jspCosting.JSP_APPROVAL_1)%>
    ...
    <script language="JavaScript">
            ...
            if (costing.getStatus().equals(I_Project.DOC_STATUS_DRAFT) && (iJSPCommand == JSPCommand.NONE || iJSPCommand == JSPCommand.ADD || (iJSPCommand == JSPCommand.EDIT && costingItem.getOID() != 0) || iErrCode != 0)) {
                if (prevJSPCommand == JSPCommand.LOAD || iJSPCommand == JSPCommand.EDIT) {
                            %>
                                document.frmcosting.<%=JspCostingItem.colNames[JspCostingItem.JSP_QTY]%>.focus();
                                document.frmcosting.<%=JspCostingItem.colNames[JspCostingItem.JSP_QTY]%>.select();
                                <%} else {%>
                                //document.frmcosting.src_code.focus(); 
                    <%}
            }
