...
<%!
				...
				int iErrCode2, String status, long itemMasterId)
	{
		...
		jsplist.addHeader("Qty","5%");
                jsplist.addHeader("Reg Disc %","4%");
                jsplist.addHeader("Reg Disc","4%");	
                jsplist.addHeader("Disc %","4%");
		jsplist.addHeader("Disc val","4%");
		...
		*/
        ...
        for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(iJSPCommand != JSPCommand.POST && index == i && (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK ||  (iJSPCommand == JSPCommand.SAVE && iErrCode2!=0 && purchaseItemId==0))){
					...
					rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"5\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_QTY] +"\" value=\""+purchaseItem.getQty()+"\" class=\"formElemen\" style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+frmObject.getErrorMsg(frmObject.JSP_QTY)+"</div>");				
                                        rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"15\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_REG_DIS_PERCENT] +"\" value=\""+purchaseItem.getRegDisPercent()+"\" class=\"formElemen\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
					rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"15\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_REG_DIS_VAL] +"\" value=\""+purchaseItem.getRegDisVal()+"\" readonly class=\"readOnly\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
                                        
                                        rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"15\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_LAST_DIS_PERCENT] +"\" value=\""+purchaseItem.getLastDisPercent()+"\" class=\"formElemen\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
                                        rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"15\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_TOTAL_DISCOUNT] +"\" value=\""+purchaseItem.getTotalDiscount()+"\" readonly class=\"readOnly\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
				...
				rowx.add("<div align=\"center\">"+purchaseItem.getQty()+"</div>");
					prOL.setQty(purchaseItem.getQty());
                                rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(purchaseItem.getRegDisPercent(), "#,###.##")+"</div>");
				rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(purchaseItem.getRegDisVal(), "#,###.##")+"</div>");
                                
                                rowx.add("<div align=\"right\">"+JSPFormater.formatNumber(purchaseItem.getLastDisPercent(), "#,###.##")+"</div>");
		...
		if(iJSPCommand != JSPCommand.POST && (iJSPCommand == JSPCommand.ADD || iJSPCommand==JSPCommand.LOAD || (iJSPCommand == JSPCommand.SAVE && iErrCode2!=0 && purchaseItemId==0))){ 
				...
				rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"3\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_QTY] +"\" value=\"1\" class=\"formElemen\" style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+frmObject.getErrorMsg(frmObject.JSP_QTY)+"</div>");				
                                rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"7\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_REG_DIS_PERCENT] +"\" value=\""+vendorItem.getRegDisPercent()+"\" class=\"formElemen\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
				rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"7\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_REG_DIS_VAL] +"\" value=\""+vendorItem.getRegDisValue()+"\" readonly class=\"readOnly\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
                                
                                rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"7\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_LAST_DIS_PERCENT] +"\" value=\""+vendorItem.getLastDiscount()+"\" class=\"formElemen\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
                                rowx.add("<div align=\"right\">"+"<input type=\"text\" size=\"7\" name=\""+frmObject.colNames[JspPurchaseItem.JSP_TOTAL_DISCOUNT] +"\" value=\""+vendorItem.getLastDisVal()+"\" readonly class=\"readOnly\" style=\"text-align:right\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">"+"</div>");
...
int vectSize=0;
            ...
            if(srcCode.length()>0){
               vectSize  = DbItemMaster.getCount(" barcode like '%"+ srcCode+"%' or code like '%" + srcCode +"%' or barcode_2 like '%" + srcCode + "%' or barcode_3 like '%" + srcCode + "%'");
                if(vectSize==1){
                   Vector vlist = DbItemMaster.list(0, 1, " barcode like '%"+ srcCode+"%' or code like '%" + srcCode +"%' or barcode_2 like '%" + srcCode + "%' or barcode_3 like '%" + srcCode + "%'", "");
...
function calculateSubTotal(){
	...
	var regdisval = document.frmpurchase.<%=JspPurchaseItem.colNames[JspPurchaseItem.JSP_REG_DIS_VAL]%>.value;
        var dispercent = document.frmpurchase.<%=JspPurchaseItem.colNames[JspPurchaseItem.JSP_LAST_DIS_PERCENT]%>.value;
        var regdisPercent = document.frmpurchase.<%=JspPurchaseItem.colNames[JspPurchaseItem.JSP_REG_DIS_PERCENT]%>.value;
	...
	regdisval = removeChar(regdisval);
	regdisval = cleanNumberFloat(regdisval, sysDecSymbol, usrDigitGroup, usrDecSymbol);	
	document.frmpurchase.<%=JspPurchaseItem.colNames[JspPurchaseItem.JSP_TOTAL_DISCOUNT]%>.value = formatFloat(''+regdisval, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace);	
         
        dispercent = removeChar(dispercent);
	dispercent = cleanNumberFloat(dispercent, sysDecSymbol, usrDigitGroup, usrDecSymbol);	
	document.frmpurchase.<%=JspPurchaseItem.colNames[JspPurchaseItem.JSP_TOTAL_DISCOUNT]%>.value = formatFloat(''+dispercent, '', sysDecSymbol, usrDigitGroup, usrDecSymbol, decPlace);	
	...
	var totalItemAmount = (parseFloat(amount) * parseFloat(qty)) -( parseFloat(discount) * parseFloat(qty) ) - (parseFloat(regdisval) * parseFloat(qty)) ;
...
function cmdVatEdit(){
    ...
    <%}%>
    <%if(ven.getDiscount()>0){%>
        document.frmpurchase.<%=JspPurchase.colNames[JspPurchase.JSP_DISCOUNT_PERCENT]%>.value="<%=ven.getDiscount()%>";		
    <%}%>
	calculateAmount();
}
                                                          ...
                                                          <tr> 
                                                            ...
                                                            <td width="15%"> 
                                                              <div align="center"> 
                                                                ...
                                                                % </div>
                                                                <input type="hidden" name="<%=JspPurchase.colNames[JspPurchase.JSP_INCLUDE_TAX]%>" size="0" value="<%=purchase.getTaxPercent()%>" style="text-align:center">
