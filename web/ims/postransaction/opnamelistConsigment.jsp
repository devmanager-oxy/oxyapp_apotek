...
if(whereClause.length()>0){
    whereClause = whereClause + " and " + DbOpname.colNames[DbOpname.COL_TYPE] + "=" + DbOpname.TYPE_CONSIGMENT;
}else{
    whereClause = DbOpname.colNames[DbOpname.COL_TYPE] + "=" + DbOpname.TYPE_CONSIGMENT;
}
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;<a href="javascript:cmdAdd()" class="tablink">Opname Stock</a>&nbsp;&nbsp;</div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                            ...
                                            <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                              ...
                                              <tr> 
                                                ...
                                                <td colspan="3"> 
                                                  ...
                                                  <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmopnamerequest.src_start_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a> 
                                                  &nbsp;&nbsp;and&nbsp;&nbsp; 
                                                  <input name="src_end_date" value="<%=JSPFormater.formatDate((srcEndDate==null) ? new Date() : srcEndDate, "dd/MM/yyyy")%>" size="11" readonly>
                                                  <a href="javascript:void(0)" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmopnamerequest.src_end_date);return false;" ><img class="PopcalTrigger" align="absmiddle" src="<%=approot%>/calendar/calbtn.gif" height="19" border="0" alt=""></a> 
