...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemRepack.jsp";
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster  
        ...
        self.opener.document.frmrepack.JSP_ITEM_MASTER_ID.value=oidItemMaster  
        self.opener.document.frmrepack.submit();                
        self.close();  
	}
