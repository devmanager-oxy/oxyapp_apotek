...
if(whereClause.length()>0){
    whereClause = whereClause + " and " + DbReceive.colNames[DbReceive.COL_TYPE] + " = " + DbReceive.TYPE_NON_CONSIGMENT + " and type_ap=0 and type_inc=1 ";
}else{
    whereClause = DbReceive.colNames[DbReceive.COL_TYPE] + " = " + DbReceive.TYPE_NON_CONSIGMENT + " and type_ap=0 and type_inc=1 ";    
}
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Transaction 
                                      ...
                                      Goods Import </span>&raquo; <span class="lvl2">Records/Archives</span></font></b></td>
                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr > 
                                          ...
                                          <td class="tabin" nowrap> 
                                            <div align="center">&nbsp;&nbsp;<a href="javascript:cmdAdd()" class="tablink">Incoming 
                                              Import</a></div>
                                          </td>
                                          <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
