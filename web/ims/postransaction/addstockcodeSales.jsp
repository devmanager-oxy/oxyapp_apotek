...
<%
            ...
            long salesId = JSPRequestValue.requestLong(request, "salesId");
            long salesItemId = JSPRequestValue.requestLong(request, "salesItemId");
...
<html ><!-- #BeginTemplate "/Templates/index.dwt" -->
    <head>
        ...
        <script language="JavaScript">
             ...
             function cmdSelect(salesId,salesItemId){
                
                <%
            if (stockCanGet <= 0) {
                %>    
                    self.opener.document.frmsalesproductdetail.OID_STOCK_CODE.value = "";
                    self.opener.document.frmsalesproductdetail.hidden_sales_item_id.value = salesItemId;
                    self.opener.document.frmsalesproductdetail.hidden_sales_id.value = salesId;
                    self.opener.document.frmsalesproductdetail.command.value="<%=JSPCommand.SUBMIT%>";    
                    self.opener.document.frmsalesproductdetail.submit();                
                    self.close();  
                <%
            } else {
                ...
                %>  
                    if(minus == 1){
                        ...
                        self.opener.document.frmsalesproductdetail.OID_STOCK_CODE.value = txs;
                    ...
                    function cmdSearch(){                   
                        ...
                        document.frmaddstockcode.action="addstockcodeSales.jsp";
    ...
    <body> 
        <table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
            <form name="frmaddstockcode" method ="post" action="">
                ...
                <input type="hidden" name="salesItemId" value="<%=salesItemId%>">                            
                ...
                <tr>
                    ...
                    for (int sc = 0; sc < vStockCode.size(); sc++) {
                        ...
                        pg++;
                            ...
                            <tr>
                                <td colspan="3">
                                    <a href="javascript:cmdSelect('<%=salesId%>','<%=salesItemId%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new21','','../images/add.gif',1)"><img src="../images/add2.gif" name="new21" height="22" border="0" style="padding:0px"></a> 
                                </td>                               
                            </tr>
                        </table>    
                    </td>
