...
<%!
    public Vector drawList(int iJSPCommand, JspRepackItem frmObject,
        ...
        if (iJSPCommand != JSPCommand.POST && isEdit == false && (iJSPCommand == JSPCommand.ADD || iJSPCommand == JSPCommand.LOAD || (iJSPCommand == JSPCommand.SAVE && iErrCode2 != 0 && costingItemId == 0))) {
            ...
            objEntity.setItemMasterId(itemMasterId);
            double stockItems = getItemTotalStock(oidLocation, objEntity.getItemMasterId());
            ItemMaster colCombo2 = new ItemMaster();
    ...
    public static double getItemTotalStock(long locationId, long itemOID) {
        ...
        String sql = " select sum(qty * in_out) " +
                ...
                " and location_id=" + locationId + " and type_item=0 and to_days(date) <= to_days('" + JSPFormater.formatDate(new Date(), "yyyy-MM-dd") + "')";
        double result = 0;
                ...
                if (getCountForMulty(repack.getOID()) == 1) {
                                                                                                            ...
                                                                                                            <table width="293" border="0" cellspacing="1" cellpadding="1">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="264">&nbsp;<a href="javascript:cmdGoToMulty('<%=repack.getOID()%>')">Transfer 
                                                                                                                        To Multy Output</a></td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                            <%}
            }%>
