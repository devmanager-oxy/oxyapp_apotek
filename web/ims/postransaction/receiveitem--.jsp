 ...
 function cmdVendorChange(){
    ...
    if (receive.getOID() != 0 && purchItems != null && purchItems.size() > 0) {
        ...
        if (receive.getOID() != 0 && purchItems != null && purchItems.size() > 0) {
                                                                                                                %>
                                                                                                                <tr> 
                                                                                                                    <%if ((privEditIncoming) ||( !receive.getStatus().equals(I_Project.DOC_STATUS_APPROVED) && !receive.getStatus().equals(I_Project.DOC_STATUS_CHECKED) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES"))){%>
