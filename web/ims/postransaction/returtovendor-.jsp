        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (index == i && (iJSPCommand == JSPCommand.EDIT || iJSPCommand == JSPCommand.ASK)) {
                ...
                if (status.equals(I_Project.DOC_STATUS_DRAFT)) {
                    rowx.add("<a href=\"javascript:cmdEdit('" + String.valueOf(returItem.getOID()) + "')\">" + (i + 1) + "</a>");
        ...
        us = DbUser.fetch(retur.getUserId());
                                                                                        ...
                                                                                        <tr align="left"> 
                                                                                            ...
                                                                                            <td height="26" width="27%">
                                                                                                ...
                                                                                                <span class="comment"> 
                                                                                                    <select name="<%=jspDirectRetur.colNames[jspDirectRetur.JSP_LOCATION_ID]%>" <%if (((!retur.getStatus().equals(I_Project.DOC_STATUS_APPROVED)) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES")) || DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("NO")) {%>onChange="javascript:cmdLocation()"<%}%>>
                                                                                                            <%
...
%>
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td colspan="4"> 
                                                                                                            <table width="80%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <%if ((!retur.getStatus().equals(I_Project.DOC_STATUS_CLOSE) || iErrCode != 0)) {%>
                                                                                                                <tr> 
                                                                                                            ...
                                                                                                            <table width="80%" border="0" cellspacing="0" cellpadding="0" id="closingreason">
                                                                                                                <tr> 
                                                                                                                    ...
                                                                                                                    <td width="88%"> 
                                                                                                                        <%if ((!retur.getStatus().equals(I_Project.DOC_STATUS_CLOSE) || iErrCode != 0)) {%>
                                                                                                                        <textarea name="<%=JspDirectRetur.colNames[JspDirectRetur.JSP_CLOSED_REASON]%>" cols="50"><%=(retur.getClosedReason() == null) ? "" : retur.getClosedReason()%></textarea>
                                                                                                                        * <%=jspDirectRetur.getErrorMsg(JspDirectRetur.JSP_CLOSED_REASON)%> 
                                                                                                                        <%} else {%>
                                                                                                                        <i><%=(retur.getClosedReason() == null) ? "" : retur.getClosedReason()%> </i> 
                                                                                                                        <%}%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr> 
    ...
    u = new User();
    try {
        u = DbUser.fetch(retur.getApproval2());
    } catch (Exception e) {
    }
                                                                                                                    %>
                                                                                                                <%=u.getLoginId()%></div>
                                                                                                        ...
                                                                                                        <td width="33%" class="tablecell1"> 
                                                                                                            <div align="center"> 
                                                                                                                <div align="center"> 
                                                                                                                    <%if (retur.getApproval2() != 0) {%>
                                                                                                                    <%=JSPFormater.formatDate(retur.getApproval2Date(), "dd MMMM yy")%> 
                                                                                                                    <%}%>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </td>
