...
<%@ page import = "com.project.ccs.postransaction.costing.JspCostingItem" %>
...
<%!
	...
	public String drawList(Vector objectClass,  long itemMasterId)
	{
		...
		jsplist.addHeader("Unit Stock","15%");
		...
		for (int i = 0; i < objectClass.size(); i++){
                    ItemMaster s = (ItemMaster) objectClass.get(i);
                    itemMaster = s;
...
if(location_id==0){
    location_id=JSPRequestValue.requestLong(request, "hidden_location_id");
}
...
String whereClause = " for_sales=1 ";
...
if(srcCode!=null && srcCode.length()>0){
	...
	whereClause = whereClause + "(" + DbItemMaster.colNames[DbItemMaster.COL_BARCODE]+" like '%"+srcCode+"%' or " + DbItemMaster.colNames[DbItemMaster.COL_BARCODE_2]+" like '%"+srcCode+"%' or " + DbItemMaster.colNames[DbItemMaster.COL_BARCODE_3]+" like '%"+srcCode+"%' or " + DbItemMaster.colNames[DbItemMaster.COL_CODE]+" like '%"+srcCode+"%')";
}
...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemCosting.jsp";
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster          
        self.opener.document.frmcosting.JSP_ITEM_MASTER_ID.value=oidItemMaster
        self.opener.document.frmcosting.submit();                
        self.close();  
}
                                                ...
                                                <td height="8" valign="middle" colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td width="14%"> 
                                                        <input type="text" name="src_code" size="10" value="<%=srcCode%>" onChange="javascript:cmdSearch()">
                                                      </td>
                                                      <td width="64%">&nbsp; </td>
                                                    </tr>
                                                    <tr> 
