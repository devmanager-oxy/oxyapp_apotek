...
<%!
				...
				int iErrCode2, String status, long itemMasterId)
	{
		...
		/* selected ItemGroupId*/
                //Vector vectVendMaster = DbStock.getStock(oidFromLocationId,DbStock.TYPE_NON_CONSIGMENT);
	...
	//	}
		...
		if(iJSPCommand != JSPCommand.POST && (iJSPCommand == JSPCommand.ADD || iJSPCommand==JSPCommand.LOAD || (iJSPCommand == JSPCommand.SAVE && iErrCode2!=0 && adjusmentItemId==0))){ 
				...
				rowx.add("<div align=\"center\">"+"<input type=\"text\" size=\"7\" name=\""+frmObject.colNames[JspAdjusmentItem.JSP_QTY_SYSTEM] +"\" value=\""+((objEntity.getQtySystem()==0) ? 0 : objEntity.getQtySystem())+"\" class=\"readonly\" readonly style=\"text-align:center\">"+frmObject.getErrorMsg(frmObject.JSP_QTY_SYSTEM)+"</div>");				
...
Vector stockItems = DbStock.getStock(adjusment.getLocationId(),DbStock.TYPE_NON_CONSIGMENT);
