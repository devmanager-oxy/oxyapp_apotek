                      ...
                      <td><!-- #BeginEditable "content" --> 
                        <form id="form1" name="form1" method="post" action="">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <td class="container">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  ...
                                  <tr> 
                                    ...
                                    <td width="19%">&nbsp;</td>
                                    <td width="10%">&nbsp;</td>
                                    <td width="56%"><font color="#FF0000">tampilkan 
                                      PR jika PR OID pada PO tidak 0 nol, kasi 
                                      - (dash) jika OID = 0</font> </td>
                                  </tr>
                                  <tr> 
                                    <td width="15%" nowrap bgcolor="#F1FDEA" height="19">PO 
                                      Number </td>
                                    <td width="19%" height="19">PO001</td>
                                    <td width="10%" bgcolor="#F1FDEA" height="19">PR 
                                      Number </td>
                                    <td width="56%" height="19">PR001</td>
                                  </tr>
                                  <tr> 
                                    <td width="15%" nowrap bgcolor="#F1FDEA" height="19">PO 
                                      Date </td>
                                  ...
                                  <tr> 
                                    ...
                                    <td width="10%" bgcolor="#F1FDEA" height="19">PR 
                                      For Deparment</td>
                                    <td width="56%" height="19">Human Resources</td>
                                  </tr>
                                  ...
                                  <tr> 
                                    ...
                                    <td width="10%" height="19">DO/Invoice Number</td>
                                    <td width="56%" height="19"> 
                                      <input type="text" name="textfield">
                                      <font color="#FF0000">otomatis readonly, 
                                      pake cara yang di direct incoming</font></td>
                                  </tr>
                                  <tr> 
                                    <td width="15%" nowrap bgcolor="#F1FDEA" height="19">Address</td>
                                    <td width="19%" height="19">Jln. Dewi Sartika</td>
                                    <td width="10%" height="19">Incoming Date 
                                    </td>
                                    <td width="56%" height="19"> 
                                  ...
                                  <tr> 
                                    ...
                                    <td width="10%" height="19">Receive By </td>
                                    <td width="56%" height="19"> 
                                      <select name="select7">
                                        <option selected>001 - Bobo</option>
                                        <option>002 - Ronald</option>
                                      </select>
                                      <font color="#FF0000">list pegawai</font></td>
                                  </tr>
                                  <tr> 
                                    <td width="15%" nowrap height="19">&nbsp;</td>
                                    <td width="19%" height="19">&nbsp; </td>
                                    <td width="10%" height="19">Due Date </td>
                                    <td width="56%" height="19"> 
                                      <input type="text" name="textfield42">
                                      <font color="#FF0000">tanggal</font></td>
                                  </tr>
                                  <tr> 
                                    ...
                                    <td width="10%" height="19"><font color="#FF0000"></font>Received 
                                      In</td>
                                    <td width="56%" height="19"> 
                                      <select name="select">
                                  ...
                                  <tr> 
                                    <td colspan="2"><font color="#FF0000">Tampilkan 
                                      semua item pada PO tanpa next prev command</font></td>
                                    <td width="10%">&nbsp;</td>
                                    <td width="56%"><font color="#FF0000">@price 
                                      diambil dari harga Item PO setelah di discount 
                                      ( total/qty -&gt; dibagi ) total &amp; qty 
                                      lihat pada direct PO</font></td>
                                  </tr>
                                  <tr> 
                                    <td colspan="4"> 
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr> 
                                          ...
                                          <td class="tablehdr" rowspan="2" width="16%">@Price</td>
                                          <td class="tablehdr" rowspan="2" width="12%">Total</td>
                                        </tr>
                                        <tr> 
                                          <td class="tablehdr" width="5%">PO</td>
                                          <td class="tablehdr" width="6%">Already 
                                            Received</td>
                                        ...
                                        <tr> 
                                          ...
                                          <td rowspan="4" bgcolor="#CCCCCC"><font color="#FF0000">jika 
                                            sudah diterima semua, tidak bisa di 
                                            tambah new received</font></td>
                                          <td rowspan="4" bgcolor="#CCCCCC"><font color="#FF0000">yang 
                                            disimpan ke incoming item adalah item 
                                            yang new receivednya &gt;0</font> 
                                          </td>
                                          <td width="8%">&nbsp;</td>
                            ...
                            <tr> 
                              <td valign="top"> 
                                <p><font color="#FF0000"><b>catatan :</b></font></p>
                                <p><b><font color="#FF0000">JIKA semua item sudah 
                                  diterima, update status PO ke CLOSED</font></b></p>
                                <p>&nbsp;</p>
                              </td>
                            </tr>
                            <tr> 
