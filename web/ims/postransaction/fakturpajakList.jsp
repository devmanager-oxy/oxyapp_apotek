...
<%-- 
    Document   : fakturpajaklist
    Created on : Sep 25, 2012, 6:58:26 PM
    Author     : Roy Andika
--%>
...
<%
            ...
            String whereClause = DbFakturPajak.colNames[DbFakturPajak.COL_TYPE_FAKTUR] + " = " + DbFakturPajak.TYPE_FAKTUR_TRANSFER;
            ...
            if(locationId != 0){
                ...
                whereClause = whereClause + DbFakturPajak.colNames[DbFakturPajak.COL_LOCATION_ID]+" = "+locationId;
            }
        ...
        <%@ include file="../main/hmenu.jsp"%>
                                                                                    ...
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr > 
                                                                                            ...
                                                                                            <td class="tabin" nowrap> 
                                                                                                <div align="center">&nbsp;&nbsp;<a href="javascript:cmdAdd()" class="tablink"><font face="arial">Transfer Tax</font></a>&nbsp;&nbsp;</div>
                                                                                            </td>
                                                                                            <td class="tabheader"><img src="<%=approot%>/images/spacer.gif" width="3" height="10"></td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td>
                                                                                                                        <select name="location_id">
                                                                                                                            <option value ="0" <%if (locationId == 0) {%>selected<%}%> >ALL</option>
                                                                                                                            <%
                                                                                            ...
                                                                                            <td colspan="3">
                                                                                                <table width="95%" cellpadding="1" cellspacing="1">    
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class = "tablehdr" width="10%">From Location</td> 
                                                                                                        <td class = "tablehdr" width="10%">To Location</td>
                                                                                                    </tr>         
                                                                                                    <%} else {%>
                                                                                                    <tr>
            ...
            if (listFakturPajak != null && listFakturPajak.size() > 0) {
                for (int i = 0; i < listFakturPajak.size(); i++) {
                    ...
                    try {
                        loc = DbLocation.fetchExc(fp.getLocationId());
                    } catch (Exception e) {
                    }
                    ...
                    try {
                        locTo = DbLocation.fetchExc(fp.getLocationToId());
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td class="tablecell1" align="left"><%=loc.getName() %></td>
