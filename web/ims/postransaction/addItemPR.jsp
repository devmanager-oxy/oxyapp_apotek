...
function cmdSearch(){
	...
	document.frmitemmaster.action="addItemPR.jsp";
...
function cmdEdit(oidItemMaster){
	//self.opener.document.frmsalesproductdetail.hidden_item_master_id.value=oidItemMaster  
        self.opener.document.frmpurchaserequest.JSP_ITEM_MASTER_ID.value=oidItemMaster  
        self.opener.document.frmpurchaserequest.submit();                
        self.close();  
	}
