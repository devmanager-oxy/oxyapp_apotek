...
<%!
    public Vector drawList(int iJSPCommand, JspTransferItem frmObject,
            ...
            int iErrCode2, String status, boolean useStockCode, Vector listStockCode, Transfer transfer, boolean isSave, boolean optionalCode, long itemMasterId, QrUserSession appuser, String srccode, boolean editTrans) {
       ...
       int vectVendMaster =1;// semntara di by pas untuk tujuan kecepatan sambil nunggu perubahan stuktur tabel stock DbStock.getStockItemCountByLocation(oidFromLocationId,DbStock.TYPE_NON_CONSIGMENT);
        ...
        for (int i = 0; i < objectClass.size(); i++) {
			...
			try{
                ...
                double stockItems = DbStock.getItemTotalStock(oidFromLocationId, objEntity.getItemMasterId());
                //objEntity.setQty(stockItems);
                
                if (vectVendMaster > 0){
                    if(!srccode.equalsIgnoreCase("")){
                        if(srccode.equals(colCombo2.getBarcode2())){
                            rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode2()+ "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:right\"> </div>");
                        }else if(srccode.equals(colCombo2.getBarcode3())){
                            rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode3()+ "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:right\"> </div>");
                        }else{
                            rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode()+ "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:right\"> </div>");
                        }
                    }else{
                        rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode()+ "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:right\"> </div>");
                    }
                ...
                rowx.add("<div align=\"right\">" + "<input type=\"text\" size=\"10\" name=\""+ JspTransferItem.colNames[JspTransferItem.JSP_QTY_STOCK]+"\" value=\"" + stockItems + "\" class=\"readOnly\" readOnly style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">" + frmObject.getErrorMsg(frmObject.JSP_QTY) + "</div>");
                if(useStockCode){
                ...
                //double stockItems = DbStock.getItemTotalStock(oidFromLocationId, transferItem.getItemMasterId());
                ...
                rowx.add("<div align=\"center\">" + (i + 1) + "</div>");
                rowx.add("<div align=\"left\">" + transferItem.getItemBarcode() + "</div>");
                if ((appuser.getUserOID()==transfer.getUserId() || (editTrans && status.equals(I_Project.DOC_STATUS_DRAFT)))&&((status != null && status.equals(I_Project.DOC_STATUS_DRAFT))&& DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES"))||DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("NO")) {
                    ...
                    detail.setBarcode(transferItem.getItemBarcode());
                ...
                rowx.add("<div align=\"center\">" + transferItem.getQtyStock() + "</div>");
        ...
        //masuk
            ...
            double stockItems = DbStock.getItemTotalStock(oidFromLocationId, itemMasterId);
           // objEntity.setQty(stockItems);
            if(stockItems <=0 && itemMasterId != 0){
                vectVendMaster =0;
            }
            if (vectVendMaster > 0){
                ...
                if(!srccode.equalsIgnoreCase("")){
                    if(srccode.equals(colCombo2.getBarcode2())){
                        rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode2() + "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:left\"> </div>");
                    }else if(srccode.equals(colCombo2.getBarcode3())){
                        rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode3() + "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:left\"> </div>");
                    }else{
                        rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode() + "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:left\"> </div>");
                    }
                }else{
                    rowx.add("<div align=\"left\">" + "<input type=\"text\" size=\"20\" name=\"JSP_ITEM_BARCODE\" value=\"" + colCombo2.getBarcode() + "\" onChange=\"javascript:cmdAddItemMaster2()\" style=\"text-align:left\"> </div>");
                }
            ...
            rowx.add("<div align=\"right\">" + "<input type=\"text\" size=\"20\" name=\"\" value=\"\" class=\"readOnly\" readOnly style=\"text-align:right\"> </div>");
            rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\""+JspTransferItem.colNames[JspTransferItem.JSP_QTY_STOCK]+"\" readonly value=\"" + stockItems + "\" class=\"readOnly\" readOnly style=\"text-align:center\" onClick=\"this.select()\" onBlur=\"javascript:calculateSubTotal()\">" + frmObject.getErrorMsg(frmObject.JSP_QTY) + "</div>");
            if(useStockCode){
                ...
                rowx.add("<div align=\"center\">" + "<input type=\"text\" size=\"10\" name=\"" + frmObject.colNames[JspTransferItem.JSP_QTY] + "\" value=\"\" class=\"formElemen\" style=\"text-align:right\" onBlur=\"javascript:calculateSubTotal()\" onChange=\"javascript:calculateSubTotal()\" onClick=\"this.select()\" >" + "</div>");
            }
...
<%
            ...
            int stockItems = 1;//DbStock.getStockItemCountByLocation(transfer.getFromLocationId(), DbStock.TYPE_NON_CONSIGMENT);
           ...
           // double subTotal = DbTransferItem.getTotalTransferAmount(oidTransfer);
            ...
            if(iJSPCommand != JSPCommand.SAVE && iJSPCommand!=JSPCommand.POST){
                if(srcCode.length()>0){
                   vItem  = DbItemMaster.list(0,0,"barcode like '%"+srcCode+"%' or barcode_2 like '%"+ srcCode + "%' or barcode_3 like '%" + srcCode + "%' or code='%"+ srcCode +"%'", "");
                   vectSize= vItem.size();
                    if(vItem.size()==1){
...
<html >
   ...
   function cmdAddItemMaster(){   
            ...
            window.open("<%=approot%>/postransaction/addItemTransfer.jsp?location_id=" + oidLoc + "&item_name=" + itemName , null, "height=400,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
   ...
   function cmdPrintPdf(){
       ...
       function removeChar(number){
        ...
        function calculateSubTotal(){
            ...
            var stockQty =document.frmtransfer.<%=JspTransferItem.colNames[JspTransferItem.JSP_QTY_STOCK]%>.value;
            //alert(stockQty);
        ...
        us = DbUser.fetch(transfer.getUserId());
                                                                                                    ...
                                                                                                    %>
                                                                                                        ...
                                                                                                        <td height="26" width="27%">
                                                                                                            <%if ( (lokFrom==0 || transfer.getUserId()== user.getOID() || transfer.getUserId()==0) && (!transfer.getStatus().equals(I_Project.DOC_STATUS_APPROVED) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES") ) || DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("NO") ) {%>												
                                                                                                            <span class="comment"> 
    ...
    <%}%>
                ...
                <input type="hidden" name="<%=JspTransfer.colNames[JspTransfer.JSP_FROM_LOCATION_ID]%>" value="<%=transfer.getFromLocationId()%>">
    ...
    if (vLocations != null && vLocations.size() > 0) {
        for (int i = 0; i < vLocations.size(); i++) {
            ...
            if (transfer.getToLocationId() == d.getOID()) {
                ...
                <input type="hidden" name="<%=JspTransfer.colNames[JspTransfer.JSP_TO_LOCATION_ID]%>" value="<%=transfer.getToLocationId()%>">
           <% }%>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr align="left"> 
            ...
            if (transfer.getOID() == 0) {
                ...
                number = DbTransfer.getNextNumber(ctr, transfer.getFromLocationId());
            ...
            rptKonstan.setNotes(transfer.getNote());
                                                                                                    ...
                                                                                                    <tr align="left" > 
                                                                                                        <td colspan="5" valign="top"> 
                                                                                                            &nbsp; 
                                                                                                            <%
            Vector x = drawList(iJSPCommand, jspTransferItem, transferItem, purchItems, oidTransferItem, approot, transfer.getFromLocationId(), iErrCode2, transfer.getStatus(), useStockCode, listStockCode, transfer, isSave, optionalCode, itemMasterId, appSessUser, srcCode, ediTransfer);
                                                                                                            ...
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr> 
                                                                                                                    <td width="45%" valign="middle"> 
                                                                                                                        <%if (((appSessUser.getUserOID()==transfer.getUserId() || (privEditTransfer && transfer.getStatus().equalsIgnoreCase(I_Project.DOC_STATUS_DRAFT))) || transfer.getOID()==0 || transfer.getUserId()==0) && ((((stockItems  > 0) && transfer.getStatus().equals(I_Project.DOC_STATUS_DRAFT)) || iJSPCommand == JSPCommand.CONFIRM) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES")) || DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("NO") ) {%>
    ...
    if (transfer.getOID() != 0 && purchItems != null && purchItems.size() > 0) {
                                                                                                                ...
                                                                                                                %>
                                                                                                                <tr> 
                                                                                                                    <%if (purchItems != null && purchItems.size() > 0 && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES")){%>
                                                                                                                    <%if(transfer.getStatus().equalsIgnoreCase("DRAFT")){%>
                                                                                                                    ...
                                                                                                                    <td width="97"> 
                                                                                                                        <div align="left"><a href="javascript:cmdAddNewDoc()"  onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('new21','','../images/new2.gif',1)"><img src="../images/new.gif" name="new21" width="71" height="22" border="0"></a></div>
                                                                                                                    </td>
                                                                                                                    <%}%>
                                                                                                                    <%if ((!transfer.getStatus().equals(I_Project.DOC_STATUS_APPROVED) || iErrCode != 0) && DbSystemProperty.getValueByName("APPLY_DOC_APPROVAL").equalsIgnoreCase("YES"))  {%>
                                                                                                                    <%if(appSessUser.getUserOID()==transfer.getUserId()){%>
                                                                                                                    <td width="102" > 
