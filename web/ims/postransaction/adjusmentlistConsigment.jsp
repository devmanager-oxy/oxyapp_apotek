...
if(whereClause.length()>0){
    whereClause =  whereClause + " and " + DbAdjusment.colNames[DbAdjusment.COL_TYPE] + "=" + DbAdjusment.TYPE_CONSIGMENT; 
}else{
    whereClause = DbAdjusment.colNames[DbAdjusment.COL_TYPE] + "=" + DbAdjusment.TYPE_CONSIGMENT; 
}
