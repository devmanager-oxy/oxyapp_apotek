...
if(whereClause.length()>0){
    whereClause = whereClause + " and " + DbReceive.colNames[DbReceive.COL_TYPE] + " = " + DbReceive.TYPE_CONSIGMENT;
}else{
    whereClause = DbReceive.colNames[DbReceive.COL_TYPE] + " = " + DbReceive.TYPE_CONSIGMENT;    
}
                                ...
                                <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                  <tr valign="bottom"> 
                                    <td width="60%" height="23"><b><font color="#990000" class="lvl1">Transaction 
                                      ...
                                      Goods </span>&raquo; <span class="lvl2">Records/Archives</span></font></b></td>
