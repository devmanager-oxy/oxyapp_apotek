...
String whereClause = "";
String orderClause = "";
Vector listPurchase = new Vector();
    try{
    listPurchase = (Vector)session.getValue("sess_result");
    }catch(Exception e){}
%>
<html >
                    ...
                    <tr> 
                      <td><!-- #BeginEditable "content" --> 
                        <form name="frmpurchase" method ="post" action="">
                          ...
                          <input type="hidden" name="hidden_purchase_id" value="">
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                        <tr valign="bottom"> 
                                          <td width="60%" height="23"><b><font color="#990000" class="lvl1">Transaction 
                                            ...
                                            <span class="lvl2">Export PR to PO 
                                            </span>&raquo; <span class="lvl2">Result</span></font></b></td>
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="top" colspan="3"> 
                                            <table cellspacing="1" cellpadding="1" width="385">
                                              <TR> 
                                                <TD colspan="2" height="20"><font color="#009900">&nbsp;<strong>Export 
                                                  PR to PO was completed successfully 
                                                  .. !</strong></font></TD>
                                              </TR>
                                              <TR> 
                                                <TD width="40%" height="20">&nbsp;Please, 
                                                  click the link in the list to 
                                                  view purchase order detail.</TD>
                                              </TR>
                                            </table>
                                          </td>
                                        </tr>
                                        ...
                                        <tr align="left" valign="top"> 
                                          <td height="22" valign="middle" colspan="3"> 
                                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                              <tr>
                                                <td><%= drawList(listPurchase,start)%></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
