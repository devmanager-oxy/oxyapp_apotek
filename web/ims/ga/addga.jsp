...
<%
            ...
            long oidItemMaster = JSPRequestValue.requestLong(request, "xxhidden_item_id");            
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){                
                ...
                document.frmitemmaster.action="addga.jsp";
                document.frmitemmaster.submit();
            }
            
            function cmdEdit(oidItemMaster){
                self.opener.document.frmgeneralaffair.xxhidden_item_id.value=oidItemMaster  
                self.opener.document.frmgeneralaffair.submit();                
                self.close();  
            }
                                                ...
                                                <tr> 
                                                    <td><!-- #BeginEditable "content" --> 
                                                        <form name="frmitemmaster" method ="post" action="">
                                                            ...
                                                            <input type="hidden" name="xxhidden_item_id" value="<%=oidItemMaster%>">
