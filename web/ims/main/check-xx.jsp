...
//Production
            boolean newProject = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_NEW_PROJECT);
            boolean newStock = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_NEW_STOCK);
            boolean mstProdCategory = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_MASTER_PRODUCT_CATEGORY);
            boolean mstProdSubCategory = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_MASTER_PRODUCT_SUB_CATEGORY);
            boolean mstProdList = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_MASTER_PRODUCT_LIST);
            boolean mstProdWorkCenter = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_MASTER_PRODUCT_WORK_CENTER);
            boolean shopFlor = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_SHOP_FLOR_MANAGEMENT);
            boolean finishGoods = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_FINISH_GOODS);
            boolean deliv = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_DELIVERY);
            boolean instExp = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_PRODUCTION, AppMenu.M2_INSTALATION_EXPENSE);
...
//Stock Management
            ...
            boolean privGA = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_STOCK_MANAGEMENT, AppMenu.M2_GA);
            boolean privGAApproved = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_STOCK_MANAGEMENT, AppMenu.M2_GA_APPROVED);
            ...
            boolean dataSync = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_DATA_SYNCHRONIZATION, AppMenu.M2_DATA_SYNCHRONIZATION);
...
//Retail Report
            ...
            boolean rptStockvsSales = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_RETAIL_REPORT, AppMenu.M2_STOCK_VSSALES);
            boolean rptSyncStatistic = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_RETAIL_REPORT, AppMenu.M2_SYNC_STATISTIC);
            boolean rptCashBackTransaction = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_RETAIL_REPORT, AppMenu.M2_CASH_BACK_TRANSACTION);
            boolean rptHistoryMember = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_RETAIL_REPORT, AppMenu.M2_HISTORY_MEMBER);
//Master Data

            boolean mstMaintenance = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_CONFIGURATION);
            boolean mstAccounting = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_ACCOUNTING);
            ...
            boolean mstProduct = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_PRODUCT);
            boolean mstAsset = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_ASSET);
            ...
            boolean mstGroupMember = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_GROUP_MEMBER);
            boolean mstMemberNonReguler = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MEMBER_NON_REGULER);
            boolean mstMemberChekPoint = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MEMBER_CHECK_POINT);
            ...
            boolean mstBackupData = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_BACKUP_DATA);
            boolean mstMenu = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_MENU);
            boolean mstResto = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_RESTO);
...
//Administrator
            boolean sysConfig = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_ADMINISTRATOR, AppMenu.M2_SYSTEM_CONFIG);
            boolean administrator =false;// appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_ADMINISTRATOR, AppMenu.M2_ADMINISTRATOR);
            boolean genUser = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_ADMINISTRATOR, AppMenu.M2_GEN_USER);
