...
<script language="JavaScript">
    ...
    function cmdChangeMenu(idx){
        ...
        switch(parseInt(idx)){ 
            ...
            <%if (incomFromPo || directIncom || incomArchives || receivingAdjusment || incomingKomisi || incomingKonsinyasi) {%>
            ...
            <%if (mTransfer || mTransferRequest || purchRetur || newRetur || newReturArc || madjustment || mOpname || mCosting || mRepack || privGA || privGAApproved) {%>
            ...
            <%if (rptPoReport || rptIncomReport || rptPoRetur || rptItemTransfer || rptStockReport || rptStockCard || rptCostingReport || rptRepackReport || rptAjustmentGA || rptInventory || rptStockvsSales || rptSyncStatistic || rptCashBackTransaction || rptHistoryMember) {%>
            document.all.report1.style.display="";
            document.all.report2.style.display="none";
            document.all.report.style.display="none";
            <%}%>
            
            <%if (mstMaintenance || mstAccounting || mstMaterial || mstProduct || mstAsset || mstMerk || mstCompany || mstGeneral || mstMember || mstGroupMember || mstMemberNonReguler || mstMemberChekPoint || mstCashier || mstBackupData || mstMenu || mstPriceChange || mstStandarStock || mstPromotion || mstCategory || mstSubCategory || mstCostChange) {%>			
            ...
            <%if (incomFromPo || directIncom || incomArchives || receivingAdjusment || incomingKomisi ) {%>
            document.all.incoming1.style.display="";
            document.all.incoming2.style.display="none";
            document.all.incoming.style.display="none";
            <%}%>
...
<table width="100%"  height="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
        <td valign="top" style="background:url(<%=approot%>/images/leftmenu-bg.gif) repeat-y"> 
                ...
                <tr> 
                    <td style="padding-left:10px" valign="top" height="1"> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id="purchase"> 
                                <td class="submenutd"> 
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0" class="submenu">
                                        ...
                                        <%if (dirPO) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/purchaseitem.jsp?menu_idx=1">Direct PO</a></td>
                                        </tr>
                                        <%}%>
                                        <%if (poArchives) {%>
                                        <tr> 
                            ...
                            <tr id="incoming"> 
                                <td class="submenutd"> 
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0" class="submenu">
                                        ...
                                        <%if (incomArchives) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/receivelist.jsp?menu_idx=2">Incoming Archives</a></td>
                                        </tr>
                                        <%}%>
                                        <%if (receivingAdjusment) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/receivelistRecAdj.jsp?menu_idx=2">Incoming Adjusment</a></td>
                                        </tr>                                        
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/recadjlist.jsp?menu_idx=2">Inc. Adjusment Archives</a></td>
                                        </tr>
                                        <%}%>
                                        <tr> 
                                            <td class="menu1">&nbsp;</td>
                            ...
                            <%if (mTransfer || mTransferRequest || purchRetur || newRetur || newReturArc || madjustment || mOpname || mCosting || mRepack || privGA) {%>
                            <tr id="stock1"> 
                            ...
                            <tr id="stock"> 
                                <td class="submenutd"> 
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0" class="submenu">
                                        <%if (mTransfer) {%>
                                         <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/transferrequestlist.jsp?menu_idx=3">Transfer Request</a></td>
                                        </tr>   
                                        <tr> 
                                        ...
                                        <%}%>
                                        <%if (privGA || privGAApproved) {%>
                                        <tr> 
                                            <td class="menu1">General Affair</td>
                                        </tr>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/ga/ga_item.jsp?menu_idx=3">New Data
                                            </a></td>
                                        </tr>
                                        <tr> 
                                            <td class="menu2"><a href="<%=approot%>/ga/ga_archives.jsp?menu_idx=3">Archives
                                            </a></td>
                                        </tr>
                                        <%}%>
                                        <tr> 
            ...
            if (dataSync) {
                            ...
                            <tr id="report"> 
                                <td class="submenutd"> 
                                    <table width="99%" cellpadding="0" cellspacing="0" class="submenu">
                                        ...
                                        <%}%>
                                        <%if (rptCashBackTransaction || rptHistoryMember) {%>
                                         <tr> 
                                            <td height="18" width="90%" class="menu1">Member Report</td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/cashback.jsp?menu_idx=13">Cash Back</a></td>
                                                    </tr>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/cashbacklocation.jsp?menu_idx=13">Cash Back (By Location)</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>                                        
                                        ...
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/incoming-report-sumary.jsp?menu_idx=13">By Invoice</a></td>
                                                    </tr>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/incomingbyitem.jsp?menu_idx=13">By Item</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <%if (rptAjustmentGA) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1">Adjusment Report</td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/adjustment_ga.jsp?menu_idx=13">Adjusment Report (GA)</a></td>
                                                    </tr>                                                    
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <%if (rptStockReport || rptInventory) {%>
                                        <tr> 
                                        ...
                                        <%if (rptItemTransfer) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/treport-transaksi.jsp?menu_idx=13">Transfer Report</a></td>
                                        </tr>                                        
                                        <%}%>
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/stock-card-mix.jsp?menu_idx=13">Stock Card Draft</a></td>
                                        </tr>                                        
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/reportstockstandar.jsp?menu_idx=13">Stock Standard</a></td>
                                        </tr>                                        
                                        <tr> 
					     ...
					     <tr> 
                                            <td height="18" width="90%" class="menu1">Auto Replenishment</td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/reportTransferOrder.jsp?menu_idx=13">Transfer</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/reportPoanalisis.jsp?menu_idx=13">Purchase Order
                                                        </a></td>
                                                    </tr>
                                        ...
                                        <%if (rptSyncStatistic) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/sinkrondata.jsp?menu_idx=13">Data Synch. Statistic</a></td>
                                        </tr>
                                        <%}%>
					     <%if (mstCostChange) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/report_history_cost_change.jsp?menu_idx=13">History Cost Change</a></td>
                                        </tr>                                        
                                        <%}%>
					     <%if (mstPriceChange) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/report_history_price_change.jsp?menu_idx=13">History Price Change</a></td>
                                        </tr>                                        
                                        <%}%>
                                        ...
                                        <tr> 
                                            <td height="18" width="90%" class="menu1"><a href="<%=approot%>/posreport/stockbalance.jsp?menu_idx=13">Check Stock vs Sales</a></td>
                                        </tr>
                                        <%}%>                                        
                                        <tr> 
                                            <td height="18" width="90%"><font color="#FFFFFF">&nbsp;</font></td>
                            ...
                            <%}%>
                            <%if (mstMaintenance || mstAccounting || mstMaterial || mstProduct || mstAsset || mstMerk || mstCompany || mstGeneral || mstMember || mstGroupMember || mstMemberNonReguler || mstMemberChekPoint || mstCashier || mstBackupData || mstMenu || mstMaterial || mstPriceChange || mstStandarStock || mstPromotion || mstCategory || mstSubCategory || mstCostChange) {%>
                            <tr id="master1x"> 
                            ...
                            <tr id="master"> 
                                <td class="submenutd"> 
                                    <table width="99%" cellpadding="0" cellspacing="0" class="submenu">
                                        ...
                                        <%if (mstMaterial || mstPriceChange || mstStandarStock || mstPromotion || mstCategory || mstSubCategory || mstCostChange) {%>
                                        <tr> 
    ...
    if (1 == 2) {
                                        ...
                                        <%if (mstMember || mstGroupMember || mstMemberNonReguler || mstMemberChekPoint) {%>
                                        <tr> 
                                        ...
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <%if(mstMember){%>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/general/customer.jsp?menu_idx=6">Member List</a></td>
                                                    </tr>
                                                    <%}%>
                                                    <%if(mstMemberNonReguler){%>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/general/customernonreguler.jsp?menu_idx=6">Member List (Opr)</a></td>
                                                    </tr>
                                                    <%}%>
                                                    <%if(mstMember){%>
                                                    <tr> 
							   ...
							   <%if(false){%>                                                   
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/membership/memberpointsetup.jsp?menu_idx=6">Member Cash Back Setup</a></td>
                                                    </tr>
                                                    <%}%>
                                                    <%if(mstMember){%>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/membership/memberpointcheck.jsp?menu_idx=6">Check Cash Back</a></td>
                                                    </tr>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/membership/memberpoint.jsp?menu_idx=6">Cash Back Mutation</a></td>
                                                    </tr>
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/membership/memberpointrecords.jsp?menu_idx=6">Cash Back Record</a></td>
                                                    </tr>
                                                    <%}%>
                                                </table>  
                                            </td>
