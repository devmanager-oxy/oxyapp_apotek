...
<script language="JavaScript">
    ...
    function cmdChangeMenu(idx){
        ...
        switch(parseInt(idx)){ 
            ...
            <%if (mstMaintenance || mstAccounting || mstMaterial || mstProduct || mstAsset || mstMerk || mstCompany || mstGeneral || mstMember || mstGroupMember || mstMemberNonReguler || mstMemberChekPoint || mstCashier || mstBackupData || mstMenu || mstPriceChange || mstStandarStock || mstPromotion || mstCategory || mstSubCategory) {%>			
    ...
    <tr> 
        <td valign="top" style="background:url(<%=approot%>/images/leftmenu-bg.gif) repeat-y"> 
            ...
            if (dataSync) {
                            ...
                            <%}%>
                            <%if (mstMaintenance || mstAccounting || mstMaterial || mstProduct || mstAsset || mstMerk || mstCompany || mstGeneral || mstMember || mstGroupMember || mstMemberNonReguler || mstMemberChekPoint || mstCashier || mstBackupData || mstMenu || mstMaterial || mstPriceChange || mstStandarStock || mstPromotion || mstCategory || mstSubCategory) {%>
                            <tr id="master1x"> 
                                        ...
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/membership/memberpointrecords.jsp?menu_idx=6">Point Record</a></td>
                                                    </tr>
                                                    <%}%>
                                                </table>  
                                            </td>
