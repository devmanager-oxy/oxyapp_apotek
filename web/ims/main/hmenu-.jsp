  ...
  <tr> 
    <td> 
      <table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td rowspan="2"><img src="<%=approot%>/images/logo-finance1-demo.jpg" width="216" height="144" /></td>
          <td><img src="<%=approot%>/images/logotxt-finance-demo.gif" width="343" height="94" /></td>
        </tr>
        <tr> 
          ...
          <td style="background:url(<%=approot%>/images/head-icon-bg.gif) repeat-x"> 
            <script language="JavaScript">
				function cmdEnterApp(idx){
					...
					if(parseInt(idx)==2){
						window.location="<%=approotx%>/?login_id=<%=user.getLoginId()%>&pass_wd=<%=user.getPassword()%>&command=1";
					}
					if(parseInt(idx)==3){
						window.location="<%=approotx%>/sipadu-sales?login_id=<%=user.getLoginId()%>&pass_wd=<%=user.getPassword()%>&command=1";
					}
					if(parseInt(idx)==4){
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0">
              <tr> 
                <td><a href="javascript:cmdEnterApp(1)" title="Sipadu Finance"><img src="<%=approot%>/images/button-finance.gif" width="50" height="45" border="0" /></a></td>
                <td>&nbsp;</td>
