...
//Incoming
            ...
            boolean incomingKonsinyasi = false;//appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_INCOMING, AppMenu.M2_INCOMING_KONSINYASI);
            
//Production
            boolean newProject = false;boolean newStock = false;boolean mstProdCategory = false;
            boolean mstProdSubCategory = false;boolean mstProdList = false;boolean mstProdWorkCenter = false;
            boolean shopFlor = false;boolean finishGoods = false;boolean deliv = false;boolean instExp = false;
//Stock Management
...
//Master Data
            ...
            boolean mstMaintenance = false;boolean mstAccounting = false;
            ...
            boolean mstCostChange = appSessUser.isPriviledged(appSessUser.getUserOID(), AppMenu.M1_MASTER_MAINTENANCE, AppMenu.M2_MASTER_COST_CHANGE);
