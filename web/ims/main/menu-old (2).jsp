                            ...
                            <tr id="report"> 
                                <td class="submenutd"> 
                                    <table width="99%" cellpadding="0" cellspacing="0" class="submenu">
                                        ...
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/inventoryreportqty.jsp?menu_idx=13">Inventory Report</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <%if (rptRepackReport) {%>
                                        <tr> 
                                            <td height="18" width="90%" class="menu1">Repack Report</td>
                                        </tr>
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/repackreportransaction.jsp?menu_idx=13">By Transaction</a></td>
                                                    </tr>
                                                     <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/repackReport.jsp?menu_idx=13">By Item</a></td>
                                                    </tr>
                                                </table>    
                                            </td>      
                                        </tr>            
