    ...
    function cmdChangeMenu(idx){
        ...
        switch(parseInt(idx)){ 
            ...
            case 1 : 
                ...
                <%if (mstMaintenance || mstAccounting || mstMaterial || mstProduct || mstAsset || mstMerk || mstCompany || mstGeneral || mstMember || mstCashier || mstBackupData || mstMenu ) {%>			
                            ...
                            <tr id="stock"> 
                                <td class="submenutd"> 
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0" class="submenu">
                                        ...
                                        <%if (mTransferRequest) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/transferlistRequest.jsp?menu_idx=3">Transfer Request</a></td>
                                        </tr>
                                        <%}%>
                                        <%if (mTransferRequest) {%>
                                        <tr> 
                                        ...
                                        <%if (mOpname) {%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/opnamelist.jsp?menu_idx=3">Opname</a></td>
                                        </tr>
                                        <%}%>
                                        <%if (false) {%>
                                        <tr> 
                                        ...
                                        <%if (mRepack){%>
                                        <tr> 
                                            <td class="menu1"><a href="<%=approot%>/postransaction/repackitem.jsp?menu_idx=3">Repack</a></td>
                                        </tr>
                                        <%}%>
                                        <tr> 
                                            <td class="menu1">&nbsp;</td>
                                    ...
                                    <table width="99%" cellpadding="0" cellspacing="0" class="submenu">
                                        ...
                                        <tr> 
                                            <td height="18" width="90%"> 
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr> 
                                                        <td width="80%" height="18" class="menu2"><a href="<%=approot%>/posreport/treport-location.jsp?menu_idx=13">By 
                                                        Location </a></td>
                                                    </tr>
                                                    <tr> 
