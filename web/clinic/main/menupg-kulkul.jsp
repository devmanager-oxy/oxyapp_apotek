        ...
        <tr> 
          <td style="padding-left:10px" valign="top" height="1"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <%if(iReceiptPriv || iArcPriv){%>
              <tr id="incoming1"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('2')"> <a href="javascript:cmdChangeMenu('2')">Credit 
                  Sales</a></td>
              </tr>
              <tr id="incoming2"> 
                <td class="menu0" onClick="javascript:cmdChangeMenu('0')"> <a href="javascript:cmdChangeMenu('0')">Credit 
                  Sales </a></td>
              </tr>
              <tr id="incoming"> 
                <td class="submenutd"> 
                  <table width="99%" border="0" cellspacing="0" cellpadding="0" class="submenu">
                    ...
                    <tr> 
                      <td class="menu1"><a href="<%=approot%>/project/projectlist.jsp?target_page=0&menu_idx=2">Credit 
                        Sales List</a></td>
                    </tr>
                    <tr> 
