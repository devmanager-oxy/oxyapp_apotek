    ...
    <td class="container"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					%>
					   ...
					   %>
                                        ...
                                        <tr align="left">
                                          <td height="8" valign="middle" width="11%">Status</td>
                                          <td height="8" colspan="2" width="89%" valign="top">
                                            <select name="<%=jspReservation.colNames[JspReservation.JSP_FIELD_STATUS] %>">
                                              <option value="0">Baru</option>
											  <option value="1" <%if(reservation.getStatus()==1){%>selected<%}%>>Register</option>
											  <option value="2" <%if(reservation.getStatus()==2){%>selected<%}%>>Selesai</option>
                                            </select>
                                          </td>
                                        </tr>
                                        <tr align="left"> 
