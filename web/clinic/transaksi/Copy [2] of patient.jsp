  ...
  <tr>
    <td class="container"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <table width="100%" border="0" cellspacing="1" cellpadding="1" height="17">
                                        <tr valign="bottom"> 
                                          <td width="60%" height="23"><b><font color="#990000" class="lvl1">Reservasi 
                                            ...
                                            </font> <span class="lvl2">Data Pasien</span></b></td>
					...
					%>
                            ...
                            <tr align="left" valign="top"> 
                              <td height="8" valign="middle" colspan="3"> 
                                <%if((iJSPCommand ==JSPCommand.ADD)||(iJSPCommand==JSPCommand.SAVE)&&(jspPatient.errorSize()>0)||(iJSPCommand==JSPCommand.EDIT)||(iJSPCommand==JSPCommand.ASK)){%>
                                      <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr align="left"> 
                                          ...
                                          <td height="21" colspan="2" width="89%"> 
                                            ...
                                            * <%= jspPatient.getErrorMsg(JspPatient.JSP_FIELD_REG_DATE) %> 
                                        <tr align="left"> 
                                        ...
                                        <tr align="left"> 
                                          ...
                                          <td height="21" colspan="2" width="89%"> 
										   ...
										   %>
                                            <%= JSPCombo.draw(jspPatient.colNames[JspPatient.JSP_FIELD_ID_TYPE],null, sel_idtype, idtype_key, idtype_value, "", "formElemen") %> 
                                        <tr align="left"> 
					   ...
					   %>
                                            <%= JSPCombo.draw(jspPatient.colNames[JspPatient.JSP_FIELD_TITLE],null, sel_title, title_key, title_value, "", "formElemen") %> 
                                        <tr align="left"> 
                                          <td height="21" width="11%">Jenis Kelamin</td>
                                          <td height="21" colspan="2" width="89%"> 
					   ...
					   %>
                                        ...
                                        <tr align="left"> 
                                          ...
                                          <td height="21" colspan="2" width="89%"> 
                                            ...
                                            * <%= jspPatient.getErrorMsg(JspPatient.JSP_FIELD_BIRTH_PLACE) %> 
                                        <tr align="left"> 
                                        ...
                                        <tr align="left"> 
                                          ...
                                          <td height="21" colspan="2" width="89%"> 
                                            <textarea name="<%=jspPatient.colNames[JspPatient.JSP_FIELD_ADDRESS] %>" class="formElemen" cols="35" rows="3"><%= patient.getAddress() %></textarea>
                                            * <%= jspPatient.getErrorMsg(JspPatient.JSP_FIELD_ADDRESS) %> 
                                        <tr align="left"> 
                                        ...
                                        <tr align="left"> 
                                          <td height="21" width="11%">Pekerjaan</td>
                                          <td height="21" colspan="2" width="89%"> 
					   ...
					   %>
                                        ...
                                        <tr align="left"> 
                                          <td height="21" width="11%">Nomor Pegawai</td>
                                          <td height="21" colspan="2" width="89%"> 
					   ...
					   %>
                                            <%= JSPCombo.draw(jspPatient.colNames[JspPatient.JSP_FIELD_INSURANCE_ID],null, sel_insuranceid, insuranceid_key, insuranceid_value, "", "formElemen") %> 
                                        <tr align="left"> 
                                          <td height="21" width="11%">Nomor Asuransi</td>
                                          <td height="21" colspan="2" width="89%"> 
                                        ...
                                        <tr align="left"> 
                                          <td height="21" width="11%">Hubungan 
                                            Dgn Asuransi</td>
                                          <td height="21" colspan="2" width="89%"> 
					   ...
					   %>
                                            <%= JSPCombo.draw(jspPatient.colNames[JspPatient.JSP_FIELD_INSURANCE_RELATION_ID],null, sel_insurancerelationid, insurancerelationid_key, insurancerelationid_value, "", "formElemen") %> 
                                        <tr align="left"> 
                                        ...
                                        <tr align="left"> 
                                          <td height="21" width="11%">Nama Dokter</td>
                                          <td height="21" colspan="2" width="89%"> 
