...
public class TestPrn {
    ...
    public static void main(String[] argv){
                Vector vct = OXY_PrinterXML.getListPrinter();
...
//     		OXY_PrintObj obj= new OXY_PrintObj();
    ...
    public static OXY_PrintObj getTestObj(){
   		OXY_PrintObj obj= new OXY_PrintObj();
	 	try{
            String str="0123456789";
            System.out.println(str.substring(3,5));
...
public static void setItemSeparate(OXY_PrintObj obj, int line, int maxSize){
    ...
    public static void setItemSizeLn(OXY_PrintObj obj, int line, String sizeTypeCode, Vector sizes){
    ...
    public static void setItemSizeHd(OXY_PrintObj obj, int line){
