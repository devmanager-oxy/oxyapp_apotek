...
public class OXY_PrnDrv_LX300 extends OpenPorts implements I_OXY_PrinterDriver {
    ...
    public boolean println(String str){
        try{
            ...
            //System.out.println(" ! EXC : OXY_PrnDrv_LX300 > println =  "+e.toString());
            return false;}
    }
    ...
    public void lineFeed(){
        try{
            ...
            //System.out.println(" ! EXC : OXY_PrnDrv_LX300 > lineFeed =  "+e.toString());
        }
    }
    ...
    private void cancelCondensed(){
        try{
            ...
            //System.out.println(" ! EXC : OXY_PrnDrv_LX300 > cancelCondensed =  "+exc.toString());
        }
    ...
    public void setCPI(int level){
        try{
            ...
            //System.out.println(" ! EXC : OXY_PrnDrv_LX300 > setCPI =  "+exc.toString());
        }
    ...
    public void formFeed(){
        try{
            ...
            //System.out.println(" ! EXC : OXY_PrnDrv_LX300 > formFeed =  "+e.toString());
        }
    }
    ...
    public void setFont(int typeFont){
        try{
            ...
            //System.out.println(" ! EXC : OXY_PrnDrv_LX300 > setFont =  "+e.toString());
        }
    }
