...
public class OXY_PrintObj implements Serializable {
   ...
   /* public void setLineRightAlign(int index, int col, String text) {
    ...
    // set footer if paper is not fit
    public void setFooter(int index){
        ...
        if(lines!=null && lines.size()>0){
            String str = (String) ( (lines.get(index)==null) ? "": lines.get(index));
            footer.set(idx-1,str);
        }
    }
	

    // set footer if paper is not fit
    public void setVloop(int index){
    	if(vloop==null)
    		vloop = new Vector();
	...
	public void setUseSpaceRowBlankForNewPaper(boolean useSpaceRowBlankForNewPaper) {
		this.useSpaceRowBlankForNewPaper = useSpaceRowBlankForNewPaper; 
	}

	public void setSpaceRowBlankForNewPaper(int spaceRowBlankForNewPaper) {
		this.spaceRowBlankForNewPaper = spaceRowBlankForNewPaper; 
	}

	public boolean getUseSpaceRowBlankForNewPaper() {
		return (this.useSpaceRowBlankForNewPaper); 
	}

	public int getSpaceRowBlankForNewPaper() {
		return (this.spaceRowBlankForNewPaper); 
	}
    ...
    private boolean useSpaceRowBlankForNewPaper = false;
    private int spaceRowBlankForNewPaper = 1;
    ...
    private Vector footer = new Vector(1,1);	//vector of String document has footer to print.
    private Vector vloop = new Vector(1,1);	//vector of String document has looping to print.
