...
public class OXY_PrinterHostXML {
    
    /** Creates new OXY_PrinterHostXML */
    public OXY_PrinterHostXML() {
    }
    
    public static void loadHosts() throws IOException {
        System.out.println(">>> OXY_PrinterHostXML -> loadHosts");
   ...
   // private static String pathConfigFile="C:\\project\\printerhosts.xml";  C:\j2sdk1.4.2\jre\project
    private static String pathConfigFile = System.getProperty("java.home") + System.getProperty("file.separator") + "project" + System.getProperty("file.separator") + "printerhosts.xml";
