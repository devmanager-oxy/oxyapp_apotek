 ...
 * <?xml version="1.0"?>
   <printers>
	<printer>
		...
		<name>LX300</name>
		<port>LPT1</port>
		<driver>com.project.printman.OXY_PrnDrv_LX300</driver>	
                <shared>1</shared>
    	</printer>
 	<printer>
		<idx>2</idx>
		<name>Lq100</name>
		<port>LPT1</port>
		<driver>com.project.printman.OXY_PrnDrv_LQ100</driver>	
                <shared>0</shared>
 	</printer>
  </printers>
 */
...
public class OXY_PrinterXML {
    
    public OXY_PrinterXML(){
    }
    ...
    private static String pathConfigFile = System.getProperty("java.home") + System.getProperty("file.separator") + "project" + System.getProperty("file.separator") + "printers.xml"; // "C:\\project\\";
