...
public class RemotePrintMan extends Object {
    ...
    private static I_OXY_PrintMan prnManSvc=null;
    static{
        try{
            ...
            prnManSvc = (I_OXY_PrintMan) Naming.lookup(getNameLookUp());
        }catch (Exception e){
     ...
     */
    public static int printObj(PrinterHost printManSvcHost, OXY_PrintObj obj){
        try{
    ...
    public static  int pausePrinter(PrinterHost printManSvcHost, PrnConfig prn){
        return setPrinterStatus(printManSvcHost,  prn, I_OXY_PrinterDriver.ST_PAUSED);
    }
    
    public static  int resumePrinter(PrinterHost printManSvcHost, PrnConfig prn){
        return setPrinterStatus(printManSvcHost,  prn, I_OXY_PrinterDriver.ST_PRINTING);
    }
    
    public static  int cancelPrinter(PrinterHost printManSvcHost, PrnConfig prn){
        return setPrinterStatus(printManSvcHost,  prn, I_OXY_PrinterDriver.ST_IDLE);
    }
