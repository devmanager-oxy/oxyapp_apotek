...
public class RptStockOpnameXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptStockOpname)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"59.75\"/>");
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s26\"><Data ss:Type=\"String\">Barcode</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptStockOpnameL detail = (RptStockOpnameL)vDetail.get(i);
                
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s50\"><Data ss:Type=\"Number\">"+(1+i)+"</Data></Cell>");
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+detail.getBarcode()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+detail.getName()+"</Data></Cell>");
                
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+detail.getQtySystem()+"</Data></Cell>");
                if(detail.getQtyReal()==0){
                    wb.println("<Cell ss:StyleID=\"s29\"><Data ss:Type=\"String\"></Data></Cell>");
                }else{
