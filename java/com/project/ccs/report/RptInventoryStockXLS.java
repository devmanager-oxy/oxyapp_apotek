...
import com.project.ccs.session.InventoryStock;
...
public class RptInventoryStockXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            loc = DbLocation.fetchExc(JSPRequestValue.requestLong(request, "location_id"));
        }catch(Exception e){}

        try {
            HttpSession session = request.getSession();
            result = (Vector) session.getValue("REPORT_INVENTORY_STOCK");
        } catch (Exception e) {
        }
        ...
        wb.println("      <Column ss:AutoFitWidth=\"0\" ss:Width=\"190\"/>");        
        ...
        if (loc.getOID() != 0) {
            wb.println("      <Row>");
            wb.println("      <Cell ss:StyleID=\"s87\"><Data ss:Type=\"String\">STORE : " + loc.getName().toUpperCase() + "</Data></Cell>");
            wb.println("      </Row>   ");
        }
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            InventoryStock iStock = (InventoryStock)result.get(i);        
            wb.println("      <Row>");
            wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"String\">" + iStock.getSku() + "</Data></Cell>");
            wb.println("      <Cell ss:StyleID=\"s69\"><Data ss:Type=\"String\">" + iStock.getName() + "</Data></Cell>");            
            wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"Number\">" + iStock.getStock() + "</Data></Cell>");
            totStock = totStock + iStock.getStock();
            wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\">" + iStock.getPrice() + "</Data></Cell>");
            totPrice = totPrice + iStock.getPrice();
            double priceStock = iStock.getStock() * iStock.getPrice();
            totPriceStock = totPriceStock + priceStock;
            wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\">" + priceStock + "</Data></Cell>");
            wb.println("      </Row>");
        }
        ...
        wb.println("      <Row>");
            ...
            wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"Number\">" + totStock + "</Data></Cell>");            
            wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\">" + totPrice + "</Data></Cell>");            
            wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\">" + totPriceStock + "</Data></Cell>");
            wb.println("      </Row>");
