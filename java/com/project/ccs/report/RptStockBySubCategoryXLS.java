...
public class RptStockBySubCategoryXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<LastPrinted>2009-09-08T08:10:59Z</LastPrinted>");
        wb.println("<Created>1996-10-14T23:33:28Z</Created>");
        wb.println("<LastSaved>2009-09-08T08:15:50Z</LastSaved>");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"207.75\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s50\"><Data ss:Type=\"String\">STOCK REPORT BY ITEM SUB CATEGORY</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s51\"><Data ss:Type=\"String\">"+cmp.getName()+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s52\"><Data ss:Type=\"String\">"+cmp.getAddress()+"</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                ttAmount = ttAmount + detail.getAmount();
                wb.println("<Cell ss:StyleID=\"s61\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getAmount(), "##,##0.00")+"</Data></Cell>");
                wb.println("</Row>");
            }
        }
        ...
        wb.println("</Row>");
            ...
            wb.println("<Row>");
            wb.println("<Cell ss:Index=\"5\" ss:StyleID=\"s68\"><Data ss:Type=\"String\">Total </Data></Cell>");
