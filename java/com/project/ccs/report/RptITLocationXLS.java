...
public class RptITLocationXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            HttpSession session = request.getSession();
            SrcTransferReport srcTransferReport = (SrcTransferReport)session.getValue("KONSTAN");
            listReport = SessTransferReport.getTransferReport(srcTransferReport, DbTransfer.TYPE_NON_CONSIGMENT, 0, 0);//(Vector)session.getValue("DETAIL");
         ...
         wb.println("<Worksheet ss:Name=\"Sheet1\">");
          ...
          wb.println(" x:FullRows=\"1\" ss:DefaultRowHeight=\"15\">");
           ...
           wb.println("<Row ss:Height=\"15.75\">");
            wb.println("<Cell ss:StyleID=\"s75\"><Data ss:Type=\"String\">ITEM TRANSFER REPORT</Data></Cell>");
           ...
           wb.println("<Row>");
            ...
            wb.println("<Cell ss:StyleID=\"s72\"><Data ss:Type=\"String\">From</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s72\"><Data ss:Type=\"String\">To</Data></Cell>");
           ...
           if(listReport!=null && listReport.size()>0){
               ...
               for(int i=0; i<listReport.size(); i++){
                    ...
                    totQty = totQty + transferReport.getTotalQty();
                    totAmount = totAmount + transferReport.getPurchAmount();
               
                   wb.println("<Row>");
                    wb.println("<Cell ss:StyleID=\"s77\"><Data ss:Type=\"Number\">"+(i+1)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">"+transferReport.getPurchNumber()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s93\"><Data ss:Type=\"String\" x:Ticked=\"1\">"+JSPFormater.formatDate(transferReport.getDate(),"dd-MM-yyyy")+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s77\"><Data ss:Type=\"String\">"+ux.getLoginId()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s77\"><Data ss:Type=\"String\">"+transferReport.getLocationName()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s77\"><Data ss:Type=\"String\">"+transferReport.getLocationToName()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s77\"><Data ss:Type=\"Number\">"+transferReport.getTotalQty()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s83\"><Data ss:Type=\"Number\">"+transferReport.getPurchAmount()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s63\"><Data ss:Type=\"String\">"+transfer.getStatus()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s77\"><Data ss:Type=\"String\">"+transfer.getNote().toLowerCase()+"</Data></Cell>");
                   wb.println("</Row>");
