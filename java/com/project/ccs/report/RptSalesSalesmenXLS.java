...
public class RptSalesSalesmenXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            whereClausa = (String)session.getValue("REPORT_SALES_WHERE");
        ...
        if(result!=null && result.size()>0){
            ...
            for(int i=0; i<result.size(); i++){
                    ...
                    try{
                       ...
                       uses = DbUser.fetch(sales.getSpgId());
                    }catch(Exception ex){
                    }
                    double diskonglob=0;
                    diskonglob=(sales.getGlobalDiskonPercent()* DbSalesDetail.getSubTotalSalesAmount(sales.getOID()))/100;
                    totSales = totSales + (DbSalesDetail.getSubTotalSalesAmount(sales.getOID())-diskonglob);
                    ...
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">"+uses.getLoginId()+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber((DbSalesDetail.getSubTotalSalesAmount(sales.getOID())- diskonglob), "#,###.##")+"</Data></Cell>");
