...
public class RptRequestTranferXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s45\"><Data ss:Type=\"String\">TRANSFER REQUEST</Data></Cell>");
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s33\"><Data ss:Type=\"String\">Product</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">Qty Request</Data></Cell>");
        wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">"+detail.getName()+"</Data></Cell>");
                //wb.println("<Cell ss:StyleID=\"s36\"/>");
                wb.println("<Cell ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+detail.getCode()+"</Data></Cell>");
        ...
        */
        ...
        //wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"2\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Request by,                       </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Receive by,</Data></Cell>");
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
        ...
        //wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"2\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">(                )                                         </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"String\">               </Data></Cell>");
