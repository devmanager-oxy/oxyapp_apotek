 ...
 * @author Roy Andika
 */
public class ReportPajakSalesXls extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        wb.println("      <Cell ss:StyleID=\"s76\"><Data ss:Type=\"String\">:</Data></Cell>");
        wb.println("      <Cell ss:StyleID=\"s75\"/>");
        wb.println("      <Cell ss:MergeAcross=\"3\" ss:StyleID=\"s77\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("      <Cell ss:StyleID=\"s74\"/>");
        wb.println("      </Row>");
        wb.println("      <Row ss:AutoFitHeight=\"0\">");
        wb.println("      <Cell ss:Index=\"2\" ss:StyleID=\"s72\"/>");
        ...
        if(vFakturPajakItem != null && vFakturPajakItem.size() > 0){
            ...
            sum = sum + total;
            totPotongan = totPotongan + fakturPajakItem.getDiscount();
        ...
        if(ij == loopSummary){
            wb.println("      <Cell ss:StyleID=\"s138\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(totPotongan, "#,###.##")+"</Data></Cell>");
        }else{
            wb.println("      <Cell ss:StyleID=\"s138\"><Data ss:Type=\"String\"></Data></Cell>");
        }
        wb.println("      <Cell ss:StyleID=\"s139\"/>");
        ...
        double y = 110;
        double z = 10;
        double pengenaanPajak = (x/y) * ( sum - totPotongan) ;
        wb.println("      <Row ss:AutoFitHeight=\"0\">");
        wb.println("      <Cell ss:Index=\"2\" ss:StyleID=\"s134\"/>");
