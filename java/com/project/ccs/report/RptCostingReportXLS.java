 ...
 * @author Roy
 */
public class RptCostingReportXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            vpar = (Vector) session.getValue("PARAMETER_COSTING");
        } catch (Exception ex) {
            System.out.println(ex.toString());
        }

        try {
            vDetail = (Vector) session.getValue("DETAIL_COSTING");
        } catch (Exception ex) {
            System.out.println(ex.toString());
        }

        long locationId = Long.parseLong("" + vpar.get(0));
        long costId = Long.parseLong("" + vpar.get(1));
        int ignore = Integer.parseInt("" + vpar.get(2));
        Date startDate = JSPFormater.formatDate("" + vpar.get(3), "dd/MM/yyyy");
        Date endDate = JSPFormater.formatDate("" + vpar.get(4), "dd/MM/yyyy");
        String srcStatus = "" + vpar.get(5);
        String srcCode = "" + vpar.get(6);
        String srcName = "" + vpar.get(7);
        String user = "" + vpar.get(8);
        String grp = "" + vpar.get(9);
        ...
        wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s86\"><Data ss:Type=\"String\">" + cmp.getName().toUpperCase() + "</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row ss:Index=\"3\" ss:Height=\"15.75\">");
        wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s86\"><Data ss:Type=\"String\">" + cmp.getAddress().toUpperCase() + "</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row>");
        wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\">Printed by : " + user + ", date : " + JSPFormater.formatDate(new Date(), "dd-MMM-yyyy") + "</Data></Cell>");
        wb.println("      </Row>");
        ...
        if (locationId != 0) {
            try {
                ...
                wb.println("      <Row>");
                wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\">Location : " + l.getName() + "</Data></Cell>");
                wb.println("      </Row>");
            } catch (Exception e) {
            }
        }
        ...
        if (costId != 0) {
            try {
                Location l = DbLocation.fetchExc(costId);
                wb.println("      <Row>");
                wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\">Cost Location : " + l.getName() + "</Data></Cell>");
                wb.println("      </Row>");
            } catch (Exception e) {
            }
        }
        ...
        if (ignore == 0) {
            wb.println("      <Row>");
            wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\">Period : " + JSPFormater.formatDate(startDate, "dd/MM/yyyy") + " - " + JSPFormater.formatDate(endDate, "dd/MM/yyyy") + "</Data></Cell>");
            wb.println("      </Row>");
        }
        ...
        if ((srcCode != null && srcCode.length() > 0) || (srcName != null && srcName.length() > 0)) {
            ...
            wb.println("      <Row>");
            wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\">" + parameter + "</Data></Cell>");
            wb.println("      </Row>");
        }

        if (grp != null && grp.length() > 0) {
            wb.println("      <Row>");
            wb.println("      <Cell ss:MergeAcross=\"9\" ss:StyleID=\"s85\"><Data ss:Type=\"String\">Group : " + grp + "</Data></Cell>");
            wb.println("      </Row>");
        }
        ...
        wb.println("      <Cell ss:StyleID=\"s77\"><Data ss:Type=\"String\">Cost Location </Data></Cell>");
