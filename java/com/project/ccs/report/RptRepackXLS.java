...
public class RptRepackXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        RptRepack rptKonstan = new RptRepack();
        try{
            HttpSession session = request.getSession();
            rptKonstan = (RptRepack)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"170\"/>");//item name
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");//qty
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"25\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");
        wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s45\"><Data ss:Type=\"String\">REPACK</Data></Cell>");
        ...
        wb.println("<Cell ss:MergeAcross=\"3\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">: "+rptKonstan.getLocation()+"</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">Code</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">Type</Data></Cell>");
        wb.println("</Row>");
        
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptRepackL detail = (RptRepackL)vDetail.get(i);
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s38\"><Data ss:Type=\"Number\">"+(1+i)+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s36\"><Data ss:Type=\"String\">"+detail.getCode()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s36\"><Data ss:Type=\"String\">"+detail.getBarcode()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+detail.getName()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s36\"><Data ss:Type=\"Number\">"+detail.getQty()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+detail.getTipe()+"</Data></Cell>");
                wb.println("</Row>");
            }
        }
