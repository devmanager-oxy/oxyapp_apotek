...
import com.project.ccs.session.SessServiceLevel ;
...
public class RptServiceLevelSupplierXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        RptServiceLevelSupplier rptKonstan = new RptServiceLevelSupplier();
        long locationId=0;
        
        try{
            HttpSession session = request.getSession();
            rptKonstan = (RptServiceLevelSupplier)session.getValue("PAR");
           locationId=rptKonstan.getLocationId();
        }catch(Exception ex){
        ...
        try{
            HttpSession session = request.getSession();
            String wareclause = session.getValue("DETAIL").toString();
            vDetail = DbVendor.list(0, 0, wareclause, "");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"100\"/>");//address
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"50\"/>");//qty receive
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");//service level
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");//service level
        
        wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"6\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">SERVICE LEVEL SUPPLIER</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"6\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">"+cmp.getName()+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("</Row>");
        wb.println("<Row ss:AutoFitHeight=\"0\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"6\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">"+cmp.getAddress()+"</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"1\" ss:StyleID=\"s24\"><Data ss:Type=\"String\">Date Periode</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s24\"><Data ss:Type=\"String\">: "+JSPFormater.formatDate(rptKonstan.getTanggalFrom(), "dd/MM/yyyy")+"-"+ JSPFormater.formatDate(rptKonstan.getTanggalTo(), "dd/MM/yyyy")+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s25\"/>");
        wb.println("<Cell ss:StyleID=\"s25\"/>");
        wb.println("<Cell ss:StyleID=\"s25\"/>");
        wb.println("</Row>");
        ...
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Address</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Qty PO</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Qty Receive</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Service Level(%)</Data></Cell>");
        wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                double qtyPO=0;
                double qtyReceive=0;
                Vendor vendor = (Vendor)vDetail.get(i);
                Vector vDet = new Vector();
                vDet = SessServiceLevel.getServiceLevel(vendor.getOID(), locationId, rptKonstan.getTanggalFrom(), rptKonstan.getTanggalTo());
                 qtyPO = Double.parseDouble(""+vDet.get(0));
                qtyReceive = Double.parseDouble(""+vDet.get(1));
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s50\"><Data ss:Type=\"Number\">"+(1+i)+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+vendor.getName()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+vendor.getAddress()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(qtyPO, "##,##0")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(qtyReceive, "##,##0")+"</Data></Cell>");
                if(qtyReceive!=0){
                    wb.println("<Cell ss:StyleID=\"s87\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber((qtyReceive / qtyPO) * 100, "##,##0.00") +"</Data></Cell>");
                }else{
                    wb.println("<Cell ss:StyleID=\"s87\"><Data ss:Type=\"String\">0</Data></Cell>");
                }
                wb.println("</Row>");
