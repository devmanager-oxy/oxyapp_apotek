...
public class RptOpnameSumaryXLS1 extends HttpServlet {
           ...
           // }
            ...
            if(vOpitem!=null && vOpitem.size()>0){
                ...
                for(int i=0;i<vOpitem.size();i++){
                    ...
                    wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+vDet.get(1)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+vDet.get(2)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+vDet.get(3)+"</Data></Cell>");
