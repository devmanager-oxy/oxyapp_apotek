...
public class RptChangePriceXLSnew extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Table ss:ExpandedColumnCount=\"21\"  x:FullColumns=\"1\"");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");//ref_number
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"50\"/>");//gol11
        wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"15\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">DAFTAR HARGA BARANG</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"15\" ss:StyleID=\"s44\"><Data ss:Type=\"String\">"+cmp.getName()+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        wb.println("<Cell ss:StyleID=\"s22\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"15\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">"+cmp.getAddress()+"</Data></Cell>");
        ...
        wb.println("<Row ss:AutoFitHeight=\"0\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"14\" ss:StyleID=\"s42\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        wb.println("<Cell ss:StyleID=\"s23\"/>");
        wb.println("</Row>");
           ...
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Ref Number</Data></Cell>");
           ...
           wb.println("<Cell  ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Gol11</Data></Cell>");
           wb.println("</Row>");
        
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                
                RptChangePriceL detail = (RptChangePriceL)vDetail.get(i);
                wb.println("<Row>");
                ...
                wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+detail.getRefNumber()+"</Data></Cell>");
                ...
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol6(), "##,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol7(), "##,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol8(), "##,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol9(), "##,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol10(), "##,###.##")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol11(), "##,###.##")+"</Data></Cell>");                
                wb.println("</Row>");
