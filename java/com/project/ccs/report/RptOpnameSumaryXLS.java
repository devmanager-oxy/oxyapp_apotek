...
public class RptOpnameSumaryXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        vOpitem = DbOpnameItem.list(0, 0, DbOpnameItem.colNames[DbOpnameItem.COL_OPNAME_ID]+ "=" + oidOpname + " GROUP BY item_master_id", "opname_item_id");
        vopsubLoc= DbOpnameSubLocation.list(0, 0, " opname_id="+opname.getOID() + " GROUP BY sub_location_id ", "");
        ...
        wb.println("</Row>");
            ...
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Varian</Data></Cell>");
            ...
            if(vOpitem!=null && vOpitem.size()>0){
                ...
                for(int i=0;i<vOpitem.size();i++){
                    ...
                    for(int b=0 ; b<vopsubLoc.size();b++){
                       ...
                       wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+totalqty+"</Data></Cell>");
                    }
                    wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+grantotalreal+"</Data></Cell>");
                    qtyClosing=DbClosingOpname.getTotalQtyClosing(im.getOID(), opname.getOID(), opname.getLocationId());
                    wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+qtyClosing+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+(grantotalreal - qtyClosing)+"</Data></Cell>");
