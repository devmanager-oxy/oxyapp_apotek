...
public class RptIGCategoryXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Style ss:ID=\"m251756561\">");
        wb.println("<Alignment ss:Horizontal=\"Center\" ss:Vertical=\"Bottom\"/>");
        wb.println("<Borders>");
        wb.println("<Border ss:Position=\"Bottom\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("<Border ss:Position=\"Left\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        ...
        wb.println("<Border ss:Position=\"Top\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("</Borders>");
        wb.println("<Font x:Family=\"Swiss\" ss:Bold=\"1\" ss:Size=\"8\"/>");
        wb.println("</Style>");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"5\"/>");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"150\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"150\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"9\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">INCOMING REPORT</Data></Cell>");
       ...
       // wb.println("<Cell ss:StyleID=\"s22\"/>");
        ...
        wb.println("</Row>");
        wb.println("<Row ss:AutoFitHeight=\"0\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"9\" ss:StyleID=\"s42\"><Data ss:Type=\"String\"></Data></Cell>");
        //wb.println("<Cell ss:StyleID=\"s23\"/>");
        //wb.println("<Cell ss:StyleID=\"s23\"/>");
        //wb.println("<Cell ss:StyleID=\"s23\"/>");
        //wb.println("<Cell ss:StyleID=\"s23\"/>");
        ...
        /*if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Cell ss:StyleID=\"s25\"><Data ss:Type=\"String\">: "+rptKonstan.getSupplier()+"</Data></Cell>");
            wb.println("</Row>");
        ...
        if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Document</Data></Cell>");
            wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Supplier</Data></Cell>");
        ...
        wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">No</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Date</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Rec Number</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">PO Number</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Supplier</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Item Name</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Unit</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Price</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Qty</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m251756561\"><Data ss:Type=\"String\">Total</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptIGCategoryL detail = (RptIGCategoryL)vDetail.get(i);
                
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s29\"><Data ss:Type=\"Number\">"+detail.getNo()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+ JSPFormater.formatDate(detail.getDate(),"dd-MM-yyyy")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getRecNumber()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getPoNumber()+"</Data></Cell>");
                ...
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getUnit()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getPrice(), "##,##0.00")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"Number\">"+detail.getQty()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getTotal(), "##,##0.00")+"</Data></Cell>");
                wb.println("</Row>");
                
                tt = tt + detail.getTotal();
            }
        }
        ...
        wb.println("<Row>");
        //wb.println("<Cell ss:Index=\"4\" ss:MergeAcross=\"2\" ss:StyleID=\"s28\"><Data");
        //wb.println("ss:Type=\"String\">Total</Data></Cell>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"7\" ss:StyleID=\"s421\"><Data ss:Type=\"String\">Total</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s32\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(tt,"##,##0.00")+"</Data></Cell>");
        wb.println("</Row>");
