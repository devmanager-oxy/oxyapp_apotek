...
public class RptNewItemListXLS1 extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"9\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">DAFTAR BARANG BARU</Data></Cell>");
        ...
        wb.println("</Row>");
           ...
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Reg Date</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol1(), "##,##0.00")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol2(), "##,##0.00")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol3(), "##,##0.00")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol4(), "##,##0.00")+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getGol5(), "##,##0.00")+"</Data></Cell>");
