...
public class RptPRItemXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptPRItem)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">PO RETURN BY ITEM</Data></Cell>");
        ...
        if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Row ss:AutoFitHeight=\"0\" ss:Height=\"6.75\"/>");
            wb.println("<Row ss:Index=\"15\">");
            wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s26\"><Data ss:Type=\"String\">No</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">SKU</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Barcode</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Name</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Number</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Qty</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Total Amount</Data></Cell>");
            wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            ...
            RptPRItemL detail = (RptPRItemL)vDetail.get(i);
            ...
            wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">"+detail.getNoPo()+"</Data></Cell>");
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"6\" ss:StyleID=\"s35\"><Data ss:Type=\"String\">Total</Data></Cell>");
