 ...
 * @author PNCI
 */
public class RptKonsinyasiJualXls extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vndx.getOID() != 0) {
            wb.println("      <Row ss:Height=\"18.75\">");
            wb.println("      <Cell ss:MergeAcross=\"16\" ss:StyleID=\"s102\"><Data ss:Type=\"String\">" + vndx.getName().toUpperCase() + "</Data></Cell>");
            wb.println("      </Row>");
        }
        ...
        if (result != null && result.size() > 0) {
            ...
            wb.println("      <Cell ss:StyleID=\"s64\"><Data ss:Type=\"String\">Disc1  </Data></Cell>");
            wb.println("      <Cell ss:StyleID=\"s64\"><Data ss:Type=\"String\">Discount#1  </Data></Cell>");
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                if (sold.getQty() * -1 <= 0) {
                    double lastPrice = 0;
                    try {
                        lastPrice = DbSales.getLastPrice(rp.getLocationId(), rsm.getItemMasterId(), rp.getDateFrom());
                    } catch (Exception e) {
                    }
                    price = lastPrice;
                }
                ...
                wb.println("      <Cell ss:StyleID=\"s68\"><Data ss:Type=\"Number\">" + discount + "</Data></Cell>");
                wb.println("      <Cell ss:StyleID=\"s66\"><Data ss:Type=\"Number\">" + tmpAmountDisc + "</Data></Cell>");
            ...
            wb.println("      <Cell ss:StyleID=\"s66\"><Data ss:Type=\"Number\">" + tot11 + "</Data></Cell>");
            wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"Number\">" + tot10 + "</Data></Cell>");
            wb.println("      </Row>");
            wb.println("      <Row>");
            wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s80\"><Data ss:Type=\"String\">Total Bill</Data></Cell>");
            ...
            wb.println("      </Row>");
            double margin = 0;
            margin = (vndx.getPercentMargin() / 100) * tot9;
            wb.println("      <Row>");
            ...
            wb.println("      </Row>");
            double tot = tot9 - margin;
            wb.println("      <Row>");
            wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s81\"><Data ss:Type=\"String\">Total</Data></Cell>");
            ...
            wb.println("      </Row>");
            double barcode = (vndx.getPercentBarcode() / 100) * tot2;
            wb.println("      <Row>");
            ...
            wb.println("      </Row>");
            double grandTotal = tot - totPotongan;
            wb.println("      <Row>");
