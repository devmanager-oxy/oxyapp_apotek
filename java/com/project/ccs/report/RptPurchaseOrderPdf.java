/*
 * RptPurchaseOrderPdf.java
 *
 * Created on January 17, 2009, 10:05 AM
 */
 ...
 * @author  offices
 */
public class RptPurchaseOrderPdf extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        System.out.println("===| RptPurchaseOrderPdf |===");
        //long oidEmployee = FRMQueryString.requestLong(request, "oid");
        
        SessPurchaseOrder po = new SessPurchaseOrder(); 
        try{
            HttpSession session = request.getSession();
            po = (SessPurchaseOrder)session.getValue("PURCHASE_TITTLE");
        }catch(Exception e){
        ...
        Font fontHeader = new Font(Font.HELVETICA, 10, Font.BOLD, border);
        Font fontContent = new Font(Font.HELVETICA, 10, Font.BOLD, border);
        Font fontTitle = new Font(Font.HELVETICA, 12, Font.BOLD, border);
        Font tableContent = new Font(Font.HELVETICA, 10, Font.NORMAL, border);
        Font fontSpellCharge = new Font(Font.HELVETICA, 10, Font.BOLDITALIC, border);
        Font fontItalic = new Font(Font.HELVETICA, 10, Font.BOLDITALIC, border);
        Font fontItalicBottom = new Font(Font.HELVETICA, 10, Font.ITALIC, border);
        Font fontUnderline = new  Font(Font.HELVETICA, 10, Font.UNDERLINE, border);
        Font fontNotes = new  Font(Font.HELVETICA, 14, Font.BOLD, border);
        ...
        Document document = new Document(PageSize.A4,15,15,25,25);
      ...
      //for header =========================================================== 
            ...
            Cell titleCellHeader = new Cell(new Chunk(JSPFormater.formatDate((po.getDate()==null) ? new Date() : po.getDate(), "dd-MM-yyyy"), fontTitle));
            ...
            titleCellHeader = new Cell(new Chunk("PURCHASE ORDER", fontTitle));
  ...
  //==========================end================================
            ...
            purchaseTable.setCellspacing(1);
             ...
             //0
            /*
            Cell titleCellTop = new Cell(new Chunk("Purchase Order", fontContent));
            ...
            //Vendor
            Cell titleCellTop = new Cell(new Chunk("Vendor", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((po.getVendor()==null) ? "" : ":  " + po.getVendor(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk("Deliver To", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((po.getDeliverTo()==null) ? "" : ":  " +po.getDeliverTo(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((po.getAddress()==null) ? "" : ":  " + po.getAddress(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk(":  " + po.getPaymentType(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);        
            ...
            titleCellTop = new Cell(new Chunk((po.getPoNumber()==null) ? "" : ":  " + po.getPoNumber(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
             ...
             titleCellTop = new Cell(new Chunk("Expired PO", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            
             titleCellTop = new Cell(new Chunk(":  " + JSPFormater.formatDate((po.getDate()==null) ? new Date() : po.getExpiredDate(), "dd-MM-yyyy"), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
           ...
           // titleCellTop = new Cell(new Chunk(JSPFormater.formatDate((po.getDate()==null) ? new Date() : po.getDate(), "dd/MM/yyy"), tableContent));
           ...
           // purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((po.getNotes()==null)?"": ":  " + po.getNotes().toUpperCase(), fontNotes));
            titleCellTop.setColspan(3);
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            if(vectorList!=null && vectorList.size()>0){
                    ...
                    //membuat table 
                    int poHeaderTop[] = {3,14,46,10,5,5,12,5};
                    ...
                    titlePrCellTop = new Cell(new Chunk("Barcode", fontHeader));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_CENTER);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    titlePrCellTop.setBackgroundColor(bgColor);
                    ...
                    titlePrCellTop = new Cell(new Chunk("Dic", fontHeader));
                    titlePrCellTop.setHorizontalAlignment(Element.ALIGN_CENTER);
                    titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                    titlePrCellTop.setBorderColor(blackColor);
                    titlePrCellTop.setBackgroundColor(bgColor);
                    ...
                    for(int i=0;i<vectorList.size();i++){
                        SessPurchaseOrderL poL = (SessPurchaseOrderL)vectorList.get(i);
                        //1
                        titlePrCellTop = new Cell(new Chunk(String.valueOf(i+1), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);

                        titlePrCellTop = new Cell(new Chunk(poL.getBarcode(), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);
                        
                        titlePrCellTop = new Cell(new Chunk(poL.getGroup(), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);
                        
                        titlePrCellTop = new Cell(new Chunk(JSPFormater.formatNumber(poL.getPrice(), "#,###.##") , tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);

                        titlePrCellTop = new Cell(new Chunk(""+poL.getQty(), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);

                        titlePrCellTop = new Cell(new Chunk(""+poL.getDiscount(), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);

                        titlePrCellTop = new Cell(new Chunk(JSPFormater.formatNumber(poL.getTotal(), "#,###.##"), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);

                        titlePrCellTop = new Cell(new Chunk(""+poL.getUnit(), tableContent));
                        titlePrCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titlePrCellTop.setBorderColor(blackColor);
                        prTable.addCell(titlePrCellTop);
           ...
           //Subnya
            ...
            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(po.getSubTotal(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
            ...
            spaceCellTop = new Cell(new Chunk(po.getDiscount1()+" % ", tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);

            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(po.getDiscount2(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
            ...
            spaceCellTop = new Cell(new Chunk(po.getVat1()+" % ", tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);

            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(po.getVat2(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
            ...
            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(po.getGrandTotal(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
  ...
  //Approval and Prepared By
            ...
            Cell spaceCell1Top = new Cell(new Chunk("Prepared By", tableContent));
