...
public class RptITCategoryXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptITCategory)session.getValue("KONSTAN");
        }catch(Exception ex){
       ...
       // response.setCharacterEncoding( "UTF-8" ) ;
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">ITEM TRANSFER BY CATEGORY</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptITCategoryL detail = (RptITCategoryL)vDetail.get(i);
