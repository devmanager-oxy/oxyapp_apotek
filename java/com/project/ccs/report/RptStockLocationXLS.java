...
import com.project.ccs.session.SessStockReportByLocation;
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            vendorId = Long.valueOf(session.getValue("VENDORID").toString());
        }catch(Exception ex){
        ...
        try{
            HttpSession session = request.getSession();
            vDet = (Vector)session.getValue("DETAIL");
            if(vendorId != 0){
                vDetail = SessStockReportByLocation.getItemStockBySupplier(vDet.get(0).toString(), vDet.get(1).toString(), Long.valueOf(vDet.get(2).toString()) ,Long.valueOf(vDet.get(3).toString()), (Integer.valueOf(vDet.get(4).toString())),(Integer.valueOf(vDet.get(5).toString())),0, 0, Long.valueOf(vDet.get(8).toString()));
            }else{
                vDetail = SessStockReportByLocation.getItemStock(vDet.get(0).toString(), vDet.get(1).toString(), Long.valueOf(vDet.get(2).toString()) ,Long.valueOf(vDet.get(3).toString()), (Integer.valueOf(vDet.get(4).toString())),(Integer.valueOf(vDet.get(5).toString())),0, 0);
            }
        }catch(Exception e){
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"25\"/>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"1\" ss:StyleID=\"s26\"><Data ss:Type=\"String\">Location </Data></Cell>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"1\" ss:StyleID=\"s26\"><Data ss:Type=\"String\">Date </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">: "+JSPFormater.formatDate(new Date(),"dd-MM-yyyy")+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s27\"/>");
        //wb.println("<Cell ss:StyleID=\"s27\"/>");
        //wb.println("<Cell ss:StyleID=\"s27\"/>");
        wb.println("</Row>");
        ...
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Location</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Qty Draft</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">On Hand</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Available</Data></Cell>");
        //wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Cogs</Data></Cell>");
        ...
        double amount = 0.0;
        double ttAmount = 0.0;
        double ttQtyDraft = 0.0;
        double ttQtyAvailable = 0.0;
        double totalHpp = 0.0;
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                wb.println("<Cell ss:StyleID=\"s32\"><Data ss:Type=\"String\">"+detail.getLocationName() +"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s32\"><Data ss:Type=\"String\">"+detail.getCode()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s73\"><Data ss:Type=\"String\" x:Ticked=\"1\">"+detail.getDescription()+"</Data></Cell>");
                double stDraft = SessStockReportByLocation.getStockByStatus(detail.getLocation(), detail.getItemMasterId(), "DRAFT" );
                wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+stDraft+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+detail.getQty()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+(detail.getQty()+stDraft)+"</Data></Cell>");
                //wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+im.getNew_cogs()+"</Data></Cell>");
                //wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+(im.getNew_cogs()*detail.getQty())+"</Data></Cell>");
                //wb.println("<Cell ss:StyleID=\"s61\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getPrice(), "##,##0.00")+"</Data></Cell>");
                
                amount = detail.getQty();
                ttAmount = ttAmount + amount;
                totalHpp = totalHpp + (im.getNew_cogs()*detail.getQty());
                ttQtyDraft = ttQtyDraft + stDraft;
                ttQtyAvailable = ttQtyAvailable + ((detail.getQty()+stDraft));
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"4\" ss:StyleID=\"s68\"><Data ss:Type=\"String\">Total </Data></Cell>");
        //wb.println("<Cell ss:StyleID=\"s72\"><Data ss:Type=\"Number\">10</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\"></Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s71\"><Data ss:Type=\"Number\">"+ttQtyDraft+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s71\"><Data ss:Type=\"Number\">"+ttAmount+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s71\"><Data ss:Type=\"Number\">"+ttQtyAvailable+"</Data></Cell>");
        //wb.println("<Cell ss:StyleID=\"s71\"><Data ss:Type=\"String\"></Data></Cell>");
        //wb.println("<Cell ss:StyleID=\"s71\"><Data ss:Type=\"Number\">"+totalHpp+"</Data></Cell>");
        wb.println("</Row>");
