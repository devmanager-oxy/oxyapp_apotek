 ...
 * @author Roy Andikas
 */
public class RptInventoryGroupXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            result = (Vector) session.getValue("REPORT_INVENTORY_GROUP_STOCK");
        } catch (Exception e) {
        }
        ...
        for (int i = 0; i < result.size(); i++) {
            ...
            totPriceStock = totPriceStock + iStock.getTotPrice();
            wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\">" + iStock.getTotPrice() + "</Data></Cell>");
            wb.println("      </Row>");
        }
