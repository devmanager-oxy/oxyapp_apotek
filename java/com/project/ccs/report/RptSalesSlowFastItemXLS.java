...
public class RptSalesSlowFastItemXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            vDetail = (Vector)session.getValue("REPORT_SALES_QTY_DETAIL");
            slow = (Integer)session.getValue("REPORT_SALES_SLOW");
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"170\"/>");// name
        ...
        if(slow==0){
            wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"8\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">REPORT SLOW MOVING ITEMS</Data></Cell>");
        }else{
            wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"8\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">REPORT FAST MOVING ITEMS</Data></Cell>");
        }
        ...
        if(rp.getLocationId()!=0){
            wb.println("<Cell ss:StyleID=\"s24\" ss:MergeAcross=\"1\"><Data ss:Type=\"String\">: "+loc.getName()+"</Data></Cell>");
        }else{
            wb.println("<Cell ss:StyleID=\"s24\" ss:MergeAcross=\"1\"><Data ss:Type=\"String\">: All Location</Data></Cell>");
        }
        ...
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Qty Sold</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Qty Stock</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                vItemDet = (Vector)vDetail.get(i);
                   
                
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s50\"><Data ss:Type=\"Number\">"+vItemDet.get(0).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(1).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(2).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(3).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(4).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(5).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(6).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(7).toString()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+ vItemDet.get(8).toString()+"</Data></Cell>");
                wb.println("</Row>");
