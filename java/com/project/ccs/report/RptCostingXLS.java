...
public class RptCostingXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            rptKonstan = (RptCosting)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"160\"/>");//qty
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"25\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");
        wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s45\"><Data ss:Type=\"String\">COSTING</Data></Cell>");
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">: "+rptKonstan.getNumber()+"</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Date  : "+ JSPFormater.formatDate(rptKonstan.getTanggal(), "dd-MM-yyyy") +"</Data></Cell>");
        wb.println("</Row>");
       
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Location</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">: "+rptKonstan.getLocation()+"</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Cost Location : "+ rptKonstan.getCostLocation() +"</Data></Cell>");
        wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptCostingL detail = (RptCostingL)vDetail.get(i);
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s38\"><Data ss:Type=\"Number\">"+(1+i)+"</Data></Cell>");
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s36\"><Data ss:Type=\"String\">"+detail.getBarcode()+"</Data></Cell>");
                //wb.println("<Cell ss:StyleID=\"s36\"/>");
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+detail.getName()+"</Data></Cell>");
                //wb.println("<Cell ss:StyleID=\"s37\"><Data ss:Type=\"String\">"+detail.getCategory()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s36\"><Data ss:Type=\"Number\">"+detail.getPrice()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s36\"><Data ss:Type=\"Number\">"+detail.getQty()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s37\"><Data ss:Type=\"Number\">"+detail.getTotal()+"</Data></Cell>");
                wb.println("</Row>");
                grntotal = grntotal + detail.getTotal();
            }
        }
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s31\"><Data ss:Type=\"String\"> </Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s32\"><Data ss:Type=\"String\">Grand Total</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s32\"><Data ss:Type=\"String\">:</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s32s\"><Data ss:Type=\"Number\">"+ JSPFormater.formatNumber(grntotal, "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
        
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:MergeAcross=\"3\" ss:StyleID=\"s54\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("</Row>");
        ...
        //wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Prepared by,               Approved by,</Data></Cell>");
        //wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"String\">          Send by,</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">                    Check by,</Data></Cell>");
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
