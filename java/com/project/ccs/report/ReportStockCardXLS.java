 ...
 * @author Roy Andika
 */
public class ReportStockCardXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector listReport = DbItemMaster.list(0, 0, whereClause, null);
	...
	wb.println("      <Cell ss:StyleID=\"s63\"><Data ss:Type=\"Number\">"+itemMaster.getCode()+"</Data></Cell>");
	wb.println("      <Cell ss:StyleID=\"s68\"><Data ss:Type=\"String\">"+itemMaster.getBarcode()+"</Data></Cell>");
	wb.println("      <Cell ss:StyleID=\"s62\"><Data ss:Type=\"String\">"+itemMaster.getName()+"</Data></Cell>");
        wb.println("      <Cell ss:StyleID=\"s63\"><Data ss:Type=\"Number\">"+DbStock.getItemTotalStock(rsp.getLocationId(), itemMaster.getOID())+"</Data></Cell>");
	wb.println("      </Row>");
        }
        }
