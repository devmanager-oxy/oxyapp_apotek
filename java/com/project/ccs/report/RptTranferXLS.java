...
public class RptTranferXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            HttpSession session = request.getSession();
            namaUser = String.valueOf(session.getValue("NAMA_USER"));
            userId = Long.parseLong((session.getValue("PREPARED_BY").toString()));
        ...
        wb.println("<Alignment ss:Vertical=\"Bottom\"/>");
        wb.println("<Font ss:FontName=\"Tahoma\" x:Family=\"Swiss\" ss:Size=\"10\" ss:Bold=\"1\"/>");
        wb.println("</Style>");
        ...
        wb.println("<Border ss:Position=\"Top\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("</Borders>");
        wb.println("<Font ss:FontName=\"Tahoma\" x:Family=\"Swiss\" ss:Size=\"10\"/>");
        wb.println("</Style>");
        ...
        wb.println("<Row ss:Index=\"1\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">print by :"+namaUser+"</Data></Cell>");
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">: "+rptKonstan.getFrom()+"</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">To    : "+rptKonstan.getTo()+"</Data></Cell>");
        wb.println("</Row>");
        ...
        //wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">Unit Cost</Data></Cell>");
       // wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">Total Cost</Data></Cell>");
        wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                //wb.println("<Cell ss:StyleID=\"s37\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getTotal(), "###,###.##")+"</Data></Cell>");
                wb.println("</Row>");
            }
        }
        ...
        */
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">Send by,               Receive by,</Data></Cell>");
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
        ...
        wb.println("</Row>");
        //wb.println("<Row>");
       // wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">"+namaUser+"</Data></Cell>");
       // wb.println("<Cell ss:StyleID=\"s32\"/>");
       // wb.println("<Cell ss:StyleID=\"s32\"/>");
       // wb.println("<Cell ss:StyleID=\"s32\"/>");
       // wb.println("<Cell ss:StyleID=\"s32\"/>");
       // wb.println("<Cell ss:StyleID=\"s32\"/>");
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s31\"><Data ss:Type=\"String\">"+user.getFullName()+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
        wb.println("<Cell ss:StyleID=\"s32\"/>");
