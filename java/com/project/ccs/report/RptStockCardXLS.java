...
public class RptStockCardXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s50\"><Data ss:Type=\"String\">STOCK CARD</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Opening</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Qty In</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Qty Out</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">Qty Saldo</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                SrcStockCardL detail = (SrcStockCardL)vDetail.get(i);
                ...
                wb.println("<Cell ss:StyleID=\"s73\"><Data ss:Type=\"String\">"+detail.getItemName()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+detail.getOpening()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+detail.getQtyIn()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s31\"><Data ss:Type=\"Number\">"+detail.getQtyOut()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s61\"><Data ss:Type=\"Number\">"+detail.getSaldo()+"</Data></Cell>");
                
                amount = (detail.getQtyIn()*detail.getSaldo());
