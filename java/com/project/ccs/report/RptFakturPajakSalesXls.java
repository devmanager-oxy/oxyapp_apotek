...
public class RptFakturPajakSalesXls extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<WindowWidth>15900</WindowWidth>");
        ...
        wb.println("</Style>");
         ...
         wb.println("<Style ss:ID=\"yyatasbawah\">");
        wb.println("<Alignment ss:Horizontal=\"Right\" ss:Vertical=\"Bottom\"/>");
        wb.println("<Borders>");
        //wb.println("<Border ss:Position=\"Bottom\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("<Border ss:Position=\"Left\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        ...
        wb.println("</Style>");
        wb.println("</Styles>");
        wb.println("<Worksheet ss:Name=\"Lembar_1_PPN\">");
        ...
        wb.println("<Row>");
        //wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"y3344\"><Data ss:Type=\"String\">Lembar ke-1 :</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"5\" ss:StyleID=\"s26\"/>");
       ...
       //vendor
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                ...
                totDiscount = totDiscount + igL.getDiscount();
                grandTotal = grandTotal + igL.getTotal();
                wb.println("<Row>");
                ...
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"yyatasbawah\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(igL.getTotal(), "#,###.##")+"</Data></Cell>");
               
               wb.println("</Row>");
            }
        }
        DPP = Double.parseDouble("0.909090909")* (grandTotal-totDiscount);  //((100/110)*(grandTotal-totDiscount));
        //DPP = ((100/110)*(grandTotal-totDiscount));
        ppn=Double.parseDouble("0.1")* DPP;
        wb.println("<Row>");
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"yy33\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(grandTotal, "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
        
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"y33\"><Data ss:Type=\"String\">Dikurangi Potongan Harga</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"yy33\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(totDiscount, "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
        ...
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"yy33\"><Data ss:Type=\"String\">-</Data></Cell>");
        wb.println("</Row>");
        
        
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"y33\"><Data ss:Type=\"String\">Dasar Pengenaan Pajak</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"yy33\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(DPP, "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
        
        
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"y33\"><Data ss:Type=\"String\">PPN = 10% x Dasar Pengenaan Pajak</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"yy33\"><Data ss:Type=\"String\">"+JSPFormater.formatNumber(ppn, "#,###.##")+"</Data></Cell>");
        wb.println("</Row>");
       ...
       wb.println("<Row>");
        ...
        wb.println("<Cell ss:MergeAcross=\"2\" ss:StyleID=\"ykanan1\"><Data ss:Type=\"String\">Denpasar, </Data></Cell>");
        wb.println("</Row>");
        ...
        wb.println("<Worksheet ss:Name=\"Lembar_2_PPN\">");
        wb.println("<Table ss:ExpandedColumnCount=\"11\" x:FullColumns=\"1\"");
        wb.println("x:FullRows=\"1\">");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"4.5\"/>");
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"35\"/>");
        ...
        //wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"90\"/>");
         ...
         wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"y3344\"><Data ss:Type=\"String\">Lembar ke-1 :</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"y3344\"><Data ss:Type=\"String\">Untuk Penjual BKP/Pemberi JKP</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s26\"/>");
        wb.println("</Row>");
        ...
        //wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"y3344\"><Data ss:Type=\"String\">Lembar ke-1 :</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"5\" ss:StyleID=\"s26\"/>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"y3344\"><Data ss:Type=\"String\">sebagai bukti Pajak Keluaran</Data></Cell>");
