...
public class RptCostingReport extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        Vector vreportItem = new Vector();
        Location loc = new Location();
        SrcCostingReport cr = new SrcCostingReport();
        try{
            HttpSession session = request.getSession();
            cr = (SrcCostingReport)session.getValue("KONSTAN");
        ...
        vreportItem = SessCostingReport.getItemCosting(cr, 0, 0, 0 );
        boolean gzip = false ;
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"200\"/>");//barcode
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");//name
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"50\"/>");//gol1
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"60\"/>");//gol2
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"60\"/>");//gol3
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");//gol4
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");//gol5
        wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"8\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">COSTING REPORT</Data></Cell>");
        ...
        wb.println("</Row>");
           ...
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Kode/SKU</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Name</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Number</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Qty</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Unit Price</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Total Price</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Location</Data></Cell>");
           wb.println("<Cell ss:StyleID=\"m25175646\"><Data ss:Type=\"String\">Cost Location</Data></Cell>");
           wb.println("</Row>");
        ...
        //double tdis=0;
        //m25175646
        if(vreportItem!=null && vreportItem.size()>0){
            for(int i=0;i<vreportItem.size();i++){
                //RptIRSupplierL detail = (RptIRSupplierL)vDetail.get(i);
                CostingReport detail = (CostingReport)vreportItem.get(i);
                ItemMaster im = new ItemMaster();
                
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s29\"><Data ss:Type=\"Number\">"+(i+1)+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getItemCode()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+detail.getItemName()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getNumber()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+detail.getTotalQty()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+detail.getUnitPrice()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+detail.getTotalPrice()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getLocationName()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">"+detail.getLocationCostName()+"</Data></Cell>");                
                wb.println("</Row>");
                
               // tt = tt + detail.getTotalAmount();
                tamount =  tamount + detail.getTotalPrice();
            }
        }
        ...
        wb.println("<Row>");
                ...
                wb.println("<Cell ss:StyleID=\"s25\"/>");
                wb.println("<Cell ss:StyleID=\"s25\"/>");
               wb.println("<Cell ss:StyleID=\"m25175656\"><Data ss:Type=\"String\">Total</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"Number\">"+tamount+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s25\"/>");
