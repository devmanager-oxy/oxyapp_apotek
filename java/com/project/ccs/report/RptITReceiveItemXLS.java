...
public class RptITReceiveItemXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        RptITItem rptKonstan = new RptITItem();
        try{
            HttpSession session = request.getSession();
            rptKonstan = (RptITItem)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        try{
            ...
            srcTransferReport =  (SrcTransferReport)session.getValue("PARAMETER");
            
            Vector listReport = new Vector();
            listReport = SessTransferReport.getTransferReport(srcTransferReport, DbTransfer.TYPE_NON_CONSIGMENT, 0, 0 );  
            for(int i=0;i<listReport.size();i++){
                TransferReport transferReport = (TransferReport)listReport.get(i);
                RptITItemL detail = new RptITItemL();
                detail.setNo((i+1));
                detail.setCode(transferReport.getItemCode());        
                detail.setName(transferReport.getItemName());
        ...
        wb.println("<LastPrinted>2009-08-06T07:05:36Z</LastPrinted>");
        wb.println("<Created>1996-10-14T23:33:28Z</Created>");
        wb.println("<LastSaved>2009-08-06T07:06:43Z</LastSaved>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s40\"><Data ss:Type=\"String\">ITEM TRANSFER BY ITEM</Data></Cell>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s39\"><Data ss:Type=\"String\">"+cmp.getAddress()+"</Data></Cell>");
        ...
        if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Cell ss:Index=\"6\" ss:StyleID=\"s25\"><Data ss:Type=\"String\">To </Data></Cell>");
            ...
            wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"1\" ss:StyleID=\"s24\"><Data ss:Type=\"String\">From </Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s24\"><Data ss:Type=\"String\">: "+rptKonstan.getLocation()+"</Data></Cell>");
            wb.println("<Cell ss:Index=\"6\" ss:StyleID=\"s24\"/>");
            wb.println("<Cell ss:StyleID=\"s25\"/>");
            wb.println("</Row>");
            ...
            wb.println("<Cell ss:Index=\"6\" ss:StyleID=\"s25\"><Data ss:Type=\"String\">Supplier</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s25\"><Data ss:Type=\"String\">: "+rptKonstan.getToLocation()+"</Data></Cell>");
            wb.println("</Row>");
        ...
        wb.println("<Cell ss:StyleID=\"s24\"><Data ss:Type=\"String\">: "+rptKonstan.getDocStatus()+"</Data></Cell>");
        wb.println("<Cell ss:Index=\"6\" ss:StyleID=\"s24\"><Data ss:Type=\"String\">Group By</Data></Cell>");
        ...
        wb.println("<Cell ss:StyleID=\"s24\"><Data ss:Type=\"String\">: "+rptKonstan.getCategory()+"</Data></Cell>");
        wb.println("<Cell ss:Index=\"6\" ss:StyleID=\"s24\"><Data ss:Type=\"String\">Sub Category</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s25\"><Data ss:Type=\"String\">: "+rptKonstan.getSubCategory()+"</Data></Cell>");
        wb.println("</Row>");
         */
        ...
        if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Number Transfer</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            ...
            RptITItemL detail = (RptITItemL)vDetail.get(i);
            
            wb.println("<Row>");
            wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s29\"><Data ss:Type=\"Number\">"+detail.getNo()+"</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s44\"><Data ss:Type=\"String\">"+detail.getCode()+"</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+detail.getName()+"</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s33\"><Data ss:Type=\"String\">"+detail.getDoc()+"</Data></Cell>");
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"5\" ss:StyleID=\"s35\"><Data ss:Type=\"String\">Total</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s35\"><Data ss:Type=\"Number\">"+ttQty+"</Data></Cell>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"2\" ss:StyleID=\"s45\"><Data ss:Type=\"String\">(����������.)</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s25\"/>");
        wb.println("<Cell ss:StyleID=\"s25\"/>");
