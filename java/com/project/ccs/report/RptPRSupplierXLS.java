...
public class RptPRSupplierXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        RptPRSupplier rptKonstan = new RptPRSupplier();
        try{
            HttpSession session = request.getSession();
            rptKonstan = (RptPRSupplier)session.getValue("KONSTAN");
        }catch(Exception ex){
        ...
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"4.5\"/>");//a
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"18\"/>");//b
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"80\"/>");//c lokasi
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"160\"/>");//d supplier
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");//e tgl
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"70\"/>");// doc
        wb.println("<Column ss:AutoFitWidth=\"0\" ss:Width=\"107.25\"/>");// total
        wb.println("<Row ss:Index=\"2\">");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"4\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">PO RETURN BY SUPPLIER</Data></Cell>");
        ...
        if(rptKonstan.getIgnored()==1){
            ...
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Location</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Supplier</Data></Cell>");
            wb.println("<Cell ss:StyleID=\"s26\"><Data ss:Type=\"String\">Date</Data></Cell>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            for(int i=0;i<vDetail.size();i++){
                RptPRSupplierL detail = (RptPRSupplierL)vDetail.get(i);
                
                wb.println("<Row>");
                wb.println("<Cell ss:Index=\"2\" ss:StyleID=\"s29\"><Data ss:Type=\"Number\">"+detail.getNo()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+detail.getLocationName()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+detail.getSupplier()+"</Data></Cell>");
                wb.println("<Cell ss:StyleID=\"s27\"><Data ss:Type=\"String\">"+detail.getDateDoc()+"</Data></Cell>");
        ...
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"5\" ss:MergeAcross=\"1\" ss:StyleID=\"m25175666\"><Data");
