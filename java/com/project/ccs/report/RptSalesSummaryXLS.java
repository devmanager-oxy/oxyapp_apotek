 ...
 * @author Roy Andika
 */
public class RptSalesSummaryXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            rp = (ReportParameterLocation) session.getValue("REPORT_SALES_SUMMARY");
        } catch (Exception e) {
        }
        ...
        Vector list = SQLGeneral.getDataSummarySales(rp.getStartDate(), rp.getEndDate());
        ...
        wb.println("      <Created>2013-05-11T10:59:08Z</Created>");
        ...
        wb.println("      <Table >");
        wb.println("      <Column ss:Index=\"2\" ss:AutoFitWidth=\"0\" ss:Width=\"181.5\"/>");
        wb.println("      <Column ss:AutoFitWidth=\"0\" ss:Width=\"93\"/>");

        wb.println("      <Row >");
        wb.println("      <Cell ss:StyleID=\"s65\"><Data ss:Type=\"String\">" + cmp.getName().toUpperCase() + "</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row >");
        wb.println("      <Cell ss:StyleID=\"s65\"><Data ss:Type=\"String\">SALES SUMMARY</Data></Cell>");
        wb.println("      </Row>");
        wb.println("      <Row >");
        wb.println("      <Cell ss:StyleID=\"s65\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("      </Row>");
        ...
        wb.println("      <Cell ss:StyleID=\"s66\"><Data ss:Type=\"String\">TOTAL</Data></Cell>");
        wb.println("      </Row>");
        ...
        for (int k = 0; k < list.size(); k++) {
            ...
            wb.println("      <Row>");
            wb.println("      <Cell ss:StyleID=\"s66\"><Data ss:Type=\"Number\">" + (k + 1) + "</Data></Cell>");
            wb.println("      <Cell ss:StyleID=\"s68\"><Data ss:Type=\"String\">" + salesClosing.getMember() + "</Data></Cell>");
            wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"Number\">" + salesClosing.getAmount() + "</Data></Cell>");
            wb.println("      </Row>");
        }

        wb.println("      <Row>");
        wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s66\"><Data ss:Type=\"String\">TOTAL</Data></Cell>");
