...
public class RptSalesOutlet extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            result = (Vector)session.getValue("REPORT_OUTLET");
       ...
       // response.setCharacterEncoding( "UTF-8" ) ;
        ...
        wb.println("<Column ss:Index=\"2\" ss:StyleID=\"s63\" ss:AutoFitWidth=\"0\" ss:Width=\"150\"/>");
        wb.println("<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>");
        wb.println("<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>");
        wb.println("<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>");
        wb.println("<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>");
        wb.println("<Column ss:StyleID=\"s63\" ss:Width=\"100\"/>");
        ...
        wb.println("</Row>");
        wb.println("<Row>");
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"5\" ss:StyleID=\"s68\"><Data ss:Type=\"String\">LAPORAN PENJUALAN OUTLET</Data></Cell>");
        wb.println("</Row>");
        wb.println("<Row>");
        ...
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">NAMA OUTLET</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">JUAL TUNAI</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">RETUR</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">TOTAL KREDIT</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">SISA TUNAI</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">PLUNAS TUNAI</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">TOTAL TUNAI</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s81\"><Data ss:Type=\"String\">PLUNAS BG</Data></Cell>");
        
        Vector v = new Vector();
        v = DbSalesDetail.list(0, 0, "", "");
            ...
            for(int i=0; i<result.size(); i++){
                    ...
                    Vector temp = (Vector)result.get(i); 
                     if(i==result.size()-1){
                        ...
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(1)+"</Data></Cell>");
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(2)+"</Data></Cell>");
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(3)+"</Data></Cell>");
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(4)+"</Data></Cell>");
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(5)+"</Data></Cell>");
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(6)+"</Data></Cell>");
                        wb.println("<Cell ss:StyleID=\"s80\"><Data ss:Type=\"Number\">"+(Double)temp.get(7)+"</Data></Cell>");
                    ...
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"String\">"+(String)temp.get(0)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(1)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(2)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(3)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(4)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(5)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(6)+"</Data></Cell>");
                    wb.println("<Cell ss:StyleID=\"s84\"><Data ss:Type=\"Number\">"+(Double)temp.get(7)+"</Data></Cell>");
