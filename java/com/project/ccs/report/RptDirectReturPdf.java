 ...
 * 
 *
 * Created on 13 november, 2012, 10:05 AM
 */
 ...
 * @author  offices
 */
public class RptDirectReturPdf extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        System.out.println("===| RptDirectReturPdf |===");
      ...
      //for header =========================================================== 
            ...
            Cell titleCellHeader = new Cell(new Chunk(JSPFormater.formatDate((rt.getDate()==null) ? new Date() : rt.getDate(), "dd-MM-yyyy"), fontTitle));
            ...
            titleCellHeader = new Cell(new Chunk("RETUR", fontTitle));
  ...
  //==========================end================================
            ...
            int purchaseHeaderTop[] = {10,50,12,28};
            ...
            titleCellTop = new Cell(new Chunk((rt.getVendor()==null) ? "" : ":  " + rt.getVendor(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk("Location", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk(":  "+rt.getDeliverTo(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((rt.getAddress()==null) ? "" : ":  " + rt.getAddress(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            //Payment Type
            titleCellTop = new Cell(new Chunk("Retur Number", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk(":  "+rt.getReturNumber(), tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);        
           ...
           // purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((rt.getNotes()==null)?"": ":  " + rt.getNotes().toUpperCase(), fontNotes));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk(":  "+JSPFormater.formatDate(rt.getDate(), "dd-MM-yyyy") , tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop); 
            ...
            //Status
            titleCellTop = new Cell(new Chunk("Status", tableContent));
            titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellTop.setBorderColor(new Color(255,255,255));
            purchaseTable.addCell(titleCellTop);
            ...
            titleCellTop = new Cell(new Chunk((rt.getAddress()==null) ? "" : ":  " + rt.getStatusDoc(), tableContent));
           ...
           //Subnya
            ...
            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(rt.getSubTotal(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
            ...
            approvalTable.addCell(spaceCellTop);
            if(rt.getVat2()!=0){
                spaceCellTop = new Cell(new Chunk("10%", tableContent));
                spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                spaceCellTop.setBorderColor(new Color(255,255,255));
                approvalTable.addCell(spaceCellTop);
            }else{
                spaceCellTop = new Cell(new Chunk("0%", tableContent));
                spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
                spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                spaceCellTop.setBorderColor(new Color(255,255,255));
                approvalTable.addCell(spaceCellTop);
            ...
            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(rt.getVat2(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
            ...
            spaceCellTop = new Cell(new Chunk(JSPFormater.formatNumber(rt.getGrandTotal(), "#,###.##"), tableContent));
            spaceCellTop.setHorizontalAlignment(Element.ALIGN_RIGHT);
            spaceCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCellTop.setBorderColor(new Color(255,255,255));
            approvalTable.addCell(spaceCellTop);
  ...
  //Approval and Prepared By
            ...
            spaceCell1Top = new Cell(new Chunk("Received By", tableContent));
            //spaceCell1Top.setColspan(3);
            spaceCell1Top.setHorizontalAlignment(Element.ALIGN_LEFT);
            spaceCell1Top.setVerticalAlignment(Element.ALIGN_MIDDLE);
            spaceCell1Top.setBorderColor(new Color(255,255,255));
