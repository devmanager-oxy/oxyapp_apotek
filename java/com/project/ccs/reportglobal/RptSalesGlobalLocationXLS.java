 ...
 */
package com.project.ccs.reportglobal;
...
import com.project.ccs.session.SessGlobalDiskon;
 ...
 * @author Roy
 */
public class RptSalesGlobalLocationXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int a = 0; a < vLoca.size(); a++) {
            ...
            if (listSales != null && listSales.size() > 0) {
                ...
                wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"String\">Number</Data></Cell>");
                wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"String\">Cashier</Data></Cell>");
                ...
                wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"String\">Global Discount  </Data></Cell>");
                ...
                wb.println("      <Cell ss:StyleID=\"s67\"><Data ss:Type=\"String\">Profit  </Data></Cell>");
                wb.println("      </Row>");
                ...
                if (listSales != null && listSales.size() > 0) {
                    for (int i = 0; i < listSales.size(); i++) {
                        ...
                        double dDiscGlobal = 0;

                        double subTotal = SessGlobalDiskon.getSubTotal(sales.getOID());
                        ...
                        if (temp != null && temp.size() > 0) {
                            ...
                            for (int xx = 0; xx < temp.size(); xx++) {
                                ...
                                if (sales.getType() == DbSales.TYPE_RETUR_CASH || sales.getType() == DbSales.TYPE_RETUR_CREDIT) {
                                    ...
                                    totallaba = totallaba - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount()) - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount()) / subTotal) * sales.getGlobalDiskon())) - (sd.getCogs() * sd.getQty()));
                                ...
                                totalDiscGlobal = totalDiscGlobal + ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount()) / subTotal) * sales.getGlobalDiskon());
                                ...
                                if (sales.getType() == DbSales.TYPE_RETUR_CASH || sales.getType() == DbSales.TYPE_RETUR_CREDIT) {
                                    totalKwitansi = totalKwitansi - ((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount() - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon()));
                                } else {
                                    totalKwitansi = totalKwitansi + ((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount() - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon()));
                                }
                                ...
                                if (xx == 0) {
                                    ...
                                    if (sales.getType() == DbSales.TYPE_RETUR_CASH || sales.getType() == DbSales.TYPE_RETUR_CREDIT) {
                                        wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + ((sd.getQty() * sd.getSellingPrice()) * -1) + "</Data></Cell>");
                                        dAmount = dAmount + ((sd.getQty() * sd.getSellingPrice()) * -1);
                                    } else {
                                        wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + (sd.getQty() * sd.getSellingPrice()) + "</Data></Cell>");
                                        dAmount = dAmount + ((sd.getQty() * sd.getSellingPrice()));
                                    }
                                    ...
                                    wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon()) + "</Data></Cell>");
                                    dDiscGlobal = dDiscGlobal + ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon());
                                    
                                    if (sales.getType() == DbSales.TYPE_RETUR_CASH || sales.getType() == DbSales.TYPE_RETUR_CREDIT) {
                                        wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + ((((sd.getQty() * sd.getSellingPrice())) - sd.getDiscountAmount() - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon())) * -1) + "</Data></Cell>");
                                    } else {
                                        wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + ((((sd.getQty() * sd.getSellingPrice())) - sd.getDiscountAmount() - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon())))  + "</Data></Cell>");
                                    ...
                                    if (sales.getType() == DbSales.TYPE_RETUR_CASH || sales.getType() == DbSales.TYPE_RETUR_CREDIT) {
                                        wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + (((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount()) - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon())) - (sd.getCogs() * sd.getQty())) * -1) + "</Data></Cell>");
                                    } else {
                                        wb.println("      <Cell ss:StyleID=\"s78\"><Data ss:Type=\"Number\">" + (((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount()) - ((((sd.getQty() * sd.getSellingPrice()) - sd.getDiscountAmount())/subTotal)*sales.getGlobalDiskon())) - (sd.getCogs() * sd.getQty()))) + "</Data></Cell>");
                                    }
                                    wb.println("      </Row>");
                            ...
                            if (temp.size() > 1) {
                                ...
                                wb.println("      <Cell ss:StyleID=\"s81\"><Data ss:Type=\"Number\">" + dDiscGlobal + "</Data></Cell>");
                ...
                wb.println("      <Cell ss:StyleID=\"s81\"><Data ss:Type=\"Number\">" + totalDiscGlobal + "</Data></Cell>");
