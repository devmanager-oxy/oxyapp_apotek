 ...
 */
public class SessStockReportByLocation {
    ...
    public static int getItemStockCount(String itmCode, String itmName, long locationId, long groupId, int orderBy, int type){
        int count=0;
        String sql = "select " +
            " l."+DbLocation.colNames[DbLocation.COL_NAME]+" as loc "+
            ", g."+DbItemGroup.colNames[DbItemGroup.COL_NAME]+" as ig "+
