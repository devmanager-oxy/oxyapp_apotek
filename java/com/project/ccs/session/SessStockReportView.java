 ...
 * @author Eka Ds
 */
public class SessStockReportView {
    ...
    public static Vector getItemForPriceUpdate(long vendorId, String code, String name, long groupId){
        
        Vector result = new Vector();
        
        String sql = "SELECT * FROM pos_update_price_view p";
                ...
                if(name!=null){
                    where = where + " and item_name like '%"+name+"%'";
                }
                
                if(groupId!=0){
                    where = where + " and item_group_id="+groupId;
                }
