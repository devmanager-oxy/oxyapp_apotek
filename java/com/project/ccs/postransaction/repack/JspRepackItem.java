...
public class JspRepackItem extends JSPHandler implements I_JSPInterface, I_JSPType {
	...
	public JspRepackItem(){
	}
	public JspRepackItem(RepackItem repackItem){
		this.repackItem = repackItem;
	}

	public JspRepackItem(HttpServletRequest request, RepackItem repackItem){
		super(new JspRepackItem(repackItem), request);
		this.repackItem = repackItem;
	}
