 ...
 * @author Roy Andika
 */
public class CmdReceiveBudget extends Control implements I_Language {
    ...
    public CmdReceiveBudget(HttpServletRequest request) {
        msgString = "";
        receive = new Receive();
        try {
            ...
            case JSPCommand.SAVE:
                ...
                if (receive.getOID() == 0) {
                    ...
                    if(bRequest.getOID() == 0 || bRequest.getRefId() != 0){
                        jspReceiveMemo.addError(jspReceiveMemo.JSP_COA_ID, "Account already exsist");
                    }                    
                }                
                
                if (jspReceiveMemo.errorSize() > 0 ) {
