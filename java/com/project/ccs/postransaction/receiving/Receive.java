...
public class Receive extends Entity {
    ...
    private long coaId;
    private int typeAp;
    private int paymentStatusPosted;
    private String noPajak="";
    private int typeInc;
    ...
    public int getPaymentStatusPosted() {
        return paymentStatusPosted;
    }

    public void setPaymentStatusPosted(int paymentStatusPosted) {
        this.paymentStatusPosted = paymentStatusPosted;
    }
    ...
    public int getTypeInc() {
        return typeInc;
    }

    public void setTypeInc(int typeInc) {
