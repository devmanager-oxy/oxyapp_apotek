...
public class JspDirectRetur extends JSPHandler implements I_JSPInterface, I_JSPType {
    ...
    public JspDirectRetur() {
    }

    public JspDirectRetur(Retur retur) {
        this.retur = retur;
    }

    public JspDirectRetur(HttpServletRequest request, Retur retur) {
        super(new JspDirectRetur(retur), request);
        this.retur = retur;
    }
