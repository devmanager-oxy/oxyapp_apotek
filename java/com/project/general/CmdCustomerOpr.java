 ...
 * @author Roy
 */
public class CmdCustomerOpr extends Control {
    ...
    private JspCustomerOpr jspCustomer;

    /** Creates new CtrlUser */
    public CmdCustomerOpr(HttpServletRequest request) {
        msgString = "";
        // errCode = Message.OK;
        ...
        jspCustomer = new JspCustomerOpr(request);
    }
