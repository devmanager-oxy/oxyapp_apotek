...
public class JspCompany_2 extends JSPHandler implements I_JSPInterface, I_JSPType 
{
	...
	public static final int JSP_CONTACT			=  23 ;
        ...
        public static final int JSP_INVOICE_CODE                =   25;
        
        public static final int JSP_CUSTOMER_REQUEST_CODE                =   26;
        
        public static final int JSP_INTRO_LETTER_CODE			=  26 ;
        public static final int JSP_SHOP_ORDER_CODE			=  27 ;
	...
	public static String[] colNames = {
		...
		"JSP_SYSTEM_LOCATION_CODE",  "JSP_CONTACT",
                "JSP_ADDRESS2", "JSP_INVOICE_CODE",
                
                "JSP_CUSTOMER_REQUEST_CODE",
                
                "JSP_INTRO_LETTER_CODE", "JSP_SHOP_ORDER_CODE"
	...
	public JspCompany_2(Company company){
		this.company = company;
	}

	public JspCompany_2(HttpServletRequest request, Company company){
		super(new JspCompany_2(company), request);
		this.company = company;
	}
	...
	public void requestEntityObject(Company company) {
		try{
			...
			company.setGeneralLedgerCode(getString(JSP_GENERAL_LEDGER_CODE));
                        company.setInvoiceCode(getString(JSP_INVOICE_CODE));
			...
			company.setContact(getString(JSP_CONTACT));
                        ...
                        company.setCustomerRequestCode(getString(JSP_CUSTOMER_REQUEST_CODE));
                        
                        company.setIntroLetterCode(getString(JSP_INTRO_LETTER_CODE));
                        company.setShopOrderCode(getString(JSP_SHOP_ORDER_CODE));
