...
public class CmdCompany_1 extends Control implements I_Language 
{
	...
	private JspCompany_1 jspCompany;
	int language = LANGUAGE_DEFAULT;

	public CmdCompany_1(HttpServletRequest request){
		msgString = "";
		company = new Company();
		try{
			pstCompany = new DbCompany(0);
		}catch(Exception e){;}
		jspCompany = new JspCompany_1(request, company);
	}
	...
	public JspCompany_1 getForm() { return jspCompany; }
