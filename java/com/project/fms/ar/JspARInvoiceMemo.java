 ...
 * @author Roy Andika
 */
public class JspARInvoiceMemo extends JSPHandler implements I_JSPInterface, I_JSPType {
    ...
    public static String[] colNames = {
        ...
        "JSP_CREATE_DATE","JSP_LOCATION_ID",
        "JSP_DOC_STATUS","JSP_REF_ID"
    };
    ...
    public JspARInvoiceMemo() {
    }

    public JspARInvoiceMemo(ARInvoice aRInvoice) {
        this.aRInvoice = aRInvoice;
    }

    public JspARInvoiceMemo(HttpServletRequest request, ARInvoice aRInvoice) {
        super(new JspARInvoiceMemo(aRInvoice), request);
        this.aRInvoice = aRInvoice;
    }

    public String getFormName() {
        return JSP_NAME_ARINVOICE;
    }
    ...
    public ARInvoice getEntityObject() {
        return aRInvoice;
    }
    ...
    public void requestEntityObject(ARInvoice aRInvoice) {
        try {
            ...
            aRInvoice.setDate(JSPFormater.formatDate(getString(JSP_DATE), "dd/MM/yyyy"));
