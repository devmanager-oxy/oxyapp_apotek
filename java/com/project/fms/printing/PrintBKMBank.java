...
public class PrintBKMBank {

    static int rowx = 0;
    static int rowLoop = 0;
    static boolean rowSpellMoreThanOne = false;

    public OXY_PrintObj PrintSummaryFormBKM(int typeDoc, long bankDepositId, int maxLoopItem, boolean footLengkap) {
        ...
        try {
            ...
            obj.setObjDescription(" ******** PRINT BKM BANK ******** ");
            obj.setTopMargin(1);
            obj.setLeftMargin(0);
            ...
            // header
            obj = headerBKM(obj);
            obj = mainBKM(obj, bankDepositId);

            if (typeDoc == 2) {
                obj = (OXY_PrintObj) detailBKM(obj, bankDepositId, maxLoopItem);
    ...
    public OXY_PrintObj mainBKM(OXY_PrintObj obj, long bankDepositId) {
        try {
            ...
            obj.setColumnValue(2, rowx, ":", obj.TEXT_LEFT);
            obj.setColumnValue(3, rowx, "" + bankDeposit.getJournalNumber(), obj.TEXT_LEFT);
            obj.setHeader(rowx);
            rowLoop++;
            rowx++;
            ...
            obj.setColumnValue(2, rowx, ":", obj.TEXT_LEFT);
            obj.setColumnValue(3, rowx, "" + JSPFormater.formatDate(bankDeposit.getTransDate(), "dd/MM/yy"), obj.TEXT_LEFT);
            obj.setHeader(rowx);
            rowLoop++;
            rowx++;
            ...
            obj.setColumnValue(2, rowx, ":", obj.TEXT_LEFT);
            obj.setColumnValue(3, rowx, idr + " " + JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##"), obj.TEXT_LEFT);
            obj.setHeader(rowx);
            rowLoop++;
            rowx++;
    ...
    public OXY_PrintObj detailBKM(OXY_PrintObj obj, long bankDepositId, int maxLoopItem) {
        try {
            int[] cola = {8, 1, 5, 1, 21, 1, 20, 1, 20, 1, 20, 1};
            obj.newColumn(12, "", cola);

            String whereClause = DbBankDepositDetail.colNames[DbBankDepositDetail.COL_BANK_DEPOSIT_ID] + "=" + bankDepositId;
            ...
            for (int k = 0; k < vbankDepositDetail.size(); k++) {
                BankDepositDetail bankDepositDetail = (BankDepositDetail) vbankDepositDetail.get(k);
            ...
            //int minLoop = vbankDepositDetail.size() % maxLoopItem;
    ...
    public OXY_PrintObj footerBKM(OXY_PrintObj obj, boolean footLengkap) {
        try {
            ...
            if (footLengkap) {
                ...
                obj.setColumnValue(5, rowx, "|", obj.TEXT_LEFT);
                obj.setColumnValue(6, rowx, "DITERIMA", obj.TEXT_CENTER);
                obj.setColumnValue(7, rowx, "|", obj.TEXT_LEFT);
