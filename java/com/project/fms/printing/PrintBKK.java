...
public class PrintBKK {
    ...
    public OXY_PrintObj PrintSummaryFormBKK(int typeDoc, long pettyCashOID, int maxRowDetail, boolean footLengkap) {
        ...
        try {
            ...
            if (typeDoc == 2) {
                obj = (OXY_PrintObj) detailBKK(obj, pettyCashOID, maxRowDetail);
        ...
        try {
            ...
            if (strSpell.length() < 67) {
                ...
                for (int k = spell1.length(); k > 0; k--) {
                    ...
                    // untuk mengurangi line last
                    // obj.setSpaceRowBlankForNewPaper(obj.getSpaceRowBlankForNewPaper()-1);
                }
    ...
    public OXY_PrintObj detailBKK(OXY_PrintObj obj, long pettyCashOID, int maxLoopItem) {
        try {
            ...
            System.out.println("rowItem : " + rowItem + " minLoop : " + minLoop);
            ...
            System.out.println("rowItem2 : " + rowItem + " minLoop2 : " + minLoop);
    ...
    public OXY_PrintObj footerBKK(OXY_PrintObj obj, long pettyCashOID, boolean footLengkap) {
        try {
            //if(rowLoop > (obj.getPageLength() - 5)){
            //    rowLoop = obj.getPageLength() + 3;
            //}
