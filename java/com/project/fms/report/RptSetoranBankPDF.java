 ...
 * @author Roy Andika
 */
public class RptSetoranBankPDF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            bankDepositId = JSPRequestValue.requestLong(request, "bank_deposit_id");
            bankDeposit = DbBankDeposit.fetchExc(bankDepositId);
        } catch (Exception e) {
        ...
        try {
            ...
            titleCellHeader2 = new Cell(new Chunk("No BBM", fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            titleCellHeader2 = new Cell(new Chunk("" + bankDeposit.getJournalNumber(), fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            titleCellHeader2 = new Cell(new Chunk("" + JSPFormater.formatDate(bankDeposit.getTransDate(), "dd-MM-yyyy"), fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            titleCellHeader2 = new Cell(new Chunk("" + idr + " " + JSPFormater.formatNumber(bankDeposit.getAmount(), "#,###.##"), fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            if (vBankDepositDetail != null && vBankDepositDetail.size() > 0) {
                ...
                for (int i = 0; i < vBankDepositDetail.size(); i++) {

                    BankDepositDetail bankDepositDetail = (BankDepositDetail) vBankDepositDetail.get(i);
                    int page = i + 1;
                    ...
                    total = total + bankDepositDetail.getAmount();
                    ...
                    String segment ="";
                    if(bankDepositDetail.getSegment1Id() != 0){
                        SegmentDetail sd1 = new SegmentDetail();
                        try{
                            sd1 = DbSegmentDetail.fetchExc(bankDepositDetail.getSegment1Id());
                        }catch(Exception e){}
                        
                        segment = segment + sd1.getName();
                    }
                    
                    if(bankDepositDetail.getSegment2Id() != 0){
                        SegmentDetail sd2 = new SegmentDetail();
                        try{
                            sd2 = DbSegmentDetail.fetchExc(bankDepositDetail.getSegment2Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd2.getName();
                    }
                    
                    if(bankDepositDetail.getSegment3Id() != 0){
                        SegmentDetail sd3 = new SegmentDetail();
                        try{
                            sd3 = DbSegmentDetail.fetchExc(bankDepositDetail.getSegment3Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd3.getName();
                    }
                    
                    if(bankDepositDetail.getSegment4Id() != 0){
                        SegmentDetail sd4 = new SegmentDetail();
                        try{
                            sd4 = DbSegmentDetail.fetchExc(bankDepositDetail.getSegment4Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd4.getName();
                    }
                    
                    if(bankDepositDetail.getSegment5Id() != 0){
                        SegmentDetail sd5 = new SegmentDetail();
                        try{
                            sd5 = DbSegmentDetail.fetchExc(bankDepositDetail.getSegment5Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd5.getName();
                    }
                    
                    if(bankDepositDetail.getSegment6Id() != 0){
                        SegmentDetail sd6 = new SegmentDetail();
                        try{
                            sd6 = DbSegmentDetail.fetchExc(bankDepositDetail.getSegment6Id());
                        }catch(Exception e){}
