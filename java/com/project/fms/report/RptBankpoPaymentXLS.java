 ...
 * @author Roy
 */
public class RptBankpoPaymentXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (vVendor != null && vVendor.size() > 0) {
            ...
            for (int v = 0; v < vVendor.size(); v++) {
                ...
                wb.println("      <Cell ss:MergeAcross=\"2\" ss:StyleID=\"s62\"><Data ss:Type=\"String\">" + JSPFormater.formatDate(new Date(), "dd MMM yyyy") + " at " + JSPFormater.formatDate(new Date(), "hh:mm:ss") + "</Data></Cell>");
                wb.println("      <Cell ss:StyleID=\"s62\"/>");
                wb.println("      <Cell ss:Index=\"9\" ss:StyleID=\"s64\"><Data ss:Type=\"String\">Page " + page + " of " + totalPages + "</Data></Cell>");
                ...
                wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"String\">:</Data></Cell>");
                wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s103\"><Data ss:Type=\"String\">" + vend.getAddress() + "</Data></Cell>");
                wb.println("      <Cell ss:Index=\"11\" ss:StyleID=\"s71\"/>");
                wb.println("      </Row>");
                baris++;
                ...
                wb.println("      <Cell ss:StyleID=\"s70\"><Data ss:Type=\"String\">:</Data></Cell>");
                wb.println("      <Cell ss:MergeAcross=\"6\" ss:StyleID=\"s105\"><Data ss:Type=\"String\">" + bankpoPayment.getMemo() + "</Data></Cell>");
                wb.println("      <Cell ss:Index=\"11\" ss:StyleID=\"s71\"/>");
                wb.println("      </Row>");
                baris++;
                ...
                if (vBpd != null && vBpd.size() > 0) {
                    ...
                    for (int i = 0; i < vBpd.size(); i++) {
                        ...
                        double tmpPurchase = 0;
                        double tmpDeduction = 0;

                        if (bpd.getPaymentAmount() > 0) {
                            tmpPurchase = bpd.getPaymentAmount();
                        } else {
                            tmpDeduction = bpd.getPaymentAmount() * -1;
                        }
                            ...
                            for (int t = 0; t < looping; t++) {
                                ...
                                if (idx <= maxDatas) {
                                    if (available) {
                                        ...
                                        wb.println("      <Cell ss:MergeAcross=\"2\" ss:StyleID=\"s62\"><Data ss:Type=\"String\">" + desc + "</Data></Cell>");
                                        ...
                                        wb.println("      <Cell ss:MergeAcross=\"1\" ss:StyleID=\"s134\"><Data ss:Type=\"Number\">" + JSPFormater.formatNumber(tmpPurchase, "#,###.##") + "</Data></Cell>");
                                        wb.println("      <Cell ss:StyleID=\"s134\"><Data ss:Type=\"Number\">" + JSPFormater.formatNumber(tmpDeduction, "#,###.##") + "</Data></Cell>");
                                        wb.println("      <Cell ss:Index=\"11\" ss:StyleID=\"s71\"/>");
                                        wb.println("      </Row>");
                                    } else {
                                        wb.println("      <Row ss:AutoFitHeight=\"0\">");
                        ...
                        tPurchase = tPurchase + tmpPurchase;
                        tDeduction = tDeduction + tmpDeduction;
                    }
