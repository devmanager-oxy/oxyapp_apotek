 ...
 * @author Roy Andika
 */
public class RptPoPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("===| Rpt PO Payment Pdf |===");
        int lang = 0;
        ...
        try{
            vVendor = DbBankpoPaymentDetail.getGroupVendor(bankpoPayment.getRefId());            
        }catch(Exception e){}
        ...
        BankpoPayment tt = new BankpoPayment();
        try{
            tt = DbBankpoPayment.fetchExc(bankpoPayment.getRefId());
        }catch(Exception e){}
        ...
        try {
            ...
            if (vVendor != null && vVendor.size() > 0) {
                ...
                for(int v = 0; v < vVendor.size(); v++){
                    ...
                    String where = DbBankpoPaymentDetail.colNames[DbBankpoPaymentDetail.COL_BANKPO_PAYMENT_ID]+" = "+bankpoPayment.getRefId()+" and "+DbBankpoPaymentDetail.colNames[DbBankpoPaymentDetail.COL_VENDOR_ID]+" = "+vendorId;                    
                    ...
                    titleCellHeader = new Cell(new Chunk(JSPFormater.formatDate(tt.getDate(),"dd/MM/yyyy"), fontHeaderv));
                    titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                    titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                    titleCellHeader.setBorderColor(new Color(255, 255, 255));
                    titleTable.addCell(titleCellHeader);
                    ...
                    String clearingDate = "";
                    if(tt.getTransDate() != null){
                        try{
                            clearingDate = JSPFormater.formatDate(tt.getTransDate(),"dd/MM/yyyy");
                        }catch(Exception e){}                        
                    }
                    
                    titleCellHeader = new Cell(new Chunk(clearingDate, fontHeaderv));
                    titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                    titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                    titleCellHeader.setBorderColor(new Color(255, 255, 255));
                    titleTable.addCell(titleCellHeader);
                   ...
                   //new
                    ...
                    titleCellHeader = new Cell(new Chunk("Payment Method", fontHeader));
                    titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                    titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                    titleCellHeader.setBorderColor(new Color(255, 255, 255));
                    titleTable.addCell(titleCellHeader);
                    ...
                    try{
                        pm = DbPaymentMethod.fetchExc(tt.getPaymentMethodId());
                    }catch(Exception e){}
                    
                    titleCellHeader = new Cell(new Chunk(pm.getDescription(), fontHeaderv));
                    titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                    titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                    titleCellHeader.setBorderColor(new Color(255, 255, 255));
                    titleTable.addCell(titleCellHeader);
                    
                    if(tt.getDueDateBG() != null){
                        titleCellHeader = new Cell(new Chunk("Due Date BG", fontHeader));
                        titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                        titleCellHeader.setBorderColor(new Color(255, 255, 255));
                        titleTable.addCell(titleCellHeader);
                        ...
                        titleCellHeader = new Cell(new Chunk(""+JSPFormater.formatDate(tt.getDueDateBG(), "dd/MM/yyyyy"), fontHeaderv));
                        titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                        titleCellHeader.setBorderColor(new Color(255, 255, 255));
                        titleTable.addCell(titleCellHeader);
                        ...
                        titleCellHeader = new Cell(new Chunk("", fontHeaderv));
                        titleCellHeader.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellHeader.setVerticalAlignment(Element.ALIGN_MIDDLE);                    
                        titleCellHeader.setBorderColor(new Color(255, 255, 255));
                        titleTable.addCell(titleCellHeader);
                    ...
                    if (vBpd != null && vBpd.size() > 0) {
                        ...
                        for (int i = 0; i < vBpd.size(); i++){
                            ...
                            titlePrCellTop = new Cell(new Chunk(receive.getInvoiceNumber(), tableContent));
                            titlePrCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                            titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);                            
