 ...
 * @author Roy Andika
 */
public class RptProfitLossSegmentMTDV02XLS_backup extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        long year = 0;
        try{
            year = Long.parseLong((String)session.getValue("PERIODMTDIDMULTIPLE"));
        }catch(Exception e){}
        
        try{
            segment1Id = Long.parseLong((String)session.getValue("SEGMENT1MTDIDMULTIPLE"));
        }catch(Exception e){}
        ...
        if(sd.getOID() != 0){
            ...
            wb.println("     <Cell ss:Index=\"2\" ss:MergeAcross=\"" + (colSpan + 2) + "\" ss:StyleID=\"s42\"><Data ss:Type=\"String\">MULTI PERIODS</Data></Cell>");
            wb.println("     </Row>");
        }else{
            wb.println("     <Row ss:Height=\"18\">");
            wb.println("     <Cell ss:Index=\"2\" ss:MergeAcross=\"" + (colSpan + 2) + "\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">MULTI PERIODS</Data></Cell>");
            wb.println("     </Row>");
        }
