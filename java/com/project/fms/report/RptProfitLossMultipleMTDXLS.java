 ...
 * @author Roy Andika
 */
public class RptProfitLossMultipleMTDXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            temp = (Vector) session.getValue("PERIODE_MULTIPLE_MTD");
        } catch (Exception e) {
        }
        ...
        wb.println("     <Border ss:Position=\"Top\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("    </Borders>");
        wb.println("    <NumberFormat ss:Format=\"_(* #,##0.00_);_(* \\(#,##0.00\\);_(* &quot;0.00&quot;??_);_(@_)\"/>");        
        wb.println("   </Style>");        
        ...
        wb.println("     <Border ss:Position=\"Top\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\"/>");
        wb.println("    </Borders>");
        wb.println("    <NumberFormat ss:Format=\"_(* #,##0.00%;_(* \\(#,##0.00%\\);_(* &quot;0.00%&quot;;_(@_)\"/>");        
        wb.println("   </Style>");
