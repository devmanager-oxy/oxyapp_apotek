 ...
 * @author  Suarjaya
 */
public class RptSaldoDepositXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"2\" ss:StyleID=\"s23\"><Data ss:Type=\"String\">Penitip/Unit : "+rptKonstan.getUnit()+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s24\"/>");
        wb.println("</Row>");
        ...
        wb.println("<Cell ss:StyleID=\"s25\"><Data ss:Type=\"String\">Penitip/Unit</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25044696\"><Data ss:Type=\"String\">Saldo Titipan</Data></Cell>");
        wb.println("</Row>");
