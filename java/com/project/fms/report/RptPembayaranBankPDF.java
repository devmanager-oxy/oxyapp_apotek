 ...
 * @author Roy Andika
 */
public class RptPembayaranBankPDF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            banknonpoPaymentId = JSPRequestValue.requestLong(request, "cash_id");
            banknonpoPayment = DbBanknonpoPayment.fetchExc(banknonpoPaymentId);
        } catch (Exception e) {
            System.out.println(e.toString());
        }

        String whereClause = DbBanknonpoPaymentDetail.colNames[DbBanknonpoPaymentDetail.COL_BANKNONPO_PAYMENT_ID] + "=" + banknonpoPayment.getOID();
        Vector vDbBanknonpoPaymentDetail = DbBanknonpoPaymentDetail.list(0, 0, whereClause, null);        
        ...
        try {
            ...
            titleCellHeader2 = new Cell(new Chunk("No BBK", fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            titleCellHeader2 = new Cell(new Chunk("" + banknonpoPayment.getJournalNumber(), fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            titleCellHeader2 = new Cell(new Chunk("" + JSPFormater.formatDate(banknonpoPayment.getTransDate(), "dd-MM-yyyy"), fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            titleCellHeader2 = new Cell(new Chunk("Supplier", fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            String pegawai = "";
            try {                
                Vendor vendor = DbVendor.fetchExc(banknonpoPayment.getVendorId());                
                pegawai = vendor.getName();
            } catch (Exception e) {
            ...
            titleCellHeader2 = new Cell(new Chunk("" + idr + " " + JSPFormater.formatNumber(banknonpoPayment.getAmount(), "#,###.##"), fontHeader));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorderColor(new Color(255, 255, 255));
            titleTable2.addCell(titleCellHeader2);
            ...
            if (vDbBanknonpoPaymentDetail != null && vDbBanknonpoPaymentDetail.size() > 0) {
                ...
                titlePrCellTop = new Cell(new Chunk("NO. REKENING", fontHeader));
                titlePrCellTop.setHorizontalAlignment(Element.ALIGN_CENTER);
                titlePrCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                titlePrCellTop.setBorderColor(blackColor);
                titlePrCellTop.setBorderWidth(1);
                ...
                for (int i = 0; i < vDbBanknonpoPaymentDetail.size(); i++) {

                    BanknonpoPaymentDetail banknonpoPaymentDetail = (BanknonpoPaymentDetail) vDbBanknonpoPaymentDetail.get(i);
                    int page = i + 1;
                    ...
                    if (banknonpoPaymentDetail.getAmount() == 0) {
                        strAmount = "(" + JSPFormater.formatNumber(banknonpoPaymentDetail.getForeignAmount(), "#,###.##") + ")";
                    } else {
                        strAmount = JSPFormater.formatNumber(banknonpoPaymentDetail.getAmount(), "#,###.##");
                    }

                    total = total + banknonpoPaymentDetail.getAmount();

                    try {
                        if (banknonpoPaymentDetail.getCoaId() != 0) {
                            result = DbCashReceiveDetail.getCodeCoa(banknonpoPaymentDetail.getCoaId());
                    ...
                    String segment ="";
                    if(banknonpoPaymentDetail.getSegment1Id() != 0){
                        SegmentDetail sd1 = new SegmentDetail();
                        try{
                            sd1 = DbSegmentDetail.fetchExc(banknonpoPaymentDetail.getSegment1Id());
                        }catch(Exception e){}
                        
                        segment = segment + sd1.getName();
                    }
                    
                    if(banknonpoPaymentDetail.getSegment2Id() != 0){
                        SegmentDetail sd2 = new SegmentDetail();
                        try{
                            sd2 = DbSegmentDetail.fetchExc(banknonpoPaymentDetail.getSegment2Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd2.getName();
                    }
                    
                    if(banknonpoPaymentDetail.getSegment3Id() != 0){
                        SegmentDetail sd3 = new SegmentDetail();
                        try{
                            sd3 = DbSegmentDetail.fetchExc(banknonpoPaymentDetail.getSegment3Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd3.getName();
                    }
                    
                    if(banknonpoPaymentDetail.getSegment4Id() != 0){
                        SegmentDetail sd4 = new SegmentDetail();
                        try{
                            sd4 = DbSegmentDetail.fetchExc(banknonpoPaymentDetail.getSegment4Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd4.getName();
                    }
                    
                    if(banknonpoPaymentDetail.getSegment5Id() != 0){
                        SegmentDetail sd5 = new SegmentDetail();
                        try{
                            sd5 = DbSegmentDetail.fetchExc(banknonpoPaymentDetail.getSegment5Id());
                        }catch(Exception e){}
                        
                        segment = segment +" | "+ sd5.getName();
                    }
                    
                    if(banknonpoPaymentDetail.getSegment6Id() != 0){
                        SegmentDetail sd6 = new SegmentDetail();
                        try{
                            sd6 = DbSegmentDetail.fetchExc(banknonpoPaymentDetail.getSegment6Id());
                        }catch(Exception e){}
