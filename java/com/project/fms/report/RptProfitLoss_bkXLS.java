...
public class RptProfitLoss_bkXLS extends HttpServlet {
    ...
    */
	...
	int colSpan = 0;
        ...
        wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"466.25\"/>");
        wb.println("    <Column ss:AutoFitWidth=\"0\" ss:Width=\"158.75\" ss:Span=\""+(colSpan)+"\"/>");
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+1)+"\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">PERIOD "+ openPeriod.toUpperCase()+"</Data></Cell>");
        wb.println("     </Row>");
