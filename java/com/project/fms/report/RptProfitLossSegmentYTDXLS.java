 ...
 * @author Roy Andika
 */
public class RptProfitLossSegmentYTDXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{            
            vectorList = (Vector)session.getValue("PROFIT0YTD");
        } catch (Exception e) { System.out.println(e); }
        
        try{
            periodeId = Long.parseLong((String)session.getValue("PERIODIDYTD"));
        }catch(Exception e){}
        
        try{
            segment1Id = Long.parseLong((String)session.getValue("LOCATIONIDYTD"));
        }catch(Exception e){}
        ...
        wb.println("      <Cell ss:StyleID=\"s41\"><Data ss:Type=\"String\">"+prevPeriod.toUpperCase()+"</Data></Cell>");
        wb.println("      <Cell ss:MergeAcross=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">" + opPeriod.toUpperCase() + "</Data></Cell>");
