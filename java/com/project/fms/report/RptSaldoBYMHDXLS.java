 ...
 * @author  Suarjaya
 */
public class RptSaldoBYMHDXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"3\" ss:StyleID=\"s46\"><Data ss:Type=\"String\">SALDO BYMHD</Data></Cell>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"2\" ss:StyleID=\"s23\"><Data ss:Type=\"String\">Uraian : "+rptKonstan.getUraian()+"</Data></Cell>");
        ...
        wb.println("<Cell ss:Index=\"2\" ss:MergeAcross=\"2\" ss:StyleID=\"s23\"><Data ss:Type=\"String\">Uraian : "+((rptKonstan.getUnit()==null) ? "-" : rptKonstan.getUnit())+"</Data></Cell>");
        wb.println("<Cell ss:StyleID=\"s24\"/>");
        wb.println("</Row>");
        ...
        wb.println("<Cell ss:StyleID=\"s25\"><Data ss:Type=\"String\">Uraian</Data></Cell>");
        wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25044696\"><Data ss:Type=\"String\">Saldo BYMHD</Data></Cell>");
        wb.println("</Row>");
        ...
        if(vDetail!=null && vDetail.size()>0){
            ...
            RptSaldoHDL detail = (RptSaldoHDL)vDetail.get(i);
                ...
                wb.println("<Cell ss:StyleID=\"s28\"><Data ss:Type=\"String\">"+detail.getUnitBYMHD()+"</Data></Cell>");
                wb.println("<Cell ss:MergeAcross=\"1\" ss:StyleID=\"m25044706\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(detail.getSaldoBYMHD(), "#,##0.00")+"</Data></Cell>");
                wb.println("</Row>");
            }
        }
        ...
        wb.println("<Cell ss:StyleID=\"s29\"><Data ss:Type=\"Number\">"+JSPFormater.formatNumber(rptKonstan.getTotalBYMHD(), "#,##0.00")+"</Data></Cell>");
        wb.println("</Row>");
        wb.println("<Row>");
