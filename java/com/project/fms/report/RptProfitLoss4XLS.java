 ...
 * @author Roy Andika
 */
public class RptProfitLoss4XLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(lastPeriod.getOID() == 0){
            lstPeriod = JSPFormater.formatDate(periode.getStartDate(), "MMM");
            int lastYr = periode.getStartDate().getYear()+1900-1;
            lstPeriod = lstPeriod +" "+lastYr;
        }
        ...
        try {
            ...
            startDate = (Date) session.getValue("START_DATE");
            endDate = (Date) session.getValue("END_DATE");
        } catch (Exception e) {
        ...
        wb.println("    <Column ss:Index=\"" + (colSpan + 6) + "\" ss:Hidden=\"1\" ss:AutoFitWidth=\"0\" ss:Span=\"" + (256 - colSpan - 6) + "\"/>");
        ...
        String opPeriod = JSPFormater.formatDate(periode.getStartDate(), "MMM yyyy");        
        wb.println("     <Row>");
        wb.println("      <Cell ss:Index=\"2\" ss:MergeDown=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">Description</Data></Cell>");
        wb.println("      <Cell ss:StyleID=\"s41\"><Data ss:Type=\"String\">Previous Period</Data></Cell>");
        wb.println("      <Cell ss:MergeAcross=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">" + opPeriod + "</Data></Cell>");
        wb.println("      <Cell ss:MergeDown=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">Total Corporate</Data></Cell>");
        wb.println("     </Row>");
        //content
