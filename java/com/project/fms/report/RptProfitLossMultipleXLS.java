...
public class RptProfitLossMultipleXLS extends HttpServlet {
    ...
    */
    ...
    throws ServletException, java.io.IOException {
        ...
        Vector vDep = DbPeriode.list(0,0, where, "start_date");
	...
	int colSpan = vDep.size();
        ...
        wb.println("      <Cell ss:Index=\"2\" ss:MergeAcross=\""+(colSpan+1)+"\" ss:StyleID=\"s43\"><Data ss:Type=\"String\">MULTIPLE PERIODS</Data></Cell>");
        wb.println("     </Row>");
        ...
        if(vDep!=null && vDep.size()>0){
            for(int i=0; i<vDep.size(); i++){
                Periode dep = (Periode)vDep.get(i);												
                wb.println("      <Cell ss:MergeAcross=\"0\" ss:StyleID=\"s41\"><Data ss:Type=\"String\">"+dep.getName()+"</Data></Cell>");
            }
        }
            ...
            for(int i=0; i<vectorList.size(); i++){
                ...
                {    
                    ...
                    if(vDepx!=null && vDepx.size()>0)
                    {
                        ...
                        //System.out.println("val = "+dblDep);
                    }
                    wb.println("      <Cell ss:StyleID=\""+xFont1+"\"><Data ss:Type=\"Number\">"+dblDep+"</Data></Cell>");   
                }


                //wb.println("      <Cell ss:StyleID=\""+xFont1+"\"><Data ss:Type=\"String\">"+srb.getDepartment()+"</Data></Cell>");   
