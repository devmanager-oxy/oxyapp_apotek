 ...
 * @author  Suarjaya
 */
public class RptAccPayableAgingXLS extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        try{
            ...
            if(str!=null && str.length()>0){
                unitUsaha = DbUnitUsaha.fetchExc(Long.parseLong(str));
            }
        } catch (Exception e) { 
            System.out.println(e); 
        }
        ...
        wb.println("      <Column ss:StyleID=\"s21\" ss:AutoFitWidth=\"0\" ss:Width=\"82.5\" ss:Span=\"4\"/>");
        wb.println("      <Column ss:Index=\"10\" ss:StyleID=\"s21\" ss:AutoFitWidth=\"0\" ss:Width=\"108.75\"/>");
        wb.println("      <Column ss:StyleID=\"s21\" ss:AutoFitWidth=\"0\" ss:Width=\"9\"/>");
        ...
        wb.println("      <Row ss:AutoFitHeight=\"0\" ss:Height=\"12.75\">");
        wb.println("       <Cell ss:Index=\"2\" ss:StyleID=\"s28\"><Data ss:Type=\"String\" x:Ticked=\"1\">ACCOUNT PAYABLE</Data></Cell>");
        //wb.println("       <Cell ss:Index=\"4\"><Data ss:Type=\"String\"></Data></Cell>");
        wb.println("       <Cell ss:Index=\"5\" ss:StyleID=\"s29\"/>");
        ...
        wb.println("      <Row ss:AutoFitHeight=\"0\" ss:Height=\"9\" ss:StyleID=\"s30\">");
        ...
        wb.println("       <Cell ss:MergeDown=\"1\" ss:StyleID=\"m15979064\"><Data ss:Type=\"String\">Vendor</Data></Cell>");
        ...
        wb.println("<Row ss:AutoFitHeight=\"0\" ss:Height=\"7.5\" ss:StyleID=\"s30\"/>");
