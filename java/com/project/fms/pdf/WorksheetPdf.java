 ...
 * @author gwawan
 */
public class WorksheetPdf extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Vector vReport = (Vector) session.getValue("SESS_WORKSHEET_PDF");
    ...
    public static void getReport(Document document, Vector vReport) throws BadElementException, DocumentException {
        ...
        if(vReport != null && vReport.size() > 0) {
            ...
            String reportPeriod = (String)vReport.get(2);
            String date = (String)vReport.get(3);
            String transDate = (String)vReport.get(4);
            Vector vRow = (Vector)vReport.get(5);
            ...
            report.addCell(new Phrase(reportPeriod, fontHeaderB));
            if(!date.equals("")) report.addCell(new Phrase(date, fontContentB));
            if(!transDate.equals("")) report.addCell(new Phrase(transDate, fontContentB));
            ...
            if(vRow != null && vRow.size() > 0) {
                for(int i=0; i<vRow.size(); i++) {
                    Worksheet ws = (Worksheet)vRow.get(i);
                    ...
                    if (ws.getRowType() == Worksheet.ROW_TYPE_DESCRIPTION) {
                        report.setDefaultRowspan(1);
                        report.setDefaultColspan(5);
                        report.setDefaultCellBorder(Table.NO_BORDER);
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_LEFT);
                        report.addCell(new Phrase((ws.getJournalNumber()+" - "+ws.getNote()+"; Tanggal Dibuat: "+JSPFormater.formatDate(ws.getDate(), "dd/MM/yyyy")+"; Tanggal Transaksi: "+JSPFormater.formatDate(ws.getTransDate(), "dd/MM/yyyy")+"; Referensi: "+ws.getRefNumber()), fontContent));
                        
                        report.setDefaultRowspan(1);
                        report.setDefaultColspan(1);
                        report.setDefaultCellBorder(Table.LEFT | Table.TOP | Table.RIGHT | Table.BOTTOM);
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_CENTER);
                        report.addCell(new Phrase("Perkiraan", fontContentB));
                        report.addCell(new Phrase("Tipe", fontContentB));
                    ...
                    } else if (ws.getRowType() == Worksheet.ROW_TYPE_SUB_TOTAL) {
                        report.setDefaultCellBorder(Table.LEFT | Table.TOP | Table.RIGHT | Table.BOTTOM);
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_CENTER);
                        report.addCell(new Phrase(ws.getAccount(), fontContent));
                        report.addCell(new Phrase("", fontContent));
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_RIGHT);
                        report.addCell(new Phrase(toAccountingFormat(ws.getDebet()), fontContent));
                        report.addCell(new Phrase(toAccountingFormat(ws.getCredit()), fontContent));
                        report.addCell(new Phrase("", fontContent));
                        ...
                        report.setDefaultCellBorder(Table.NO_BORDER);
                        report.addCell(new Phrase("", fontContent));
                    } else if (ws.getRowType() == Worksheet.ROW_TYPE_TOTAL) {
                        report.setDefaultRowspan(1);
                        report.setDefaultColspan(5);
                        report.setDefaultCellBorder(Table.NO_BORDER);
                        report.addCell(new Phrase("", fontContent));
                        ...
                        report.setDefaultCellBorder(Table.LEFT | Table.TOP | Table.RIGHT | Table.BOTTOM);
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_CENTER);
                        report.addCell(new Phrase(ws.getAccount(), fontContentB));
                        report.addCell(new Phrase("", fontContent));
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_RIGHT);
                        report.addCell(new Phrase(toAccountingFormat(ws.getDebet()), fontContent));
                        report.addCell(new Phrase(toAccountingFormat(ws.getCredit()), fontContent));
                        ...
                        report.addCell(new Phrase(ws.getAccount(), fontContent));
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_CENTER);
                        report.addCell(new Phrase(ws.getAccountType(), fontContent));
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_RIGHT);
                        report.addCell(new Phrase(toAccountingFormat(ws.getDebet()), fontContent));
                        report.addCell(new Phrase(toAccountingFormat(ws.getCredit()), fontContent));
                        report.setDefaultHorizontalAlignment(Cell.ALIGN_LEFT);
                        report.addCell(new Phrase(ws.getDetailNote(), fontContent));
                    }
                }
            }
        }
