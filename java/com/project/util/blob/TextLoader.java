...
public class TextLoader {
    ...
    public Hashtable hsFiles = new Hashtable(); 	// key -> html_field_name(String), val -> Object_of_byte[](Object array of bayte)
    private String strResult = new String();
    public Hashtable hsFilesString = new Hashtable(); 
    ...
    private int composeText() {
        try {
            com.project.util.blob.Files hsBlobFiles = smartUploader.getFiles();
            System.out.println("Number of uploaded file......>> " + hsBlobFiles.getCount());
            
            for(int i = 0; i < hsBlobFiles.getCount(); i++) {
                com.project.util.blob.File upFile = hsBlobFiles.getFile(i);
                ...
                for(int j = 0;  j < fSize; j++) {
                    ...
                    System.out.println("realBytes[j] : "+realBytes[j]);
                }
                
                String strResult = new String(realBytes);
                ...
                hsFilesString.put(key, strResult);
    ...
    public String getStringFile(String key) {
        String str = (String)hsFilesString.get(key);
        return str;
    }
