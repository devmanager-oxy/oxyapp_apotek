 ...
 * @author gwawan
 */
public class RptAssesmentTransaction {
    private long sewaTanahInvoiceId = 0;
    private String InvoiceNumber = "";
    private String NoFp = "";
    private double JumlahAssesment = 0;
    ...
    public double getJumlahAssesment() {
        return JumlahAssesment;
    }

    public void setJumlahAssesment(double JumlahAssesment) {
        this.JumlahAssesment = JumlahAssesment;
    }
