 ...
 * @author Tu Roy
 */
public class RptLimbahPeriodXls extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector vlistRptLimbahBulanan = new Vector();  
        
        HttpSession sess = request.getSession(true);
        
        try {               
            
            vlistRptLimbahBulanan = (Vector)sess.getValue("RPT_LIMBAH_BULANAN");

        }catch(Exception e){
            System.out.println("[exception] "+e.toString());
        }
        
        if(vlistRptLimbahBulanan != null && vlistRptLimbahBulanan.size() > 0 ){
            
            String frmCurrency = "#,###";
            
            RptLimbahPeriod objRpt = (RptLimbahPeriod)vlistRptLimbahBulanan.get(0);
            String namePeriod = "";
            ...
            String[] tableTitle = {
                "PENGAKUAN PENDAPATAN AIR LIMBAH",
                "BULAN",
                ""+namePeriod
            };
            ...
            String[] tableHeader = {                
                "NO", "KETERANGAN", "BULAN INI","BULAN LALU","STAND","PEMAKAIAN","HATGA (RP)","JUMLAH","REK. KREDIT","PPN","TOTAL PENDAPATAN","REK. DEBET"                
            };            
            ...
            for(int i = 0; i < vlistRptLimbahBulanan.size() ; i ++){
                ...
                try{
                    rptLimbahPeriod = (RptLimbahPeriod)vlistRptLimbahBulanan.get(i);
                }catch(Exception e){
                    System.out.println("Exception "+e.toString());
                }
                 ...
                 */
                cell = row.createCell((short) collPos);
                cell.setCellValue(String.valueOf(rptLimbahPeriod.getCustName()));
                cell.setCellStyle(styleValue);
                collPos++;
                 ...
                 */
                cell = row.createCell((short) collPos);
                cell.setCellValue(JSPFormater.formatNumber(rptLimbahPeriod.getTransBulanIni(),frmCurrency));
                cell.setCellStyle(styleValue);
                collPos++;
                
                bulIni = bulIni + rptLimbahPeriod.getTransBulanIni();
                /**
                 * @DESC    : FULL NAME
                 */
                cell = row.createCell((short) collPos);
                cell.setCellValue(JSPFormater.formatNumber(rptLimbahPeriod.getTransBulanLalu(),frmCurrency));
                cell.setCellStyle(styleValue);
                collPos++;                
               
                bulLalu = bulLalu + rptLimbahPeriod.getTransBulanLalu();
                
                double stand = rptLimbahPeriod.getTransBulanIni() - rptLimbahPeriod.getTransBulanLalu();
                ...
                double tmpPemakaian = ((rptLimbahPeriod.getTransBulanIni() - rptLimbahPeriod.getTransBulanLalu()) * rptLimbahPeriod.getTransPercentage()) / 100;
                /**
                 * @DESC    : PEMAKAIAN
                 */
                cell = row.createCell((short) collPos);
                 ...
                 */
                cell = row.createCell((short) collPos);
                cell.setCellValue(JSPFormater.formatNumber(rptLimbahPeriod.getTransHarga(),frmCurrency));
                cell.setCellStyle(styleValue);
                collPos++;
                 ...
                 * @DESC    : JUMLAH
                 */
                double jumlah = tmpPemakaian * rptLimbahPeriod.getTransHarga();
                 ...
                 * @DESC    : PPN
                 */
                double tmpPpn = rptLimbahPeriod.getLimPpnPercent() * jumlah;
