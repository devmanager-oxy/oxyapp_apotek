 ...
 * @author Roy Andika
 */
public class RptKwitansiPdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String a = JSPFormater.formatNumber(pembayaran.getJumlah(), "#,###");
            ...
            titleCellHeader2 = new Cell(new Chunk("Rp. " + JSPFormater.formatNumber(pembayaran.getJumlah(), "###,###")+",-", fontBold));
            titleCellHeader2.setHorizontalAlignment(Element.ALIGN_LEFT);
            titleCellHeader2.setVerticalAlignment(Element.ALIGN_MIDDLE);
            titleCellHeader2.setBorder(0);
            titleCellHeader2.setBorderColor(putih);
